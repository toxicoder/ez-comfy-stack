...
def test_lab_graphs_use_model_native_prompts_and_enhance_nodes() -> None:
    ...
    ltx_t = json.loads(lab_json("motion/av/text-to-video-10s.json").read_text(encoding="utf-8"))
    ltx_i = json.loads(lab_json("motion/av/still-to-video-10s.json").read_text(encoding="utf-8"))
