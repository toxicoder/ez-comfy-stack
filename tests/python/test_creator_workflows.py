...
CREATORS = (
    ...
    ("motion/av/shorts-still-12s", "ez_shorts_ltx_video", True),
    ...
    ("motion/av/dialogue-12s", "ez_ltx_dialogue", True),
    ("motion/av/multishot-12s", "ez_ltx_multishot", True),
    ("motion/av/product-hero", "ez_ltx_product", True),
    ("motion/av/first-last-12s", "ez_ltx_flf", True),
    ("motion/av/audio-to-video-12s", "ez_ltx_a2v", True),
