...
def test_pick_template_heuristic() -> None:
    ...
    assert pick_template("background edit cartoon alley", "auto") == "stills/background-edit"
    assert pick_template("restyle background cel ink", "auto") == "stills/background-edit"
