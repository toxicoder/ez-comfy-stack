...
GOSEE_IDENTITY = (
    f"A {STYLE_LOCK}, cinematic first-person eye-level body-cam already at a dead sprint "
    "across a golden-hour tropical rooftop terrace, looking straight ahead at a wide rooftop "
    "gap that already fills the center. An original techno wizard occupies only the lower "
    "third: ink-black fitted running sleeves, blank matte-black gloves, contralateral pump, "
    "left glove hip-to-chest, empty palms, hands free. An open short storm-cloak in matte "
    "charcoal with a warm-gold inner lining streams at the left and right frame edges. Tiny "
    "floating warm-gold rune motes hover near the wrists only. Unmarked palm trees and glass "
    "towers rush toward a bright bay beyond the gap. Physically plausible late-sun rim light, "
    "fabric weave and stone grit, mild film grain. Wide 24mm body-cam, slight barrel, a "
    "full-bleed photographic plate in YouTube 16:9 with bare frame edges and a clean unmarked "
    "lens, empty of lettering."
)
GOSEE_WAN_I2V_01 = (
    "First-person eye-level body-cam already at a dead sprint across a sunlit terrace. "
    "Contralateral arm pump in the lower third, blank gloves, empty palms, elbows bent, "
...
GOSEE_LTX_I2V_01 = (
    ...
    "eye-level body-cam tracks forward, horizon bobbing, no cut. Ink-black sleeves and "
    "blank matte-black gloves stay in the lower third, empty palms, as the open short "
    "storm-cloak streams with warm-gold lining flashing and tiny wrist motes only. The "
    "rooftop gap already in the start frame grows dead ahead. Last frames hold the gap "
    "in the center until it fills the frame. Photoreal cinematic motion, physically "
    "plausible light, fabric weave and stone grit. Full-bleed photographic plate, bare "
    "edges, clean unmarked lens. No speech. No music and no score."
)
