...
REL_RENAMES: dict[str, str] = {
    ...
    "dcc/ltx/canny-control-5s": "dcc/canny-control-10s",
    "dcc/ltx/depth-control-5s": "dcc/depth-control-10s",
    "dcc/ltx/depth-control-shorts": "dcc/depth-control-shorts",
    "dcc/ltx/depth-from-loader": "dcc/depth-from-loader",
    "dcc/ltx/iclora-canny-5s": "dcc/canny-control-10s",
    "dcc/ltx/iclora-depth-5s": "dcc/depth-control-10s",
    ...
    "ltx/a2v-5s": "motion/av/audio-to-video-10s",
    "ltx/audio-to-video-5s": "motion/av/audio-to-video-10s",
    ...
    "ltx/dialogue-5s": "motion/av/dialogue-10s",
    "ltx/first-last-5s": "motion/av/first-last-10s",
    "ltx/flf-5s": "motion/av/first-last-10s",
    "ltx/hook-av": "motion/av/hook-av",
    "ltx/i2v-5s": "motion/av/still-to-video-10s",
    "ltx/i2v-shot": "motion/av/still-to-shot",
    "ltx/interior-ambience": "motion/av/interior-ambience",
    "ltx/multishot-5s": "motion/av/multishot-10s",
    "ltx/product-hero": "motion/av/product-hero",
    "ltx/shorts-i2v": "motion/av/shorts-still-10s",
    "ltx/shorts-still-5s": "motion/av/shorts-still-10s",
    "ltx/still-to-shot": "motion/av/still-to-shot",
    "ltx/still-to-video-5s": "motion/av/still-to-video-10s",
    "ltx/t2v-5s": "motion/av/text-to-video-10s",
    "ltx/text-to-video-5s": "motion/av/text-to-video-10s",
