...
| IC-LoRA Union Control | Depth / canny / pose v2v. Lab envelope: `workflows/dcc/dcc/ltx/iclora-depth-5s.json`. Official graph stays Templates (`LTX-2.5_ICLoRA_Union_Control_Distilled.json`). LoRA: `download-ltx --tier iclora` → `ltx-2.3-22b-ic-lora-union-control-ref0.5.safetensors`. Distilled-only. Refuse 19B. |
