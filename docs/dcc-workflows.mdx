...
| **dcc/depth-control-10s** | ltx | Envelope. Templates → LTX-2.5 Union Control. Depth default. Distilled-only. Refuse 19B. MagCache off. |
| **dcc/canny-control-10s** | ltx | Same envelope; wire `canny.mp4`. |
