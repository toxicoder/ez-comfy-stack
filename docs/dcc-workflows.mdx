...
| **dcc/depth-control-12s** | ltx | Envelope. Templates → LTX-2.5 Union Control. Depth default. Distilled-only. Refuse 19B. MagCache off. |
| **dcc/canny-control-12s** | ltx | Same envelope; wire `canny.mp4`. |
