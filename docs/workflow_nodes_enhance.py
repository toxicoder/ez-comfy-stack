...
def enhance_nodes() -> dict[str, Any]:
    ...
    nodes["EZLTXPromptEnhance"] = _n(
        ...
        origin="ez_prompt_enhance",
        lab="Off on 90s films, talking-head, authored showcase. On for generic 12 s printers.",
        ...
        widgets=[
            ...
            _w("duration_hint", index=4, rng="12 seconds, 24 fps", desc="Duration hint.", gen="Does not set 289 frames — LTXVImgToVideo does. Film printers stay 5 seconds / 121."),
            _w("audio_notes", index=5, desc="World SFX / no-score policy.", gen="Lab 12 s Apps ask for world SFX matching the start image, no score."),
