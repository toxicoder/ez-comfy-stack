...
def enhance_nodes() -> dict[str, Any]:
    ...
    nodes["EZLTXPromptEnhance"] = _n(
        ...
        origin="ez_prompt_enhance",
        lab="Off on 90s films, talking-head, authored showcase. On for generic 8 s printers.",
        ...
        widgets=[
            ...
            _w("duration_hint", index=4, rng="8 seconds, 24 fps", desc="Duration hint.", gen="Does not set 193 frames — LTXVImgToVideo does. Film printers stay 5 seconds / 121."),
            _w("audio_notes", index=5, desc="World SFX / no-score policy.", gen="Lab 8 s Apps ask for world SFX matching the start image, no score."),
