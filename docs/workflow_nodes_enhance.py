...
def enhance_nodes() -> dict[str, Any]:
    ...
    nodes["EZKleinPromptEnhance"] = _n(
        ...
        widgets=[
            _w("sample", index=0, typ="COMBO", rng="custom", desc="Lab sample prompt or Custom.", gen="Custom keeps the textarea. Picking a sample fills and locks the Prompt. The App dropdown lists this graph's 20 recipes plus Custom (place recipes such as Cliff villa on klein/dream-house)."),
