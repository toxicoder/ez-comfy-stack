...
- **One hundred thirty-five 180 s original Nill Bye takes** without cloud music APIs
- **Eighty-five 180 s original Drive-through EDM takes** without cloud music APIs
...
-   :material-microphone:{ .lg .middle } **RAP-FIRST**

    ---

    Draft **32 s**, full **96 s**, then nine Nill Bye 180 s albums (135 takes).

    [:octicons-arrow-right-24: Nill Bye albums](create/music-rap.md)

-   :material-waveform:{ .lg .middle } **Drive-through EDM**

    ---

    Five bass-set albums (85 takes). Drop-first warped hybrid-trap. Not rap over a club bed.

    [:octicons-arrow-right-24: Drive-through EDM](create/music-edm.md)

-   :material-scale-balance:{ .lg .middle } **Disclosure**

    ---

    DistroKid / Spotify / YouTube / USCO, tags vs lyrics, Hard no, QC. Not legal advice.

    [:octicons-arrow-right-24: Music disclosure](create/music-disclosure.md)
...
Then load **audio/music/rap-full** (96 s), **or** a numbered take under `_lab/audio/albums/nill-bye/<album>/`, **or** `_lab/audio/albums/drive-through/<album>/`.
