...
- GIF loop motion and dream-house world bible (one place prompt; walkthrough shot cards per room — lens, height, volume, near/far; Prompt Join lock=view). Clay tour: same bible, Klein restyles Blender stills
