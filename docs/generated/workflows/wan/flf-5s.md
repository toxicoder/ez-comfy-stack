...
**Who this is for:** studio users who loaded `wan/flf-5s` from Apps or Workflows.

> Generated from `workflows/_lab/wan/flf-5s.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/flf-5s** from **Apps** or **Workflows**
