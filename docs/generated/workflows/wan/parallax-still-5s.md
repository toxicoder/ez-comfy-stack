...
**This graph:** `## wan/parallax-still-5s Silent Wan 5B I2V subtle parallax (~5 s). LoadImage: a still. Prefix `ez_parallax_video`. After Queue, click **Save video (MP4) — open node for preview** for an inline previe…`
