...
**Who this is for:** studio users who loaded `wan/bumper-loop` from Apps or Workflows.

> Generated from `workflows/_lab/wan/bumper-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/bumper-loop** from **Apps** or **Workflows**
...
**This graph:** `## wan/bumper-loop Short loopable MP4 bumper (Wan 5B, 49 frames @ 12 fps, ping-pong ON). Prefix `ez_bumper`. LoadImage: a still or logo plate. Leave ping-pong on for seamless loops. After Queue, clic…`
