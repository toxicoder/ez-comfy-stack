...
**This graph:** `## wan/bumper-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Short loopable MP4 bumper (Wan 5B, 49 frames @ 12 fps, ping-pong ON). Prefix `ez_bumper`. …`
