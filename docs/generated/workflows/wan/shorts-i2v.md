...
**Who this is for:** studio users who loaded `wan/shorts-i2v` from Apps or Workflows.

> Generated from `workflows/_lab/wan/shorts-i2v.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/shorts-i2v** from **Apps** or **Workflows**
...
**This graph:** `## wan/shorts-i2v Vertical silent Wan 5B I2V for Shorts (~5 s @ 24 fps). Apache 2.0. LoadImage: `ez_shorts_still_*.png` (or example.png to smoke-test). PRIMARY OUTPUT: MP4 via VHS. Prefix `ez_shorts_…`
