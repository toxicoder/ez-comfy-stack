...
**This graph:** `## wan/orbit-still-5s Silent Wan 5B I2V slow orbit (~5 s). LoadImage: packshot or still (`ez_packshot_*.png`). Prefix `ez_orbit_video`. After Queue, click **Save video (MP4) — open node for preview**…`
