...
**Who this is for:** studio users who loaded `wan/still-to-shot` from Apps or Workflows.

> Generated from `workflows/_lab/wan/still-to-shot.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
90s films: prefer the one-click **shorts/go-see** graphs (Queue once). This graph remains the silent 5.00s rehearsal.
...
90s films: prefer the one-click **shorts/go-see** graphs (Queue once: identity + 18 LTX prints + stitch). This graph remains the generic 5.00s printer / spark-farm shot / Wan rehearsal.
90s films: prefer the one-click **shorts/go-see** graphs (Queue once: identity + 18 LTX prints + stitch). This graph remains the generic 5.00s printer / spark-farm shot / Wan rehearsal.
90s films: prefer the one-click **shorts/go-see** graphs (Queue once: identity + 18 LTX prints + stitch). This graph remains the generic 5.00s printer / spark-farm shot / Wan rehearsal.
90s films: prefer the one-click **shorts/go-see** graphs (Queue once: identity + 18 LTX prints + stitch). This graph remains the generic 5.00s printer / spark-farm shot / Wan rehearsal.
90s films: prefer the one-click **shorts/go-see** graphs (Queue once: identity + 18 LTX prints + stitch). This graph remains the generic 5.00s printer / spark-farm shot / Wan rehearsal.
...
2. Load **wan/still-to-shot** from **Apps** or **Workflows**
...
**This graph:** `## wan/still-to-shot Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. After Queue, click **Save video (MP4) — open node for preview** for an inline preview. F…`
