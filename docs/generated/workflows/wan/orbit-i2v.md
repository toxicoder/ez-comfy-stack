...
**Who this is for:** studio users who loaded `wan/orbit-i2v` from Apps or Workflows.

> Generated from `workflows/_lab/wan/orbit-i2v.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/orbit-i2v** from **Apps** or **Workflows**
...
**This graph:** `## wan/orbit-i2v Silent Wan 5B I2V slow orbit (~5 s). LoadImage: packshot or still (`ez_packshot_*.png`). Prefix `ez_orbit_video`. After Queue, click **Save video (MP4) — open node for preview** for …`
