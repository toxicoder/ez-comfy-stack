...
**Who this is for:** studio users who loaded `wan/parallax-i2v` from Apps or Workflows.

> Generated from `workflows/_lab/wan/parallax-i2v.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/parallax-i2v** from **Apps** or **Workflows**
...
**This graph:** `## wan/parallax-i2v Silent Wan 5B I2V subtle parallax (~5 s). LoadImage: a still. Prefix `ez_parallax_video`. After Queue, click **Save video (MP4) — open node for preview** for an inline preview. Fi…`
