...
**Who this is for:** studio users who loaded `wan/push-in-i2v` from Apps or Workflows.

> Generated from `workflows/_lab/wan/push-in-i2v.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/push-in-i2v** from **Apps** or **Workflows**
...
**This graph:** `## wan/push-in-i2v Silent Wan 5B I2V hero push-in (~5 s). LoadImage: a still or thumbnail. Prefix `ez_pushin_video`. After Queue, click **Save video (MP4) — open node for preview** for an inline prev…`
