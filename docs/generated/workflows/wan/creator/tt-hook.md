...
**Who this is for:** studio users who loaded `wan/creator/tt-hook` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/tt-hook.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/tt-hook** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/tt-hook Silent TikTok hook punch 9:16. Lab size **480×832**. Prefix `ez_tt_hook`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podcast, …`
...
**This graph:** `wan/creator/tt-hook`
