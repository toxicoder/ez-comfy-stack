...
**This graph:** `## wan/creator/candle-loop Silent candle-flicker loop. Lab size **832×480**. Prefix `ez_candle`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podcast, …`
