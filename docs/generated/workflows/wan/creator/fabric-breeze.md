...
**This graph:** `## wan/creator/fabric-breeze Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent fabric/hair breeze ~5 s. Lab size **832×480**. Prefix `ez_breeze`. Empty …`
