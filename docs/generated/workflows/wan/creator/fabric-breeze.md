---
title: wan/creator/fabric-breeze
...
**Who this is for:** studio users who loaded `wan/creator/fabric-breeze` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/fabric-breeze.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/fabric-breeze** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/fabric-breeze Silent fabric/hair breeze ~5 s. Lab size **832×480**. Prefix `ez_breeze`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, pod…`
...
**This graph:** `wan/creator/fabric-breeze`
