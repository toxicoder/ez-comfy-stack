---
title: wan/creator/product-spin
...
**Who this is for:** studio users who loaded `wan/creator/product-spin` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/product-spin.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/product-spin** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/product-spin Silent product orbit ~5 s. Lab size **832×480**. Prefix `ez_spin`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podcast, mu…`
...
**This graph:** `wan/creator/product-spin`
