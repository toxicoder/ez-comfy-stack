...
**Who this is for:** studio users who loaded `wan/creator/unbox-hands` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/unbox-hands.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/unbox-hands** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/unbox-hands Silent unbox / hands motion ~5 s. Lab size **832×480**. Prefix `ez_unbox`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podc…`
...
**This graph:** `wan/creator/unbox-hands`
