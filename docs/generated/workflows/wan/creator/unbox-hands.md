...
**This graph:** `## wan/creator/unbox-hands Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent unbox / hands motion ~5 s. Lab size **832×480**. Prefix `ez_unbox`. Empty o…`
