...
**Who this is for:** studio users who loaded `wan/creator/pan-left` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/pan-left.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/pan-left** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/pan-left Silent locked-identity pan ~5 s. Lab size **832×480**. Prefix `ez_pan`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podcast, m…`
...
**This graph:** `wan/creator/pan-left`
