...
**This graph:** `## wan/creator/pan-left Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent locked-identity pan ~5 s. Lab size **832×480**. Prefix `ez_pan`. Empty of lett…`
