...
**This graph:** `## wan/creator/youtube-subscribe-bump Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent YouTube subscribe bumper loop. Lab size **832×480**. Prefix `ez_…`
