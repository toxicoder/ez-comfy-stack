---
title: wan/creator/youtube-subscribe-bump
...
# wan/creator/youtube-subscribe-bump
...
**Who this is for:** studio users who loaded `wan/creator/youtube-subscribe-bump` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/youtube-subscribe-bump.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent YouTube subscribe bumper loop. Lab size **832×480**. Prefix `ez_yt_bump`.
...
2. Load **wan/creator/youtube-subscribe-bump** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Tiny cyclic shimmer on the subject. Ping-pong friendly. No walk, no dolly. Keep…` |
...
**This graph:** `## wan/creator/youtube-subscribe-bump Silent YouTube subscribe bumper loop. Lab size **832×480**. Prefix `ez_yt_bump`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan…`
...
**This graph:** `Tiny cyclic shimmer on the subject. Ping-pong friendly. No walk, no dolly. Keep every object and surface from the start image; do not redesign.`

```text
Tiny cyclic shimmer on the subject. Ping-pong friendly. No walk, no dolly. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `wan/creator/youtube-subscribe-bump`
