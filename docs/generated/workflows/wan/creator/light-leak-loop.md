...
**This graph:** `## wan/creator/light-leak-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent light-leak overlay loop. Lab size **832×480**. Prefix `ez_leak`. Empty …`
