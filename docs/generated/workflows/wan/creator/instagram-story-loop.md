---
title: wan/creator/instagram-story-loop
...
# wan/creator/instagram-story-loop
...
**Who this is for:** studio users who loaded `wan/creator/instagram-story-loop` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/instagram-story-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent Instagram Story loop 9:16. Lab size **480×832**. Prefix `ez_ig_loop`.
...
2. Load **wan/creator/instagram-story-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Locked-camera breeze in fabric and palms. Ping-pong friendly. No walk. Keep eve…` |
...
**This graph:** `## wan/creator/instagram-story-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent Instagram Story loop 9:16. Lab size **480×832**. Prefix `ez_ig_loo…`
...
**This graph:** `Locked-camera breeze in fabric and palms. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Locked-camera breeze in fabric and palms. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `wan/creator/instagram-story-loop`
