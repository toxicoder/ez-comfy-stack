---
title: wan/creator/lyric-bg-loop
...
**Who this is for:** studio users who loaded `wan/creator/lyric-bg-loop` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/lyric-bg-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent lyric-background loop 16:9. Lab size **832×480**. Prefix `ez_lyric_loop`.
...
2. Load **wan/creator/lyric-bg-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow drift of light on a quiet scene. Ping-pong friendly. Center stays simple. …` |
...
**This graph:** `ez_lyric_loop_frames`
...
**This graph:** `## wan/creator/lyric-bg-loop Silent lyric-background loop 16:9. Lab size **832×480**. Prefix `ez_lyric_loop`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop L…`
...
**This graph:** `Slow drift of light on a quiet scene. Ping-pong friendly. Center stays simple. Keep every object and surface from the start image; do not redesign.`

```text
Slow drift of light on a quiet scene. Ping-pong friendly. Center stays simple. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `wan/creator/lyric-bg-loop`
