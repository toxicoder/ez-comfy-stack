---
title: wan/creator/twitch-starting-loop
...
# wan/creator/twitch-starting-loop
...
**Who this is for:** studio users who loaded `wan/creator/twitch-starting-loop` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/twitch-starting-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent starting-soon loop 16:9. Lab size **832×480**. Prefix `ez_tw_start_loop`.
...
2. Load **wan/creator/twitch-starting-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow cyclic light pulse on a quiet set. Ping-pong friendly. No walk. Keep every…` |
...
**This graph:** `ez_tw_start_loop_frames`
...
**This graph:** `## wan/creator/twitch-starting-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent starting-soon loop 16:9. Lab size **832×480**. Prefix `ez_tw_start…`
...
**This graph:** `Slow cyclic light pulse on a quiet set. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Slow cyclic light pulse on a quiet set. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `wan/creator/twitch-starting-loop`
