---
title: wan/creator/handheld-vlog
...
**Who this is for:** studio users who loaded `wan/creator/handheld-vlog` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/handheld-vlog.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent handheld vlog micro-shake 9:16. Lab size **480×832**. Prefix `ez_vlog`.
...
2. Load **wan/creator/handheld-vlog** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Subtle handheld micro-shake. Keep identity locked. No whip pan. Keep every obje…` |
...
**This graph:** `## wan/creator/handheld-vlog Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent handheld vlog micro-shake 9:16. Lab size **480×832**. Prefix `ez_vlog`. E…`
...
**This graph:** `Subtle handheld micro-shake. Keep identity locked. No whip pan. Keep every object and surface from the start image; do not redesign.`

```text
Subtle handheld micro-shake. Keep identity locked. No whip pan. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `wan/creator/handheld-vlog`
