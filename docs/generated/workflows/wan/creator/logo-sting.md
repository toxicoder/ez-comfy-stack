...
**Who this is for:** studio users who loaded `wan/creator/logo-sting` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/logo-sting.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/logo-sting** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/logo-sting Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent logo sting ~5 s. Lab size **832×480**. Prefix `ez_sting`. Empty of lettering…`
...
**This graph:** `wan/creator/logo-sting`
