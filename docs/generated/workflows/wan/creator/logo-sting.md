...
**This graph:** `## wan/creator/logo-sting Silent logo sting ~5 s. Lab size **832×480**. Prefix `ez_sting`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podcast, music.…`
