...
**Who this is for:** studio users who loaded `wan/creator/city-night` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/city-night.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/city-night** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/city-night Silent night-drive / city-lights ~5 s. Lab size **832×480**. Prefix `ez_night`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, …`
...
**This graph:** `wan/creator/city-night`
