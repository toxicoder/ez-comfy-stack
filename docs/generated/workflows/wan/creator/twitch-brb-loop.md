---
title: wan/creator/twitch-brb-loop
...
**Who this is for:** studio users who loaded `wan/creator/twitch-brb-loop` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/twitch-brb-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent BRB loop 16:9. Lab size **832×480**. Prefix `ez_tw_brb_loop`.
...
2. Load **wan/creator/twitch-brb-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Soft looping idle on a quiet set. Ping-pong friendly. No walk. Keep every objec…` |
...
**This graph:** `ez_tw_brb_loop_frames`
...
**This graph:** `## wan/creator/twitch-brb-loop Silent BRB loop 16:9. Lab size **832×480**. Prefix `ez_tw_brb_loop`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podcas…`
...
**This graph:** `Soft looping idle on a quiet set. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Soft looping idle on a quiet set. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `wan/creator/twitch-brb-loop`
