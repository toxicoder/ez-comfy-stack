...
**Who this is for:** studio users who loaded `wan/creator/x-post-5s` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/x-post-5s.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/x-post-5s** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/x-post-5s Silent X clip ~5 s 16:9. Lab size **832×480**. Prefix `ez_x_video`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podcast, musi…`
...
**This graph:** `wan/creator/x-post-5s`
