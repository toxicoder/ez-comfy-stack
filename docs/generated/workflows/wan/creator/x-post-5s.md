...
**This graph:** `## wan/creator/x-post-5s Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent X clip ~5 s 16:9. Lab size **832×480**. Prefix `ez_x_video`. Empty of letteri…`
