---
title: wan/creator/macro-product
...
**Who this is for:** studio users who loaded `wan/creator/macro-product` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/macro-product.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/macro-product** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/macro-product Silent macro product crawl ~5 s. Lab size **832×480**. Prefix `ez_macro`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, pod…`
...
**This graph:** `wan/creator/macro-product`
