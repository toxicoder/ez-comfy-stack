...
**This graph:** `## wan/creator/macro-product Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent macro product crawl ~5 s. Lab size **832×480**. Prefix `ez_macro`. Empty …`
