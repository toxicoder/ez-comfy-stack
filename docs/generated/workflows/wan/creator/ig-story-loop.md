---
title: wan/creator/ig-story-loop
...
**Who this is for:** studio users who loaded `wan/creator/ig-story-loop` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/ig-story-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/ig-story-loop** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/ig-story-loop Silent Instagram Story loop 9:16. Lab size **480×832**. Prefix `ez_ig_loop`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, …`
...
**This graph:** `wan/creator/ig-story-loop`
