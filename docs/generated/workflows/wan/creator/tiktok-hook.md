---
title: wan/creator/tiktok-hook
description: Silent TikTok hook punch 9:16 Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film shots) is encoded as written. Turn Enhance
tags: [workflows, generated, comfyui, wan]
---

# wan/creator/tiktok-hook
...
**Who this is for:** studio users who loaded `wan/creator/tiktok-hook` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/tiktok-hook.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent TikTok hook punch 9:16. Lab size **480×832**. Prefix `ez_tt_hook`.
...
2. Load **wan/creator/tiktok-hook** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Fast push-in toward the start-image face. One continuous take. No cut. Keep eve…` |
...
**This graph:** `## wan/creator/tiktok-hook Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent TikTok hook punch 9:16. Lab size **480×832**. Prefix `ez_tt_hook`. Empty of…`
...
**This graph:** `Fast push-in toward the start-image face. One continuous take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Fast push-in toward the start-image face. One continuous take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `wan/creator/tiktok-hook`
