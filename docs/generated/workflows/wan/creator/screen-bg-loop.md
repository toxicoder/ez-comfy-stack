...
**This graph:** `## wan/creator/screen-bg-loop Silent desk/screen loop. Lab size **832×480**. Prefix `ez_screen`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podcast, …`
