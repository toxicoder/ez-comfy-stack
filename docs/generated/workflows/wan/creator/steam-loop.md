...
**Who this is for:** studio users who loaded `wan/creator/steam-loop` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/steam-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent steam / kettle loop. Lab size **832×480**. Prefix `ez_steam`.
...
2. Load **wan/creator/steam-loop** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/steam-loop Silent steam / kettle loop. Lab size **832×480**. Prefix `ez_steam`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podcast, mu…`
...
**This graph:** `wan/creator/steam-loop`
