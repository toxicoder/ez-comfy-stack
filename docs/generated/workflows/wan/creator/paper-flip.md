...
**This graph:** `## wan/creator/paper-flip Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent page / carousel flip ~5 s. Lab size **832×480**. Prefix `ez_flip`. Empty of …`
