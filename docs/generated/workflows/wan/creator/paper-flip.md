...
**Who this is for:** studio users who loaded `wan/creator/paper-flip` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/paper-flip.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/paper-flip** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/paper-flip Silent page / carousel flip ~5 s. Lab size **832×480**. Prefix `ez_flip`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podcas…`
...
**This graph:** `wan/creator/paper-flip`
