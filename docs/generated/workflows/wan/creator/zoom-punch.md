...
**Who this is for:** studio users who loaded `wan/creator/zoom-punch` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/zoom-punch.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/zoom-punch** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/zoom-punch Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent 9:16 hook zoom punch. Lab size **480×832**. Prefix `ez_punch`. Empty of lett…`
...
**This graph:** `wan/creator/zoom-punch`
