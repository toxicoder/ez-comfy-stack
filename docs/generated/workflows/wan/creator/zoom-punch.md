...
**This graph:** `## wan/creator/zoom-punch Silent 9:16 hook zoom punch. Lab size **480×832**. Prefix `ez_punch`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — stop LTX, podcast, m…`
