---
title: wan/creator/yt-subscribe-bump
...
**Who this is for:** studio users who loaded `wan/creator/yt-subscribe-bump` from Apps or Workflows.

> Generated from `workflows/_lab/wan/creator/yt-subscribe-bump.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **wan/creator/yt-subscribe-bump** from **Apps** or **Workflows**
...
**This graph:** `## wan/creator/yt-subscribe-bump Silent YouTube subscribe bumper loop. Lab size **832×480**. Prefix `ez_yt_bump`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: wan — st…`
...
**This graph:** `wan/creator/yt-subscribe-bump`
