---
title: shorts/breakwater/act-04
...
**Who this is for:** studio users who loaded `shorts/breakwater/act-04` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/breakwater/act-04.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (storm-wall walk · Lookout and return): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 4/5** of a 7.5 min film (90 × 5.00s). Act 4 LoadImage should be the previous act last frame (ez_breakwater_b18_s3_last_*.png). In-graph stitch writes `ez_breakwater_act4_90s.mp4`. After all five acts: `concat-shots.sh --film breakwater --yes` → `ez_breakwater_450s.mp4`.
...
2. Load **shorts/breakwater/act-04** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A dip in …` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Through t…` |
| b1 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The far s…` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Up to a l…` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A hold on…` |
| b2 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. No ships …` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Grey to t…` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A turn ba…` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The path …` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The unlit…` |
| b4 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Past it t…` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Spray les…` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The sea i…` |
| b5 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A faster …` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The stair…` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Up the bl…` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The origi…` |
| b6 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The gap a…` |
...
| Save last frame | `ez_breakwater_b19_s1_last` |
| Save last frame | `ez_breakwater_b19_s2_last` |
| Save last frame | `ez_breakwater_b19_s3_last` |
| Save last frame | `ez_breakwater_b20_s1_last` |
| Save last frame | `ez_breakwater_b20_s2_last` |
| Save last frame | `ez_breakwater_b20_s3_last` |
| Save last frame | `ez_breakwater_b21_s1_last` |
| Save last frame | `ez_breakwater_b21_s2_last` |
| Save last frame | `ez_breakwater_b21_s3_last` |
| Save last frame | `ez_breakwater_b22_s1_last` |
| Save last frame | `ez_breakwater_b22_s2_last` |
| Save last frame | `ez_breakwater_b22_s3_last` |
| Save last frame | `ez_breakwater_b23_s1_last` |
| Save last frame | `ez_breakwater_b23_s2_last` |
| Save last frame | `ez_breakwater_b23_s3_last` |
| Save last frame | `ez_breakwater_b24_s1_last` |
| Save last frame | `ez_breakwater_b24_s2_last` |
| Save last frame | `ez_breakwater_b24_s3_last` |
...
**This graph:** `## shorts/breakwater/act-04 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outpu…`
...
**This graph:** `shorts/breakwater/act-04`
...
**This graph:** `## breakwater (storm-wall walk · Lookout and return) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121…`

```text
## breakwater (storm-wall walk · Lookout and return)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Past bench | A dip in the wall | Through the dip | The far side climbs |
| 2 | Climb two | Up to a lookout pad | A hold on the sea | No ships with marks |
| 3 | Empty sea | Grey to the horizon | A turn back along the wall | The path home |
| 4 | Home path | The unlit lamp returns | Past it the other way | Spray less |
| 5 | Less spray | The sea is a rumble | A faster walk | The stairs up |
| 6 | Stairs up | Up the blocks | The original wall | The gap again |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A dip in …` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Through t…` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The far s…` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Up to a l…` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A hold on…` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. No ships …` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Grey to t…` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A turn ba…` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The path …` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The unlit…` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Past it t…` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Spray les…` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The sea i…` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A faster …` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The stair…` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Up the bl…` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The origi…` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The gap a…` |
...
**This graph (all 18 instances):** `shorts/breakwater/act-04`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_breakwater_b19_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b19_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b19_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b20_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b20_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b20_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b21_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b21_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b21_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b22_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b22_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b22_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b23_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b23_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b23_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b24_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b24_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b24_s3_ltx_video` |
...
**This graph:** `ez_breakwater_b18_s3_last.png`
