---
title: shorts/breakwater/act-05
description: One-click storm-wall walk · Land end hold: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film
tags: [workflows, generated, comfyui, shorts]
---

# shorts/breakwater/act-05
...
**Who this is for:** studio users who loaded `shorts/breakwater/act-05` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/breakwater/act-05.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (storm-wall walk · Land end hold): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
3. The MP4 is already on disk at `${COMFY_OUTPUT_DIR}/ez_breakwater_90s.mp4` (act graphs write `ez_breakwater_actN_90s.mp4`). A **Film ready** overlay plays it. Copy off the Spark with scp.
4. Optional single-shot iterate: **ltx/i2v-shot**. Optional silent rehearsal: **wan/i2v-shot**.
5. Spark-farm / host stitch fallback: `./scripts/utilities/concat-shots.sh --film breakwater --yes`
...
This graph is **act 5/5** of a 7.5 min film (90 × 5.00s). Act 5 LoadImage should be the previous act last frame (ez_breakwater_b24_s3_last_*.png). In-graph stitch writes `ez_breakwater_act5_90s.mp4`. After all five acts: `concat-shots.sh --film breakwater --yes` → `ez_breakwater_450s.mp4`.
...
2. Load **shorts/breakwater/act-05** from **Apps** or **Workflows**
...
| 52 | breakwater 90s shot map | `MarkdownNote` | Ungrouped |
...
| Instance | Value |
| --- | --- |
| Positive | `A chest-mounted first-person body-cam still, eye-level, already walking a wet g…` |
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Over the …` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves st…` |
| b1 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The first…` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The start…` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A last lo…` |
| b2 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Walk towa…` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Concrete …` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. No gate, …` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A stop bo…` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves ha…` |
| b4 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Only wind…` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A hold on…` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The storm…` |
| b5 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Sleeves a…` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The sea k…` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Yellow un…` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Blank glo…` |
| b6 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The frame…` |
...
| Instance | Value |
| --- | --- |
| Save identity PNG | `ez_breakwater_identity` |
| Save last frame | `ez_breakwater_b25_s1_last` |
| Save last frame | `ez_breakwater_b25_s2_last` |
| Save last frame | `ez_breakwater_b25_s3_last` |
| Save last frame | `ez_breakwater_b26_s1_last` |
| Save last frame | `ez_breakwater_b26_s2_last` |
| Save last frame | `ez_breakwater_b26_s3_last` |
| Save last frame | `ez_breakwater_b27_s1_last` |
| Save last frame | `ez_breakwater_b27_s2_last` |
| Save last frame | `ez_breakwater_b27_s3_last` |
| Save last frame | `ez_breakwater_b28_s1_last` |
| Save last frame | `ez_breakwater_b28_s2_last` |
| Save last frame | `ez_breakwater_b28_s3_last` |
| Save last frame | `ez_breakwater_b29_s1_last` |
| Save last frame | `ez_breakwater_b29_s2_last` |
| Save last frame | `ez_breakwater_b29_s3_last` |
| Save last frame | `ez_breakwater_b30_s1_last` |
| Save last frame | `ez_breakwater_b30_s2_last` |
| Save last frame | `ez_breakwater_b30_s3_last` |
...
**This graph:** `## shorts/breakwater/act-05 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outpu…`
...
**This graph:** `shorts/breakwater/act-05`
...
**This graph:** `## breakwater (storm-wall walk · Land end hold) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 fram…`

```text
## breakwater (storm-wall walk · Land end hold)

Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8n per shot). Optional silent rehearsal: **wan/i2v-shot**. Optional host stitch: `./scripts/utilities/concat-shots.sh --film breakwater --yes`.
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Gap two | Over the gap homeward | Gloves still blank | The first granite |
| 2 | First granite | The start of the wall | A last look at sea | Walk toward the unmarked land end |
| 3 | Land end | Concrete meets a path | No gate, no sign | A stop |
| 4 | Stop | Gloves hang still | Only wind at the wall | A hold on the wall behind |
| 5 | Wall behind | The storm wall in grey | Sleeves at the bottom edge | The sea keeps |
| 6 | Close | Yellow unmarked slicker sleeves in frame | Blank gloves, empty palms | The frame holds the wall and the sea |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Over the …` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves st…` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The first…` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The start…` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A last lo…` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Walk towa…` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Concrete …` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. No gate, …` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A stop bo…` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves ha…` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Only wind…` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A hold on…` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The storm…` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Sleeves a…` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The sea k…` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Yellow un…` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Blank glo…` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The frame…` |
...
**This graph (all 18 instances):** `shorts/breakwater/act-05`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_breakwater_b25_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b25_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b25_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b26_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b26_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b26_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b27_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b27_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b27_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b28_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b28_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b28_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b29_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b29_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b29_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b30_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b30_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b30_s3_ltx_video` |
...
**This graph:** `ez_breakwater_b24_s3_last.png`
