---
title: shorts/breakwater/act-02
description: One-click storm-wall walk · Stairs to sea: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film
tags: [workflows, generated, comfyui, shorts]
---

# shorts/breakwater/act-02
...
**Who this is for:** studio users who loaded `shorts/breakwater/act-02` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/breakwater/act-02.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (storm-wall walk · Stairs to sea): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 2/5** of a 7.5 min film (90 × 5.00s). Act 2 LoadImage should be the previous act last frame (ez_breakwater_b6_s3_last_*.png). In-graph stitch writes `ez_breakwater_act2_90s.mp4`. After all five acts: `concat-shots.sh --film breakwater --yes` → `ez_breakwater_450s.mp4`.
...
2. Load **shorts/breakwater/act-02** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Open wall…` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A low cro…` |
| b1 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Up again …` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Horizon b…` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Spray aga…` |
| b2 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A stair o…` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Down thre…` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A landing…` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The sea i…` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Green wat…` |
| b4 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A look, t…` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A chain, …` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The chain…` |
| b5 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Past the …` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A wider l…` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Puddles a…` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A pause w…` |
| b6 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Walk resu…` |
...
| Save last frame | `ez_breakwater_b7_s1_last` |
| Save last frame | `ez_breakwater_b7_s2_last` |
| Save last frame | `ez_breakwater_b7_s3_last` |
| Save last frame | `ez_breakwater_b8_s1_last` |
| Save last frame | `ez_breakwater_b8_s2_last` |
| Save last frame | `ez_breakwater_b8_s3_last` |
| Save last frame | `ez_breakwater_b9_s1_last` |
| Save last frame | `ez_breakwater_b9_s2_last` |
| Save last frame | `ez_breakwater_b9_s3_last` |
| Save last frame | `ez_breakwater_b10_s1_last` |
| Save last frame | `ez_breakwater_b10_s2_last` |
| Save last frame | `ez_breakwater_b10_s3_last` |
| Save last frame | `ez_breakwater_b11_s1_last` |
| Save last frame | `ez_breakwater_b11_s2_last` |
| Save last frame | `ez_breakwater_b11_s3_last` |
| Save last frame | `ez_breakwater_b12_s1_last` |
| Save last frame | `ez_breakwater_b12_s2_last` |
| Save last frame | `ez_breakwater_b12_s3_last` |
...
**This graph:** `## shorts/breakwater/act-02 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outpu…`
...
**This graph:** `shorts/breakwater/act-02`
...
**This graph:** `## breakwater (storm-wall walk · Stairs to sea) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 fram…`

```text
## breakwater (storm-wall walk · Stairs to sea)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Rail end | Open wall, sea louder | A low crouch of the camera | Up again |
| 2 | Eye-level | Horizon bob with walk | Spray again | A stair of blocks down |
| 3 | Stairs | Down three blocks | A landing | The sea is closer |
| 4 | Close sea | Green water, unmarked | A look, then walk | A chain, unmarked, rust |
| 5 | Chain | The chain is not held | Past the chain | A wider landing |
| 6 | Wide landing | Puddles and grit | A pause | Walk resumes |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Open wall…` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A low cro…` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Up again …` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Horizon b…` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Spray aga…` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A stair o…` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Down thre…` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A landing…` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The sea i…` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Green wat…` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A look, t…` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A chain, …` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The chain…` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Past the …` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A wider l…` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Puddles a…` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A pause w…` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Walk resu…` |
...
**This graph (all 18 instances):** `shorts/breakwater/act-02`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_breakwater_b7_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b7_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b7_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b8_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b8_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b8_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b9_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b9_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b9_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b10_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b10_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b10_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b11_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b11_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b11_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b12_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b12_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_breakwater_b12_s3_ltx_video` |
...
**This graph:** `ez_breakwater_b6_s3_last.png`
