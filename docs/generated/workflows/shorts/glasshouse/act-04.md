---
title: shorts/glasshouse/act-04
...
**Who this is for:** studio users who loaded `shorts/glasshouse/act-04` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/glasshouse/act-04.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **shorts/glasshouse/act-04** from **Apps** or **Workflows**
...
**This graph:** `## shorts/glasshouse/act-04 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outpu…`
...
**This graph:** `shorts/glasshouse/act-04`
...
**This graph (all 18 instances):** `shorts/glasshouse/act-04`
