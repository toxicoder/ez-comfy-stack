---
title: shorts/glasshouse/act-01
...
**Who this is for:** studio users who loaded `shorts/glasshouse/act-01` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/glasshouse/act-01.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (storm glasshouse · Rain on copper): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 1/5** of a 7.5 min film (90 × 5.00s). Act 1 starts from Klein identity. In-graph stitch writes `ez_glasshouse_act1_90s.mp4`. After all five acts: `concat-shots.sh --film glasshouse --yes` → `ez_glasshouse_450s.mp4`.
...
2. Load **shorts/glasshouse/act-01** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Rain ticks the glass roof rain, tick …` |
| b1 s2 LTX I2V | `The start image holds as the first frame. The can sits copper-wet metal tick, c…` |
| b1 s3 LTX I2V | `The start image holds as the first frame. A drip hits the can splash, rain The …` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Drips become a sheet rain, splash The…` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Ferns bow wind, cloth The camera doll…` |
| b2 s3 LTX I2V | `The start image holds as the first frame. The can is moved metal scrape, grit T…` |
| b3 s1 LTX I2V | `The start image holds as the first frame. A pour into a clay pot pour, splash T…` |
| b3 s2 LTX I2V | `The start image holds as the first frame. The pot drinks water tick, grit The c…` |
| b3 s3 LTX I2V | `The start image holds as the first frame. The can lowers metal tick, cloth The …` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Puddle around the can splash, rain Th…` |
| b4 s2 LTX I2V | `The start image holds as the first frame. A look up the nave of glass wind, rai…` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Unmarked spars, no brand metal tick, …` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Rain on the ridge rain, tick The came…` |
| b5 s2 LTX I2V | `The start image holds as the first frame. A leaf dumps water splash, cloth The …` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The can is filled from a barrel pour,…` |
| b6 s1 LTX I2V | `The start image holds as the first frame. The barrel is unmarked pour, splash T…` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Hands lift the full can metal scrape,…` |
| b6 s3 LTX I2V | `The start image holds as the first frame. A walk down the aisle footstep, rain …` |
...
| Save last frame | `ez_glasshouse_b1_s1_last` |
| Save last frame | `ez_glasshouse_b1_s2_last` |
| Save last frame | `ez_glasshouse_b1_s3_last` |
| Save last frame | `ez_glasshouse_b2_s1_last` |
| Save last frame | `ez_glasshouse_b2_s2_last` |
| Save last frame | `ez_glasshouse_b2_s3_last` |
| Save last frame | `ez_glasshouse_b3_s1_last` |
| Save last frame | `ez_glasshouse_b3_s2_last` |
| Save last frame | `ez_glasshouse_b3_s3_last` |
| Save last frame | `ez_glasshouse_b4_s1_last` |
| Save last frame | `ez_glasshouse_b4_s2_last` |
| Save last frame | `ez_glasshouse_b4_s3_last` |
| Save last frame | `ez_glasshouse_b5_s1_last` |
| Save last frame | `ez_glasshouse_b5_s2_last` |
| Save last frame | `ez_glasshouse_b5_s3_last` |
| Save last frame | `ez_glasshouse_b6_s1_last` |
| Save last frame | `ez_glasshouse_b6_s2_last` |
| Save last frame | `ez_glasshouse_b6_s3_last` |
...
**This graph:** `## shorts/glasshouse/act-01 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outpu…`
...
**This graph:** `shorts/glasshouse/act-01`
...
**This graph:** `## glasshouse (storm glasshouse · Rain on copper) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 fr…`

```text
## glasshouse (storm glasshouse · Rain on copper)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Flagstone | Rain ticks the glass roof | The can sits copper-wet | A drip hits the can |
| 2 | Drip | Drips become a sheet | Ferns bow | The can is moved |
| 3 | In hand | A pour into a clay pot | The pot drinks | The can lowers |
| 4 | Stone | Puddle around the can | A look up the nave of glass | Unmarked spars, no brand |
| 5 | Spars | Rain on the ridge | A leaf dumps water | The can is filled from a barrel |
| 6 | Barrel | The barrel is unmarked | Hands lift the full can | A walk down the aisle |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Rain ticks the glass roof rain, tick …` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. The can sits copper-wet metal tick, c…` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. A drip hits the can splash, rain The …` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Drips become a sheet rain, splash The…` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Ferns bow wind, cloth The camera doll…` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. The can is moved metal scrape, grit T…` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. A pour into a clay pot pour, splash T…` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. The pot drinks water tick, grit The c…` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. The can lowers metal tick, cloth The …` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Puddle around the can splash, rain Th…` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. A look up the nave of glass wind, rai…` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Unmarked spars, no brand metal tick, …` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Rain on the ridge rain, tick The came…` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. A leaf dumps water splash, cloth The …` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The can is filled from a barrel pour,…` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. The barrel is unmarked pour, splash T…` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Hands lift the full can metal scrape,…` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. A walk down the aisle footstep, rain …` |
...
**This graph (all 18 instances):** `shorts/glasshouse/act-01`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_glasshouse_b1_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b1_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b1_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b2_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b2_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b2_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b3_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b3_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b3_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b4_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b4_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b4_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b5_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b5_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b5_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b6_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b6_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_glasshouse_b6_s3_ltx_video` |
