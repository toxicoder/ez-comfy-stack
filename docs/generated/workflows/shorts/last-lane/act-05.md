...
**Who this is for:** studio users who loaded `shorts/last-lane/act-05` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/last-lane/act-05.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (night two-lane · Dawn dash): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 5/5** of a 7.5 min film (90 × 5.00s). Act 5 LoadImage should be the previous act last frame (ez_lastlane_b24_s3_last_*.png). In-graph stitch writes `ez_lastlane_act5_90s.mp4`. After all five acts: `concat-shots.sh --film last-lane --yes` → `ez_lastlane_450s.mp4`.
...
2. Load **shorts/last-lane/act-05** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Sage goes…` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The cone …` |
| b1 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Day wants…` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Dust on t…` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The wheel…` |
| b2 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. No badges…` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The lane …` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A last ni…` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The bug i…` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Dawn on u…` |
| b4 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves at…` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The cone …` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The two-l…` |
| b5 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A hold on…` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The dash …` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Blank glo…` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The count…` |
...
| Save last frame | `ez_lastlane_b25_s1_last` |
| Save last frame | `ez_lastlane_b25_s2_last` |
| Save last frame | `ez_lastlane_b25_s3_last` |
| Save last frame | `ez_lastlane_b26_s1_last` |
| Save last frame | `ez_lastlane_b26_s2_last` |
| Save last frame | `ez_lastlane_b26_s3_last` |
| Save last frame | `ez_lastlane_b27_s1_last` |
| Save last frame | `ez_lastlane_b27_s2_last` |
| Save last frame | `ez_lastlane_b27_s3_last` |
| Save last frame | `ez_lastlane_b28_s1_last` |
| Save last frame | `ez_lastlane_b28_s2_last` |
| Save last frame | `ez_lastlane_b28_s3_last` |
| Save last frame | `ez_lastlane_b29_s1_last` |
| Save last frame | `ez_lastlane_b29_s2_last` |
| Save last frame | `ez_lastlane_b29_s3_last` |
| Save last frame | `ez_lastlane_b30_s1_last` |
| Save last frame | `ez_lastlane_b30_s2_last` |
| Save last frame | `ez_lastlane_b30_s3_last` |
...
**This graph:** `## shorts/last-lane/act-05 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/output…`
...
**This graph:** `shorts/last-lane/act-05`
...
**This graph:** `## last-lane (night two-lane · Dawn dash) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1…`

```text
## last-lane (night two-lane · Dawn dash)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | More pale | Sage goes from black to grey | The cone weakens | Day wants the dash |
| 2 | Day dash | Dust on the dash in grey | The wheel is clearer | No badges still |
| 3 | Blank wheel | The lane keeps | A last night bug on the glass | The bug is gone |
| 4 | Clean glass | Dawn on unmarked country | Gloves at rest on the wheel | The cone is nothing |
| 5 | Daylight ruts | The two-lane in first sun | A hold on the gloves | The dash in sun |
| 6 | Close | Blank gloves on the unmarked wheel | The country goes gold | The frame holds the dash and the lane |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Sage goes…` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The cone …` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Day wants…` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Dust on t…` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The wheel…` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. No badges…` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The lane …` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A last ni…` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The bug i…` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Dawn on u…` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves at…` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The cone …` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The two-l…` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A hold on…` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The dash …` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Blank glo…` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The count…` |
...
**This graph (all 18 instances):** `shorts/last-lane/act-05`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_lastlane_b25_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b25_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b25_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b26_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b26_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b26_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b27_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b27_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b27_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b28_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b28_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b28_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b29_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b29_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b29_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b30_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b30_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b30_s3_ltx_video` |
...
**This graph:** `ez_lastlane_b24_s3_last.png`
