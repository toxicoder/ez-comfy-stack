...
**Who this is for:** studio users who loaded `shorts/last-lane/act-01` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/last-lane/act-01.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (night two-lane · Gravel cone): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 1/5** of a 7.5 min film (90 × 5.00s). Act 1 starts from Klein identity. In-graph stitch writes `ez_lastlane_act1_90s.mp4`. After all five acts: `concat-shots.sh --film last-lane --yes` → `ez_lastlane_450s.mp4`.
...
2. Load **shorts/last-lane/act-01** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The cone …` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves ea…` |
| b1 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A sage bu…` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Bugs tick…` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The lane …` |
| b2 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A rise ah…` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The cone …` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A crest, …` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Radio is …` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. No song, …` |
| b4 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves do…` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A cattle-…` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The grid …` |
| b5 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The lane …` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A pale mi…` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Empty of …` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A jackrab…` |
| b6 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The cone …` |
...
| Save last frame | `ez_lastlane_b1_s1_last` |
| Save last frame | `ez_lastlane_b1_s2_last` |
| Save last frame | `ez_lastlane_b1_s3_last` |
| Save last frame | `ez_lastlane_b2_s1_last` |
| Save last frame | `ez_lastlane_b2_s2_last` |
| Save last frame | `ez_lastlane_b2_s3_last` |
| Save last frame | `ez_lastlane_b3_s1_last` |
| Save last frame | `ez_lastlane_b3_s2_last` |
| Save last frame | `ez_lastlane_b3_s3_last` |
| Save last frame | `ez_lastlane_b4_s1_last` |
| Save last frame | `ez_lastlane_b4_s2_last` |
| Save last frame | `ez_lastlane_b4_s3_last` |
| Save last frame | `ez_lastlane_b5_s1_last` |
| Save last frame | `ez_lastlane_b5_s2_last` |
| Save last frame | `ez_lastlane_b5_s3_last` |
| Save last frame | `ez_lastlane_b6_s1_last` |
| Save last frame | `ez_lastlane_b6_s2_last` |
| Save last frame | `ez_lastlane_b6_s3_last` |
...
**This graph:** `## shorts/last-lane/act-01 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/output…`
...
**This graph:** `shorts/last-lane/act-01`
...
**This graph:** `## last-lane (night two-lane · Gravel cone) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames =…`

```text
## last-lane (night two-lane · Gravel cone)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Gravel | The cone finds pale gravel | Gloves ease the wheel | A sage bush slides past |
| 2 | Sage | Bugs tick the unmarked glass | The lane is only two ruts | A rise ahead |
| 3 | Rise | The cone climbs | A crest, then more lane | Radio is only static hiss |
| 4 | Static | No song, only hiss | Gloves do not reach a dial | A cattle-grid rumble, unmarked |
| 5 | Grid | The grid ends | The lane straightens | A pale mile with no sign |
| 6 | No sign | Empty of lettering, always | A jackrabbit-shadow only | The cone is the only light |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The cone …` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves ea…` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A sage bu…` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Bugs tick…` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The lane …` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A rise ah…` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The cone …` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A crest, …` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Radio is …` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. No song, …` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves do…` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A cattle-…` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The grid …` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The lane …` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A pale mi…` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Empty of …` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A jackrab…` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The cone …` |
...
**This graph (all 18 instances):** `shorts/last-lane/act-01`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_lastlane_b1_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b1_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b1_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b2_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b2_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b2_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b3_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b3_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b3_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b4_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b4_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b4_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b5_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b5_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b5_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b6_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b6_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_lastlane_b6_s3_ltx_video` |
