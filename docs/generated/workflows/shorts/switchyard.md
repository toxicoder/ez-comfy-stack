---
title: shorts/switchyard
description: One-click 90s night freight yard: Klein identity + 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags,
...
**Who this is for:** studio users who loaded `shorts/switchyard` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/switchyard.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s film (night freight yard): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
3. The MP4 is already on disk at `${COMFY_OUTPUT_DIR}/ez_switchyard_90s.mp4`. A **90s film ready** overlay plays it; `ez_switchyard_90s.html` is a local player. Copy off the Spark with scp.
4. Optional single-shot iterate: **ltx/i2v-shot**. Optional silent rehearsal: **wan/i2v-shot**.
5. Spark-farm / host stitch fallback: `./scripts/utilities/concat-shots.sh --film switchyard --yes`
...
2. Load **shorts/switchyard** from **Apps** or **Workflows**
...
| 13 | switchyard 90s shot map | `MarkdownNote` | Ungrouped |
...
| Instance | Value |
| --- | --- |
| Positive | `A photoreal night freight-yard still in rain. Three generic unmarked boxcars si…` |
...
| b1 s1 LTX I2V | `The start image holds as the first frame. The camera walks wet gravel between u…` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Breath fogs in cold air over puddles;…` |
| b1 s3 LTX I2V | `The start image holds as the first frame. The walk stops between the first unma…` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Between unmarked boxcars, gloves find…` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Gravel, puddles, then a coupling clan…` |
| b2 s3 LTX I2V | `The start image holds as the first frame. The view tilts up the ladder; the car…` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Gloves climb a generic boxcar ladder …` |
| b3 s2 LTX I2V | `The start image holds as the first frame. The climb continues, gloves wet, the …` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Hands reach the roof edge in rain and…` |
| b4 s1 LTX I2V | `The start image holds as the first frame. A roof walk along the dark string of …` |
| b4 s2 LTX I2V | `The start image holds as the first frame. A distant generic horn answers far of…` |
| b4 s3 LTX I2V | `The start image holds as the first frame. The roof walk ends; the view looks do…` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Drop back to gravel, a puddle splash.…` |
| b5 s2 LTX I2V | `The start image holds as the first frame. Walk toward a yard-office window glow…` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Window glow, still no readable sign, …` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Stop under a lamp. Rain ticks the lam…` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Look down the dark string of unmarked…` |
| b6 s3 LTX I2V | `The start image holds as the first frame. A quiet short laugh leaves the breath…` |
...
| Instance | Value |
| --- | --- |
| Save identity PNG | `ez_switchyard_identity` |
| Save last frame | `ez_switchyard_b1_s1_last` |
| Save last frame | `ez_switchyard_b1_s2_last` |
| Save last frame | `ez_switchyard_b1_s3_last` |
| Save last frame | `ez_switchyard_b2_s1_last` |
| Save last frame | `ez_switchyard_b2_s2_last` |
| Save last frame | `ez_switchyard_b2_s3_last` |
| Save last frame | `ez_switchyard_b3_s1_last` |
| Save last frame | `ez_switchyard_b3_s2_last` |
| Save last frame | `ez_switchyard_b3_s3_last` |
| Save last frame | `ez_switchyard_b4_s1_last` |
| Save last frame | `ez_switchyard_b4_s2_last` |
| Save last frame | `ez_switchyard_b4_s3_last` |
| Save last frame | `ez_switchyard_b5_s1_last` |
| Save last frame | `ez_switchyard_b5_s2_last` |
| Save last frame | `ez_switchyard_b5_s3_last` |
| Save last frame | `ez_switchyard_b6_s1_last` |
| Save last frame | `ez_switchyard_b6_s2_last` |
| Save last frame | `ez_switchyard_b6_s3_last` |
...
**This graph:** `## shorts/switchyard LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}/ez_*_90s.mp4` (container `…`
...
**This graph:** `## switchyard 90s (night freight yard) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8n…`

```text
## switchyard 90s (night freight yard)

Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8n per shot). Optional silent rehearsal: **wan/i2v-shot**. Optional host stitch: `./scripts/utilities/concat-shots.sh --film switchyard --yes`.
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. The camera walks wet gravel between u…` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Breath fogs in cold air over puddles;…` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. The walk stops between the first unma…` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Between unmarked boxcars, gloves find…` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Gravel, puddles, then a coupling clan…` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. The view tilts up the ladder; the car…` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Gloves climb a generic boxcar ladder …` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. The climb continues, gloves wet, the …` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Hands reach the roof edge in rain and…` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. A roof walk along the dark string of …` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. A distant generic horn answers far of…` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. The roof walk ends; the view looks do…` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Drop back to gravel, a puddle splash.…` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. Walk toward a yard-office window glow…` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Window glow, still no readable sign, …` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Stop under a lamp. Rain ticks the lam…` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Look down the dark string of unmarked…` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. A quiet short laugh leaves the breath…` |
...
**This graph (all 18 instances):** `shorts/switchyard`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_switchyard_b1_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b1_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b1_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b2_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b2_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b2_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b3_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b3_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b3_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b4_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b4_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b4_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b5_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b5_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b5_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b6_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b6_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_switchyard_b6_s3_ltx_video` |
