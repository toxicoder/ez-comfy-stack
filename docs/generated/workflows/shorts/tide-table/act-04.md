---
title: shorts/tide-table/act-04
...
**Who this is for:** studio users who loaded `shorts/tide-table/act-04` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/tide-table/act-04.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (dawn skiff · Home the cut): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 4/5** of a 7.5 min film (90 × 5.00s). Act 4 LoadImage should be the previous act last frame (ez_tidetable_b18_s3_last_*.png). In-graph stitch writes `ez_tidetable_act4_90s.mp4`. After all five acts: `concat-shots.sh --film tide-table --yes` → `ez_tidetable_450s.mp4`.
...
2. Load **shorts/tide-table/act-04** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. The hard is dry above the ring grit, …` |
| b1 s2 LTX I2V | `The start image holds as the first frame. The painter drips once water tick, me…` |
| b1 s3 LTX I2V | `The start image holds as the first frame. The camera eases back cloth, hull kno…` |
| b2 s1 LTX I2V | `The start image holds as the first frame. The whole unmarked skiff in frame win…` |
| b2 s2 LTX I2V | `The start image holds as the first frame. A slow hold water tick, creak The cam…` |
| b2 s3 LTX I2V | `The start image holds as the first frame. Last light on the thwart steam, cloth…` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Sun leaves the cut wind, water tick T…` |
| b3 s2 LTX I2V | `The start image holds as the first frame. The coil darkens cloth, hull tick The…` |
| b3 s3 LTX I2V | `The start image holds as the first frame. The ring is a black mark metal click,…` |
| b4 s1 LTX I2V | `The start image holds as the first frame. The hard goes blue wind, splash The c…` |
| b4 s2 LTX I2V | `The start image holds as the first frame. One last drip water tick, creak The c…` |
| b4 s3 LTX I2V | `The start image holds as the first frame. The camera holds cloth, hull knock Th…` |
| b5 s1 LTX I2V | `The start image holds as the first frame. No one in frame but the skiff wind, w…` |
| b5 s2 LTX I2V | `The start image holds as the first frame. The cut is a dark ribbon splash, grit…` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The bow is the only warm wood wood cr…` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Grain of the thwart in close cloth, h…` |
| b6 s2 LTX I2V | `The start image holds as the first frame. A hairline scratch, unmarked grit, wa…` |
| b6 s3 LTX I2V | `The start image holds as the first frame. The camera holds the scratch wind, cr…` |
...
| Save last frame | `ez_tidetable_b19_s1_last` |
| Save last frame | `ez_tidetable_b19_s2_last` |
| Save last frame | `ez_tidetable_b19_s3_last` |
| Save last frame | `ez_tidetable_b20_s1_last` |
| Save last frame | `ez_tidetable_b20_s2_last` |
| Save last frame | `ez_tidetable_b20_s3_last` |
| Save last frame | `ez_tidetable_b21_s1_last` |
| Save last frame | `ez_tidetable_b21_s2_last` |
| Save last frame | `ez_tidetable_b21_s3_last` |
| Save last frame | `ez_tidetable_b22_s1_last` |
| Save last frame | `ez_tidetable_b22_s2_last` |
| Save last frame | `ez_tidetable_b22_s3_last` |
| Save last frame | `ez_tidetable_b23_s1_last` |
| Save last frame | `ez_tidetable_b23_s2_last` |
| Save last frame | `ez_tidetable_b23_s3_last` |
| Save last frame | `ez_tidetable_b24_s1_last` |
| Save last frame | `ez_tidetable_b24_s2_last` |
| Save last frame | `ez_tidetable_b24_s3_last` |
...
**This graph:** `## shorts/tide-table/act-04 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outpu…`
...
**This graph:** `shorts/tide-table/act-04`
...
**This graph:** `## tide-table (dawn skiff · Home the cut) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1…`

```text
## tide-table (dawn skiff · Home the cut)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Home plate | The hard is dry above the ring | The painter drips once | The camera eases back |
| 2 | Ease back | The whole unmarked skiff in frame | A slow hold | Last light on the thwart |
| 3 | Last light | Sun leaves the cut | The coil darkens | The ring is a black mark |
| 4 | Night edge | The hard goes blue | One last drip | The camera holds |
| 5 | Hold two | No one in frame but the skiff | The cut is a dark ribbon | The bow is the only warm wood |
| 6 | Warm wood | Grain of the thwart in close | A hairline scratch, unmarked | The camera holds the scratch |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. The hard is dry above the ring grit, …` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. The painter drips once water tick, me…` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. The camera eases back cloth, hull kno…` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. The whole unmarked skiff in frame win…` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. A slow hold water tick, creak The cam…` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. Last light on the thwart steam, cloth…` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Sun leaves the cut wind, water tick T…` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. The coil darkens cloth, hull tick The…` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. The ring is a black mark metal click,…` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. The hard goes blue wind, splash The c…` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. One last drip water tick, creak The c…` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. The camera holds cloth, hull knock Th…` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. No one in frame but the skiff wind, w…` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. The cut is a dark ribbon splash, grit…` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The bow is the only warm wood wood cr…` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Grain of the thwart in close cloth, h…` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. A hairline scratch, unmarked grit, wa…` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. The camera holds the scratch wind, cr…` |
...
**This graph (all 18 instances):** `shorts/tide-table/act-04`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_tidetable_b19_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b19_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b19_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b20_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b20_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b20_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b21_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b21_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b21_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b22_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b22_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b22_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b23_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b23_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b23_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b24_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b24_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_tidetable_b24_s3_ltx_video` |
...
**This graph:** `ez_tidetable_b18_s3_last.png`
