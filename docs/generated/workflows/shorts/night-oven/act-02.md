---
title: shorts/night-oven/act-02
...
**Who this is for:** studio users who loaded `shorts/night-oven/act-02` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/night-oven/act-02.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (overnight bakery · Heat): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 2/5** of a 7.5 min film (90 × 5.00s). Act 2 LoadImage should be the previous act last frame (ez_nightoven_b6_s3_last_*.png). In-graph stitch writes `ez_nightoven_act2_90s.mp4`. After all five acts: `concat-shots.sh --film night-oven --yes` → `ez_nightoven_450s.mp4`.
...
2. Load **shorts/night-oven/act-02** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Heat rolls out steam, hum The camera …` |
| b1 s2 LTX I2V | `The start image holds as the first frame. A tray slides in metal scrape, tick T…` |
| b1 s3 LTX I2V | `The start image holds as the first frame. The door shuts click, steam The camer…` |
| b2 s1 LTX I2V | `The start image holds as the first frame. The window shows sodium alley hum, wi…` |
| b2 s2 LTX I2V | `The start image holds as the first frame. A look at the alley wind, grit The ca…` |
| b2 s3 LTX I2V | `The start image holds as the first frame. Back to the oven steam, cloth The cam…` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Sodium light on steel hum, metal tick…` |
| b3 s2 LTX I2V | `The start image holds as the first frame. The apron is a pale shape cloth, grit…` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Hands check the door click, steam The…` |
| b4 s1 LTX I2V | `The start image holds as the first frame. The handle is too hot metal tick, clo…` |
| b4 s2 LTX I2V | `The start image holds as the first frame. A wait hum, steam The camera pans rig…` |
| b4 s3 LTX I2V | `The start image holds as the first frame. The door opens again scrape, steam Th…` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Unmarked loaves, no brand steam, tick…` |
| b5 s2 LTX I2V | `The start image holds as the first frame. A tray slides out metal scrape, cloth…` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The apron is dusted again grit, fabri…` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Cooling rack, unmarked hum, metal tic…` |
| b6 s2 LTX I2V | `The start image holds as the first frame. A loaf is set down tick, steam The ca…` |
| b6 s3 LTX I2V | `The start image holds as the first frame. The alley window brightens wind, hum …` |
...
| Save last frame | `ez_nightoven_b7_s1_last` |
| Save last frame | `ez_nightoven_b7_s2_last` |
| Save last frame | `ez_nightoven_b7_s3_last` |
| Save last frame | `ez_nightoven_b8_s1_last` |
| Save last frame | `ez_nightoven_b8_s2_last` |
| Save last frame | `ez_nightoven_b8_s3_last` |
| Save last frame | `ez_nightoven_b9_s1_last` |
| Save last frame | `ez_nightoven_b9_s2_last` |
| Save last frame | `ez_nightoven_b9_s3_last` |
| Save last frame | `ez_nightoven_b10_s1_last` |
| Save last frame | `ez_nightoven_b10_s2_last` |
| Save last frame | `ez_nightoven_b10_s3_last` |
| Save last frame | `ez_nightoven_b11_s1_last` |
| Save last frame | `ez_nightoven_b11_s2_last` |
| Save last frame | `ez_nightoven_b11_s3_last` |
| Save last frame | `ez_nightoven_b12_s1_last` |
| Save last frame | `ez_nightoven_b12_s2_last` |
| Save last frame | `ez_nightoven_b12_s3_last` |
...
**This graph:** `## shorts/night-oven/act-02 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outpu…`
...
**This graph:** `shorts/night-oven/act-02`
...
**This graph:** `## night-oven (overnight bakery · Heat) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8…`

```text
## night-oven (overnight bakery · Heat)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Oven | Heat rolls out | A tray slides in | The door shuts |
| 2 | Shut | The window shows sodium alley | A look at the alley | Back to the oven |
| 3 | Alley glance | Sodium light on steel | The apron is a pale shape | Hands check the door |
| 4 | Handle | The handle is too hot | A wait | The door opens again |
| 5 | Gold | Unmarked loaves, no brand | A tray slides out | The apron is dusted again |
| 6 | Dust | Cooling rack, unmarked | A loaf is set down | The alley window brightens |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Heat rolls out steam, hum The camera …` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. A tray slides in metal scrape, tick T…` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. The door shuts click, steam The camer…` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. The window shows sodium alley hum, wi…` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. A look at the alley wind, grit The ca…` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. Back to the oven steam, cloth The cam…` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Sodium light on steel hum, metal tick…` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. The apron is a pale shape cloth, grit…` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Hands check the door click, steam The…` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. The handle is too hot metal tick, clo…` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. A wait hum, steam The camera pans rig…` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. The door opens again scrape, steam Th…` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Unmarked loaves, no brand steam, tick…` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. A tray slides out metal scrape, cloth…` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The apron is dusted again grit, fabri…` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Cooling rack, unmarked hum, metal tic…` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. A loaf is set down tick, steam The ca…` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. The alley window brightens wind, hum …` |
...
**This graph (all 18 instances):** `shorts/night-oven/act-02`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_nightoven_b7_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b7_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b7_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b8_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b8_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b8_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b9_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b9_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b9_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b10_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b10_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b10_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b11_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b11_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b11_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b12_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b12_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b12_s3_ltx_video` |
...
**This graph:** `ez_nightoven_b6_s3_last.png`
