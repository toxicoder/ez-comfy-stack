---
title: shorts/night-oven/act-04
...
**Who this is for:** studio users who loaded `shorts/night-oven/act-04` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/night-oven/act-04.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (overnight bakery · Alley dawn): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 4/5** of a 7.5 min film (90 × 5.00s). Act 4 LoadImage should be the previous act last frame (ez_nightoven_b18_s3_last_*.png). In-graph stitch writes `ez_nightoven_act4_90s.mp4`. After all five acts: `concat-shots.sh --film night-oven --yes` → `ez_nightoven_450s.mp4`.
...
2. Load **shorts/night-oven/act-04** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. The path to the door grit, hum The ca…` |
| b1 s2 LTX I2V | `The start image holds as the first frame. The door is unmarked click, wind The …` |
| b1 s3 LTX I2V | `The start image holds as the first frame. A pause at the door cloth, tick The c…` |
| b2 s1 LTX I2V | `The start image holds as the first frame. The door opens on the alley wind, cli…` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Steam of cold in the alley steam, win…` |
| b2 s3 LTX I2V | `The start image holds as the first frame. The bakery stays behind hum, metal ti…` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Wet asphalt, unmarked wind, grit The …` |
| b3 s2 LTX I2V | `The start image holds as the first frame. A look back at the window hum, cloth …` |
| b3 s3 LTX I2V | `The start image holds as the first frame. The window holds the apron fabric, ti…` |
| b4 s1 LTX I2V | `The start image holds as the first frame. The apron is a pale square cloth, win…` |
| b4 s2 LTX I2V | `The start image holds as the first frame. A hold hum, grit The camera pans righ…` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Dawn lifts the sodium wind, steam The…` |
| b5 s1 LTX I2V | `The start image holds as the first frame. The alley goes grey wind, grit The ca…` |
| b5 s2 LTX I2V | `The start image holds as the first frame. No signage tick, cloth The camera sta…` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The bakery window cools hum, steam Th…` |
| b6 s1 LTX I2V | `The start image holds as the first frame. The loaf is a silhouette tick, cloth …` |
| b6 s2 LTX I2V | `The start image holds as the first frame. The apron still hangs fabric, hum The…` |
| b6 s3 LTX I2V | `The start image holds as the first frame. A last tungsten click click, metal Th…` |
...
| Save last frame | `ez_nightoven_b19_s1_last` |
| Save last frame | `ez_nightoven_b19_s2_last` |
| Save last frame | `ez_nightoven_b19_s3_last` |
| Save last frame | `ez_nightoven_b20_s1_last` |
| Save last frame | `ez_nightoven_b20_s2_last` |
| Save last frame | `ez_nightoven_b20_s3_last` |
| Save last frame | `ez_nightoven_b21_s1_last` |
| Save last frame | `ez_nightoven_b21_s2_last` |
| Save last frame | `ez_nightoven_b21_s3_last` |
| Save last frame | `ez_nightoven_b22_s1_last` |
| Save last frame | `ez_nightoven_b22_s2_last` |
| Save last frame | `ez_nightoven_b22_s3_last` |
| Save last frame | `ez_nightoven_b23_s1_last` |
| Save last frame | `ez_nightoven_b23_s2_last` |
| Save last frame | `ez_nightoven_b23_s3_last` |
| Save last frame | `ez_nightoven_b24_s1_last` |
| Save last frame | `ez_nightoven_b24_s2_last` |
| Save last frame | `ez_nightoven_b24_s3_last` |
...
**This graph:** `## shorts/night-oven/act-04 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outpu…`
...
**This graph:** `shorts/night-oven/act-04`
...
**This graph:** `## night-oven (overnight bakery · Alley dawn) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames…`

```text
## night-oven (overnight bakery · Alley dawn)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Path | The path to the door | The door is unmarked | A pause at the door |
| 2 | Door | The door opens on the alley | Steam of cold in the alley | The bakery stays behind |
| 3 | Alley | Wet asphalt, unmarked | A look back at the window | The window holds the apron |
| 4 | Window | The apron is a pale square | A hold | Dawn lifts the sodium |
| 5 | Dawn | The alley goes grey | No signage | The bakery window cools |
| 6 | Cool glass | The loaf is a silhouette | The apron still hangs | A last tungsten click |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. The path to the door grit, hum The ca…` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. The door is unmarked click, wind The …` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. A pause at the door cloth, tick The c…` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. The door opens on the alley wind, cli…` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Steam of cold in the alley steam, win…` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. The bakery stays behind hum, metal ti…` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Wet asphalt, unmarked wind, grit The …` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. A look back at the window hum, cloth …` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. The window holds the apron fabric, ti…` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. The apron is a pale square cloth, win…` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. A hold hum, grit The camera pans righ…` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Dawn lifts the sodium wind, steam The…` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. The alley goes grey wind, grit The ca…` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. No signage tick, cloth The camera sta…` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The bakery window cools hum, steam Th…` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. The loaf is a silhouette tick, cloth …` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. The apron still hangs fabric, hum The…` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. A last tungsten click click, metal Th…` |
...
**This graph (all 18 instances):** `shorts/night-oven/act-04`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_nightoven_b19_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b19_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b19_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b20_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b20_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b20_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b21_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b21_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b21_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b22_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b22_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b22_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b23_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b23_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b23_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b24_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b24_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b24_s3_ltx_video` |
...
**This graph:** `ez_nightoven_b18_s3_last.png`
