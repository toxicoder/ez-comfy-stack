---
title: shorts/night-oven/act-05
description: One-click overnight bakery · Lights out: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film s
tags: [workflows, generated, comfyui, shorts]
---

# shorts/night-oven/act-05
...
**Who this is for:** studio users who loaded `shorts/night-oven/act-05` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/night-oven/act-05.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (overnight bakery · Lights out): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 5/5** of a 7.5 min film (90 × 5.00s). Act 5 LoadImage should be the previous act last frame (ez_nightoven_b24_s3_last_*.png). In-graph stitch writes `ez_nightoven_act5_90s.mp4`. After all five acts: `concat-shots.sh --film night-oven --yes` → `ez_nightoven_450s.mp4`.
...
2. Load **shorts/night-oven/act-05** from **Apps** or **Workflows**
...
| 52 | night-oven 90s shot map | `MarkdownNote` | 2. LTX models |
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Lights out click, hum The camera trac…` |
| b1 s2 LTX I2V | `The start image holds as the first frame. The apron in the dark cloth, grit The…` |
| b1 s3 LTX I2V | `The start image holds as the first frame. A hold on the hook metal tick, fabric…` |
| b2 s1 LTX I2V | `The start image holds as the first frame. The hook is a black mark metal tick, …` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Flour dust settles grit, steam The ca…` |
| b2 s3 LTX I2V | `The start image holds as the first frame. The bench is empty hum, scrape The ca…` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Steel and night metal tick, wind The …` |
| b3 s2 LTX I2V | `The start image holds as the first frame. The mixer is a shape hum, scrape The …` |
| b3 s3 LTX I2V | `The start image holds as the first frame. The oven mouth is black click, steam …` |
| b4 s1 LTX I2V | `The start image holds as the first frame. No fire tick, cloth The camera pans r…` |
| b4 s2 LTX I2V | `The start image holds as the first frame. A last steam ghost steam, hum The cam…` |
| b4 s3 LTX I2V | `The start image holds as the first frame. The ghost dies wind, grit The camera …` |
| b5 s1 LTX I2V | `The start image holds as the first frame. The unmarked bakery waits hum, cloth …` |
| b5 s2 LTX I2V | `The start image holds as the first frame. The apron waits fabric, tick The came…` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The camera holds metal tick, grit The…` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Dawn at the high window only wind, st…` |
| b6 s2 LTX I2V | `The start image holds as the first frame. The apron in first grey cloth, hum Th…` |
| b6 s3 LTX I2V | `The start image holds as the first frame. The frame holds the apron on steel fa…` |
...
| Save last frame | `ez_nightoven_b25_s1_last` |
| Save last frame | `ez_nightoven_b25_s2_last` |
| Save last frame | `ez_nightoven_b25_s3_last` |
| Save last frame | `ez_nightoven_b26_s1_last` |
| Save last frame | `ez_nightoven_b26_s2_last` |
| Save last frame | `ez_nightoven_b26_s3_last` |
| Save last frame | `ez_nightoven_b27_s1_last` |
| Save last frame | `ez_nightoven_b27_s2_last` |
| Save last frame | `ez_nightoven_b27_s3_last` |
| Save last frame | `ez_nightoven_b28_s1_last` |
| Save last frame | `ez_nightoven_b28_s2_last` |
| Save last frame | `ez_nightoven_b28_s3_last` |
| Save last frame | `ez_nightoven_b29_s1_last` |
| Save last frame | `ez_nightoven_b29_s2_last` |
| Save last frame | `ez_nightoven_b29_s3_last` |
| Save last frame | `ez_nightoven_b30_s1_last` |
| Save last frame | `ez_nightoven_b30_s2_last` |
| Save last frame | `ez_nightoven_b30_s3_last` |
...
**This graph:** `## shorts/night-oven/act-05 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outpu…`
...
```text
A photoreal third-person bakery still at 2 a.m. A flour-dusted linen apron hangs on a steel bench in the foreground, unmarked mixer bowls and a dark oven mouth behind. Warm tungsten versus a sodium alley through one high window. Eye-level 35mm lens, framed for YouTube 16:9, empty of lettering, mild film grain, clean unmarked lens.
```
...
**This graph:** `shorts/night-oven/act-05`
...
**This graph:** `## night-oven (overnight bakery · Lights out) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames…`

```text
## night-oven (overnight bakery · Lights out)

Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8n per shot). Optional silent rehearsal: **wan/still-to-shot**. Optional host stitch: `./scripts/utilities/concat-shots.sh --film night-oven --yes`.
...
**Identity look:** A photoreal third-person bakery still at 2 a.m. A flour-dusted linen apron hangs on a steel bench in the foreground, unmarked mixer bowls and a dark oven mouth behind. Warm tungsten versus a sodium alley through one high window. Eye-level 35mm lens, framed for YouTube 16:9, empty of lettering, mild film grain, clean unmarked lens.

| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Dark shop | Lights out | The apron in the dark | A hold on the hook |
| 2 | Hook | The hook is a black mark | Flour dust settles | The bench is empty |
| 3 | Empty bench | Steel and night | The mixer is a shape | The oven mouth is black |
| 4 | Black mouth | No fire | A last steam ghost | The ghost dies |
| 5 | Still air | The unmarked bakery waits | The apron waits | The camera holds |
| 6 | Close | Dawn at the high window only | The apron in first grey | The frame holds the apron on steel |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Lights out click, hum The camera trac…` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. The apron in the dark cloth, grit The…` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. A hold on the hook metal tick, fabric…` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. The hook is a black mark metal tick, …` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Flour dust settles grit, steam The ca…` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. The bench is empty hum, scrape The ca…` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Steel and night metal tick, wind The …` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. The mixer is a shape hum, scrape The …` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. The oven mouth is black click, steam …` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. No fire tick, cloth The camera pans r…` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. A last steam ghost steam, hum The cam…` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. The ghost dies wind, grit The camera …` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. The unmarked bakery waits hum, cloth …` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. The apron waits fabric, tick The came…` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The camera holds metal tick, grit The…` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Dawn at the high window only wind, st…` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. The apron in first grey cloth, hum Th…` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. The frame holds the apron on steel fa…` |
...
**This graph (all 18 instances):** `shorts/night-oven/act-05`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_nightoven_b25_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b25_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b25_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b26_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b26_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b26_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b27_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b27_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b27_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b28_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b28_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b28_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b29_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b29_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b29_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b30_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b30_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b30_s3_ltx_video` |
...
**This graph:** `ez_nightoven_b24_s3_last.png`
