---
title: shorts/night-oven/act-03
description: One-click overnight bakery · Gold loaves: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film
tags: [workflows, generated, comfyui, shorts]
---

# shorts/night-oven/act-03
...
**Who this is for:** studio users who loaded `shorts/night-oven/act-03` from Apps or Workflows.

> Generated from `workflows/_lab/shorts/night-oven/act-03.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (overnight bakery · Gold loaves): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 3/5** of a 7.5 min film (90 × 5.00s). Act 3 LoadImage should be the previous act last frame (ez_nightoven_b12_s3_last_*.png). In-graph stitch writes `ez_nightoven_act3_90s.mp4`. After all five acts: `concat-shots.sh --film night-oven --yes` → `ez_nightoven_450s.mp4`.
...
2. Load **shorts/night-oven/act-03** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Night thinning wind, cloth The camera…` |
| b1 s2 LTX I2V | `The start image holds as the first frame. The mixer is washed pour, splash The …` |
| b1 s3 LTX I2V | `The start image holds as the first frame. A cloth on the bench cloth, scrape Th…` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Water on steel pour, splash The camer…` |
| b2 s2 LTX I2V | `The start image holds as the first frame. A wring of the cloth cloth, tick The …` |
| b2 s3 LTX I2V | `The start image holds as the first frame. The apron is untied fabric, click The…` |
| b3 s1 LTX I2V | `The start image holds as the first frame. The apron returns to the hook cloth, …` |
| b3 s2 LTX I2V | `The start image holds as the first frame. It hangs hum, grit The camera pans le…` |
| b3 s3 LTX I2V | `The start image holds as the first frame. The oven is dark again click, steam T…` |
| b4 s1 LTX I2V | `The start image holds as the first frame. The bakery is almost still hum, tick …` |
| b4 s2 LTX I2V | `The start image holds as the first frame. A last look at the loaf steam, cloth …` |
| b4 s3 LTX I2V | `The start image holds as the first frame. The window goes towards dawn wind, hu…` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Tungsten loses to blue hum, cloth The…` |
| b5 s2 LTX I2V | `The start image holds as the first frame. The loaf sits tick, steam The camera …` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Hands do not take it cloth, grit The …` |
| b6 s1 LTX I2V | `The start image holds as the first frame. The apron on the hook fabric, hum The…` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Flour on the floor grit, tick The cam…` |
| b6 s3 LTX I2V | `The start image holds as the first frame. A broom somewhere off scrape, cloth T…` |
...
| Save last frame | `ez_nightoven_b13_s1_last` |
| Save last frame | `ez_nightoven_b13_s2_last` |
| Save last frame | `ez_nightoven_b13_s3_last` |
| Save last frame | `ez_nightoven_b14_s1_last` |
| Save last frame | `ez_nightoven_b14_s2_last` |
| Save last frame | `ez_nightoven_b14_s3_last` |
| Save last frame | `ez_nightoven_b15_s1_last` |
| Save last frame | `ez_nightoven_b15_s2_last` |
| Save last frame | `ez_nightoven_b15_s3_last` |
| Save last frame | `ez_nightoven_b16_s1_last` |
| Save last frame | `ez_nightoven_b16_s2_last` |
| Save last frame | `ez_nightoven_b16_s3_last` |
| Save last frame | `ez_nightoven_b17_s1_last` |
| Save last frame | `ez_nightoven_b17_s2_last` |
| Save last frame | `ez_nightoven_b17_s3_last` |
| Save last frame | `ez_nightoven_b18_s1_last` |
| Save last frame | `ez_nightoven_b18_s2_last` |
| Save last frame | `ez_nightoven_b18_s3_last` |
...
**This graph:** `## shorts/night-oven/act-03 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outpu…`
...
**This graph:** `shorts/night-oven/act-03`
...
**This graph:** `## night-oven (overnight bakery · Gold loaves) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frame…`

```text
## night-oven (overnight bakery · Gold loaves)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Pale sodium | Night thinning | The mixer is washed | A cloth on the bench |
| 2 | Wash | Water on steel | A wring of the cloth | The apron is untied |
| 3 | Untie | The apron returns to the hook | It hangs | The oven is dark again |
| 4 | Dark mouth | The bakery is almost still | A last look at the loaf | The window goes towards dawn |
| 5 | Blue window | Tungsten loses to blue | The loaf sits | Hands do not take it |
| 6 | Untouched | The apron on the hook | Flour on the floor | A broom somewhere off |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Night thinning wind, cloth The camera…` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. The mixer is washed pour, splash The …` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. A cloth on the bench cloth, scrape Th…` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Water on steel pour, splash The camer…` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. A wring of the cloth cloth, tick The …` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. The apron is untied fabric, click The…` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. The apron returns to the hook cloth, …` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. It hangs hum, grit The camera pans le…` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. The oven is dark again click, steam T…` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. The bakery is almost still hum, tick …` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. A last look at the loaf steam, cloth …` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. The window goes towards dawn wind, hu…` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Tungsten loses to blue hum, cloth The…` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. The loaf sits tick, steam The camera …` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Hands do not take it cloth, grit The …` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. The apron on the hook fabric, hum The…` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Flour on the floor grit, tick The cam…` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. A broom somewhere off scrape, cloth T…` |
...
**This graph (all 18 instances):** `shorts/night-oven/act-03`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) — open node for preview | `ez_nightoven_b13_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b13_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b13_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b14_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b14_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b14_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b15_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b15_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b15_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b16_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b16_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b16_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b17_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b17_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b17_s3_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b18_s1_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b18_s2_ltx_video` |
| Save video (MP4) — open node for preview | `ez_nightoven_b18_s3_ltx_video` |
...
**This graph:** `ez_nightoven_b12_s3_last.png`
