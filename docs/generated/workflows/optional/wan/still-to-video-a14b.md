---
title: optional/wan/still-to-video-a14b
...
# optional/wan/still-to-video-a14b
...
**Who this is for:** studio users who loaded `optional/wan/still-to-video-a14b` from Apps or Workflows.

> Generated from `workflows/_lab/optional/wan/still-to-video-a14b.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Opt-in Wan 2.2 A14B FP8 silent hero. Not download-models.
Download: ./scripts/utilities/download-wan.sh run --tier a14b
Unload 5B first. MagCache is off. Lightning-style 8 steps (not 4-step TI2V-5B).
...
2. Load **optional/wan/still-to-video-a14b** from **Apps** or **Workflows**
...
```mermaid
flowchart LR
  N1["Wan 2.2 A14B high-noise FP8"]
  N16["Wan 2.2 A14B low-noise FP8"]
  N2["UMT5 CLIP (wan)"]
  N3["Wan 2.1 VAE"]
  N4["First frame"]
  N6["Motion / prompt"]
...
| 10 | KSampler 8-step Lightning | `KSampler` | Ungrouped |
...
| Instance | Value |
| --- | --- |
| Wan 2.2 A14B high-noise FP8 | `wan2.2_i2v_high_noise_14B_fp8_scaled.safetensors` |
| Wan 2.2 A14B low-noise FP8 | `wan2.2_i2v_low_noise_14B_fp8_scaled.safetensors` |
...
**This graph:** `## optional/wan/still-to-video-a14b Opt-in Wan 2.2 A14B FP8 silent hero. Not download-models. Download: ./scripts/utilities/download-wan.sh run --tier a14b Unload 5B first. MagCache is off. Lightning…`
...
**This graph:** `optional/wan/still-to-video-a14b`
