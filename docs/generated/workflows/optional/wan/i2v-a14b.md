...
**Who this is for:** studio users who loaded `optional/wan/i2v-a14b` from Apps or Workflows.

> Generated from `workflows/_lab/optional/wan/i2v-a14b.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **optional/wan/i2v-a14b** from **Apps** or **Workflows**
...
**This graph:** `## optional/wan/i2v-a14b Opt-in Wan 2.2 A14B FP8 silent hero. Not download-models. Download: ./scripts/utilities/download-wan.sh run --tier a14b Unload 5B first. MagCache is off. Lightning-style 8 st…`
...
**This graph:** `optional/wan/i2v-a14b`
