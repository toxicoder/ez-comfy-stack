...
**Who this is for:** studio users who loaded `optional/klein/trellis2` from Apps or Workflows.

> Generated from `workflows/_lab/optional/klein/trellis2.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **optional/klein/trellis2** from **Apps** or **Workflows**
...
| 2 | Klein still | `LoadImage` | Ungrouped |
...
**This graph:** `## optional/klein/trellis2 Klein still → native TRELLIS.2 INT8 mesh (Comfy core nodes). ```bash ./scripts/manage.sh download-3d --tier trellis2 ./scripts/manage.sh occupancy enter trellis --yes ``` L…`
