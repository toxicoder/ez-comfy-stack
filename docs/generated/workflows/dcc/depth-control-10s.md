...
**Who this is for:** studio users who loaded `dcc/depth-control-10s` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/depth-control-10s.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Lab envelope for Path B depth-guided 10.00s print. LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). **241 frames @ 24 fps**. MagCache **off**. Distilled transformer only.
...
2. Load **dcc/depth-control-10s** from **Apps** or **Workflows**
...
**This graph:** `## dcc/depth-control-10s Lab envelope for Path B depth-guided 10.00s print. LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). **241 frames @ 24 fps**. MagCache **o…`
...
**This graph:** `dcc/depth-control-10s`
