...
**Who this is for:** studio users who loaded `dcc/canny-hero` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/canny-hero.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/canny-hero** from **Apps** or **Workflows**
...
| 9 | Save canny hero | `SaveImage` | OUTPUT |
| 10 | Operator note | `Note` | NOTE |
| 11 | Canny first.png (guide pack) | `LoadImage` | INPUT |
| 12 | Klein Prompt Enhance (edit) | `EZKleinPromptEnhance` | PROMPT |
| 13 | Encode canny plate | `VAEEncode` | SETTINGS |
| 14 | Positive + canny plate | `ReferenceLatent` | SETTINGS |
