...
**Who this is for:** studio users who loaded `dcc/depth-control-8s` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/depth-control-8s.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/depth-control-8s** from **Apps** or **Workflows**
