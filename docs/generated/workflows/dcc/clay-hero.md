...
**Who this is for:** studio users who loaded `dcc/clay-hero` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/clay-hero.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/clay-hero** from **Apps** or **Workflows**
...
| 9 | Save clay hero | `SaveImage` | OUTPUT |
...
**This graph:** `## dcc/clay-hero Klein 4B **edit** of a DCC clay first frame (guide pack ``first.png``). Enhance **on**. Seed **42**. Size **1280x704** (LTX VAE grid - not 1280x720). LoadImage: clay ``first.png`` fr...`
