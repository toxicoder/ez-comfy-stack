...
**Who this is for:** studio users who loaded `dcc/depth-from-loader` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/depth-from-loader.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/depth-from-loader** from **Apps** or **Workflows**
...
| 4 | Load guide still | `EZDCCLoadGuideStill` | INPUT |
...
| 12 | Save ez_iclora_guide | `SaveImage` | OUTPUT |
...
| 20 | Save ez_iclora_guide | `SaveImage` | OUTPUT |
...
| 24 | Occupancy gate (ltx) | `EZDCCOccupancyGate` | INPUT |
| 25 | Load guide video path | `EZDCCLoadGuideVideo` | INPUT |
| 26 | Negative Prompt Enhance | `EZNegativePromptEnhance` | PROMPT |
| 27 | Quality | `EZQuality` | QUALITY |
| 28 | Check models | `EZModelCheck` | QUALITY |
...
**This graph (all 2 instances):** `ez_iclora_guide`
...
**This graph:** `## dcc/depth-from-loader Lab envelope for Path B depth-guided 8.00s print from in-canvas loaders. LTX canvas **1280x704** (width/height must be divisible by 32; 720 and 1080 are invalid). **193 frame…`
...
**This graph:** `dcc/depth-from-loader`
