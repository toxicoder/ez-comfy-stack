...
**Who this is for:** studio users who loaded `dcc/canny-control-8s` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/canny-control-8s.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/canny-control-8s** from **Apps** or **Workflows**
...
**This graph:** `## dcc/canny-control-8s Lab envelope for Path B **canny**-guided 8.00s print. LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). **193 frames @ 24 fps**. MagCache *…`
...
**This graph:** `dcc/canny-control-8s`
