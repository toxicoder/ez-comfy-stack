---
title: dcc/ltx/depth-from-loader
...
**Who this is for:** studio users who loaded `dcc/ltx/depth-from-loader` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/ltx/depth-from-loader.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/ltx/depth-from-loader** from **Apps** or **Workflows**
...
**This graph:** `## dcc/ltx/depth-from-loader Lab envelope for Path B depth-guided 5.00s print from in-canvas loaders. LTX canvas **1280x704** (width/height must be divisible by 32; 720 and 1080 are invalid). **120 f…`
...
**This graph:** `dcc/ltx/depth-from-loader`
