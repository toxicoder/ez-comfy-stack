---
title: dcc/ltx/iclora-from-guide-loader
...
**Who this is for:** studio users who loaded `dcc/ltx/iclora-from-guide-loader` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/ltx/iclora-from-guide-loader.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/ltx/iclora-from-guide-loader** from **Apps** or **Workflows**
...
| 4 | Load guide still | `EZDCCLoadGuideStill` | Ungrouped |
...
| 12 | Save ez_iclora_guide | `SaveImage` | Ungrouped |
...
| 20 | Save ez_iclora_guide | `SaveImage` | Ungrouped |
...
**This graph:** `## dcc/ltx/iclora-from-guide-loader Lab envelope for Path B depth-guided 5.00s print from in-canvas loaders. LTX canvas **1280x704** (width/height must be divisible by 32; 720 and 1080 are invalid). …`
...
**This graph:** `dcc/ltx/iclora-from-guide-loader`
