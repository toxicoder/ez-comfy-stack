---
title: dcc/ltx/depth-control-shorts
...
**Who this is for:** studio users who loaded `dcc/ltx/depth-control-shorts` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/ltx/depth-control-shorts.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/ltx/depth-control-shorts** from **Apps** or **Workflows**
...
**This graph:** `## dcc/ltx/depth-control-shorts Lab envelope for Path B depth-guided **portrait** 5.00s print. LTX canvas **768x1280** (width/height must be divisible by 32; 720 and 1080 are invalid). **120 frames @…`
...
**This graph:** `dcc/ltx/depth-control-shorts`
