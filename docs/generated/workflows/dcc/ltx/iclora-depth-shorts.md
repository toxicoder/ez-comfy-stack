---
title: dcc/ltx/iclora-depth-shorts
description: LTX-2.5 IC-LoRA Union Control envelope, 768x1280, 120 frames, depth default Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or fi
...
**Who this is for:** studio users who loaded `dcc/ltx/iclora-depth-shorts` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/ltx/iclora-depth-shorts.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/ltx/iclora-depth-shorts** from **Apps** or **Workflows**
...
**This graph:** `## dcc/ltx/iclora-depth-shorts Lab envelope for Path B depth-guided **portrait** 5.00s print. LTX canvas **768x1280** (width/height must be divisible by 32; 720 and 1080 are invalid). **120 frames @ …`
...
**This graph:** `ez_iclora_depth_shorts`
...
**This graph:** `dcc/ltx/iclora-depth-shorts`
