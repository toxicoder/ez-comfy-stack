...
**Who this is for:** studio users who loaded `dcc/ltx/iclora-canny-5s` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/ltx/iclora-canny-5s.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/ltx/iclora-canny-5s** from **Apps** or **Workflows**
...
**This graph:** `## dcc/ltx/iclora-canny-5s Lab envelope for Path B **canny**-guided 5.00s print. LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). **120 frames @ 24 fps**. MagCach…`
...
**This graph:** `dcc/ltx/iclora-canny-5s`
