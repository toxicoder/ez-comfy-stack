---
title: dcc/klein/from-clay-plates
...
**Who this is for:** studio users who loaded `dcc/klein/from-clay-plates` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/klein/from-clay-plates.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/klein/from-clay-plates** from **Apps** or **Workflows**
...
**This graph:** `## dcc/klein/from-clay-plates One clay still, four Klein **edit** plates. Enhance **on**. Seed **42**. Ctrl+B unused SHOT groups. Prefixes and sizes: - ez_clay_pack_hero 1280x704 (LTX feeder) - ez_cl…`
...
**This graph:** `dcc/klein/from-clay-plates`
