---
title: dcc/klein/from-guide-loader
description: Klein 4B edit of EZDCCLoadGuideStill first.png. Enhance on. 1280x704. Seed 42.
...
**Who this is for:** studio users who loaded `dcc/klein/from-guide-loader` from Apps or Workflows.

> Generated from `workflows/_lab/dcc/klein/from-guide-loader.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **dcc/klein/from-guide-loader** from **Apps** or **Workflows**
...
flowchart LR
  ...
  N7["KSampler"]
  N8["VAE Decode"]
  N9["Save ez_guide_hero"]
  N10["Operator note"]
  N11["Load guide still"]
...
**This graph:** `## dcc/klein/from-guide-loader Klein 4B **edit** of a guide-pack still loaded in-canvas (no LoadImage / --install-inputs). Enhance **on**. Seed **42**. Size **1280x704**. Prefix ``ez_guide_hero``. Oc…`
...
**This graph:** `dcc/klein/from-guide-loader`
