...
**This graph:** `## motion/loops/sticker-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Loopable sticker MP4 (Wan 5B, 49 frames @ 12 fps, ping-pong ON). Prefix `ez_stic…`
