...
**This graph:** `## motion/loops/gif-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. After Queue, click **Infinite loop (ping-pong) — open for preview** for an inline pr…`
