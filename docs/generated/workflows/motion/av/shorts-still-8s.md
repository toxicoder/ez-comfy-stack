...
| 7 | Vertical I2V (9:16) | `LTXVImgToVideo` | SETTINGS |
...
**This graph:** `## motion/av/shorts-still-8s Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. LTX canvas 768x1280 (width/height must be divisible by 32; 720 and 1080 are inva...`
