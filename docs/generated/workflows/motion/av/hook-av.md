...
~12 s AV cold-open / hook (LTX-2.5 T2V). Community License — not Apache.
...
**This graph:** `## motion/av/hook-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). ~1…`
