...
Weather B-roll AV (~10 s T2V). LTX-2.5 distilled. Community License — not Apache.
...
```text
Locked-camera weather B-roll. A tropical storm streaks across a rooftop terrace and a dark indigo-violet suede running coat; palms thrash and rain sheets off unmarked glass. Soft wind, rain on glass, thunder far off. Unmarked surfaces. No music and no score. Ten seconds.
```
