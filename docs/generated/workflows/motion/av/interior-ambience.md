...
**Who this is for:** studio users who loaded `motion/av/interior-ambience` from Apps or Workflows.

> Generated from `workflows/_lab/motion/av/interior-ambience.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Interior room-tone AV (~8 s T2V). LTX-2.5 distilled. Community License - not Apache.
...
2. Load **motion/av/interior-ambience** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Locked-camera interior B-roll. A quiet unmarked kitchen at first light. Steam f...` |
...
**This graph:** `## motion/av/interior-ambience Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are in...`
...
**This graph:** `Locked-camera interior B-roll. A quiet unmarked kitchen at first light. Steam from a kettle, a ceramic mug on oak. House creak, kettle hush, distant clock. No music and no score. Eight seconds.`

```text
Locked-camera interior B-roll. A quiet unmarked kitchen at first light. Steam from a kettle, a ceramic mug on oak. House creak, kettle hush, distant clock. No music and no score. Eight seconds.
```
...
**This graph:** `motion/av/interior-ambience`
