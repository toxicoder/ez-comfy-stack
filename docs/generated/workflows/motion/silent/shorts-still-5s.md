...
**This graph:** `## motion/silent/shorts-still-5s Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Vertical silent Wan 5B I2V for Shorts (~5 s @ 24 fps). Apache 2.0. LoadImage…`
