...
**This graph:** `## motion/silent/push-in-still-5s Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent Wan 5B I2V hero push-in (~5 s). LoadImage: a still or thumbnail. Pre…`
