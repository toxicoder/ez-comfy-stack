...
| 6 | Positive | `CLIPTextEncode` | PROMPT |
...
**This graph:** `## motion/silent/text-to-video-5s Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. After Queue, click **Save video (MP4) - open node for preview** for an inli...`
