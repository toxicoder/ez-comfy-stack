---
title: "motion/silent/text-to-video-5s"
description: "Wan 2.2 5B silent T2V smoke, 121 frames @ 24 fps"
...
**Who this is for:** studio users who loaded `motion/silent/text-to-video-5s` from Apps or Workflows.

> Generated from `workflows/_lab/motion/silent/text-to-video-5s.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Wan 2.2 TI2V-5B Apache 2.0 silent T2V smoke (~5 s @ 24 fps).
Models: wan2.2_ti2v_5B_fp16.safetensors + umt5_xxl_fp8_e4m3fn_scaled.safetensors (CLIP type wan) + wan2.2_vae.safetensors.
Widgets: seed 42 fixed · 121 frames · 832x480 · 24 fps.

LoadImage is bypassed. Edit Motion / prompt. PRIMARY OUTPUT: VHS_VideoCombine MP4 24 fps.
No native audio. For I2V from a still, use motion/silent/still-to-video-5s.
...
2. Load **motion/silent/text-to-video-5s** from **Apps** or **Workflows**
...
| 6 | Positive | `CLIPTextEncode` | Ungrouped |
...
**This graph:** `## motion/silent/text-to-video-5s Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. After Queue, click **Save video (MP4) — open node for preview** for an inli…`
...
**This graph:** `motion/silent/text-to-video-5s`
