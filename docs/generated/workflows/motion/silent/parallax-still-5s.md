...
**This graph:** `## motion/silent/parallax-still-5s Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent Wan 5B I2V subtle parallax (~5 s). LoadImage: a still. Prefix `ez_p…`
