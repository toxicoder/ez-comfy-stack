...
**This graph:** `## motion/silent/orbit-still-5s Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent Wan 5B I2V slow orbit (~5 s). LoadImage: packshot or still (`ez_packsh…`
