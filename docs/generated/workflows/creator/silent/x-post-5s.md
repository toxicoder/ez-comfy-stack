---
title: "creator/silent/x-post-5s"
description: "Silent X clip ~5 s 16:9 Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film shots) is encoded as written. Turn Enhance on onl"
tags: [workflows, generated, comfyui, creator]
---

# creator/silent/x-post-5s
...
**Who this is for:** studio users who loaded `creator/silent/x-post-5s` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/x-post-5s.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent X clip ~5 s 16:9. Lab size **832x480**. Prefix `ez_x_video`.
...
2. Load **creator/silent/x-post-5s** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Gentle push-in. Fabric and foliage drift. One continuous five-second take. Keep...` |
...
**This graph:** `## creator/silent/x-post-5s Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent X clip ~5 s 16:9. Lab size **832x480**. Prefix `ez_x_video`. Empty of lett...`
...
**This graph:** `Gentle push-in. Fabric and foliage drift. One continuous five-second take. Keep every object and surface from the start image; do not redesign.`

```text
Gentle push-in. Fabric and foliage drift. One continuous five-second take. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/silent/x-post-5s`
