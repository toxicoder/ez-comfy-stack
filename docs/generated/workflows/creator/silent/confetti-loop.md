...
**This graph:** `## creator/silent/confetti-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent celebration loop. Lab size **832×480**. Prefix `ez_confetti`. Empty of…`
