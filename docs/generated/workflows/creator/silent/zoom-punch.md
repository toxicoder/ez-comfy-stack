...
**This graph:** `## creator/silent/zoom-punch Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent 9:16 hook zoom punch. Lab size **480×832**. Prefix `ez_punch`. Empty of l…`
