---
title: "creator/silent/tiktok-hook"
...
**Who this is for:** studio users who loaded `creator/silent/tiktok-hook` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/tiktok-hook.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent TikTok hook punch 9:16. Lab size **480x832**. Prefix `ez_tt_hook`.
...
2. Load **creator/silent/tiktok-hook** from **Apps** or **Workflows**
...
**This graph:** `## creator/silent/tiktok-hook Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent TikTok hook punch 9:16. Lab size **480x832**. Prefix `ez_tt_hook`. Empty...`
...
**This graph:** `creator/silent/tiktok-hook`
