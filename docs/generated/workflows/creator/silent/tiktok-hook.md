...
**This graph:** `## creator/silent/tiktok-hook Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent TikTok hook punch 9:16. Lab size **480×832**. Prefix `ez_tt_hook`. Empty…`
