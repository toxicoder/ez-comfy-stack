...
# creator/silent/youtube-subscribe-bump
...
**Who this is for:** studio users who loaded `creator/silent/youtube-subscribe-bump` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/youtube-subscribe-bump.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent YouTube subscribe bumper loop. Lab size **832x480**. Prefix `ez_yt_bump`.
...
2. Load **creator/silent/youtube-subscribe-bump** from **Apps** or **Workflows**
...
**This graph:** `## creator/silent/youtube-subscribe-bump Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent YouTube subscribe bumper loop. Lab size **832x480**. Prefix `...`
...
**This graph:** `creator/silent/youtube-subscribe-bump`
