---
title: "creator/silent/ken-burns"
description: "Silent Ken Burns pan/zoom ~5 s Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film shots) is encoded as written. Turn Enhance"
tags: [workflows, generated, comfyui, creator]
---

# creator/silent/ken-burns
...
**Who this is for:** studio users who loaded `creator/silent/ken-burns` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/ken-burns.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent Ken Burns pan/zoom ~5 s. Lab size **832x480**. Prefix `ez_kenburns`.
...
2. Load **creator/silent/ken-burns** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow Ken Burns zoom on the start still. Identity locked. No cut. Keep every obj...` |
...
**This graph:** `## creator/silent/ken-burns Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent Ken Burns pan/zoom ~5 s. Lab size **832x480**. Prefix `ez_kenburns`. Empty...`
...
**This graph:** `Slow Ken Burns zoom on the start still. Identity locked. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Slow Ken Burns zoom on the start still. Identity locked. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/silent/ken-burns`
