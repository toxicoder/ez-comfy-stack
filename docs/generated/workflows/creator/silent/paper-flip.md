...
**Who this is for:** studio users who loaded `creator/silent/paper-flip` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/paper-flip.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent page / carousel flip ~5 s. Lab size **832x480**. Prefix `ez_flip`.
...
2. Load **creator/silent/paper-flip** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `A page or card turns once. Keep identity locked. One take. Keep every object an...` |
...
**This graph:** `## creator/silent/paper-flip Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent page / carousel flip ~5 s. Lab size **832x480**. Prefix `ez_flip`. Empty ...`
...
**This graph:** `A page or card turns once. Keep identity locked. One take. Keep every object and surface from the start image; do not redesign.`

```text
A page or card turns once. Keep identity locked. One take. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/silent/paper-flip`
