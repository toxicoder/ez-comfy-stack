...
**Who this is for:** studio users who loaded `creator/silent/city-night` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/city-night.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent night-drive / city-lights ~5 s. Lab size **832x480**. Prefix `ez_night`.
...
2. Load **creator/silent/city-night** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow dolly past city lights. Keep the start-image identity locked. Keep every o...` |
...
**This graph:** `## creator/silent/city-night Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent night-drive / city-lights ~5 s. Lab size **832x480**. Prefix `ez_night`. ...`
...
**This graph:** `Slow dolly past city lights. Keep the start-image identity locked. Keep every object and surface from the start image; do not redesign.`

```text
Slow dolly past city lights. Keep the start-image identity locked. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/silent/city-night`
