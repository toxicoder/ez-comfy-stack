---
title: "creator/silent/macro-product"
description: "Silent macro product crawl ~5 s Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film shots) is encoded as written. Turn Enhanc"
tags: [workflows, generated, comfyui, creator]
---

# creator/silent/macro-product
...
**Who this is for:** studio users who loaded `creator/silent/macro-product` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/macro-product.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent macro product crawl ~5 s. Lab size **832x480**. Prefix `ez_macro`.
...
2. Load **creator/silent/macro-product** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow macro crawl across the start-image surface. Identity locked. Keep every ob...` |
...
**This graph:** `## creator/silent/macro-product Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent macro product crawl ~5 s. Lab size **832x480**. Prefix `ez_macro`. Emp...`
...
**This graph:** `Slow macro crawl across the start-image surface. Identity locked. Keep every object and surface from the start image; do not redesign.`

```text
Slow macro crawl across the start-image surface. Identity locked. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/silent/macro-product`
