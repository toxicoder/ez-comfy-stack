...
**This graph:** `## creator/silent/instagram-story-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent Instagram Story loop 9:16. Lab size **480×832**. Prefix `ez_ig_…`
