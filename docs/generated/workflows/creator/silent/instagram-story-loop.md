...
# creator/silent/instagram-story-loop
...
**Who this is for:** studio users who loaded `creator/silent/instagram-story-loop` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/instagram-story-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent Instagram Story loop 9:16. Lab size **480x832**. Prefix `ez_ig_loop`.
...
2. Load **creator/silent/instagram-story-loop** from **Apps** or **Workflows**
...
**This graph:** `## creator/silent/instagram-story-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent Instagram Story loop 9:16. Lab size **480x832**. Prefix `ez_ig_...`
...
**This graph:** `creator/silent/instagram-story-loop`
