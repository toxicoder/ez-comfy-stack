...
**Who this is for:** studio users who loaded `creator/silent/screen-bg-loop` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/screen-bg-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent desk/screen loop. Lab size **832x480**. Prefix `ez_screen`.
...
2. Load **creator/silent/screen-bg-loop** from **Apps** or **Workflows**
...
**This graph:** `## creator/silent/screen-bg-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent desk/screen loop. Lab size **832x480**. Prefix `ez_screen`. Empty of ...`
...
**This graph:** `creator/silent/screen-bg-loop`
