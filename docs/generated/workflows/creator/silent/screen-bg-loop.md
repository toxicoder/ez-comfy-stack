...
**This graph:** `## creator/silent/screen-bg-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent desk/screen loop. Lab size **832×480**. Prefix `ez_screen`. Empty of …`
