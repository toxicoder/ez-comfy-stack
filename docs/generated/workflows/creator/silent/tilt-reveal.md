...
**Who this is for:** studio users who loaded `creator/silent/tilt-reveal` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/tilt-reveal.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent tilt reveal ~5 s. Lab size **832x480**. Prefix `ez_tilt`.
...
2. Load **creator/silent/tilt-reveal** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow tilt down to reveal the subject. One continuous take. No cut. Keep every o...` |
...
**This graph:** `## creator/silent/tilt-reveal Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent tilt reveal ~5 s. Lab size **832x480**. Prefix `ez_tilt`. Empty of lette...`
...
**This graph:** `Slow tilt down to reveal the subject. One continuous take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Slow tilt down to reveal the subject. One continuous take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/silent/tilt-reveal`
