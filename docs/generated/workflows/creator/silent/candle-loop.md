...
**Who this is for:** studio users who loaded `creator/silent/candle-loop` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/candle-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent candle-flicker loop. Lab size **832x480**. Prefix `ez_candle`.
...
2. Load **creator/silent/candle-loop** from **Apps** or **Workflows**
...
**This graph:** `## creator/silent/candle-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent candle-flicker loop. Lab size **832x480**. Prefix `ez_candle`. Empty of ...`
...
**This graph:** `creator/silent/candle-loop`
