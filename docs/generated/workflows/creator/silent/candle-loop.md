...
**This graph:** `## creator/silent/candle-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent candle-flicker loop. Lab size **832×480**. Prefix `ez_candle`. Empty of …`
