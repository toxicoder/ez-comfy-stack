...
**Who this is for:** studio users who loaded `creator/silent/handheld-vlog` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/handheld-vlog.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent handheld vlog micro-shake 9:16. Lab size **480x832**. Prefix `ez_vlog`.
...
2. Load **creator/silent/handheld-vlog** from **Apps** or **Workflows**
...
**This graph:** `## creator/silent/handheld-vlog Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent handheld vlog micro-shake 9:16. Lab size **480x832**. Prefix `ez_vlog`...`
...
**This graph:** `creator/silent/handheld-vlog`
