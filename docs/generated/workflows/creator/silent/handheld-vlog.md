...
**This graph:** `## creator/silent/handheld-vlog Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent handheld vlog micro-shake 9:16. Lab size **480×832**. Prefix `ez_vlog`…`
