...
**Who this is for:** studio users who loaded `creator/silent/unbox-hands` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/unbox-hands.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent unbox / hands motion ~5 s. Lab size **832x480**. Prefix `ez_unbox`.
...
2. Load **creator/silent/unbox-hands** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Hands ease a box open. Slow, locked identity. One continuous take. Keep every o...` |
...
**This graph:** `## creator/silent/unbox-hands Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent unbox / hands motion ~5 s. Lab size **832x480**. Prefix `ez_unbox`. Empt...`
...
**This graph:** `Hands ease a box open. Slow, locked identity. One continuous take. Keep every object and surface from the start image; do not redesign.`

```text
Hands ease a box open. Slow, locked identity. One continuous take. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/silent/unbox-hands`
