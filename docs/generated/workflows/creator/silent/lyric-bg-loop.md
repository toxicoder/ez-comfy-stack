...
**Who this is for:** studio users who loaded `creator/silent/lyric-bg-loop` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/lyric-bg-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent lyric-background loop 16:9. Lab size **832x480**. Prefix `ez_lyric_loop`.
...
2. Load **creator/silent/lyric-bg-loop** from **Apps** or **Workflows**
...
**This graph:** `## creator/silent/lyric-bg-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent lyric-background loop 16:9. Lab size **832x480**. Prefix `ez_lyric_loo...`
...
**This graph:** `creator/silent/lyric-bg-loop`
