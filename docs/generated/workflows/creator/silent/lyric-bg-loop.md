...
**This graph:** `## creator/silent/lyric-bg-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent lyric-background loop 16:9. Lab size **832×480**. Prefix `ez_lyric_loo…`
