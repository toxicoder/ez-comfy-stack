...
Silent logo sting ~5 s. Lab size **832×480**. Prefix `ez_sting`.
...
**This graph:** `## creator/silent/logo-sting Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent logo sting ~5 s. Lab size **832×480**. Prefix `ez_sting`. Empty of letter…`
