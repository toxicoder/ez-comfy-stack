...
**Who this is for:** studio users who loaded `creator/silent/logo-sting` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/logo-sting.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent logo sting ~5 s. Lab size **832x480**. Prefix `ez_sting`.
...
2. Load **creator/silent/logo-sting** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `A short push-in toward the start-image mark. No lettering. One take. Keep every...` |
...
**This graph:** `## creator/silent/logo-sting Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent logo sting ~5 s. Lab size **832x480**. Prefix `ez_sting`. Empty of letter...`
...
**This graph:** `A short push-in toward the start-image mark. No lettering. One take. Keep every object and surface from the start image; do not redesign.`

```text
A short push-in toward the start-image mark. No lettering. One take. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/silent/logo-sting`
