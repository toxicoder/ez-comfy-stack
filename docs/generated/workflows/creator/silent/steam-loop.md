...
**This graph:** `## creator/silent/steam-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent steam / kettle loop. Lab size **832×480**. Prefix `ez_steam`. Empty of le…`
