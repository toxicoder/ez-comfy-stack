---
title: "creator/silent/steam-loop"
description: "Silent steam / kettle loop Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film shots) is encoded as written. Turn Enhance on"
tags: [workflows, generated, comfyui, creator]
---

# creator/silent/steam-loop
...
**Who this is for:** studio users who loaded `creator/silent/steam-loop` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/steam-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent steam / kettle loop. Lab size **832x480**. Prefix `ez_steam`.
...
2. Load **creator/silent/steam-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Soft steam rises from a mug. Locked camera. Ping-pong friendly. Keep every obje...` |
...
**This graph:** `## creator/silent/steam-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent steam / kettle loop. Lab size **832x480**. Prefix `ez_steam`. Empty of le...`
...
**This graph:** `Soft steam rises from a mug. Locked camera. Ping-pong friendly. Keep every object and surface from the start image; do not redesign.`

```text
Soft steam rises from a mug. Locked camera. Ping-pong friendly. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/silent/steam-loop`
