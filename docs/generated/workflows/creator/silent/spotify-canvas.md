...
**Who this is for:** studio users who loaded `creator/silent/spotify-canvas` from Apps or Workflows.

> Generated from `workflows/_lab/creator/silent/spotify-canvas.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent Spotify Canvas rebound 9:16. Lab size **480x832**. Prefix `ez_spot_canvas`.
...
2. Load **creator/silent/spotify-canvas** from **Apps** or **Workflows**
...
**This graph:** `## creator/silent/spotify-canvas Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent Spotify Canvas rebound 9:16. Lab size **480x832**. Prefix `ez_spot_ca...`
...
**This graph:** `creator/silent/spotify-canvas`
