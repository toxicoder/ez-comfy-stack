...
**This graph:** `## creator/silent/spotify-canvas Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent Spotify Canvas rebound 9:16. Lab size **480×832**. Prefix `ez_spot_ca…`
