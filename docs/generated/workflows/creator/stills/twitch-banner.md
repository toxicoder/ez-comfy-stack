...
**Who this is for:** studio users who loaded `creator/stills/twitch-banner` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/twitch-banner.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/twitch-banner** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/twitch-banner Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Twitch channel banner ~3:1. Lab size **1536×512**. Prefix `ez_tw_banner`. Emp…`
