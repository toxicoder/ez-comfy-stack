...
**Who this is for:** studio users who loaded `creator/stills/episode-art` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/episode-art.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/episode-art** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/episode-art Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Per-episode podcast art 1:1. Lab size **1024×1024**. Prefix `ez_episode`. Empty…`
