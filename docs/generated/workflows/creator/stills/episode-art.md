...
Per-episode podcast art 1:1. Lab size **1024x1024**. Prefix `ez_episode`.
...
**This graph:** `## creator/stills/episode-art Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Per-episode podcast art 1:1. Lab size **1024x1024**. Prefix `ez_episode`. Empty...`
...
**This graph:** `Podcast - episode art (1024x1024)`
