...
YouTube channel icon, circle-safe 1:1. Lab size **768x768**. Prefix `ez_yt_icon`.
...
**This graph:** `## creator/stills/youtube-channel-icon Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. YouTube channel icon, circle-safe 1:1. Lab size **768x768**. Prefix `e...`
...
**This graph:** `YouTube - channel icon (768x768)`
