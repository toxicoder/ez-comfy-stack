---
title: creator/stills/youtube-channel-icon
description: YouTube channel icon, circle-safe 1:1
tags: [workflows, generated, comfyui, creator]
---

# creator/stills/youtube-channel-icon
...
**Who this is for:** studio users who loaded `creator/stills/youtube-channel-icon` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/youtube-channel-icon.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/youtube-channel-icon** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/youtube-channel-icon Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube channel icon, circle-safe 1:1. Lab size **768×768**. Prefix `e…`
