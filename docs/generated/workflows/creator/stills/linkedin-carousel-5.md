...
# creator/stills/linkedin-carousel-5
...
**Who this is for:** studio users who loaded `creator/stills/linkedin-carousel-5` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/linkedin-carousel-5.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
LinkedIn document carousel, five squares. Lab size **1024x1024**. Prefix `ez_li_c01`.
Empty of lettering. Add titles in your editor, not in the prompt.
Occupancy: klein - stop Wan, LTX, podcast, music. One GB10 job.
Handoff: none.
Pack prefixes: `ez_li_c01`, `ez_li_c02`, `ez_li_c03`, `ez_li_c04`, `ez_li_c05`.
...
2. Load **creator/stills/linkedin-carousel-5** from **Apps** or **Workflows**
...
flowchart TB
  ...
  GMODEL["MODEL"]
  GIDENTITY["IDENTITY"]
  GSHOT_COVER["SHOT COVER"]
  GSHOT_POINT["SHOT POINT"]
  GSHOT_PROOF["SHOT PROOF"]
  GSHOT_SCENE["SHOT SCENE"]
...
| 10 | SHOT COVER | `EZPromptJoin` | SHOT COVER |
| 11 | Positive COVER | `CLIPTextEncode` | SHOT COVER |
| 12 | Sampler COVER | `KSampler` | SHOT COVER |
| 13 | Decode COVER | `VAEDecode` | SHOT COVER |
| 14 | Save COVER | `SaveImage` | SHOT COVER |
| 16 | SHOT POINT | `EZPromptJoin` | SHOT POINT |
| 17 | Positive POINT | `CLIPTextEncode` | SHOT POINT |
| 18 | Sampler POINT | `KSampler` | SHOT POINT |
| 19 | Decode POINT | `VAEDecode` | SHOT POINT |
| 20 | Save POINT | `SaveImage` | SHOT POINT |
| 22 | SHOT PROOF | `EZPromptJoin` | SHOT PROOF |
| 23 | Positive PROOF | `CLIPTextEncode` | SHOT PROOF |
| 24 | Sampler PROOF | `KSampler` | SHOT PROOF |
| 25 | Decode PROOF | `VAEDecode` | SHOT PROOF |
| 26 | Save PROOF | `SaveImage` | SHOT PROOF |
| 28 | SHOT SCENE | `EZPromptJoin` | SHOT SCENE |
| 29 | Positive SCENE | `CLIPTextEncode` | SHOT SCENE |
| 30 | Sampler SCENE | `KSampler` | SHOT SCENE |
| 31 | Decode SCENE | `VAEDecode` | SHOT SCENE |
| 32 | Save SCENE | `SaveImage` | SHOT SCENE |
| 34 | SHOT CLOSE | `EZPromptJoin` | SHOT CLOSE |
| 35 | Positive CLOSE | `CLIPTextEncode` | SHOT CLOSE |
...
| 40 | Quality | `EZQuality` | QUALITY |
| 41 | Format / platform | `EZImageFormat` | SETTINGS |
| 42 | Upscale still | `EZImageUpscale` | SHOT COVER |
| 43 | Upscale still | `EZImageUpscale` | SHOT POINT |
| 44 | Upscale still | `EZImageUpscale` | SHOT PROOF |
| 45 | Upscale still | `EZImageUpscale` | SHOT SCENE |
| 46 | Upscale still | `EZImageUpscale` | SHOT CLOSE |
| 47 | Check models | `EZModelCheck` | QUALITY |
| 48 | Negative SHOT POINT | `EZNegativePromptEnhance` | Ungrouped |
| 49 | Negative Negative SHOT POINT | `CLIPTextEncode` | Ungrouped |
| 50 | Negative SHOT PROOF | `EZNegativePromptEnhance` | Ungrouped |
| 51 | Negative Negative SHOT PROOF | `CLIPTextEncode` | Ungrouped |
| 52 | Negative SHOT SCENE | `EZNegativePromptEnhance` | Ungrouped |
| 53 | Negative Negative SHOT SCENE | `CLIPTextEncode` | Ungrouped |
| 54 | Negative SHOT CLOSE | `EZNegativePromptEnhance` | Ungrouped |
| 55 | Negative Negative SHOT CLOSE | `CLIPTextEncode` | Ungrouped |
...
**This graph:** `creator/stills/linkedin-carousel-5`
...
| Positive COVER | `Cover still. Subject large, quiet lower band for a title. Same building, rooms,...` |
| Positive POINT | `Point two. Same person, 35mm, a second gesture. Same building, rooms, furniture...` |
| Positive PROOF | `Proof still. Prop or desk detail, 50mm. Same building, rooms, furniture placeme...` |
| Positive SCENE | `Scene still. Wider 24mm of the same terrace. Same building, rooms, furniture pl...` |
| Positive CLOSE | `Close still. 85mm, same coat and light. Same building, rooms, furniture placeme...` |
| Negative Negative SHOT POINT | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT PROOF | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT SCENE | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
...
**This graph:** `## creator/stills/linkedin-carousel-5 Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. LinkedIn document carousel, five squares. Lab size **1024x1024**. Prefi...`
...
| Instance | Value |
| --- | --- |
| SHOT COVER | `Cover still. Subject large, quiet lower band for a title.` |
| SHOT POINT | `Point two. Same person, 35mm, a second gesture.` |
| SHOT PROOF | `Proof still. Prop or desk detail, 50mm.` |
| SHOT SCENE | `Scene still. Wider 24mm of the same terrace.` |
| SHOT CLOSE | `Close still. 85mm, same coat and light.` |
...
**This graph (all 5 instances):** `view`
...
**This graph (all 5 instances):** `1.0`
...
**This graph (all 5 instances):** `euler`
...
**This graph (all 5 instances):** `simple`
...
| Instance | Value |
| --- | --- |
| Save COVER | `ez_li_c01` |
| Save POINT | `ez_li_c02` |
| Save PROOF | `ez_li_c03` |
| Save SCENE | `ez_li_c04` |
| Save CLOSE | `ez_li_c05` |
...
**This graph (all 5 instances):** `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melted geometry, duplicate limbs, watermarks, oversharpen halos, muddy blacks`
...
**This graph (all 5 instances):** `true`
...
**This graph (all 5 instances):** `klein`
...
**This graph:** `1:1 square (1024x1024)`
