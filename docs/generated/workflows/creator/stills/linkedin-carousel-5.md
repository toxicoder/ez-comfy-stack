...
LinkedIn document carousel, five squares. Lab size **1024×1024**. Prefix `ez_li_c01`.
...
**This graph:** `## creator/stills/linkedin-carousel-5 Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LinkedIn document carousel, five squares. Lab size **1024×1024**. Prefi…`
...
**This graph:** `1:1 square (1024×1024)`
