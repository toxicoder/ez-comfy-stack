...
# creator/stills/instagram-portrait
...
**Who this is for:** studio users who loaded `creator/stills/instagram-portrait` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/instagram-portrait.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/instagram-portrait** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/instagram-portrait Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram 4:5 feed still. Lab size **1024×1280**. Prefix `ez_ig_portrait…`
