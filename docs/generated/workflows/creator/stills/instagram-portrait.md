...
Instagram 4:5 feed still. Lab size **1024x1280**. Prefix `ez_ig_portrait`.
...
**This graph:** `## creator/stills/instagram-portrait Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Instagram 4:5 feed still. Lab size **1024x1280**. Prefix `ez_ig_portrait...`
...
**This graph:** `Instagram - 4:5 portrait (1024x1280)`
