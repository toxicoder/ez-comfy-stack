...
**Who this is for:** studio users who loaded `creator/stills/pinterest-pin` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/pinterest-pin.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/pinterest-pin** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/pinterest-pin Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Pinterest standard pin 2:3. Lab size **768×1152**. Prefix `ez_pin`. Empty of …`
