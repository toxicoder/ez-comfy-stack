...
Pinterest standard pin 2:3. Lab size **768x1152**. Prefix `ez_pin`.
...
**This graph:** `## creator/stills/pinterest-pin Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Pinterest standard pin 2:3. Lab size **768x1152**. Prefix `ez_pin`. Empty of ...`
...
**This graph:** `Pinterest - pin (768x1152)`
