...
YouTube chapter plate 16:9. Lab size **1280x720**. Prefix `ez_yt_chapter`.
...
**This graph:** `## creator/stills/youtube-chapter-card Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. YouTube chapter plate 16:9. Lab size **1280x720**. Prefix `ez_yt_chapt...`
...
**This graph:** `YouTube - chapter card (1280x720)`
