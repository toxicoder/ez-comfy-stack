...
**Who this is for:** studio users who loaded `creator/stills/moodboard-6up` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/moodboard-6up.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Six-still moodboard of one identity. Lab size **768x432**. Prefix `ez_mood_c01`.
...
2. Load **creator/stills/moodboard-6up** from **Apps** or **Workflows**
...
**This graph:** `creator/stills/moodboard-6up`
...
**This graph:** `## creator/stills/moodboard-6up Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Six-still moodboard of one identity. Lab size **768x432**. Prefix `ez_mood_c0...`
