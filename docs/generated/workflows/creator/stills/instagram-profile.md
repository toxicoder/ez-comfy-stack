...
Instagram profile photo, circle-safe. Lab size **768x768**. Prefix `ez_ig_profile`.
...
**This graph:** `## creator/stills/instagram-profile Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Instagram profile photo, circle-safe. Lab size **768x768**. Prefix `ez_ig...`
...
**This graph:** `Instagram - profile (768x768)`
