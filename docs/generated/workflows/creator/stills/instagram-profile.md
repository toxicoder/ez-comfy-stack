...
# creator/stills/instagram-profile
...
**Who this is for:** studio users who loaded `creator/stills/instagram-profile` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/instagram-profile.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/instagram-profile** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/instagram-profile Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram profile photo, circle-safe. Lab size **768×768**. Prefix `ez_ig…`
