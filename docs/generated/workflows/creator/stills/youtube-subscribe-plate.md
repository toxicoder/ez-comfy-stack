...
Subscribe-safe end plate 16:9. Lab size **1280x720**. Prefix `ez_yt_sub`.
...
**This graph:** `## creator/stills/youtube-subscribe-plate Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Subscribe-safe end plate 16:9. Lab size **1280x720**. Prefix `ez_yt...`
...
**This graph:** `YouTube - subscribe plate (1280x720)`
