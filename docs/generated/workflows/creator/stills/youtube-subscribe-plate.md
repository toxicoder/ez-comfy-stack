...
# creator/stills/youtube-subscribe-plate
...
**Who this is for:** studio users who loaded `creator/stills/youtube-subscribe-plate` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/youtube-subscribe-plate.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/youtube-subscribe-plate** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/youtube-subscribe-plate Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Subscribe-safe end plate 16:9. Lab size **1280×720**. Prefix `ez_yt…`
