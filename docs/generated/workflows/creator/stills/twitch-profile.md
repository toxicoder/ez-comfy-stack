...
**Who this is for:** studio users who loaded `creator/stills/twitch-profile` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/twitch-profile.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/twitch-profile** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/twitch-profile Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Twitch profile photo, circle-safe. Lab size **768×768**. Prefix `ez_tw_profi…`
