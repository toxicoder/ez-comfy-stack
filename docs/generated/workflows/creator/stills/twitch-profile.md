...
Twitch profile photo, circle-safe. Lab size **768x768**. Prefix `ez_tw_profile`.
...
**This graph:** `## creator/stills/twitch-profile Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Twitch profile photo, circle-safe. Lab size **768x768**. Prefix `ez_tw_profi...`
...
**This graph:** `Twitch - profile (768x768)`
