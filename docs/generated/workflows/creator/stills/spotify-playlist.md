...
Spotify playlist cover 1:1. Lab size **1024x1024**. Prefix `ez_spot_pl`.
...
**This graph:** `## creator/stills/spotify-playlist Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Spotify playlist cover 1:1. Lab size **1024x1024**. Prefix `ez_spot_pl`. E...`
...
**This graph:** `Spotify - playlist (1024x1024)`
