...
# creator/stills/spotify-playlist
...
**Who this is for:** studio users who loaded `creator/stills/spotify-playlist` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/spotify-playlist.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/spotify-playlist** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/spotify-playlist Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Spotify playlist cover 1:1. Lab size **1024×1024**. Prefix `ez_spot_pl`. E…`
