...
**Who this is for:** studio users who loaded `creator/stills/x-header` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/x-header.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/x-header** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/x-header Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. X header 3:1. Lab size **1536×512**. Prefix `ez_x_header`. Empty of lettering. Add…`
