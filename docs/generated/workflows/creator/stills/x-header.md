...
X header 3:1. Lab size **1536x512**. Prefix `ez_x_header`.
...
**This graph:** `## creator/stills/x-header Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. X header 3:1. Lab size **1536x512**. Prefix `ez_x_header`. Empty of lettering. Add...`
