...
YouTube Shorts thumbnail 9:16. Lab size **576x1024**. Prefix `ez_yt_shorts_thumb`.
...
**This graph:** `## creator/stills/youtube-shorts-thumb Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. YouTube Shorts thumbnail 9:16. Lab size **576x1024**. Prefix `ez_yt_sh...`
...
**This graph:** `YouTube - Shorts thumb (576x1024)`
