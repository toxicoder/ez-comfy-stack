...
Instagram Highlight cover, circle-safe. Lab size **768x768**. Prefix `ez_ig_highlight`.
...
**This graph:** `## creator/stills/instagram-highlight Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Instagram Highlight cover, circle-safe. Lab size **768x768**. Prefix `e...`
...
**This graph:** `Instagram - Highlight (768x768)`
