...
# creator/stills/instagram-highlight
...
**Who this is for:** studio users who loaded `creator/stills/instagram-highlight` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/instagram-highlight.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/instagram-highlight** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/instagram-highlight Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram Highlight cover, circle-safe. Lab size **768×768**. Prefix `e…`
