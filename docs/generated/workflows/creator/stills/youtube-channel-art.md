...
YouTube channel art 16:9 with a mobile-safe center band. Lab size **1536x864**. Prefix `ez_yt_art`.
...
**This graph:** `## creator/stills/youtube-channel-art Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. YouTube channel art 16:9 with a mobile-safe center band. Lab size **153...`
