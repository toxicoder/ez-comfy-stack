...
# creator/stills/youtube-channel-art
...
**Who this is for:** studio users who loaded `creator/stills/youtube-channel-art` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/youtube-channel-art.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/youtube-channel-art** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/youtube-channel-art Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube channel art 16:9 with a mobile-safe center band. Lab size **153…`
