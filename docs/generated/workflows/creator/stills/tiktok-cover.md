...
**Who this is for:** studio users who loaded `creator/stills/tiktok-cover` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/tiktok-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/tiktok-cover** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/tiktok-cover Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. TikTok cover 9:16. Lab size **576×1024**. Prefix `ez_tt_cover`. Empty of lette…`
