...
TikTok cover 9:16. Lab size **576x1024**. Prefix `ez_tt_cover`.
...
**This graph:** `## creator/stills/tiktok-cover Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. TikTok cover 9:16. Lab size **576x1024**. Prefix `ez_tt_cover`. Empty of lette...`
...
**This graph:** `TikTok - cover (576x1024)`
