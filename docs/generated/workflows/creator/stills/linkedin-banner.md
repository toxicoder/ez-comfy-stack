...
LinkedIn personal banner 4:1. Lab size **1536x384**. Prefix `ez_li_banner`.
...
**This graph:** `## creator/stills/linkedin-banner Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. LinkedIn personal banner 4:1. Lab size **1536x384**. Prefix `ez_li_banner`....`
...
**This graph:** `LinkedIn - banner (1536x384)`
