...
# creator/stills/linkedin-banner
...
**Who this is for:** studio users who loaded `creator/stills/linkedin-banner` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/linkedin-banner.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/linkedin-banner** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/linkedin-banner Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LinkedIn personal banner 4:1. Lab size **1536×384**. Prefix `ez_li_banner`.…`
