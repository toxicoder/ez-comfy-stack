...
# creator/stills/product-lifestyle
...
**Who this is for:** studio users who loaded `creator/stills/product-lifestyle` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/product-lifestyle.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/product-lifestyle** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/product-lifestyle Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. In-use product lifestyle 4:5. Lab size **1024×1280**. Prefix `ez_lifestyl…`
