...
In-use product lifestyle 4:5. Lab size **1024x1280**. Prefix `ez_lifestyle`.
...
**This graph:** `## creator/stills/product-lifestyle Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. In-use product lifestyle 4:5. Lab size **1024x1280**. Prefix `ez_lifestyl...`
...
**This graph:** `Product lifestyle (1024x1280)`
