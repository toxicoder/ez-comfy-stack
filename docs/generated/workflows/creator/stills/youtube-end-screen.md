...
YouTube end-screen plate, left-weighted. Lab size **1280x720**. Prefix `ez_yt_endscreen`.
...
**This graph:** `## creator/stills/youtube-end-screen Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. YouTube end-screen plate, left-weighted. Lab size **1280x720**. Prefix `...`
...
**This graph:** `YouTube - end screen (1280x720)`
