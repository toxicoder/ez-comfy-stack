...
# creator/stills/youtube-end-screen
...
**Who this is for:** studio users who loaded `creator/stills/youtube-end-screen` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/youtube-end-screen.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/youtube-end-screen** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/youtube-end-screen Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube end-screen plate, left-weighted. Lab size **1280×720**. Prefix `…`
