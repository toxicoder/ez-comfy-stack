...
**Who this is for:** studio users who loaded `creator/stills/tiktok-shop` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/tiktok-shop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/tiktok-shop** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/tiktok-shop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. TikTok Shop packshot 1:1. Lab size **1024×1024**. Prefix `ez_tt_shop`. Empty of…`
