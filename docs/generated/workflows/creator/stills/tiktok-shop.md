...
TikTok Shop packshot 1:1. Lab size **1024x1024**. Prefix `ez_tt_shop`.
...
**This graph:** `## creator/stills/tiktok-shop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. TikTok Shop packshot 1:1. Lab size **1024x1024**. Prefix `ez_tt_shop`. Empty of...`
...
**This graph:** `TikTok - Shop (1024x1024)`
