...
Newsletter / email header ~1.91:1. Lab size **1216x640**. Prefix `ez_email`.
...
**This graph:** `## creator/stills/email-header Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Newsletter / email header ~1.91:1. Lab size **1216x640**. Prefix `ez_email`. E...`
...
**This graph:** `Email - header (1216x640)`
