...
**Who this is for:** studio users who loaded `creator/stills/email-header` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/email-header.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/email-header** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/email-header Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Newsletter / email header ~1.91:1. Lab size **1216×640**. Prefix `ez_email`. E…`
