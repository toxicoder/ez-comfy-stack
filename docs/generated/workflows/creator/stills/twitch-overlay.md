---
title: creator/stills/twitch-overlay
description: Twitch webcam-hole overlay 16:9
tags: [workflows, generated, comfyui, creator]
---

# creator/stills/twitch-overlay
...
**Who this is for:** studio users who loaded `creator/stills/twitch-overlay` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/twitch-overlay.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/twitch-overlay** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/twitch-overlay Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Twitch webcam-hole overlay 16:9. Lab size **1280×720**. Prefix `ez_tw_overla…`
