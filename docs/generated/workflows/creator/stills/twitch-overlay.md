...
Twitch webcam-hole overlay 16:9. Lab size **1280x720**. Prefix `ez_tw_overlay`.
...
**This graph:** `## creator/stills/twitch-overlay Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Twitch webcam-hole overlay 16:9. Lab size **1280x720**. Prefix `ez_tw_overla...`
...
**This graph:** `Twitch - overlay (1280x720)`
