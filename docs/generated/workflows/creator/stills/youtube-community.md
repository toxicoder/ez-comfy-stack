...
YouTube Community post 1:1. Lab size **1024x1024**. Prefix `ez_yt_community`.
...
**This graph:** `## creator/stills/youtube-community Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. YouTube Community post 1:1. Lab size **1024x1024**. Prefix `ez_yt_communi...`
...
**This graph:** `YouTube - Community (1024x1024)`
