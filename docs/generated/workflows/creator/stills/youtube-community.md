---
title: creator/stills/youtube-community
description: YouTube Community post 1:1
tags: [workflows, generated, comfyui, creator]
---

# creator/stills/youtube-community
...
**Who this is for:** studio users who loaded `creator/stills/youtube-community` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/youtube-community.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/youtube-community** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/youtube-community Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube Community post 1:1. Lab size **1024×1024**. Prefix `ez_yt_communi…`
