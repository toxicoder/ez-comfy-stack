...
Instagram Reel cover, center-weighted for the grid crop. Lab size **576x1024**. Prefix `ez_ig_reel`.
...
**This graph:** `## creator/stills/instagram-reel-cover Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Instagram Reel cover, center-weighted for the grid crop. Lab size **57...`
...
**This graph:** `Instagram - Reel cover (576x1024)`
