...
# creator/stills/instagram-reel-cover
...
**Who this is for:** studio users who loaded `creator/stills/instagram-reel-cover` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/instagram-reel-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/instagram-reel-cover** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/instagram-reel-cover Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram Reel cover, center-weighted for the grid crop. Lab size **57…`
