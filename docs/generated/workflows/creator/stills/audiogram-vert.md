...
Audiogram background 9:16. Lab size **576x1024**. Prefix `ez_ag_vert`.
...
**This graph:** `## creator/stills/audiogram-vert Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Audiogram background 9:16. Lab size **576x1024**. Prefix `ez_ag_vert`. Empty...`
...
**This graph:** `Audiogram - vertical (576x1024)`
