...
# creator/stills/linkedin-landscape
...
**Who this is for:** studio users who loaded `creator/stills/linkedin-landscape` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/linkedin-landscape.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/linkedin-landscape** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/linkedin-landscape Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LinkedIn landscape post ~1.91:1. Lab size **1216×640**. Prefix `ez_li_la…`
