...
**Who this is for:** studio users who loaded `creator/stills/lyric-card` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/lyric-card.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/lyric-card** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/lyric-card Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Lyric-card background 1:1. Lab size **1024×1024**. Prefix `ez_lyric`. Empty of l…`
