...
Lyric-card background 1:1. Lab size **1024x1024**. Prefix `ez_lyric`.
...
**This graph:** `## creator/stills/lyric-card Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Lyric-card background 1:1. Lab size **1024x1024**. Prefix `ez_lyric`. Empty of l...`
...
**This graph:** `Lyric card (1024x1024)`
