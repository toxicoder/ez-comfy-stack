...
X in-stream still 16:9. Lab size **1280x720**. Prefix `ez_x_post`.
...
**This graph:** `## creator/stills/x-post Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. X in-stream still 16:9. Lab size **1280x720**. Prefix `ez_x_post`. Empty of letterin...`
