...
**Who this is for:** studio users who loaded `creator/stills/x-post` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/x-post.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/x-post** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/x-post Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. X in-stream still 16:9. Lab size **1280×720**. Prefix `ez_x_post`. Empty of letterin…`
