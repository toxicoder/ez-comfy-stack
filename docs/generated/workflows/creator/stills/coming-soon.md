...
Launch / coming-soon plate 16:9. Lab size **1280x720**. Prefix `ez_soon`.
...
**This graph:** `## creator/stills/coming-soon Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Launch / coming-soon plate 16:9. Lab size **1280x720**. Prefix `ez_soon`. Empty...`
...
**This graph:** `Coming soon (1280x720)`
