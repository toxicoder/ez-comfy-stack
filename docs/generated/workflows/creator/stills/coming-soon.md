...
**Who this is for:** studio users who loaded `creator/stills/coming-soon` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/coming-soon.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/coming-soon** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/coming-soon Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Launch / coming-soon plate 16:9. Lab size **1280×720**. Prefix `ez_soon`. Empty…`
