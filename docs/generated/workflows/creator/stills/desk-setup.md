...
Workspace establishing still 16:9. Lab size **1280x720**. Prefix `ez_desk`.
...
**This graph:** `## creator/stills/desk-setup Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Workspace establishing still 16:9. Lab size **1280x720**. Prefix `ez_desk`. Empt...`
...
**This graph:** `Desk setup (1280x720)`
