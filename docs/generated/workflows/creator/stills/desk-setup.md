---
title: creator/stills/desk-setup
description: Workspace establishing still 16:9
tags: [workflows, generated, comfyui, creator]
---

# creator/stills/desk-setup
...
**Who this is for:** studio users who loaded `creator/stills/desk-setup` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/desk-setup.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/desk-setup** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/desk-setup Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Workspace establishing still 16:9. Lab size **1280×720**. Prefix `ez_desk`. Empt…`
