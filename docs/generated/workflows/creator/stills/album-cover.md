...
Release / album cover 1:1. Lab size **1024x1024**. Prefix `ez_album`.
...
**This graph:** `## creator/stills/album-cover Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Release / album cover 1:1. Lab size **1024x1024**. Prefix `ez_album`. Empty of ...`
...
**This graph:** `Album - cover (1024x1024)`
