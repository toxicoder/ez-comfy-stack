...
**Who this is for:** studio users who loaded `creator/stills/twitch-panel` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/twitch-panel.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/twitch-panel** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/twitch-panel Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Twitch about-panel art. Lab size **768×1024**. Prefix `ez_tw_panel`. Empty of …`
