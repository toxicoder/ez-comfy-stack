...
**Who this is for:** studio users who loaded `creator/stills/facebook-post` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/facebook-post.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/facebook-post** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/facebook-post Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Facebook shared-image still ~1.91:1. Lab size **1216×640**. Prefix `ez_fb_pos…`
