...
Facebook shared-image still ~1.91:1. Lab size **1216x640**. Prefix `ez_fb_post`.
...
**This graph:** `## creator/stills/facebook-post Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Facebook shared-image still ~1.91:1. Lab size **1216x640**. Prefix `ez_fb_pos...`
...
**This graph:** `Facebook - post (1216x640)`
