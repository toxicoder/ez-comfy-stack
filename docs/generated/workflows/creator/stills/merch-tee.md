...
Unmarked tee mock 1:1. Lab size **1024x1024**. Prefix `ez_tee`.
...
**This graph:** `## creator/stills/merch-tee Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Unmarked tee mock 1:1. Lab size **1024x1024**. Prefix `ez_tee`. Empty of letterin...`
...
**This graph:** `Merch - tee (1024x1024)`
