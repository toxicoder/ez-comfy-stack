---
title: "creator/stills/merch-tee"
description: "Unmarked tee mock 1:1"
tags: [workflows, generated, comfyui, creator]
---

# creator/stills/merch-tee
...
**Who this is for:** studio users who loaded `creator/stills/merch-tee` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/merch-tee.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/merch-tee** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/merch-tee Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Unmarked tee mock 1:1. Lab size **1024×1024**. Prefix `ez_tee`. Empty of letterin…`
