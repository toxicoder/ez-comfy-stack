---
title: creator/stills/instagram-landscape
description: Instagram landscape feed ~1.91:1
tags: [workflows, generated, comfyui, creator]
---

# creator/stills/instagram-landscape
...
**Who this is for:** studio users who loaded `creator/stills/instagram-landscape` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/instagram-landscape.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/instagram-landscape** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/instagram-landscape Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram landscape feed ~1.91:1. Lab size **1216×640**. Prefix `ez_ig_…`
