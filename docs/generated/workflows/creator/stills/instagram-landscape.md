...
Instagram landscape feed ~1.91:1. Lab size **1216x640**. Prefix `ez_ig_land`.
...
**This graph:** `## creator/stills/instagram-landscape Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Instagram landscape feed ~1.91:1. Lab size **1216x640**. Prefix `ez_ig_...`
...
**This graph:** `Instagram - landscape (1216x640)`
