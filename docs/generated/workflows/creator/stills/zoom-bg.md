...
Webcam-safe Zoom / Meet background 16:9. Lab size **1280x720**. Prefix `ez_zoom`.
...
**This graph:** `## creator/stills/zoom-bg Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Webcam-safe Zoom / Meet background 16:9. Lab size **1280x720**. Prefix `ez_zoom`. E...`
...
**This graph:** `Zoom / Meet background (1280x720)`
