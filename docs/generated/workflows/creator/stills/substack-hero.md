---
title: "creator/stills/substack-hero"
description: "Substack / blog hero ~1.91:1"
tags: [workflows, generated, comfyui, creator]
---

# creator/stills/substack-hero
...
**Who this is for:** studio users who loaded `creator/stills/substack-hero` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/substack-hero.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/substack-hero** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/substack-hero Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Substack / blog hero ~1.91:1. Lab size **1216×640**. Prefix `ez_substack`. Em…`
