...
Threads 4:5 still. Lab size **1024x1280**. Prefix `ez_threads`.
...
**This graph:** `## creator/stills/threads-portrait Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Threads 4:5 still. Lab size **1024x1280**. Prefix `ez_threads`. Empty of l...`
...
**This graph:** `Threads - 4:5 (1024x1280)`
