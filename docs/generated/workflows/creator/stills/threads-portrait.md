...
# creator/stills/threads-portrait
...
**Who this is for:** studio users who loaded `creator/stills/threads-portrait` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/threads-portrait.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/threads-portrait** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/threads-portrait Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Threads 4:5 still. Lab size **1024×1280**. Prefix `ez_threads`. Empty of l…`
