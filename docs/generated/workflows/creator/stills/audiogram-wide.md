...
Audiogram background 16:9. Lab size **1280x720**. Prefix `ez_ag_wide`.
...
**This graph:** `## creator/stills/audiogram-wide Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Audiogram background 16:9. Lab size **1280x720**. Prefix `ez_ag_wide`. Empty...`
...
**This graph:** `Audiogram - wide (1280x720)`
