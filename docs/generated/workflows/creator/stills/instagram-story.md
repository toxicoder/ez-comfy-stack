...
Instagram Story 9:16 with UI-safe edges. Lab size **576x1024**. Prefix `ez_ig_story`.
...
**This graph:** `## creator/stills/instagram-story Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Instagram Story 9:16 with UI-safe edges. Lab size **576x1024**. Prefix `ez_...`
...
**This graph:** `Instagram - Story (576x1024)`
