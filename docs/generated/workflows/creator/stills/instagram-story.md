...
# creator/stills/instagram-story
...
**Who this is for:** studio users who loaded `creator/stills/instagram-story` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/instagram-story.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/instagram-story** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/instagram-story Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram Story 9:16 with UI-safe edges. Lab size **576×1024**. Prefix `ez_…`
