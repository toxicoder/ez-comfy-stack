...
Pinterest Idea Pin 9:16. Lab size **576x1024**. Prefix `ez_pin_story`.
...
**This graph:** `## creator/stills/pinterest-story Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Pinterest Idea Pin 9:16. Lab size **576x1024**. Prefix `ez_pin_story`. Empt...`
...
**This graph:** `Pinterest - Idea Pin (576x1024)`
