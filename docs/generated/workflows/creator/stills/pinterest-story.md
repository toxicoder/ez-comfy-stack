...
# creator/stills/pinterest-story
...
**Who this is for:** studio users who loaded `creator/stills/pinterest-story` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/pinterest-story.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/pinterest-story** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/pinterest-story Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Pinterest Idea Pin 9:16. Lab size **576×1024**. Prefix `ez_pin_story`. Empt…`
