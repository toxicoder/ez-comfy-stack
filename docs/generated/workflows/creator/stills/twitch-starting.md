...
Twitch starting-soon screen 16:9. Lab size **1280x720**. Prefix `ez_tw_start`.
...
**This graph:** `## creator/stills/twitch-starting Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Twitch starting-soon screen 16:9. Lab size **1280x720**. Prefix `ez_tw_star...`
...
**This graph:** `Twitch - starting soon (1280x720)`
