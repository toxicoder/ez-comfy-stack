...
Spotify Canvas still 9:16 (silent JPG stand-in). Lab size **576x1024**. Prefix `ez_spot_still`.
...
**This graph:** `## creator/stills/spotify-canvas-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Spotify Canvas still 9:16 (silent JPG stand-in). Lab size **576x1024**...`
...
**This graph:** `Spotify - Canvas still (576x1024)`
