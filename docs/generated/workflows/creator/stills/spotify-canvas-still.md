...
# creator/stills/spotify-canvas-still
...
**Who this is for:** studio users who loaded `creator/stills/spotify-canvas-still` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/spotify-canvas-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/spotify-canvas-still** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/spotify-canvas-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Spotify Canvas still 9:16 (silent JPG stand-in). Lab size **576×1024**…`
