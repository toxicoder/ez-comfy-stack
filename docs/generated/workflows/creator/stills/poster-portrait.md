...
Print poster 2:3. Lab size **768x1152**. Prefix `ez_poster`.
...
**This graph:** `## creator/stills/poster-portrait Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Print poster 2:3. Lab size **768x1152**. Prefix `ez_poster`. Empty of lette...`
...
**This graph:** `Print poster (768x1152)`
