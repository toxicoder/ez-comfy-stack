...
# creator/stills/poster-portrait
...
**Who this is for:** studio users who loaded `creator/stills/poster-portrait` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/poster-portrait.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/poster-portrait** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/poster-portrait Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Print poster 2:3. Lab size **768×1152**. Prefix `ez_poster`. Empty of lette…`
