---
title: creator/stills/x-card
description: X link-card still ~1.91:1
tags: [workflows, generated, comfyui, creator]
---

# creator/stills/x-card
...
**Who this is for:** studio users who loaded `creator/stills/x-card` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/x-card.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/x-card** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/x-card Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. X link-card still ~1.91:1. Lab size **1216×640**. Prefix `ez_x_card`. Empty of lette…`
