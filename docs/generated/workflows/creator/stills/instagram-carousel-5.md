...
Instagram 4:5 carousel, five slides. Lab size **1024×1280**. Prefix `ez_ig_c01`.
...
**This graph:** `## creator/stills/instagram-carousel-5 Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram 4:5 carousel, five slides. Lab size **1024×1280**. Prefix `e…`
...
**This graph:** `4:5 portrait (1024×1280)`
