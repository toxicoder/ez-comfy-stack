...
# creator/stills/instagram-carousel-5
...
**Who this is for:** studio users who loaded `creator/stills/instagram-carousel-5` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/instagram-carousel-5.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Instagram 4:5 carousel, five slides. Lab size **1024x1280**. Prefix `ez_ig_c01`.
...
Pack prefixes: `ez_ig_c01`, `ez_ig_c02`, `ez_ig_c03`, `ez_ig_c04`, `ez_ig_c05`.
...
2. Load **creator/stills/instagram-carousel-5** from **Apps** or **Workflows**
...
flowchart TB
  ...
  GMODEL["MODEL"]
  GIDENTITY["IDENTITY"]
  GSHOT_HOOK["SHOT HOOK"]
  GSHOT_BEAT["SHOT BEAT"]
  GSHOT_DETAIL["SHOT DETAIL"]
...
| 10 | SHOT HOOK | `EZPromptJoin` | SHOT HOOK |
| 11 | Positive HOOK | `CLIPTextEncode` | SHOT HOOK |
| 12 | Sampler HOOK | `KSampler` | SHOT HOOK |
| 13 | Decode HOOK | `VAEDecode` | SHOT HOOK |
| 14 | Save HOOK | `SaveImage` | SHOT HOOK |
| 16 | SHOT BEAT | `EZPromptJoin` | SHOT BEAT |
| 17 | Positive BEAT | `CLIPTextEncode` | SHOT BEAT |
| 18 | Sampler BEAT | `KSampler` | SHOT BEAT |
| 19 | Decode BEAT | `VAEDecode` | SHOT BEAT |
| 20 | Save BEAT | `SaveImage` | SHOT BEAT |
| 22 | SHOT DETAIL | `EZPromptJoin` | SHOT DETAIL |
| 23 | Positive DETAIL | `CLIPTextEncode` | SHOT DETAIL |
| 24 | Sampler DETAIL | `KSampler` | SHOT DETAIL |
| 25 | Decode DETAIL | `VAEDecode` | SHOT DETAIL |
| 26 | Save DETAIL | `SaveImage` | SHOT DETAIL |
| 28 | SHOT WIDE | `EZPromptJoin` | SHOT WIDE |
| 29 | Positive WIDE | `CLIPTextEncode` | SHOT WIDE |
| 30 | Sampler WIDE | `KSampler` | SHOT WIDE |
| 31 | Decode WIDE | `VAEDecode` | SHOT WIDE |
| 32 | Save WIDE | `SaveImage` | SHOT WIDE |
...
| 48 | Negative SHOT BEAT | `EZNegativePromptEnhance` | Ungrouped |
| 49 | Negative Negative SHOT BEAT | `CLIPTextEncode` | Ungrouped |
| 50 | Negative SHOT DETAIL | `EZNegativePromptEnhance` | Ungrouped |
| 51 | Negative Negative SHOT DETAIL | `CLIPTextEncode` | Ungrouped |
| 52 | Negative SHOT WIDE | `EZNegativePromptEnhance` | Ungrouped |
| 53 | Negative Negative SHOT WIDE | `CLIPTextEncode` | Ungrouped |
...
**This graph:** `creator/stills/instagram-carousel-5`
...
| Positive HOOK | `Opening still. Subject large, 35mm, eye level. Quiet edges. Same building, room...` |
| Positive BEAT | `Second beat. Step closer, 50mm. Same wardrobe and light. Same building, rooms, ...` |
| Positive DETAIL | `Detail still. Hands or prop, 85mm. Same place. Same building, rooms, furniture ...` |
| Positive WIDE | `Wide establishing. 24mm, more terrace and towers. Same building, rooms, furnitu...` |
| Positive CLOSE | `Close closer. Face and coat, 85mm, same golden hour. Same building, rooms, furn...` |
| Negative Negative SHOT BEAT | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
...
**This graph:** `## creator/stills/instagram-carousel-5 Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Instagram 4:5 carousel, five slides. Lab size **1024x1280**. Prefix `e...`
...
| Instance | Value |
| --- | --- |
| SHOT HOOK | `Opening still. Subject large, 35mm, eye level. Quiet edges.` |
| SHOT BEAT | `Second beat. Step closer, 50mm. Same wardrobe and light.` |
| SHOT DETAIL | `Detail still. Hands or prop, 85mm. Same place.` |
| SHOT WIDE | `Wide establishing. 24mm, more terrace and towers.` |
| SHOT CLOSE | `Close closer. Face and coat, 85mm, same golden hour.` |
...
| Save HOOK | `ez_ig_c01` |
| Save BEAT | `ez_ig_c02` |
| Save DETAIL | `ez_ig_c03` |
| Save WIDE | `ez_ig_c04` |
| Save CLOSE | `ez_ig_c05` |
...
**This graph:** `4:5 portrait (1024x1280)`
