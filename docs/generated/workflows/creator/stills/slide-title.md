...
Course / webinar title plate 16:9. Lab size **1280x720**. Prefix `ez_slide`.
...
**This graph:** `## creator/stills/slide-title Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Course / webinar title plate 16:9. Lab size **1280x720**. Prefix `ez_slide`. Em...`
...
**This graph:** `Slide title (1280x720)`
