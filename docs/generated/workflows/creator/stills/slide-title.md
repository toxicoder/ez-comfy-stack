...
**Who this is for:** studio users who loaded `creator/stills/slide-title` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/slide-title.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/slide-title** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/slide-title Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Course / webinar title plate 16:9. Lab size **1280×720**. Prefix `ez_slide`. Em…`
