...
**Who this is for:** studio users who loaded `creator/stills/brand-kit-4` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/brand-kit-4.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Four brand plates, same camera, different lights. Lab size **768x432**. Prefix `ez_brand_01`.
Empty of lettering. Add titles in your editor, not in the prompt.
Occupancy: klein - stop Wan, LTX, podcast, music. One GB10 job.
Handoff: none.
Pack prefixes: `ez_brand_01`, `ez_brand_02`, `ez_brand_03`, `ez_brand_04`.
...
2. Load **creator/stills/brand-kit-4** from **Apps** or **Workflows**
...
| 13 | Decode KEY | `VAEDecode` | SHOT KEY |
| 14 | Save KEY | `SaveImage` | SHOT KEY |
| 16 | SHOT COOL | `EZPromptJoin` | SHOT COOL |
| 17 | Positive COOL | `CLIPTextEncode` | SHOT COOL |
| 18 | Sampler COOL | `KSampler` | SHOT COOL |
| 19 | Decode COOL | `VAEDecode` | SHOT COOL |
| 20 | Save COOL | `SaveImage` | SHOT COOL |
| 21 | Ref from 01 (COOL) | `ReferenceLatent` | SHOT COOL |
| 22 | SHOT NIGHT | `EZPromptJoin` | SHOT NIGHT |
| 23 | Positive NIGHT | `CLIPTextEncode` | SHOT NIGHT |
| 24 | Sampler NIGHT | `KSampler` | SHOT NIGHT |
| 25 | Decode NIGHT | `VAEDecode` | SHOT NIGHT |
| 26 | Save NIGHT | `SaveImage` | SHOT NIGHT |
| 27 | Ref from 01 (NIGHT) | `ReferenceLatent` | SHOT NIGHT |
| 28 | SHOT HIGH | `EZPromptJoin` | SHOT HIGH |
| 29 | Positive HIGH | `CLIPTextEncode` | SHOT HIGH |
| 30 | Sampler HIGH | `KSampler` | SHOT HIGH |
...
| 42 | Negative SHOT COOL | `EZNegativePromptEnhance` | Ungrouped |
| 43 | Negative Negative SHOT COOL | `CLIPTextEncode` | Ungrouped |
| 44 | Negative + identity plate | `ReferenceLatent` | Ungrouped |
| 45 | Negative SHOT NIGHT | `EZNegativePromptEnhance` | Ungrouped |
| 46 | Negative Negative SHOT NIGHT | `CLIPTextEncode` | Ungrouped |
| 47 | Negative + identity plate | `ReferenceLatent` | Ungrouped |
| 48 | Negative SHOT HIGH | `EZNegativePromptEnhance` | Ungrouped |
| 49 | Negative Negative SHOT HIGH | `CLIPTextEncode` | Ungrouped |
| 50 | Negative + identity plate | `ReferenceLatent` | Ungrouped |
...
**This graph:** `creator/stills/brand-kit-4`
...
| Positive KEY | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Positive COOL | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Positive NIGHT | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Positive HIGH | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Negative Negative SHOT COOL | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT NIGHT | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT HIGH | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
...
**This graph:** `## creator/stills/brand-kit-4 Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Four brand plates, same camera, different lights. Lab size **768x432**. Prefix ...`
...
| Instance | Value |
| --- | --- |
| SHOT KEY | `Canonical key-light plate. 35mm, warm key.` |
| SHOT COOL | `Same camera. Cooler window fill, same pose.` |
| SHOT NIGHT | `Same camera. Night practicals, same pose.` |
| SHOT HIGH | `Same camera. High-key noon, same pose.` |
...
**This graph (all 4 instances):** `state`
...
| Instance | Value |
| --- | --- |
| Save KEY | `ez_brand_01` |
| Save COOL | `ez_brand_02` |
| Save NIGHT | `ez_brand_03` |
| Save HIGH | `ez_brand_04` |
