...
Membership post still 4:5. Lab size **1024x1280**. Prefix `ez_patreon`.
...
**This graph:** `## creator/stills/patreon-post Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Membership post still 4:5. Lab size **1024x1280**. Prefix `ez_patreon`. Empty ...`
...
**This graph:** `Patreon - post (1024x1280)`
