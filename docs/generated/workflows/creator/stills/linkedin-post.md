...
LinkedIn square post 1:1. Lab size **1024x1024**. Prefix `ez_li_post`.
...
**This graph:** `## creator/stills/linkedin-post Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. LinkedIn square post 1:1. Lab size **1024x1024**. Prefix `ez_li_post`. Empty ...`
...
**This graph:** `LinkedIn - square (1024x1024)`
