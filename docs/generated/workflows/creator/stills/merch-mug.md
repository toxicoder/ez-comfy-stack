...
**Who this is for:** studio users who loaded `creator/stills/merch-mug` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/merch-mug.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/merch-mug** from **Apps** or **Workflows**
...
**This graph:** `## creator/stills/merch-mug Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Merch mug mock 1:1. Lab size **1024×1024**. Prefix `ez_mug_merch`. Empty of lette…`
