...
Merch mug mock 1:1. Lab size **1024x1024**. Prefix `ez_mug_merch`.
...
**This graph:** `## creator/stills/merch-mug Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Merch mug mock 1:1. Lab size **1024x1024**. Prefix `ez_mug_merch`. Empty of lette...`
...
**This graph:** `Merch - mug (1024x1024)`
