...
# creator/stills/instagram-grid-3up
...
**Who this is for:** studio users who loaded `creator/stills/instagram-grid-3up` from Apps or Workflows.

> Generated from `workflows/_lab/creator/stills/instagram-grid-3up.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **creator/stills/instagram-grid-3up** from **Apps** or **Workflows**
...
flowchart TB
  ...
  GMODEL["MODEL"]
  GIDENTITY["IDENTITY"]
  GSHOT_LEFT["SHOT LEFT"]
  GSHOT_CENTER["SHOT CENTER"]
  GSHOT_RIGHT["SHOT RIGHT"]
  GPROMPT["PROMPT"]
  GSETTINGS["SETTINGS"]
```
...
| 10 | SHOT LEFT | `EZPromptJoin` | SHOT LEFT |
| 11 | Positive LEFT | `CLIPTextEncode` | SHOT LEFT |
| 12 | Sampler LEFT | `KSampler` | SHOT LEFT |
| 13 | Decode LEFT | `VAEDecode` | SHOT LEFT |
| 14 | Save LEFT | `SaveImage` | SHOT LEFT |
| 16 | SHOT CENTER | `EZPromptJoin` | SHOT CENTER |
| 17 | Positive CENTER | `CLIPTextEncode` | SHOT CENTER |
| 18 | Sampler CENTER | `KSampler` | SHOT CENTER |
| 19 | Decode CENTER | `VAEDecode` | SHOT CENTER |
| 20 | Save CENTER | `SaveImage` | SHOT CENTER |
| 22 | SHOT RIGHT | `EZPromptJoin` | SHOT RIGHT |
| 23 | Positive RIGHT | `CLIPTextEncode` | SHOT RIGHT |
| 24 | Sampler RIGHT | `KSampler` | SHOT RIGHT |
| 25 | Decode RIGHT | `VAEDecode` | SHOT RIGHT |
| 26 | Save RIGHT | `SaveImage` | SHOT RIGHT |
...
| 30 | Upscale still | `EZImageUpscale` | SHOT LEFT |
| 31 | Upscale still | `EZImageUpscale` | SHOT CENTER |
| 32 | Upscale still | `EZImageUpscale` | SHOT RIGHT |
| 33 | Check models | `EZModelCheck` | QUALITY |
| 34 | Negative SHOT CENTER | `EZNegativePromptEnhance` | Ungrouped |
| 35 | Negative Negative SHOT CENTER | `CLIPTextEncode` | Ungrouped |
| 36 | Negative SHOT RIGHT | `EZNegativePromptEnhance` | Ungrouped |
| 37 | Negative Negative SHOT RIGHT | `CLIPTextEncode` | Ungrouped |
...
**This graph:** `creator/stills/instagram-grid-3up`
...
| Positive LEFT | `Left grid tile. Subject on the right third of this square. Same building, rooms...` |
| Positive CENTER | `Center grid tile. Subject centered, same light. Same building, rooms, furniture...` |
| Positive RIGHT | `Right grid tile. Subject on the left third of this square. Same building, rooms...` |
| Negative Negative SHOT CENTER | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT RIGHT | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
...
**This graph:** `## creator/stills/instagram-grid-3up Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Instagram 1:1 three-tile grid row. Lab size **1024x1024**. Prefix `ez_ig...`
...
| Instance | Value |
| --- | --- |
| SHOT LEFT | `Left grid tile. Subject on the right third of this square.` |
| SHOT CENTER | `Center grid tile. Subject centered, same light.` |
| SHOT RIGHT | `Right grid tile. Subject on the left third of this square.` |
...
**This graph (all 3 instances):** `view`
...
**This graph (all 3 instances):** `1.0`
...
**This graph (all 3 instances):** `euler`
...
**This graph (all 3 instances):** `simple`
...
| --- | --- |
| Save LEFT | `ez_ig_g01` |
| Save CENTER | `ez_ig_g02` |
| Save RIGHT | `ez_ig_g03` |
