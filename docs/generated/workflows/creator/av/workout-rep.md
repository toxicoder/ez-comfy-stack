...
One exercise-rep AV 9:16. Lab size **768×1280**. Prefix `ez_rep`.
...
**This graph:** `## creator/av/workout-rep Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. One exercise-rep AV 9:16. Lab size **768×1280**. Prefix `ez_rep`. Empty of letterin…`
