...
**Who this is for:** studio users who loaded `creator/av/workout-rep` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/workout-rep.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One exercise-rep AV 9:16. Lab size **768x1280**. Prefix `ez_rep`.
...
2. Load **creator/av/workout-rep** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `One athletic rep from the start still. Breath, shoe squeak. No score. Keep ever...` |
...
**This graph:** `## creator/av/workout-rep Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. One exercise-rep AV 9:16. Lab size **768x1280**. Prefix `ez_rep`. Empty of letterin...`
...
**This graph:** `One athletic rep from the start still. Breath, shoe squeak. No score. Keep every object and surface from the start image; do not redesign.`

```text
One athletic rep from the start still. Breath, shoe squeak. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/av/workout-rep`
