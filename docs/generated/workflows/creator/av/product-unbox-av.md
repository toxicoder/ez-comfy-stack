...
description: "Unbox AV with paper SFX ~8 s"
tags: [workflows, generated, comfyui, creator]
---

# creator/av/product-unbox-av
...
**Who this is for:** studio users who loaded `creator/av/product-unbox-av` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/product-unbox-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Unbox AV with paper SFX ~8 s. Lab size **1280x704**. Prefix `ez_unbox_av`.
...
2. Load **creator/av/product-unbox-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Hands ease a box. Paper rustle, cardboard. No score. Keep the start image. Keep...` |
...
**This graph:** `## creator/av/product-unbox-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Unbox AV with paper SFX ~8 s. Lab size **1280x704**. Prefix `ez_unbox_av`. Emp...`
...
**This graph:** `Hands ease a box. Paper rustle, cardboard. No score. Keep the start image. Keep every object and surface from the start image; do not redesign.`

```text
Hands ease a box. Paper rustle, cardboard. No score. Keep the start image. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/av/product-unbox-av`
