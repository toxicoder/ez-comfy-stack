...
Twitch starting-soon AV ~8 s. Lab size **1280×704**. Prefix `ez_tw_start_av`.
...
**This graph:** `## creator/av/twitch-starting-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Twitch starting-soon AV ~8 s. Lab size **1280×704**. Prefix `ez_tw_start_av`…`
