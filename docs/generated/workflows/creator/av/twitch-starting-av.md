...
description: "Twitch starting-soon AV ~12 s"
tags: [workflows, generated, comfyui, creator]
---

# creator/av/twitch-starting-av
...
**Who this is for:** studio users who loaded `creator/av/twitch-starting-av` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/twitch-starting-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Twitch starting-soon AV ~12 s. Lab size **1280×704**. Prefix `ez_tw_start_av`.
...
2. Load **creator/av/twitch-starting-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Quiet set, a soft whoosh of air, no score. Locked camera. Twelve seconds.` |
...
**This graph:** `## creator/av/twitch-starting-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Twitch starting-soon AV ~12 s. Lab size **1280×704**. Prefix `ez_tw_start_av…`
...
**This graph:** `Quiet set, a soft whoosh of air, no score. Locked camera. Twelve seconds.`

```text
Quiet set, a soft whoosh of air, no score. Locked camera. Twelve seconds.
```
...
**This graph:** `soft whoosh, room tone, no score`
...
**This graph:** `creator/av/twitch-starting-av`
