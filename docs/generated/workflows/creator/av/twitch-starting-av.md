...
description: "Twitch starting-soon AV ~8 s"
...
Twitch starting-soon AV ~8 s. Lab size **1280x704**. Prefix `ez_tw_start_av`.
...
| Instance | Value |
| --- | --- |
| Positive | `Quiet set, a soft whoosh of air, no score. Locked camera. Eight seconds.` |
...
**This graph:** `## creator/av/twitch-starting-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Twitch starting-soon AV ~8 s. Lab size **1280x704**. Prefix `ez_tw_start_av`...`
...
**This graph:** `Quiet set, a soft whoosh of air, no score. Locked camera. Eight seconds.`
