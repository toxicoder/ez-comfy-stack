...
Light / particle visualizer bed AV ~8 s. Lab size **1280×704**. Prefix `ez_music_vis`.
...
**This graph:** `## creator/av/music-visual Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Light / particle visualizer bed AV ~8 s. Lab size **1280×704**. Prefix `ez_music_v…`
