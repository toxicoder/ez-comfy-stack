...
description: "Light / particle visualizer bed AV ~8 s"
...
**Who this is for:** studio users who loaded `creator/av/music-visual` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/music-visual.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Light / particle visualizer bed AV ~8 s. Lab size **1280x704**. Prefix `ez_music_vis`.
...
2. Load **creator/av/music-visual** from **Apps** or **Workflows**
...
**This graph:** `## creator/av/music-visual Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Light / particle visualizer bed AV ~8 s. Lab size **1280x704**. Prefix `ez_music_v...`
...
**This graph:** `creator/av/music-visual`
