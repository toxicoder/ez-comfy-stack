...
description: "Desk / keyboard room-tone AV ~10 s"
...
Desk / keyboard room-tone AV ~10 s. Lab size **1280×704**. Prefix `ez_desk_av`.
...
| Instance | Value |
| --- | --- |
| Positive | `Locked desk. Soft keycaps, a mug set down. No score. Ten seconds.` |
...
**This graph:** `## creator/av/desk-work Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Desk / keyboard room-tone AV ~10 s. Lab size **1280×704**. Prefix `ez_desk_av`. Empty…`
...
**This graph:** `Locked desk. Soft keycaps, a mug set down. No score. Ten seconds.`
