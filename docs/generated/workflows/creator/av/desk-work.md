...
description: "Desk / keyboard room-tone AV ~12 s"
tags: [workflows, generated, comfyui, creator]
---

# creator/av/desk-work
...
**Who this is for:** studio users who loaded `creator/av/desk-work` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/desk-work.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Desk / keyboard room-tone AV ~12 s. Lab size **1280×704**. Prefix `ez_desk_av`.
...
2. Load **creator/av/desk-work** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Locked desk. Soft keycaps, a mug set down. No score. Twelve seconds.` |
...
**This graph:** `## creator/av/desk-work Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Desk / keyboard room-tone AV ~12 s. Lab size **1280×704**. Prefix `ez_desk_av`. Empty…`
...
**This graph:** `Locked desk. Soft keycaps, a mug set down. No score. Twelve seconds.`
...
**This graph:** `creator/av/desk-work`
