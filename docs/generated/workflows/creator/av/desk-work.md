...
Desk / keyboard room-tone AV ~8 s. Lab size **1280×704**. Prefix `ez_desk_av`.
...
**This graph:** `## creator/av/desk-work Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Desk / keyboard room-tone AV ~8 s. Lab size **1280×704**. Prefix `ez_desk_av`. Empty …`
