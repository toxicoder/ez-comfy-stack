...
description: "Desk / keyboard room-tone AV ~8 s"
...
Desk / keyboard room-tone AV ~8 s. Lab size **1280x704**. Prefix `ez_desk_av`.
...
| Instance | Value |
| --- | --- |
| Positive | `Locked desk. Soft keycaps, a mug set down. No score. Eight seconds.` |
...
**This graph:** `## creator/av/desk-work Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Desk / keyboard room-tone AV ~8 s. Lab size **1280x704**. Prefix `ez_desk_av`. Empty ...`
...
**This graph:** `Locked desk. Soft keycaps, a mug set down. No score. Eight seconds.`
