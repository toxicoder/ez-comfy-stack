...
description: "Travel establishing AV ~12 s"
tags: [workflows, generated, comfyui, creator]
---

# creator/av/travel-establishing
...
**Who this is for:** studio users who loaded `creator/av/travel-establishing` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/travel-establishing.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Travel establishing AV ~12 s. Lab size **1280×704**. Prefix `ez_travel`.
...
2. Load **creator/av/travel-establishing** from **Apps** or **Workflows**
...
**This graph:** `## creator/av/travel-establishing Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Travel establishing AV ~12 s. Lab size **1280×704**. Prefix `ez_travel`. Em…`
...
**This graph:** `creator/av/travel-establishing`
