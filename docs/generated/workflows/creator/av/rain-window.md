...
description: "Rain-on-glass AV ~8 s"
...
Rain-on-glass AV ~8 s. Lab size **1280x704**. Prefix `ez_rain`.
...
| Instance | Value |
| --- | --- |
| Positive | `Rain on a dark window. Drops, distant thunder hush. No score. Eight seconds.` |
...
**This graph:** `## creator/av/rain-window Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Rain-on-glass AV ~8 s. Lab size **1280x704**. Prefix `ez_rain`. Empty of lettering....`
...
**This graph:** `Rain on a dark window. Drops, distant thunder hush. No score. Eight seconds.`

```text
Rain on a dark window. Drops, distant thunder hush. No score. Eight seconds.
```
