...
description: "Rain-on-glass AV ~12 s"
tags: [workflows, generated, comfyui, creator]
---

# creator/av/rain-window
...
**Who this is for:** studio users who loaded `creator/av/rain-window` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/rain-window.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Rain-on-glass AV ~12 s. Lab size **1280×704**. Prefix `ez_rain`.
...
2. Load **creator/av/rain-window** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Rain on a dark window. Drops, distant thunder hush. No score. Twelve seconds.` |
...
**This graph:** `## creator/av/rain-window Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Rain-on-glass AV ~12 s. Lab size **1280×704**. Prefix `ez_rain`. Empty of lettering…`
...
**This graph:** `Rain on a dark window. Drops, distant thunder hush. No score. Twelve seconds.`

```text
Rain on a dark window. Drops, distant thunder hush. No score. Twelve seconds.
```
...
**This graph:** `rain on glass, no score`
...
**This graph:** `creator/av/rain-window`
