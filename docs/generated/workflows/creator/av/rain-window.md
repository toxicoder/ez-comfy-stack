...
**This graph:** `## creator/av/rain-window Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Rain-on-glass AV ~5 s. Lab size **1280×704**. Prefix `ez_rain`. Empty of lettering.…`
