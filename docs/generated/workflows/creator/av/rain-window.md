...
description: "Rain-on-glass AV ~10 s"
...
Rain-on-glass AV ~10 s. Lab size **1280×704**. Prefix `ez_rain`.
...
| Instance | Value |
| --- | --- |
| Positive | `Rain on a dark window. Drops, distant thunder hush. No score. Ten seconds.` |
...
**This graph:** `## creator/av/rain-window Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Rain-on-glass AV ~10 s. Lab size **1280×704**. Prefix `ez_rain`. Empty of lettering…`
...
**This graph:** `Rain on a dark window. Drops, distant thunder hush. No score. Ten seconds.`

```text
Rain on a dark window. Drops, distant thunder hush. No score. Ten seconds.
```
