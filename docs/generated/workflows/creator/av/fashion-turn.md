...
Fashion turn AV 9:16. Lab size **768×1280**. Prefix `ez_turn`.
...
**This graph:** `## creator/av/fashion-turn Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Fashion turn AV 9:16. Lab size **768×1280**. Prefix `ez_turn`. Empty of lettering.…`
