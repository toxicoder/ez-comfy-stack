...
**Who this is for:** studio users who loaded `creator/av/fashion-turn` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/fashion-turn.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Fashion turn AV 9:16. Lab size **768x1280**. Prefix `ez_turn`.
...
2. Load **creator/av/fashion-turn** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow turn from the start still. Cloth rustle. No score. Eight seconds. Keep eve...` |
...
**This graph:** `## creator/av/fashion-turn Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Fashion turn AV 9:16. Lab size **768x1280**. Prefix `ez_turn`. Empty of lettering....`
...
**This graph:** `Slow turn from the start still. Cloth rustle. No score. Eight seconds. Keep every object and surface from the start image; do not redesign.`

```text
Slow turn from the start still. Cloth rustle. No score. Eight seconds. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `creator/av/fashion-turn`
