...
Recipe pour AV 9:16. Lab size **768×1280**. Prefix `ez_pour`.
...
**This graph:** `## creator/av/recipe-pour Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Recipe pour AV 9:16. Lab size **768×1280**. Prefix `ez_pour`. Empty of lettering. A…`
