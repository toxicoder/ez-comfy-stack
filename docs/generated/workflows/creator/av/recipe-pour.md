...
**Who this is for:** studio users who loaded `creator/av/recipe-pour` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/recipe-pour.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Recipe pour AV 9:16. Lab size **768x1280**. Prefix `ez_pour`.
...
2. Load **creator/av/recipe-pour** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow pour into an unmarked bowl. Liquid, ceramic clink. No score. Eight seconds...` |
...
**This graph:** `## creator/av/recipe-pour Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Recipe pour AV 9:16. Lab size **768x1280**. Prefix `ez_pour`. Empty of lettering. A...`
...
**This graph:** `Slow pour into an unmarked bowl. Liquid, ceramic clink. No score. Eight seconds. Keep every object and surface from the start image; do not redesign.`

```text
Slow pour into an unmarked bowl. Liquid, ceramic clink. No score. Eight seconds. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `pour, ceramic clink, no score`
...
**This graph:** `creator/av/recipe-pour`
