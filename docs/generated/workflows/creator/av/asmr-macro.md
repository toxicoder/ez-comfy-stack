...
Quiet macro foley AV ~8 s. Lab size **1280×704**. Prefix `ez_asmr`.
...
**This graph:** `## creator/av/asmr-macro Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Quiet macro foley AV ~8 s. Lab size **1280×704**. Prefix `ez_asmr`. Empty of letteri…`
