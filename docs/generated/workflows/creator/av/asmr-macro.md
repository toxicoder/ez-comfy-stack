...
description: "Quiet macro foley AV ~8 s"
...
**Who this is for:** studio users who loaded `creator/av/asmr-macro` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/asmr-macro.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Quiet macro foley AV ~8 s. Lab size **1280x704**. Prefix `ez_asmr`.
...
2. Load **creator/av/asmr-macro** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Macro of an unmarked surface. Soft taps, close mic. No score. Eight seconds. Ke...` |
...
**This graph:** `## creator/av/asmr-macro Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Quiet macro foley AV ~8 s. Lab size **1280x704**. Prefix `ez_asmr`. Empty of letteri...`
...
**This graph:** `Macro of an unmarked surface. Soft taps, close mic. No score. Eight seconds. Keep every object and surface from the start image; do not redesign.`

```text
Macro of an unmarked surface. Soft taps, close mic. No score. Eight seconds. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `soft taps, close mic, no score`
...
**This graph:** `creator/av/asmr-macro`
