...
description: "Fireplace AV ~12 s"
tags: [workflows, generated, comfyui, creator]
---

# creator/av/fireplace
...
**Who this is for:** studio users who loaded `creator/av/fireplace` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/fireplace.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Fireplace AV ~12 s. Lab size **1280×704**. Prefix `ez_fire`.
...
2. Load **creator/av/fireplace** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `A small unmarked fireplace. Soft crackle. No score. Twelve seconds.` |
...
**This graph:** `## creator/av/fireplace Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Fireplace AV ~12 s. Lab size **1280×704**. Prefix `ez_fire`. Empty of lettering. Add …`
...
**This graph:** `A small unmarked fireplace. Soft crackle. No score. Twelve seconds.`
...
**This graph:** `fire crackle, no score`
...
**This graph:** `creator/av/fireplace`
