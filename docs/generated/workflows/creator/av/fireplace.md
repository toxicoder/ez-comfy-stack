...
**This graph:** `## creator/av/fireplace Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Fireplace AV ~5 s. Lab size **1280×704**. Prefix `ez_fire`. Empty of lettering. Add t…`
