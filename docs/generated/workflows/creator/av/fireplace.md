...
Fireplace AV ~10 s. Lab size **1280×704**. Prefix `ez_fire`.
...
| Instance | Value |
| --- | --- |
| Positive | `A small unmarked fireplace. Soft crackle. No score. Ten seconds.` |
...
**This graph:** `## creator/av/fireplace Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Fireplace AV ~10 s. Lab size **1280×704**. Prefix `ez_fire`. Empty of lettering. Add …`
...
**This graph:** `A small unmarked fireplace. Soft crackle. No score. Ten seconds.`
