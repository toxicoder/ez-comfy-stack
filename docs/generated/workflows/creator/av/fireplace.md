...
Fireplace AV ~8 s. Lab size **1280x704**. Prefix `ez_fire`.
...
| Instance | Value |
| --- | --- |
| Positive | `A small unmarked fireplace. Soft crackle. No score. Eight seconds.` |
...
**This graph:** `## creator/av/fireplace Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Fireplace AV ~8 s. Lab size **1280x704**. Prefix `ez_fire`. Empty of lettering. Add t...`
...
**This graph:** `A small unmarked fireplace. Soft crackle. No score. Eight seconds.`
