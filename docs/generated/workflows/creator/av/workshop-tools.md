...
description: "Workshop tools AV ~10 s"
...
Workshop tools AV ~10 s. Lab size **1280×704**. Prefix `ez_tools`.
...
| Instance | Value |
| --- | --- |
| Positive | `Unmarked hand tools on a bench. Soft clink, wood. No score. Ten seconds.` |
...
**This graph:** `## creator/av/workshop-tools Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Workshop tools AV ~10 s. Lab size **1280×704**. Prefix `ez_tools`. Empty of lett…`
...
**This graph:** `Unmarked hand tools on a bench. Soft clink, wood. No score. Ten seconds.`
