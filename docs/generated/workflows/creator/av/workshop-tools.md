---
title: "creator/av/workshop-tools"
description: "Workshop tools AV ~12 s"
tags: [workflows, generated, comfyui, creator]
---

# creator/av/workshop-tools
...
**Who this is for:** studio users who loaded `creator/av/workshop-tools` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/workshop-tools.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Workshop tools AV ~12 s. Lab size **1280×704**. Prefix `ez_tools`.
...
2. Load **creator/av/workshop-tools** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Unmarked hand tools on a bench. Soft clink, wood. No score. Twelve seconds.` |
...
**This graph:** `## creator/av/workshop-tools Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Workshop tools AV ~12 s. Lab size **1280×704**. Prefix `ez_tools`. Empty of lett…`
...
**This graph:** `Unmarked hand tools on a bench. Soft clink, wood. No score. Twelve seconds.`

```text
Unmarked hand tools on a bench. Soft clink, wood. No score. Twelve seconds.
```
...
**This graph:** `tool clink, wood, no score`
...
**This graph:** `creator/av/workshop-tools`
