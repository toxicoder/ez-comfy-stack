...
description: "Workshop tools AV ~8 s"
...
Workshop tools AV ~8 s. Lab size **1280x704**. Prefix `ez_tools`.
...
| Instance | Value |
| --- | --- |
| Positive | `Unmarked hand tools on a bench. Soft clink, wood. No score. Eight seconds.` |
...
**This graph:** `## creator/av/workshop-tools Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Workshop tools AV ~8 s. Lab size **1280x704**. Prefix `ez_tools`. Empty of lette...`
...
**This graph:** `Unmarked hand tools on a bench. Soft clink, wood. No score. Eight seconds.`

```text
Unmarked hand tools on a bench. Soft clink, wood. No score. Eight seconds.
```
