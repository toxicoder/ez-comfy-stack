...
Interior walk-through AV ~8 s. Lab size **1280×704**. Prefix `ez_walk`.
...
**This graph:** `## creator/av/interior-walk Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Interior walk-through AV ~8 s. Lab size **1280×704**. Prefix `ez_walk`. Empty of …`
