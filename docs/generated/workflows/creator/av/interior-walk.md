...
description: "Interior walk-through AV ~12 s"
tags: [workflows, generated, comfyui, creator]
---

# creator/av/interior-walk
...
**Who this is for:** studio users who loaded `creator/av/interior-walk` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/interior-walk.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Interior walk-through AV ~12 s. Lab size **1280×704**. Prefix `ez_walk`.
...
2. Load **creator/av/interior-walk** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Slow walk through an unmarked interior. Footfalls, room tone. No score.` |
...
**This graph:** `## creator/av/interior-walk Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Interior walk-through AV ~12 s. Lab size **1280×704**. Prefix `ez_walk`. Empty of…`
...
**This graph:** `Slow walk through an unmarked interior. Footfalls, room tone. No score.`
...
**This graph:** `creator/av/interior-walk`
