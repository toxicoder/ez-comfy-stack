...
description: "YouTube outro AV ~10 s with room tone"
...
YouTube outro AV ~10 s with room tone. Lab size **1280×704**. Prefix `ez_yt_outro`.
...
| Instance | Value |
| --- | --- |
| Positive | `Locked-camera outro. Room tone, a chair creak, distant city. No score. Ten seco…` |
...
**This graph:** `## creator/av/youtube-outro-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube outro AV ~10 s with room tone. Lab size **1280×704**. Prefix `ez_yt_ou…`
...
**This graph:** `Locked-camera outro. Room tone, a chair creak, distant city. No score. Ten seconds.`

```text
Locked-camera outro. Room tone, a chair creak, distant city. No score. Ten seconds.
```
