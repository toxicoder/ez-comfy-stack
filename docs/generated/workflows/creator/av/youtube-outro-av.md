...
description: "YouTube outro AV ~8 s with room tone"
...
YouTube outro AV ~8 s with room tone. Lab size **1280x704**. Prefix `ez_yt_outro`.
...
| Instance | Value |
| --- | --- |
| Positive | `Locked-camera outro. Room tone, a chair creak, distant city. No score. Eight se...` |
...
**This graph:** `## creator/av/youtube-outro-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. YouTube outro AV ~8 s with room tone. Lab size **1280x704**. Prefix `ez_yt_out...`
...
**This graph:** `Locked-camera outro. Room tone, a chair creak, distant city. No score. Eight seconds.`

```text
Locked-camera outro. Room tone, a chair creak, distant city. No score. Eight seconds.
```
