...
YouTube outro AV ~8 s with room tone. Lab size **1280×704**. Prefix `ez_yt_outro`.
...
**This graph:** `## creator/av/youtube-outro-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube outro AV ~8 s with room tone. Lab size **1280×704**. Prefix `ez_yt_out…`
