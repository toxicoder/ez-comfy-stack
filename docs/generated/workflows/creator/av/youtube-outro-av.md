...
description: "YouTube outro AV ~12 s with room tone"
tags: [workflows, generated, comfyui, creator]
---

# creator/av/youtube-outro-av
...
**Who this is for:** studio users who loaded `creator/av/youtube-outro-av` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/youtube-outro-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
YouTube outro AV ~12 s with room tone. Lab size **1280×704**. Prefix `ez_yt_outro`.
...
2. Load **creator/av/youtube-outro-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Locked-camera outro. Room tone, a chair creak, distant city. No score. Twelve s…` |
...
**This graph:** `## creator/av/youtube-outro-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube outro AV ~12 s with room tone. Lab size **1280×704**. Prefix `ez_yt_ou…`
...
**This graph:** `Locked-camera outro. Room tone, a chair creak, distant city. No score. Twelve seconds.`

```text
Locked-camera outro. Room tone, a chair creak, distant city. No score. Twelve seconds.
```
...
**This graph:** `room tone, chair creak, no score`
...
**This graph:** `creator/av/youtube-outro-av`
