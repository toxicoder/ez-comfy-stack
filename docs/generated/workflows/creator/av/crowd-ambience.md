...
description: "Distant crowd bed AV ~12 s"
tags: [workflows, generated, comfyui, creator]
---

# creator/av/crowd-ambience
...
**Who this is for:** studio users who loaded `creator/av/crowd-ambience` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/crowd-ambience.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Distant crowd bed AV ~12 s. Lab size **1280×704**. Prefix `ez_crowd`.
...
2. Load **creator/av/crowd-ambience** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Distant unmarked crowd under a terrace. Murmur, no score. Twelve seconds.` |
...
**This graph:** `## creator/av/crowd-ambience Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Distant crowd bed AV ~12 s. Lab size **1280×704**. Prefix `ez_crowd`. Empty of l…`
...
**This graph:** `Distant unmarked crowd under a terrace. Murmur, no score. Twelve seconds.`

```text
Distant unmarked crowd under a terrace. Murmur, no score. Twelve seconds.
```
...
**This graph:** `distant crowd murmur, no score`
...
**This graph:** `creator/av/crowd-ambience`
