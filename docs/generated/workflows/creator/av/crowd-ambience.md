...
description: "Distant crowd bed AV ~10 s"
...
Distant crowd bed AV ~10 s. Lab size **1280×704**. Prefix `ez_crowd`.
...
| Instance | Value |
| --- | --- |
| Positive | `Distant unmarked crowd under a terrace. Murmur, no score. Ten seconds.` |
...
**This graph:** `## creator/av/crowd-ambience Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Distant crowd bed AV ~10 s. Lab size **1280×704**. Prefix `ez_crowd`. Empty of l…`
...
**This graph:** `Distant unmarked crowd under a terrace. Murmur, no score. Ten seconds.`
