...
**This graph:** `## creator/av/crowd-ambience Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Distant crowd bed AV ~5 s. Lab size **1280×704**. Prefix `ez_crowd`. Empty of le…`
