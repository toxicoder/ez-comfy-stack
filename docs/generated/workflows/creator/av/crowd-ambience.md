...
description: "Distant crowd bed AV ~8 s"
...
Distant crowd bed AV ~8 s. Lab size **1280x704**. Prefix `ez_crowd`.
...
| Instance | Value |
| --- | --- |
| Positive | `Distant unmarked crowd under a terrace. Murmur, no score. Eight seconds.` |
...
**This graph:** `## creator/av/crowd-ambience Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Distant crowd bed AV ~8 s. Lab size **1280x704**. Prefix `ez_crowd`. Empty of le...`
...
**This graph:** `Distant unmarked crowd under a terrace. Murmur, no score. Eight seconds.`
