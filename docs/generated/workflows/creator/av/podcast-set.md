...
Podcast-set AV ~8 s. Lab size **1280x704**. Prefix `ez_pod_set`.
...
**This graph:** `## creator/av/podcast-set Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Podcast-set AV ~8 s. Lab size **1280x704**. Prefix `ez_pod_set`. Empty of lettering...`
