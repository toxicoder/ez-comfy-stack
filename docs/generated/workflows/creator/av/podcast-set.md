...
description: "Podcast-set AV ~10 s"
...
**Who this is for:** studio users who loaded `creator/av/podcast-set` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/podcast-set.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Podcast-set AV ~10 s. Lab size **1280×704**. Prefix `ez_pod_set`.
...
2. Load **creator/av/podcast-set** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Two unmarked mics on oak. Room tone, a chair. No score. Ten seconds.` |
...
**This graph:** `## creator/av/podcast-set Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Podcast-set AV ~10 s. Lab size **1280×704**. Prefix `ez_pod_set`. Empty of letterin…`
...
**This graph:** `Two unmarked mics on oak. Room tone, a chair. No score. Ten seconds.`
...
**This graph:** `creator/av/podcast-set`
