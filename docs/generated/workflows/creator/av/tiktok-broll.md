...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Vertical B-roll from the start still. World SFX only. No score. Ten seconds. Ke…` |
...
**This graph:** `Vertical B-roll from the start still. World SFX only. No score. Ten seconds. Keep every object and surface from the start image; do not redesign.`

```text
Vertical B-roll from the start still. World SFX only. No score. Ten seconds. Keep every object and surface from the start image; do not redesign.
```
