...
**This graph:** `## creator/av/tiktok-broll Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. TikTok B-roll AV 9:16. Lab size **768×1280**. Prefix `ez_tt_broll`. Empty of lette…`
