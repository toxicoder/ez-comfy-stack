...
Instagram lifestyle reel AV 9:16. Lab size **768×1280**. Prefix `ez_ig_reel_av`.
...
**This graph:** `## creator/av/instagram-reel-lifestyle Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram lifestyle reel AV 9:16. Lab size **768×1280**. Prefix `ez_ig…`
