...
# creator/av/instagram-reel-lifestyle
...
**Who this is for:** studio users who loaded `creator/av/instagram-reel-lifestyle` from Apps or Workflows.

> Generated from `workflows/_lab/creator/av/instagram-reel-lifestyle.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Instagram lifestyle reel AV 9:16. Lab size **768x1280**. Prefix `ez_ig_reel_av`.
...
2. Load **creator/av/instagram-reel-lifestyle** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow lifestyle take from the start still. Fabric breeze, distant city. No score...` |
...
**This graph:** `## creator/av/instagram-reel-lifestyle Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Instagram lifestyle reel AV 9:16. Lab size **768x1280**. Prefix `ez_ig...`
...
**This graph:** `Slow lifestyle take from the start still. Fabric breeze, distant city. No score. Keep every object and surface from the start image; do not redesign.`

```text
Slow lifestyle take from the start still. Fabric breeze, distant city. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `breeze, distant city, no score`
...
**This graph:** `creator/av/instagram-reel-lifestyle`
