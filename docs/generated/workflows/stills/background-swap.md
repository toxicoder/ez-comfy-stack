...
**Who this is for:** studio users who loaded `stills/background-swap` from Apps or Workflows.

> Generated from `workflows/_lab/stills/background-swap.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/background-swap** from **Apps** or **Workflows**
...
| 9 | Save background swap | `SaveImage` | OUTPUT |
| 10 | Operator note | `Note` | NOTE |
| 11 | Source still | `LoadImage` | INPUT |
| 12 | Klein Prompt Enhance (background swap) | `EZKleinPromptEnhance` | PROMPT |
