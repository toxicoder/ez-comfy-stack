...
**Who this is for:** studio users who loaded `stills/banner-wide` from Apps or Workflows.

> Generated from `workflows/_lab/stills/banner-wide.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/banner-wide** from **Apps** or **Workflows**
...
**This graph:** `## stills/banner-wide Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Channel / LinkedIn banner (Klein 4B). Default 1536x512. Prefix `ez_banner`. Keep the up...`
...
**This graph:** `Channel - banner (1536x512)`
