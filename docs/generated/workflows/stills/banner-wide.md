...
**This graph:** `## stills/banner-wide Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Channel / LinkedIn banner (Klein 4B). Default 1536×512. Prefix `ez_banner`. Keep the up…`
