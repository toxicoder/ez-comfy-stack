...
**This graph:** `## stills/still-hero Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. HD Klein 4B still (Apache 2.0 distilled FP8). Same prompt and seed as stills/still-draft...`
