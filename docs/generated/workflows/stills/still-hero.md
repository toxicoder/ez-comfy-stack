...
**Who this is for:** studio users who loaded `stills/still-hero` from Apps or Workflows.

> Generated from `workflows/_lab/stills/still-hero.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
HD Klein 4B still (Apache 2.0 distilled FP8). Same prompt and seed as stills/still-draft.
...
Feed ez_still_hero_*.png into motion/silent/still-to-video-5s or motion/av/still-to-video-10s.
...
2. Load **stills/still-hero** from **Apps** or **Workflows**
...
**This graph:** `## stills/still-hero Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. HD Klein 4B still (Apache 2.0 distilled FP8). Same prompt and seed as stills/still-draft…`
