...
**Who this is for:** studio users who loaded `stills/instagram-square` from Apps or Workflows.

> Generated from `workflows/_lab/stills/instagram-square.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/instagram-square** from **Apps** or **Workflows**
...
**This graph:** `## stills/instagram-square Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Generic Instagram 1:1 still (Klein 4B). Default 1024x1024. Prefix `ez_ig_square`. ...`
