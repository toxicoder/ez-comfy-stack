...
**Who this is for:** studio users who loaded `stills/thumbnail` from Apps or Workflows.

> Generated from `workflows/_lab/stills/thumbnail.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/thumbnail** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `A bold YouTube thumbnail still, 16:9. An original techno wizard in an unmarked ...` |
...
**This graph:** `## stills/thumbnail Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. YouTube thumbnail still (Klein 4B). Default 1280x720. Prefix `ez_thumbnail`. Keep the sub...`
...
**This graph:** `YouTube - thumbnail (1280x720)`
