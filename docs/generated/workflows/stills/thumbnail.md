...
**This graph:** `## stills/thumbnail Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube thumbnail still (Klein 4B). Default 1280×720. Prefix `ez_thumbnail`. Keep the sub…`
...
**This graph:** `YouTube · thumbnail (1280×720)`
