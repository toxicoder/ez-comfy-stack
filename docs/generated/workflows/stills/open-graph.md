...
**This graph:** `## stills/open-graph Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Blog / Open Graph hero (Klein 4B). Default 1216×640. Prefix `ez_og`. Leave space for a t…`
