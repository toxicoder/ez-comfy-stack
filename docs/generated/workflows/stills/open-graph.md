...
**Who this is for:** studio users who loaded `stills/open-graph` from Apps or Workflows.

> Generated from `workflows/_lab/stills/open-graph.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/open-graph** from **Apps** or **Workflows**
...
**This graph:** `## stills/open-graph Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Blog / Open Graph hero (Klein 4B). Default 1216x640. Prefix `ez_og`. Leave space for a t...`
...
**This graph:** `Open Graph / blog (1216x640)`
