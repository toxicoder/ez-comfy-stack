---
title: "stills/background-edit"
description: "Klein 4B background edit. LoadImage source still. Snap + ReferenceLatent. Restyle the environment in place. Prefix ez_bg_edit."
...
**Who this is for:** studio users who loaded `stills/background-edit` from Apps or Workflows.

> Generated from `workflows/_lab/stills/background-edit.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/background-edit** from **Apps** or **Workflows**
...
flowchart LR
  ...
  N7["KSampler"]
  N8["VAE Decode"]
  N9["Save background edit"]
  N10["Operator note"]
  N11["Source still"]
  N12["Klein Prompt Enhance (background edit)"]
...
| 9 | Save background edit | `SaveImage` | Ungrouped |
| 10 | Operator note | `Note` | Ungrouped |
| 11 | Source still | `LoadImage` | Ungrouped |
| 12 | Klein Prompt Enhance (background edit) | `EZKleinPromptEnhance` | Ungrouped |
...
| Instance | Value |
| --- | --- |
| Positive | `cel-shaded ink and flat color` |
...
**This graph:** `## stills/background-edit Klein 4B **background edit**. Load a still. Restyle the environment in place: cartoon/cel, add or remove props, weather, grade. Keep the subject. Output PNG matches the sour…`
...
**This graph:** `cel-shaded ink and flat color`
...
**This graph:** `stills/background-edit`
