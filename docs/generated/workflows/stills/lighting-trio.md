...
**Who this is for:** studio users who loaded `stills/lighting-trio` from Apps or Workflows.

> Generated from `workflows/_lab/stills/lighting-trio.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/lighting-trio** from **Apps** or **Workflows**
...
| 16 | SHOT WINDOW | `EZPromptJoin` | SHOT WINDOW |
| 17 | Positive WINDOW | `CLIPTextEncode` | SHOT WINDOW |
| 18 | Sampler WINDOW | `KSampler` | SHOT WINDOW |
| 19 | Decode WINDOW | `VAEDecode` | SHOT WINDOW |
| 20 | Save WINDOW | `SaveImage` | SHOT WINDOW |
| 21 | Ref from 01 (WINDOW) | `ReferenceLatent` | SHOT WINDOW |
| 22 | SHOT NIGHT LAMP | `EZPromptJoin` | SHOT NIGHT LAMP |
| 23 | Positive NIGHT LAMP | `CLIPTextEncode` | SHOT NIGHT LAMP |
| 24 | Sampler NIGHT LAMP | `KSampler` | SHOT NIGHT LAMP |
...
| 35 | Negative SHOT WINDOW | `EZNegativePromptEnhance` | Ungrouped |
| 36 | Negative Negative SHOT WINDOW | `CLIPTextEncode` | Ungrouped |
| 37 | Negative + identity plate | `ReferenceLatent` | Ungrouped |
| 38 | Negative SHOT NIGHT LAMP | `EZNegativePromptEnhance` | Ungrouped |
| 39 | Negative Negative SHOT NIGHT LAMP | `CLIPTextEncode` | Ungrouped |
| 40 | Negative + identity plate | `ReferenceLatent` | Ungrouped |
...
**This graph:** `stills/lighting-trio`
...
| Positive WINDOW | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Positive NIGHT LAMP | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Negative Negative SHOT WINDOW | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT NIGHT LAMP | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
...
**This graph:** `## stills/lighting-trio Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Same subject under three lights (Klein 4B). Type any subject in IDENTITY. SHOT KEY is...`
...
| Instance | Value |
| --- | --- |
| SHOT KEY | `Canonical plate. Hard key light from camera left, deep contact shadows. 24mm, Y...` |
| SHOT WINDOW | `Same subject and camera. Bright overcast skylight, gentle falloff, soft shadows.` |
| SHOT NIGHT LAMP | `Same subject and camera at night under warm practical lamps.` |
...
**This graph (all 3 instances):** `state`
...
| Instance | Value |
| --- | --- |
| Save KEY | `ez_light_01` |
| Save WINDOW | `ez_light_02` |
| Save NIGHT LAMP | `ez_light_03` |
