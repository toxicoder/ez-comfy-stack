...
**This graph:** `## stills/lighting-trio Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Same subject under three lights (Klein 4B). Type any subject in IDENTITY. SHOT KEY is…`
