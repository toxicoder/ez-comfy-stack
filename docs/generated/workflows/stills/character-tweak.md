...
**Who this is for:** studio users who loaded `stills/character-tweak` from Apps or Workflows.

> Generated from `workflows/_lab/stills/character-tweak.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/character-tweak** from **Apps** or **Workflows**
...
flowchart LR
  ...
  N9["Save tweak"]
  N10["Operator note"]
  N11["Character still (ez_character_*.png)"]
  N12["Klein Prompt Enhance (edit)"]
  N13["Encode character plate"]
  N14["Positive + character plate"]
...
| 6 | Size 4:5 character still | `EmptyFlux2LatentImage` | SETTINGS |
| 7 | KSampler | `KSampler` | SETTINGS |
| 8 | VAE Decode | `VAEDecode` | OUTPUT |
| 9 | Save tweak | `SaveImage` | OUTPUT |
| 10 | Operator note | `Note` | NOTE |
| 11 | Character still (ez_character_*.png) | `LoadImage` | INPUT |
| 12 | Klein Prompt Enhance (edit) | `EZKleinPromptEnhance` | PROMPT |
| 13 | Encode character plate | `VAEEncode` | SETTINGS |
| 14 | Positive + character plate | `ReferenceLatent` | SETTINGS |
| 15 | Negative Prompt Enhance | `EZNegativePromptEnhance` | PROMPT |
...
| Instance | Value |
| --- | --- |
| Positive | `Keep this character's face, wardrobe, and proportions. Change only what this pr…` |
...
**This graph:** `## stills/character-tweak Klein 4B **edit** of a character still. LoadImage: `ez_character_*.png` from Character Draft (or any Klein still). Prompt only the change. Enhance **edit**. Style restyles m…`
...
**This graph:** `Keep this character's face, wardrobe, and proportions. Change only what this prompt names.`
...
**This graph:** `Instagram 4:5 character edit`
...
**This graph:** `stills/character-tweak`
