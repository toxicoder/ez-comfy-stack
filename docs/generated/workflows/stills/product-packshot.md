...
| 16 | Upscale still | `EZImageUpscale` | Ungrouped |
| 17 | Describe image | `EZImageDescribe` | Ungrouped |
...
**This graph:** `## stills/product-packshot Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Clean product / packshot still (Klein 4B). Default 1024×1024. Prefix `ez_packshot`…`
...
**This graph:** `Product packshot (1024×1024)`
