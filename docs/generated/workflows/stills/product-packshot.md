...
**Who this is for:** studio users who loaded `stills/product-packshot` from Apps or Workflows.

> Generated from `workflows/_lab/stills/product-packshot.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/product-packshot** from **Apps** or **Workflows**
...
| 17 | Describe image | `EZImageDescribe` | INPUT |
...
| Instance | Value |
| --- | --- |
| Positive | `A clean product packshot on a seamless light-gray cyclorama. A matte ceramic mu...` |
...
**This graph:** `## stills/product-packshot Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Clean product / packshot still (Klein 4B). Default 1024x1024. Prefix `ez_packshot`...`
...
**This graph:** `A clean product packshot on a seamless light-gray cyclorama. A matte ceramic mug centered, soft studio key light, gentle contact shadow, unmarked surface, no logos. Photoreal commercial still, square...`

```text
A clean product packshot on a seamless light-gray cyclorama. A matte ceramic mug centered, soft studio key light, gentle contact shadow, unmarked surface, no logos. Photoreal commercial still, square 1:1 framing.
```
...
**This graph:** `stills/product-packshot`
...
**This graph:** `Product packshot (1024x1024)`
