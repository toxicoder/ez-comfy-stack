...
**Who this is for:** studio users who loaded `stills/shorts-still` from Apps or Workflows.

> Generated from `workflows/_lab/stills/shorts-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/shorts-still** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `A photoreal still vertical still for Shorts. An original techno wizard in an un...` |
...
**This graph:** `## stills/shorts-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Vertical Shorts/Reels still (Klein 4B distilled FP8). Default **432x768** (9:16). Save...`
...
**This graph:** `stills/shorts-still`
...
**This graph:** `Shorts still (432x768)`
