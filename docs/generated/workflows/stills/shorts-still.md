...
**This graph:** `## stills/shorts-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Vertical Shorts/Reels still (Klein 4B distilled FP8). Default **432×768** (9:16). Save…`
...
**This graph:** `Shorts still (432×768)`
