...
**Who this is for:** studio users who loaded `stills/character-draft` from Apps or Workflows.

> Generated from `workflows/_lab/stills/character-draft.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/character-draft** from **Apps** or **Workflows**
...
| 15 | Upscale still | `EZImageUpscale` | Ungrouped |
...
**This graph:** `## stills/character-draft Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Klein 4B character still. Type a character, pick a style, Queue. 1024x1280 (Instagr…`
...
**This graph:** `stills/character-draft`
