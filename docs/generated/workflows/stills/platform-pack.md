...
**Who this is for:** studio users who loaded `stills/platform-pack` from Apps or Workflows.

> Generated from `workflows/_lab/stills/platform-pack.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/platform-pack** from **Apps** or **Workflows**
...
**This graph:** `stills/platform-pack`
...
**This graph:** `## stills/platform-pack One identity, six platform plates (Klein 4B distilled, 4 steps, CFG 1.0, seed 42). Type any subject in PACK IDENTITY. Identity-mode enhance is **on** (camera-free bible). Each…`
