...
**Who this is for:** studio users who loaded `stills/still-studio` from Apps or Workflows.

> Generated from `workflows/_lab/stills/still-studio.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Handoff: motion/silent/still-to-video-5s, motion/av/still-to-video-10s, stills/text-swap.
...
2. Load **stills/still-studio** from **Apps** or **Workflows**
...
**This graph:** `## stills/still-studio Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Klein 4B still desk. Pick Format / platform for pixels, save prefix, and Rewrite promp…`
...
**This graph:** `stills/still-studio`
