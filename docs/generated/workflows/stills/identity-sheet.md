...
**Who this is for:** studio users who loaded `stills/identity-sheet` from Apps or Workflows.

> Generated from `workflows/_lab/stills/identity-sheet.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/identity-sheet** from **Apps** or **Workflows**
...
**This graph:** `stills/identity-sheet`
...
**This graph:** `## stills/identity-sheet Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Three-angle Klein identity sheet. Type any character in IDENTITY. Frozen seed 42. Id…`
