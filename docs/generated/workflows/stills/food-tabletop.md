...
**Who this is for:** studio users who loaded `stills/food-tabletop` from Apps or Workflows.

> Generated from `workflows/_lab/stills/food-tabletop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/food-tabletop** from **Apps** or **Workflows**
...
**This graph:** `## stills/food-tabletop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Food / tabletop still (Klein 4B). Default 1024x1280 (4:5). Prefix `ez_tabletop`. Swap...`
...
**This graph:** `stills/food-tabletop`
...
**This graph:** `Food / tabletop (1024x1280)`
