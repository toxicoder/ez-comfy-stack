...
**This graph:** `## stills/food-tabletop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Food / tabletop still (Klein 4B). Default 1024×1280 (4:5). Prefix `ez_tabletop`. Swap…`
