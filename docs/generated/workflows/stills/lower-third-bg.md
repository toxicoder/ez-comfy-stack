...
**This graph:** `## stills/lower-third-bg Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Lower-third-safe 16:9 plate (Klein 4B). Default 1280×720. Prefix `ez_lowerthird`. Ke…`
