...
**Who this is for:** studio users who loaded `stills/lower-third-bg` from Apps or Workflows.

> Generated from `workflows/_lab/stills/lower-third-bg.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/lower-third-bg** from **Apps** or **Workflows**
...
**This graph:** `## stills/lower-third-bg Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Lower-third-safe 16:9 plate (Klein 4B). Default 1280x720. Prefix `ez_lowerthird`. Ke...`
...
**This graph:** `stills/lower-third-bg`
...
**This graph:** `Lower-third plate (1280x720)`
