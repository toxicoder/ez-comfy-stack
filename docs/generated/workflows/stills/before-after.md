...
**Who this is for:** studio users who loaded `stills/before-after` from Apps or Workflows.

> Generated from `workflows/_lab/stills/before-after.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/before-after** from **Apps** or **Workflows**
...
**This graph:** `stills/before-after`
...
**This graph:** `## stills/before-after Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Two Klein 4B stills of one mug. SHOT BEFORE is the identity plate; AFTER Klein-edits f...`
...
**This graph (all 2 instances):** `none`
