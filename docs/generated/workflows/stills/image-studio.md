...
**Who this is for:** studio users who loaded `stills/image-studio` from Apps or Workflows.

> Generated from `workflows/_lab/stills/image-studio.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Handoff: motion/silent/still-to-video-5s, motion/av/still-to-video-10s, stills/text-swap, stills/still-studio.
...
2. Load **stills/image-studio** from **Apps** or **Workflows**
...
**This graph:** `## stills/image-studio Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Universal Klein 4B still desk with 100 creator modes (background swap, change text, ch…`
...
**This graph:** `YouTube 16:9 still, LTX feeder`
...
**This graph:** `stills/image-studio`
