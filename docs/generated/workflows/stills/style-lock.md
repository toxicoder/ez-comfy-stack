...
**This graph:** `## stills/style-lock Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Four Klein 4B stills of **one place** from new cameras (Prompt Join lock=view). Type any…`
