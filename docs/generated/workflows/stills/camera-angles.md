...
**Who this is for:** studio users who loaded `stills/camera-angles` from Apps or Workflows.

> Generated from `workflows/_lab/stills/camera-angles.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/camera-angles** from **Apps** or **Workflows**
...
| 10 | SHOT MEDIUM | `EZPromptJoin` | SHOT MEDIUM |
| 11 | Positive MEDIUM | `CLIPTextEncode` | SHOT MEDIUM |
| 12 | Sampler MEDIUM | `KSampler` | SHOT MEDIUM |
| 13 | Decode MEDIUM | `VAEDecode` | SHOT MEDIUM |
| 14 | Save MEDIUM | `SaveImage` | SHOT MEDIUM |
...
| 22 | SHOT CLOSE | `EZPromptJoin` | SHOT CLOSE |
| 23 | Positive CLOSE | `CLIPTextEncode` | SHOT CLOSE |
| 24 | Sampler CLOSE | `KSampler` | SHOT CLOSE |
| 25 | Decode CLOSE | `VAEDecode` | SHOT CLOSE |
| 26 | Save CLOSE | `SaveImage` | SHOT CLOSE |
...
| 34 | Negative SHOT WIDE | `EZNegativePromptEnhance` | Ungrouped |
| 35 | Negative Negative SHOT WIDE | `CLIPTextEncode` | Ungrouped |
| 36 | Negative SHOT CLOSE | `EZNegativePromptEnhance` | Ungrouped |
| 37 | Negative Negative SHOT CLOSE | `CLIPTextEncode` | Ungrouped |
...
**This graph:** `stills/camera-angles`
...
| Positive MEDIUM | `35mm medium of this identity; subject fills the middle third. YouTube 16:9. Sam...` |
| Positive WIDE | `24mm wide establishing of this identity and place. YouTube 16:9. Same building,...` |
| Positive CLOSE | `50mm close on face, hands, or signature materials from the bible. YouTube 16:9....` |
...
**This graph:** `## stills/camera-angles Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Wide / medium / close of one subject (Klein 4B, lock=view). Type any subject in IDENT...`
...
| Instance | Value |
| --- | --- |
| SHOT MEDIUM | `35mm medium of this identity; subject fills the middle third. YouTube 16:9.` |
| SHOT WIDE | `24mm wide establishing of this identity and place. YouTube 16:9.` |
| SHOT CLOSE | `50mm close on face, hands, or signature materials from the bible. YouTube 16:9.` |
...
| Instance | Value |
| --- | --- |
| Save MEDIUM | `ez_angle_med` |
| Save WIDE | `ez_angle_wide` |
| Save CLOSE | `ez_angle_close` |
