...
**Who this is for:** studio users who loaded `stills/podcast-cover` from Apps or Workflows.

> Generated from `workflows/_lab/stills/podcast-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/podcast-cover** from **Apps** or **Workflows**
...
**This graph:** `## stills/podcast-cover Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Podcast / playlist cover (Klein 4B). Default 1024x1024. Prefix `ez_podcast`. Swap the...`
...
**This graph:** `stills/podcast-cover`
...
**This graph:** `Podcast - cover (1024x1024)`
