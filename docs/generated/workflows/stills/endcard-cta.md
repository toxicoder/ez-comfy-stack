...
**Who this is for:** studio users who loaded `stills/endcard-cta` from Apps or Workflows.

> Generated from `workflows/_lab/stills/endcard-cta.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/endcard-cta** from **Apps** or **Workflows**
...
**This graph:** `## stills/endcard-cta Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. YouTube/end-card still (Klein 4B). Default 1280x720. Prefix `ez_endcard`. Keep the lowe...`
...
**This graph:** `End-card / CTA (1280x720)`
