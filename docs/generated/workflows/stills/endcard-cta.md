...
**This graph:** `## stills/endcard-cta Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube/end-card still (Klein 4B). Default 1280×720. Prefix `ez_endcard`. Keep the lowe…`
