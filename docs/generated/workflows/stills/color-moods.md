...
**This graph:** `## stills/color-moods Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Four color moods, shared identity (Klein 4B). Type any subject in IDENTITY. SHOT WARM i…`
