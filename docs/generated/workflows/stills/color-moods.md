...
**Who this is for:** studio users who loaded `stills/color-moods` from Apps or Workflows.

> Generated from `workflows/_lab/stills/color-moods.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/color-moods** from **Apps** or **Workflows**
...
| 13 | Decode WARM | `VAEDecode` | SHOT WARM |
| 14 | Save WARM | `SaveImage` | SHOT WARM |
...
| 22 | SHOT MUTED | `EZPromptJoin` | SHOT MUTED |
| 23 | Positive MUTED | `CLIPTextEncode` | SHOT MUTED |
| 24 | Sampler MUTED | `KSampler` | SHOT MUTED |
| 25 | Decode MUTED | `VAEDecode` | SHOT MUTED |
| 26 | Save MUTED | `SaveImage` | SHOT MUTED |
| 27 | Ref from 01 (MUTED) | `ReferenceLatent` | SHOT MUTED |
| 28 | SHOT HIGH KEY | `EZPromptJoin` | SHOT HIGH KEY |
| 29 | Positive HIGH KEY | `CLIPTextEncode` | SHOT HIGH KEY |
| 30 | Sampler HIGH KEY | `KSampler` | SHOT HIGH KEY |
| 31 | Decode HIGH KEY | `VAEDecode` | SHOT HIGH KEY |
...
| 45 | Negative SHOT MUTED | `EZNegativePromptEnhance` | Ungrouped |
| 46 | Negative Negative SHOT MUTED | `CLIPTextEncode` | Ungrouped |
| 47 | Negative + identity plate | `ReferenceLatent` | Ungrouped |
| 48 | Negative SHOT HIGH KEY | `EZNegativePromptEnhance` | Ungrouped |
| 49 | Negative Negative SHOT HIGH KEY | `CLIPTextEncode` | Ungrouped |
...
| Positive WARM | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Positive COOL | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Positive MUTED | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Positive HIGH KEY | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Negative Negative SHOT COOL | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT MUTED | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT HIGH KEY | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
...
**This graph:** `## stills/color-moods Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Four color moods, shared identity (Klein 4B). Type any subject in IDENTITY. SHOT WARM i...`
...
| Instance | Value |
| --- | --- |
| SHOT WARM | `Canonical plate. Warm amber grade, golden sidelight. 24mm, YouTube 16:9.` |
| SHOT COOL | `Same subject and camera. Cool overcast teal, soft contrast.` |
| SHOT MUTED | `Same subject and camera. Soft coral grade, low contrast.` |
| SHOT HIGH KEY | `Same subject and camera. High-key bright daylight, lifted shadows, clean whites.` |
...
| Instance | Value |
| --- | --- |
| Save WARM | `ez_mood_01` |
| Save COOL | `ez_mood_02` |
| Save MUTED | `ez_mood_03` |
| Save HIGH KEY | `ez_mood_04` |
