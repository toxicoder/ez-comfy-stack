...
**Who this is for:** studio users who loaded `stills/time-of-day` from Apps or Workflows.

> Generated from `workflows/_lab/stills/time-of-day.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/time-of-day** from **Apps** or **Workflows**
...
| 13 | Decode GOLDEN | `VAEDecode` | SHOT GOLDEN |
| 14 | Save GOLDEN | `SaveImage` | SHOT GOLDEN |
| 16 | SHOT DAWN | `EZPromptJoin` | SHOT DAWN |
| 17 | Positive DAWN | `CLIPTextEncode` | SHOT DAWN |
| 18 | Sampler DAWN | `KSampler` | SHOT DAWN |
| 19 | Decode DAWN | `VAEDecode` | SHOT DAWN |
| 20 | Save DAWN | `SaveImage` | SHOT DAWN |
| 21 | Ref from 01 (DAWN) | `ReferenceLatent` | SHOT DAWN |
| 22 | SHOT NOON | `EZPromptJoin` | SHOT NOON |
| 23 | Positive NOON | `CLIPTextEncode` | SHOT NOON |
| 24 | Sampler NOON | `KSampler` | SHOT NOON |
| 25 | Decode NOON | `VAEDecode` | SHOT NOON |
| 26 | Save NOON | `SaveImage` | SHOT NOON |
| 27 | Ref from 01 (NOON) | `ReferenceLatent` | SHOT NOON |
| 28 | SHOT NIGHT | `EZPromptJoin` | SHOT NIGHT |
| 29 | Positive NIGHT | `CLIPTextEncode` | SHOT NIGHT |
| 30 | Sampler NIGHT | `KSampler` | SHOT NIGHT |
| 31 | Decode NIGHT | `VAEDecode` | SHOT NIGHT |
...
| 42 | Negative SHOT DAWN | `EZNegativePromptEnhance` | Ungrouped |
| 43 | Negative Negative SHOT DAWN | `CLIPTextEncode` | Ungrouped |
| 44 | Negative + identity plate | `ReferenceLatent` | Ungrouped |
| 45 | Negative SHOT NOON | `EZNegativePromptEnhance` | Ungrouped |
| 46 | Negative Negative SHOT NOON | `CLIPTextEncode` | Ungrouped |
| 47 | Negative + identity plate | `ReferenceLatent` | Ungrouped |
| 48 | Negative SHOT NIGHT | `EZNegativePromptEnhance` | Ungrouped |
| 49 | Negative Negative SHOT NIGHT | `CLIPTextEncode` | Ungrouped |
...
| Positive GOLDEN | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Positive DAWN | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Positive NOON | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Positive NIGHT | `A photoreal still of a tropical coastal city rooftop terrace at golden hour. An...` |
| Negative Negative SHOT DAWN | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT NOON | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
...
**This graph:** `## stills/time-of-day Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Same place at golden hour / dawn / noon / night (Klein 4B). Type any place in IDENTITY....`
...
| Instance | Value |
| --- | --- |
| SHOT GOLDEN | `Canonical golden-hour plate, amber sidelight. 24mm eye-level, YouTube 16:9.` |
| SHOT DAWN | `Same place and camera. First light, humid pastel sky.` |
| SHOT NOON | `Same place and camera. Hard noon sun, short shadows.` |
| SHOT NIGHT | `Same place and camera at night. Warm practicals; city glow only if the bible is...` |
...
| Instance | Value |
| --- | --- |
| Save GOLDEN | `ez_tod_01` |
| Save DAWN | `ez_tod_02` |
| Save NOON | `ez_tod_03` |
| Save NIGHT | `ez_tod_04` |
