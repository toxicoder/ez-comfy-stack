...
**This graph:** `## stills/time-of-day Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Same place at golden hour / dawn / noon / night (Klein 4B). Type any place in IDENTITY.…`
