...
**Who this is for:** studio users who loaded `stills/storyboard-6up` from Apps or Workflows.

> Generated from `workflows/_lab/stills/storyboard-6up.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **stills/storyboard-6up** from **Apps** or **Workflows**
...
| 10 | SHOT 01 | `EZPromptJoin` | SHOT 01 |
| 11 | Positive 01 | `CLIPTextEncode` | SHOT 01 |
| 12 | Sampler 01 | `KSampler` | SHOT 01 |
| 13 | Decode 01 | `VAEDecode` | SHOT 01 |
| 14 | Save 01 | `SaveImage` | SHOT 01 |
| 16 | SHOT 02 | `EZPromptJoin` | SHOT 02 |
| 17 | Positive 02 | `CLIPTextEncode` | SHOT 02 |
| 18 | Sampler 02 | `KSampler` | SHOT 02 |
| 19 | Decode 02 | `VAEDecode` | SHOT 02 |
| 20 | Save 02 | `SaveImage` | SHOT 02 |
| 22 | SHOT 03 | `EZPromptJoin` | SHOT 03 |
| 23 | Positive 03 | `CLIPTextEncode` | SHOT 03 |
| 24 | Sampler 03 | `KSampler` | SHOT 03 |
| 25 | Decode 03 | `VAEDecode` | SHOT 03 |
| 26 | Save 03 | `SaveImage` | SHOT 03 |
| 28 | SHOT 04 | `EZPromptJoin` | SHOT 04 |
| 29 | Positive 04 | `CLIPTextEncode` | SHOT 04 |
| 30 | Sampler 04 | `KSampler` | SHOT 04 |
| 31 | Decode 04 | `VAEDecode` | SHOT 04 |
| 32 | Save 04 | `SaveImage` | SHOT 04 |
| 34 | SHOT 05 | `EZPromptJoin` | SHOT 05 |
| 35 | Positive 05 | `CLIPTextEncode` | SHOT 05 |
| 36 | Sampler 05 | `KSampler` | SHOT 05 |
| 37 | Decode 05 | `VAEDecode` | SHOT 05 |
| 38 | Save 05 | `SaveImage` | SHOT 05 |
| 40 | SHOT 06 | `EZPromptJoin` | SHOT 06 |
| 41 | Positive 06 | `CLIPTextEncode` | SHOT 06 |
...
| 55 | Negative SHOT 02 | `EZNegativePromptEnhance` | Ungrouped |
| 56 | Negative Negative SHOT 02 | `CLIPTextEncode` | Ungrouped |
| 57 | Negative SHOT 03 | `EZNegativePromptEnhance` | Ungrouped |
| 58 | Negative Negative SHOT 03 | `CLIPTextEncode` | Ungrouped |
| 59 | Negative SHOT 04 | `EZNegativePromptEnhance` | Ungrouped |
| 60 | Negative Negative SHOT 04 | `CLIPTextEncode` | Ungrouped |
| 61 | Negative SHOT 05 | `EZNegativePromptEnhance` | Ungrouped |
| 62 | Negative Negative SHOT 05 | `CLIPTextEncode` | Ungrouped |
| 63 | Negative SHOT 06 | `EZNegativePromptEnhance` | Ungrouped |
| 64 | Negative Negative SHOT 06 | `CLIPTextEncode` | Ungrouped |
...
**This graph:** `stills/storyboard-6up`
...
| Positive 01 | `Wide establishing of this scene, 24mm. Unmarked surfaces, empty of lettering. S...` |
| Positive 02 | `Enter: the bible subject arriving into this scene, 35mm. Unmarked surfaces, emp...` |
| Positive 03 | `Traverse: moving through this scene, 35mm. Unmarked surfaces, empty of letterin...` |
| Positive 04 | `Insert: a material or prop detail named in the bible, 50mm. Unmarked surfaces, ...` |
| Positive 05 | `Exit: turning toward the way out of this scene, 35mm. Unmarked surfaces, empty ...` |
| Positive 06 | `Closer hook of the same scene, 24mm. Unmarked surfaces, empty of lettering. Sam...` |
| Negative Negative SHOT 02 | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT 03 | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT 04 | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT 05 | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
| Negative Negative SHOT 06 | `game-engine cutscene, Pixar rounded cartoon, illustration, muddy textures, melt...` |
...
**This graph:** `## stills/storyboard-6up Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Six Klein 4B storyboard frames of **one scene** from new cameras (lock=view). Type a...`
...
| Instance | Value |
| --- | --- |
| SHOT 01 | `Wide establishing of this scene, 24mm. Unmarked surfaces, empty of lettering.` |
| SHOT 02 | `Enter: the bible subject arriving into this scene, 35mm. Unmarked surfaces, emp...` |
| SHOT 03 | `Traverse: moving through this scene, 35mm. Unmarked surfaces, empty of letterin...` |
| SHOT 04 | `Insert: a material or prop detail named in the bible, 50mm. Unmarked surfaces, ...` |
| SHOT 05 | `Exit: turning toward the way out of this scene, 35mm. Unmarked surfaces, empty ...` |
| SHOT 06 | `Closer hook of the same scene, 24mm. Unmarked surfaces, empty of lettering.` |
