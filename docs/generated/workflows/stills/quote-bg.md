...
**This graph:** `## stills/quote-bg Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Quote-card background (Klein 4B). Default 1024×1024. Prefix `ez_quote_bg`. Keep the center…`
