---
title: "films/last-lane/act-03"
description: "One-click night two-lane - Mesa: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film shots) is"
tags: [workflows, generated, comfyui, films]
---

# films/last-lane/act-03
...
**Who this is for:** studio users who loaded `films/last-lane/act-03` from Apps or Workflows.

> Generated from `workflows/_lab/films/last-lane/act-03.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (night two-lane - Mesa): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 3/5** of a 7.5 min film (90 x 5.00s). Act 3 LoadImage should be the previous act last frame (ez_lastlane_b12_s3_last_*.png). In-graph stitch writes `ez_lastlane_act3_90s.mp4`. After all five acts: `concat-shots.sh --film last-lane --yes` -> `ez_lastlane_450s.mp4`.
...
2. Load **films/last-lane/act-03** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The ghost...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Dash dust...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A faint o...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. It is not...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The other...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Alone aga...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The lane ...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves fo...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A tank or...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The troug...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. No cattle...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The bend ...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Stars, no...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The cone ...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A slow mi...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves ea...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The ruts ...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A harder ...` |
...
| Save last frame | `ez_lastlane_b13_s1_last` |
| Save last frame | `ez_lastlane_b13_s2_last` |
| Save last frame | `ez_lastlane_b13_s3_last` |
| Save last frame | `ez_lastlane_b14_s1_last` |
| Save last frame | `ez_lastlane_b14_s2_last` |
| Save last frame | `ez_lastlane_b14_s3_last` |
| Save last frame | `ez_lastlane_b15_s1_last` |
| Save last frame | `ez_lastlane_b15_s2_last` |
| Save last frame | `ez_lastlane_b15_s3_last` |
| Save last frame | `ez_lastlane_b16_s1_last` |
| Save last frame | `ez_lastlane_b16_s2_last` |
| Save last frame | `ez_lastlane_b16_s3_last` |
| Save last frame | `ez_lastlane_b17_s1_last` |
| Save last frame | `ez_lastlane_b17_s2_last` |
| Save last frame | `ez_lastlane_b17_s3_last` |
| Save last frame | `ez_lastlane_b18_s1_last` |
| Save last frame | `ez_lastlane_b18_s2_last` |
| Save last frame | `ez_lastlane_b18_s3_last` |
...
**This graph:** `## films/last-lane/act-03 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outputs...`
...
**This graph:** `films/last-lane/act-03`
...
**This graph:** `## last-lane (night two-lane - Mesa) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8n...`

```text
## last-lane (night two-lane - Mesa)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Ghost | The ghost dies | Dash dust hangs | A faint other cone far |
| 2 | Far light | It is not a town | The other cone turns away | Alone again |
| 3 | Alone cone | The lane bends | Gloves follow | A tank or trough, unmarked |
| 4 | Trough | The trough slides past | No cattle in frame | The bend opens |
| 5 | Open flat | Stars, no town glow | The cone is a short world | A slow mile |
| 6 | Slow mile | Gloves ease | The ruts shallow | A harder pack |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The ghost...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Dash dust...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A faint o...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. It is not...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The other...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Alone aga...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The lane ...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves fo...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A tank or...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The troug...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. No cattle...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The bend ...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Stars, no...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The cone ...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A slow mi...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves ea...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The ruts ...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A harder ...` |
...
**This graph (all 18 instances):** `films/last-lane/act-03`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_lastlane_b13_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b13_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b13_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b14_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b14_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b14_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b15_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b15_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b15_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b16_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b16_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b16_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b17_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b17_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b17_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b18_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b18_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b18_s3_ltx_video` |
...
**This graph:** `ez_lastlane_b12_s3_last.png`
