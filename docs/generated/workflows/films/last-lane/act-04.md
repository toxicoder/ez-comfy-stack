---
title: "films/last-lane/act-04"
description: "One-click night two-lane - Open gate: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film shot"
tags: [workflows, generated, comfyui, films]
---

# films/last-lane/act-04
...
**Who this is for:** studio users who loaded `films/last-lane/act-04` from Apps or Workflows.

> Generated from `workflows/_lab/films/last-lane/act-04.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (night two-lane - Open gate): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 4/5** of a 7.5 min film (90 x 5.00s). Act 4 LoadImage should be the previous act last frame (ez_lastlane_b18_s3_last_*.png). In-graph stitch writes `ez_lastlane_act4_90s.mp4`. After all five acts: `concat-shots.sh --film last-lane --yes` -> `ez_lastlane_450s.mp4`.
...
2. Load **films/last-lane/act-04** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Faster gr...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The wheel...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A rise of...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The mesa ...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The lane ...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A pull-ou...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The wheel...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The mesa ...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. More lane...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A second ...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Cross tic...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The cone ...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. No sign o...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Through g...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The lane ...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Dawn is a...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves st...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The pale ...` |
...
| Save last frame | `ez_lastlane_b19_s1_last` |
| Save last frame | `ez_lastlane_b19_s2_last` |
| Save last frame | `ez_lastlane_b19_s3_last` |
| Save last frame | `ez_lastlane_b20_s1_last` |
| Save last frame | `ez_lastlane_b20_s2_last` |
| Save last frame | `ez_lastlane_b20_s3_last` |
| Save last frame | `ez_lastlane_b21_s1_last` |
| Save last frame | `ez_lastlane_b21_s2_last` |
| Save last frame | `ez_lastlane_b21_s3_last` |
| Save last frame | `ez_lastlane_b22_s1_last` |
| Save last frame | `ez_lastlane_b22_s2_last` |
| Save last frame | `ez_lastlane_b22_s3_last` |
| Save last frame | `ez_lastlane_b23_s1_last` |
| Save last frame | `ez_lastlane_b23_s2_last` |
| Save last frame | `ez_lastlane_b23_s3_last` |
| Save last frame | `ez_lastlane_b24_s1_last` |
| Save last frame | `ez_lastlane_b24_s2_last` |
| Save last frame | `ez_lastlane_b24_s3_last` |
...
**This graph:** `## films/last-lane/act-04 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outputs...`
...
**This graph:** `films/last-lane/act-04`
...
**This graph:** `## last-lane (night two-lane - Open gate) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames =...`

```text
## last-lane (night two-lane - Open gate)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Hard pack | Faster gravel tick | The wheel is still | A rise of black mesa |
| 2 | Mesa | The mesa is a wall | The lane skirts it | A pull-out of dirt |
| 3 | Pull-out | The wheel does not take it | The mesa ends | More lane |
| 4 | More lane | A second wash, dry | Cross | The cone finds a gate, unmarked, open |
| 5 | Open gate | No sign on the gate | Through | The lane is the same |
| 6 | Same lane | Dawn is a rumour | Gloves stay | The pale grows |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Faster gr...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The wheel...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A rise of...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The mesa ...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The lane ...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A pull-ou...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The wheel...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The mesa ...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. More lane...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A second ...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Cross tic...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The cone ...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. No sign o...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Through g...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The lane ...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Dawn is a...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves st...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The pale ...` |
...
**This graph (all 18 instances):** `films/last-lane/act-04`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_lastlane_b19_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b19_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b19_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b20_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b20_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b20_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b21_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b21_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b21_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b22_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b22_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b22_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b23_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b23_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b23_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b24_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b24_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b24_s3_ltx_video` |
...
**This graph:** `ez_lastlane_b18_s3_last.png`
