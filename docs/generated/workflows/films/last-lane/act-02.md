---
title: "films/last-lane/act-02"
description: "One-click night two-lane - Fork and wash: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film"
tags: [workflows, generated, comfyui, films]
---

# films/last-lane/act-02
...
**Who this is for:** studio users who loaded `films/last-lane/act-02` from Apps or Workflows.

> Generated from `workflows/_lab/films/last-lane/act-02.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (night two-lane - Fork and wash): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
3. The MP4 is already on disk at `${COMFY_OUTPUT_DIR}/ez_lastlane_90s.mp4` (act graphs write `ez_lastlane_actN_90s.mp4`). A **Film ready** overlay plays it. Copy off the Spark with scp.
4. Optional single-shot iterate: **motion/av/still-to-shot**. Optional silent rehearsal: **motion/silent/still-to-shot**.
5. Spark-farm / host stitch fallback: `./scripts/utilities/concat-shots.sh --film last-lane --yes`
...
This graph is **act 2/5** of a 7.5 min film (90 x 5.00s). Act 2 LoadImage should be the previous act last frame (ez_lastlane_b6_s3_last_*.png). In-graph stitch writes `ez_lastlane_act2_90s.mp4`. After all five acts: `concat-shots.sh --film last-lane --yes` -> `ez_lastlane_450s.mp4`.
...
2. Load **films/last-lane/act-02** from **Apps** or **Workflows**
...
| 52 | last-lane 90s shot map | `MarkdownNote` | 2. LTX models |
...
| Instance | Value |
| --- | --- |
| Positive | `A dashboard first-person still at night on an unmarked two-lane. Dusty cracked ...` |
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Dash crac...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves at...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A dip gri...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The cone ...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Dust lift...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The dip c...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A fork, b...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The wheel...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The right...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The left ...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A stone p...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The cone ...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A thin we...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves ho...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The wash ...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Sage agai...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A long st...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Heat-ghos...` |
...
| Instance | Value |
| --- | --- |
| Save identity PNG | `ez_lastlane_identity` |
| Save last frame | `ez_lastlane_b7_s1_last` |
| Save last frame | `ez_lastlane_b7_s2_last` |
| Save last frame | `ez_lastlane_b7_s3_last` |
| Save last frame | `ez_lastlane_b8_s1_last` |
| Save last frame | `ez_lastlane_b8_s2_last` |
| Save last frame | `ez_lastlane_b8_s3_last` |
| Save last frame | `ez_lastlane_b9_s1_last` |
| Save last frame | `ez_lastlane_b9_s2_last` |
| Save last frame | `ez_lastlane_b9_s3_last` |
| Save last frame | `ez_lastlane_b10_s1_last` |
| Save last frame | `ez_lastlane_b10_s2_last` |
| Save last frame | `ez_lastlane_b10_s3_last` |
| Save last frame | `ez_lastlane_b11_s1_last` |
| Save last frame | `ez_lastlane_b11_s2_last` |
| Save last frame | `ez_lastlane_b11_s3_last` |
| Save last frame | `ez_lastlane_b12_s1_last` |
| Save last frame | `ez_lastlane_b12_s2_last` |
| Save last frame | `ez_lastlane_b12_s3_last` |
...
**This graph:** `## films/last-lane/act-02 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outputs...`
...
**This graph:** `films/last-lane/act-02`
...
**This graph:** `## last-lane (night two-lane - Fork and wash) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 fram...`

```text
## last-lane (night two-lane - Fork and wash)

Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8n per shot). Optional silent rehearsal: **motion/silent/still-to-shot**. Optional host stitch: `./scripts/utilities/concat-shots.sh --film last-lane --yes`.
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Only cone | Dash cracks in the glow | Gloves at ten and two | A dip |
| 2 | Dip | The cone dives | Dust lifts | The dip climbs out |
| 3 | Out | A fork, both unmarked | The wheel takes the left | The right dies in sage |
| 4 | Left only | The left is worse gravel | A stone pops the wheel well | The cone finds a wash |
| 5 | Wash | A thin wet line | Gloves hold through it | The wash is crossed |
| 6 | Far bank | Sage again | A long straight | Heat-ghost of the day still |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Dash crac...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves at...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A dip gri...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The cone ...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Dust lift...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The dip c...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A fork, b...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The wheel...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The right...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The left ...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A stone p...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The cone ...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A thin we...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves ho...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The wash ...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Sage agai...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A long st...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Heat-ghos...` |
...
**This graph (all 18 instances):** `films/last-lane/act-02`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_lastlane_b7_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b7_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b7_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b8_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b8_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b8_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b9_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b9_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b9_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b10_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b10_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b10_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b11_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b11_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b11_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b12_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b12_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_lastlane_b12_s3_ltx_video` |
...
**This graph:** `ez_lastlane_b6_s3_last.png`
