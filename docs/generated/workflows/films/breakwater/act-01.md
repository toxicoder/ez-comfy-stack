---
title: "films/breakwater/act-01"
description: "One-click storm-wall walk - Wall walk: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film sho"
tags: [workflows, generated, comfyui, films]
---

# films/breakwater/act-01
...
**Who this is for:** studio users who loaded `films/breakwater/act-01` from Apps or Workflows.

> Generated from `workflows/_lab/films/breakwater/act-01.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (storm-wall walk - Wall walk): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 1/5** of a 7.5 min film (90 x 5.00s). Act 1 starts from Klein identity. In-graph stitch writes `ez_breakwater_act1_90s.mp4`. After all five acts: `concat-shots.sh --film breakwater --yes` -> `ez_breakwater_450s.mp4`.
...
2. Load **films/breakwater/act-01** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A walk al...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves sw...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Spray fro...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The sea h...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A look at...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The block...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A gap bet...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A step ov...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The far b...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A generic...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves do...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The wall ...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The turn ...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A puddle ...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Through t...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. Rail to t...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. A glove n...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. Wordless mix: silent mouth. The rail ...` |
...
| Save last frame | `ez_breakwater_b1_s1_last` |
| Save last frame | `ez_breakwater_b1_s2_last` |
| Save last frame | `ez_breakwater_b1_s3_last` |
| Save last frame | `ez_breakwater_b2_s1_last` |
| Save last frame | `ez_breakwater_b2_s2_last` |
| Save last frame | `ez_breakwater_b2_s3_last` |
| Save last frame | `ez_breakwater_b3_s1_last` |
| Save last frame | `ez_breakwater_b3_s2_last` |
| Save last frame | `ez_breakwater_b3_s3_last` |
| Save last frame | `ez_breakwater_b4_s1_last` |
| Save last frame | `ez_breakwater_b4_s2_last` |
| Save last frame | `ez_breakwater_b4_s3_last` |
| Save last frame | `ez_breakwater_b5_s1_last` |
| Save last frame | `ez_breakwater_b5_s2_last` |
| Save last frame | `ez_breakwater_b5_s3_last` |
| Save last frame | `ez_breakwater_b6_s1_last` |
| Save last frame | `ez_breakwater_b6_s2_last` |
| Save last frame | `ez_breakwater_b6_s3_last` |
...
**This graph:** `## films/breakwater/act-01 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/output...`
...
**This graph:** `films/breakwater/act-01`
...
**This graph:** `## breakwater (storm-wall walk - Wall walk) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames...`

```text
## breakwater (storm-wall walk - Wall walk)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Wall walk | A walk already underway on wet granite | Gloves swing contralateral | Spray from the left |
| 2 | Spray | The sea hits the wall | A look at the next block | The block is taken |
| 3 | Taken block | A gap between blocks | A step over the gap | The far block holds |
| 4 | Far block | A generic foghorn, not a real harbour | Gloves do not cover ears | The wall turns |
| 5 | Turn | The turn shows more wall | A puddle on granite | Through the puddle |
| 6 | Past puddle | Rail to the right, unmarked | A glove near the rail, not grabbing | The rail ends |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A walk al...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves sw...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Spray fro...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The sea h...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A look at...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The block...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A gap bet...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A step ov...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The far b...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A generic...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Gloves do...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The wall ...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The turn ...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A puddle ...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Through t...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. Rail to t...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. A glove n...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. Wordless mix: silent mouth. The rail ...` |
...
**This graph (all 18 instances):** `films/breakwater/act-01`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_breakwater_b1_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b1_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b1_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b2_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b2_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b2_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b3_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b3_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b3_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b4_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b4_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b4_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b5_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b5_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b5_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b6_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b6_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_breakwater_b6_s3_ltx_video` |
