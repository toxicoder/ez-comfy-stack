---
title: "films/glasshouse/act-02"
description: "One-click storm glasshouse - Nave of glass: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or fil"
tags: [workflows, generated, comfyui, films]
---

# films/glasshouse/act-02
...
**Who this is for:** studio users who loaded `films/glasshouse/act-02` from Apps or Workflows.

> Generated from `workflows/_lab/films/glasshouse/act-02.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (storm glasshouse - Nave of glass): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 2/5** of a 7.5 min film (90 x 5.00s). Act 2 LoadImage should be the previous act last frame (ez_glasshouse_b6_s3_last_*.png). In-graph stitch writes `ez_glasshouse_act2_90s.mp4`. After all five acts: `concat-shots.sh --film glasshouse --yes` -> `ez_glasshouse_450s.mp4`.
...
2. Load **films/glasshouse/act-02** from **Apps** or **Workflows**
...
| 900 | Save act 2 (90s MP4) - play / download | `EZFilmConcat` | 9. Publish 90s MP4 |
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Palms left and right rain, wind The c...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. The can pours again pour, tick The ca...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. Thunder is only rain louder rain, met...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. The glass drums rain, tick The camera...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. A puddle races the flagstone splash, ...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. The can waits metal tick, cloth The c...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Storm light, green wind, rain The cam...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. A fern against the can cloth, tick Th...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. The fern drips on copper splash, meta...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Copper darkens rain, metal tick The c...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. A pour at the far bench pour, splash ...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. The bench is wet wood wood creak, rai...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Pots in a row, unmarked tick, grit Th...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. One pot overflows splash, pour The ca...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The overflow runs to stone water tick...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. The runnel finds the aisle splash, gr...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. A walk with the can footstep, metal T...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. The door at the end is glass wind, ra...` |
...
| Save last frame | `ez_glasshouse_b7_s1_last` |
| Save last frame | `ez_glasshouse_b7_s2_last` |
| Save last frame | `ez_glasshouse_b7_s3_last` |
| Save last frame | `ez_glasshouse_b8_s1_last` |
| Save last frame | `ez_glasshouse_b8_s2_last` |
| Save last frame | `ez_glasshouse_b8_s3_last` |
| Save last frame | `ez_glasshouse_b9_s1_last` |
| Save last frame | `ez_glasshouse_b9_s2_last` |
| Save last frame | `ez_glasshouse_b9_s3_last` |
| Save last frame | `ez_glasshouse_b10_s1_last` |
| Save last frame | `ez_glasshouse_b10_s2_last` |
| Save last frame | `ez_glasshouse_b10_s3_last` |
| Save last frame | `ez_glasshouse_b11_s1_last` |
| Save last frame | `ez_glasshouse_b11_s2_last` |
| Save last frame | `ez_glasshouse_b11_s3_last` |
| Save last frame | `ez_glasshouse_b12_s1_last` |
| Save last frame | `ez_glasshouse_b12_s2_last` |
| Save last frame | `ez_glasshouse_b12_s3_last` |
...
**This graph:** `## films/glasshouse/act-02 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/output...`
...
**This graph:** `films/glasshouse/act-02`
...
**This graph:** `## glasshouse (storm glasshouse - Nave of glass) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 f...`

```text
## glasshouse (storm glasshouse - Nave of glass)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Aisle | Palms left and right | The can pours again | Thunder is only rain louder |
| 2 | Loud roof | The glass drums | A puddle races the flagstone | The can waits |
| 3 | Wait | Storm light, green | A fern against the can | The fern drips on copper |
| 4 | Drip on can | Copper darkens | A pour at the far bench | The bench is wet wood |
| 5 | Wet wood | Pots in a row, unmarked | One pot overflows | The overflow runs to stone |
| 6 | Runnel | The runnel finds the aisle | A walk with the can | The door at the end is glass |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Palms left and right rain, wind The c...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. The can pours again pour, tick The ca...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. Thunder is only rain louder rain, met...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. The glass drums rain, tick The camera...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. A puddle races the flagstone splash, ...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. The can waits metal tick, cloth The c...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Storm light, green wind, rain The cam...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. A fern against the can cloth, tick Th...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. The fern drips on copper splash, meta...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Copper darkens rain, metal tick The c...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. A pour at the far bench pour, splash ...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. The bench is wet wood wood creak, rai...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Pots in a row, unmarked tick, grit Th...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. One pot overflows splash, pour The ca...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The overflow runs to stone water tick...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. The runnel finds the aisle splash, gr...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. A walk with the can footstep, metal T...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. The door at the end is glass wind, ra...` |
...
**This graph (all 18 instances):** `films/glasshouse/act-02`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_glasshouse_b7_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b7_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b7_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b8_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b8_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b8_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b9_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b9_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b9_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b10_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b10_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b10_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b11_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b11_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b11_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b12_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b12_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b12_s3_ltx_video` |
...
**This graph:** `ez_glasshouse_b6_s3_last.png`
