---
title: "films/glasshouse/act-03"
description: "One-click storm glasshouse - Door and garden: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or f"
tags: [workflows, generated, comfyui, films]
---

# films/glasshouse/act-03
...
**Who this is for:** studio users who loaded `films/glasshouse/act-03` from Apps or Workflows.

> Generated from `workflows/_lab/films/glasshouse/act-03.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (storm glasshouse - Door and garden): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 3/5** of a 7.5 min film (90 x 5.00s). Act 3 LoadImage should be the previous act last frame (ez_glasshouse_b12_s3_last_*.png). In-graph stitch writes `ez_glasshouse_act3_90s.mp4`. After all five acts: `concat-shots.sh --film glasshouse --yes` -> `ez_glasshouse_450s.mp4`.
...
2. Load **films/glasshouse/act-03** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Rain outside harder rain, wind The ca...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. The door stays shut click, cloth The ...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. A hold on the can against the door me...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Steam fogs the glass steam, wind The ...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. A wipe cloth, tick The camera dollies...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. The garden outside is unmarked rain, ...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. No path signs rain, wind The camera p...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Back to the nave footstep, splash The...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. The can is set down metal scrape, gri...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Storm eases a hair rain, tick The cam...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. Light finds copper metal tick, wind T...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. A last pour pour, splash The camera p...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. The last pot is a fern pour, cloth Th...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. Soil goes dark water tick, grit The c...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The can is empty metal tick, scrape T...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. A shake metal tick, splash The camera...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. The drops hit stone tick, rain The ca...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. The can rests cloth, grit The camera ...` |
...
| Save last frame | `ez_glasshouse_b13_s1_last` |
| Save last frame | `ez_glasshouse_b13_s2_last` |
| Save last frame | `ez_glasshouse_b13_s3_last` |
| Save last frame | `ez_glasshouse_b14_s1_last` |
| Save last frame | `ez_glasshouse_b14_s2_last` |
| Save last frame | `ez_glasshouse_b14_s3_last` |
| Save last frame | `ez_glasshouse_b15_s1_last` |
| Save last frame | `ez_glasshouse_b15_s2_last` |
| Save last frame | `ez_glasshouse_b15_s3_last` |
| Save last frame | `ez_glasshouse_b16_s1_last` |
| Save last frame | `ez_glasshouse_b16_s2_last` |
| Save last frame | `ez_glasshouse_b16_s3_last` |
| Save last frame | `ez_glasshouse_b17_s1_last` |
| Save last frame | `ez_glasshouse_b17_s2_last` |
| Save last frame | `ez_glasshouse_b17_s3_last` |
| Save last frame | `ez_glasshouse_b18_s1_last` |
| Save last frame | `ez_glasshouse_b18_s2_last` |
| Save last frame | `ez_glasshouse_b18_s3_last` |
...
**This graph:** `## films/glasshouse/act-03 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/output...`
...
**This graph:** `films/glasshouse/act-03`
...
**This graph:** `## glasshouse (storm glasshouse - Door and garden) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121...`

```text
## glasshouse (storm glasshouse - Door and garden)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Glass door | Rain outside harder | The door stays shut | A hold on the can against the door |
| 2 | Can and door | Steam fogs the glass | A wipe | The garden outside is unmarked |
| 3 | Garden | No path signs | Back to the nave | The can is set down |
| 4 | Can on flag | Storm eases a hair | Light finds copper | A last pour |
| 5 | Last pot | The last pot is a fern | Soil goes dark | The can is empty |
| 6 | Empty can | A shake | The drops hit stone | The can rests |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Rain outside harder rain, wind The ca...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. The door stays shut click, cloth The ...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. A hold on the can against the door me...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Steam fogs the glass steam, wind The ...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. A wipe cloth, tick The camera dollies...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. The garden outside is unmarked rain, ...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. No path signs rain, wind The camera p...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Back to the nave footstep, splash The...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. The can is set down metal scrape, gri...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Storm eases a hair rain, tick The cam...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. Light finds copper metal tick, wind T...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. A last pour pour, splash The camera p...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. The last pot is a fern pour, cloth Th...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. Soil goes dark water tick, grit The c...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The can is empty metal tick, scrape T...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. A shake metal tick, splash The camera...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. The drops hit stone tick, rain The ca...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. The can rests cloth, grit The camera ...` |
...
**This graph (all 18 instances):** `films/glasshouse/act-03`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_glasshouse_b13_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b13_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b13_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b14_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b14_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b14_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b15_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b15_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b15_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b16_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b16_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b16_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b17_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b17_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b17_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b18_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b18_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b18_s3_ltx_video` |
...
**This graph:** `ez_glasshouse_b12_s3_last.png`
