---
title: "films/glasshouse/act-05"
description: "One-click storm glasshouse - Night can: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film sh"
tags: [workflows, generated, comfyui, films]
---

# films/glasshouse/act-05
...
**Who this is for:** studio users who loaded `films/glasshouse/act-05` from Apps or Workflows.

> Generated from `workflows/_lab/films/glasshouse/act-05.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (storm glasshouse - Night can): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
3. The MP4 is already on disk at `${COMFY_OUTPUT_DIR}/ez_glasshouse_90s.mp4` (act graphs write `ez_glasshouse_actN_90s.mp4`). A **Film ready** overlay plays it. Copy off the Spark with scp.
4. Optional single-shot iterate: **motion/av/still-to-shot**. Optional silent rehearsal: **motion/silent/still-to-shot**.
5. Spark-farm / host stitch fallback: `./scripts/utilities/concat-shots.sh --film glasshouse --yes`
...
This graph is **act 5/5** of a 7.5 min film (90 x 5.00s). Act 5 LoadImage should be the previous act last frame (ez_glasshouse_b24_s3_last_*.png). In-graph stitch writes `ez_glasshouse_act5_90s.mp4`. After all five acts: `concat-shots.sh --film glasshouse --yes` -> `ez_glasshouse_450s.mp4`.
...
2. Load **films/glasshouse/act-05** from **Apps** or **Workflows**
...
| 900 | Save act 5 (90s MP4) - play / download | `EZFilmConcat` | 9. Publish 90s MP4 |
...
| Instance | Value |
| --- | --- |
| Positive | `A photoreal third-person still inside a botanical glasshouse. An unmarked coppe...` |
...
| b1 s1 LTX I2V | `The start image holds as the first frame. The storm has passed the ridge wind, ...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Puddles remain splash, grit The camer...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. The can sits in a puddle metal tick, ...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. A sky in the puddle wind, splash The ...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. The copper breaks the sky metal tick,...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. A hold on that break tick, rain The c...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Evening in the glass wind, steam The ...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. The can cools metal tick, grit The ca...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. No more pours cloth, tick The camera ...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. The nave empties of weather wind, clo...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. A last drip from the ridge tick, spla...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. The drip misses the can grit, rain Th...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. The drip hits stone splash, tick The ...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. The can is dry-topped metal tick, clo...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. Night at the glass wind, steam The ca...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Night glasshouse, unmarked wind, tick...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. The copper can in one lamp metal tick...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. The frame holds the can on wet flagst...` |
...
| Instance | Value |
| --- | --- |
| Save identity PNG | `ez_glasshouse_identity` |
| Save last frame | `ez_glasshouse_b25_s1_last` |
| Save last frame | `ez_glasshouse_b25_s2_last` |
| Save last frame | `ez_glasshouse_b25_s3_last` |
| Save last frame | `ez_glasshouse_b26_s1_last` |
| Save last frame | `ez_glasshouse_b26_s2_last` |
| Save last frame | `ez_glasshouse_b26_s3_last` |
| Save last frame | `ez_glasshouse_b27_s1_last` |
| Save last frame | `ez_glasshouse_b27_s2_last` |
| Save last frame | `ez_glasshouse_b27_s3_last` |
| Save last frame | `ez_glasshouse_b28_s1_last` |
| Save last frame | `ez_glasshouse_b28_s2_last` |
| Save last frame | `ez_glasshouse_b28_s3_last` |
| Save last frame | `ez_glasshouse_b29_s1_last` |
| Save last frame | `ez_glasshouse_b29_s2_last` |
| Save last frame | `ez_glasshouse_b29_s3_last` |
| Save last frame | `ez_glasshouse_b30_s1_last` |
| Save last frame | `ez_glasshouse_b30_s2_last` |
| Save last frame | `ez_glasshouse_b30_s3_last` |
...
**This graph:** `## films/glasshouse/act-05 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/output...`
...
**This graph:** `A photoreal third-person still inside a botanical glasshouse. An unmarked copper watering can sits on wet flagstone, rain already ticking the glass roof, unmarked palms and ferns, no readable signs. ...`

```text
A photoreal third-person still inside a botanical glasshouse. An unmarked copper watering can sits on wet flagstone, rain already ticking the glass roof, unmarked palms and ferns, no readable signs. Match a standing eyeline. 35mm-equivalent classic, framed for YouTube 16:9, empty of lettering, mild film grain, clean unmarked lens.
```
...
**This graph:** `films/glasshouse/act-05`
...
**This graph:** `## glasshouse (storm glasshouse - Night can) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frame...`

```text
## glasshouse (storm glasshouse - Night can)

Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8n per shot). Optional silent rehearsal: **motion/silent/still-to-shot**. Optional host stitch: `./scripts/utilities/concat-shots.sh --film glasshouse --yes`.
...
**Identity look:** A photoreal third-person still inside a botanical glasshouse. An unmarked copper watering can sits on wet flagstone, rain already ticking the glass roof, unmarked palms and ferns, no readable signs. Match a standing eyeline. 35mm-equivalent classic, framed for YouTube 16:9, empty of lettering, mild film grain, clean unmarked lens.

| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Lace | The storm has passed the ridge | Puddles remain | The can sits in a puddle |
| 2 | Puddle | A sky in the puddle | The copper breaks the sky | A hold on that break |
| 3 | Held break | Evening in the glass | The can cools | No more pours |
| 4 | Idle can | The nave empties of weather | A last drip from the ridge | The drip misses the can |
| 5 | Missed drip | The drip hits stone | The can is dry-topped | Night at the glass |
| 6 | Close | Night glasshouse, unmarked | The copper can in one lamp | The frame holds the can on wet flagstone |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. The storm has passed the ridge wind, ...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Puddles remain splash, grit The camer...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. The can sits in a puddle metal tick, ...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. A sky in the puddle wind, splash The ...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. The copper breaks the sky metal tick,...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. A hold on that break tick, rain The c...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Evening in the glass wind, steam The ...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. The can cools metal tick, grit The ca...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. No more pours cloth, tick The camera ...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. The nave empties of weather wind, clo...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. A last drip from the ridge tick, spla...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. The drip misses the can grit, rain Th...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. The drip hits stone splash, tick The ...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. The can is dry-topped metal tick, clo...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. Night at the glass wind, steam The ca...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Night glasshouse, unmarked wind, tick...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. The copper can in one lamp metal tick...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. The frame holds the can on wet flagst...` |
...
**This graph (all 18 instances):** `films/glasshouse/act-05`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_glasshouse_b25_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b25_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b25_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b26_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b26_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b26_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b27_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b27_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b27_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b28_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b28_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b28_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b29_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b29_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b29_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b30_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b30_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b30_s3_ltx_video` |
...
**This graph:** `ez_glasshouse_b24_s3_last.png`
