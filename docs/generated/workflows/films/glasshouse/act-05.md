...
This graph is **act 5/5** of a 7.5 min film (90 × 5.00s). Act 5 LoadImage should be the previous act last frame (ez_glasshouse_b24_s3_last_*.png). In-graph stitch writes `ez_glasshouse_act5_90s.mp4`. After all five acts: `concat-shots.sh --film glasshouse --yes` → `ez_glasshouse_450s.mp4`.
...
**This graph:** `## glasshouse (storm glasshouse · Night can) Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames …`

```text
## glasshouse (storm glasshouse · Night can)

Queue **once**. Klein identity still → 18 × 5.00s LTX AV prints (last-frame continuity) → **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8n per shot). Optional silent rehearsal: **motion/silent/still-to-shot**. Optional host stitch: `./scripts/utilities/concat-shots.sh --film glasshouse --yes`.
