---
title: "films/glasshouse/act-04"
description: "One-click storm glasshouse - Storm passing: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or fil"
tags: [workflows, generated, comfyui, films]
---

# films/glasshouse/act-04
...
**Who this is for:** studio users who loaded `films/glasshouse/act-04` from Apps or Workflows.

> Generated from `workflows/_lab/films/glasshouse/act-04.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (storm glasshouse - Storm passing): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 4/5** of a 7.5 min film (90 x 5.00s). Act 4 LoadImage should be the previous act last frame (ez_glasshouse_b18_s3_last_*.png). In-graph stitch writes `ez_glasshouse_act4_90s.mp4`. After all five acts: `concat-shots.sh --film glasshouse --yes` -> `ez_glasshouse_450s.mp4`.
...
2. Load **films/glasshouse/act-04** from **Apps** or **Workflows**
...
| 900 | Save act 4 (90s MP4) - play / download | `EZFilmConcat` | 9. Publish 90s MP4 |
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Rain becomes drip rain, tick The came...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Gutters somewhere pour, metal The cam...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. The nave brightens wind, cloth The ca...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Steam off flagstone steam, rain The c...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. The can is a warm coin metal tick, wi...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. A hold cloth, tick The camera dollies...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. No one else in the nave rain, wind Th...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Palms drip splash, cloth The camera p...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. The camera finds the can again metal ...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. Copper and wet stone tick, rain The c...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. A slow circle of drips splash, wind T...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. The storm is a memory rain, cloth The...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. The roof is only ticks tick, wind The...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. A birdless quiet cloth, grit The came...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The can does not move metal tick, rai...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. Light goes gold-green wind, steam The...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. Fern lace on copper cloth, tick The c...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. The shadow slides rain, metal The cam...` |
...
| Save last frame | `ez_glasshouse_b19_s1_last` |
| Save last frame | `ez_glasshouse_b19_s2_last` |
| Save last frame | `ez_glasshouse_b19_s3_last` |
| Save last frame | `ez_glasshouse_b20_s1_last` |
| Save last frame | `ez_glasshouse_b20_s2_last` |
| Save last frame | `ez_glasshouse_b20_s3_last` |
| Save last frame | `ez_glasshouse_b21_s1_last` |
| Save last frame | `ez_glasshouse_b21_s2_last` |
| Save last frame | `ez_glasshouse_b21_s3_last` |
| Save last frame | `ez_glasshouse_b22_s1_last` |
| Save last frame | `ez_glasshouse_b22_s2_last` |
| Save last frame | `ez_glasshouse_b22_s3_last` |
| Save last frame | `ez_glasshouse_b23_s1_last` |
| Save last frame | `ez_glasshouse_b23_s2_last` |
| Save last frame | `ez_glasshouse_b23_s3_last` |
| Save last frame | `ez_glasshouse_b24_s1_last` |
| Save last frame | `ez_glasshouse_b24_s2_last` |
| Save last frame | `ez_glasshouse_b24_s3_last` |
...
**This graph:** `## films/glasshouse/act-04 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/output...`
...
**This graph:** `films/glasshouse/act-04`
...
**This graph:** `## glasshouse (storm glasshouse - Storm passing) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 f...`

```text
## glasshouse (storm glasshouse - Storm passing)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Resting | Rain becomes drip | Gutters somewhere | The nave brightens |
| 2 | Bright green | Steam off flagstone | The can is a warm coin | A hold |
| 3 | Held can | No one else in the nave | Palms drip | The camera finds the can again |
| 4 | Can center | Copper and wet stone | A slow circle of drips | The storm is a memory |
| 5 | Soft rain | The roof is only ticks | A birdless quiet | The can does not move |
| 6 | Still can | Light goes gold-green | Fern lace on copper | The shadow slides |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Rain becomes drip rain, tick The came...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Gutters somewhere pour, metal The cam...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. The nave brightens wind, cloth The ca...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Steam off flagstone steam, rain The c...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. The can is a warm coin metal tick, wi...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. A hold cloth, tick The camera dollies...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. No one else in the nave rain, wind Th...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Palms drip splash, cloth The camera p...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. The camera finds the can again metal ...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. Copper and wet stone tick, rain The c...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. A slow circle of drips splash, wind T...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. The storm is a memory rain, cloth The...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. The roof is only ticks tick, wind The...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. A birdless quiet cloth, grit The came...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The can does not move metal tick, rai...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. Light goes gold-green wind, steam The...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. Fern lace on copper cloth, tick The c...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. The shadow slides rain, metal The cam...` |
...
**This graph (all 18 instances):** `films/glasshouse/act-04`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_glasshouse_b19_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b19_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b19_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b20_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b20_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b20_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b21_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b21_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b21_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b22_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b22_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b22_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b23_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b23_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b23_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b24_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b24_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_glasshouse_b24_s3_ltx_video` |
...
**This graph:** `ez_glasshouse_b18_s3_last.png`
