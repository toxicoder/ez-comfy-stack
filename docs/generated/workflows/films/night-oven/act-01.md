...
This graph is **act 1/5** of a 7.5 min film (90 x 5.00s). Act 1 starts from Klein identity. In-graph stitch writes `ez_nightoven_act1_90s.mp4`. After all five acts: `concat-shots.sh --film night-oven --yes` -> `ez_nightoven_450s.mp4`.
...
**This graph:** `## night-oven (overnight bakery - Tie the apron) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 f...`
