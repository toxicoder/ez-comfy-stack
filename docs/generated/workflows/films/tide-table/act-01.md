---
title: "films/tide-table/act-01"
description: "One-click dawn skiff - Launch from the hard: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or fi"
tags: [workflows, generated, comfyui, films]
---

# films/tide-table/act-01
...
**Who this is for:** studio users who loaded `films/tide-table/act-01` from Apps or Workflows.

> Generated from `workflows/_lab/films/tide-table/act-01.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (dawn skiff - Launch from the hard): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 1/5** of a 7.5 min film (90 x 5.00s). Act 1 starts from Klein identity. In-graph stitch writes `ez_tidetable_act1_90s.mp4`. After all five acts: `concat-shots.sh --film tide-table --yes` -> `ez_tidetable_450s.mp4`.
...
2. Load **films/tide-table/act-01** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. Hands untie the painter from a wet ri...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. The skiff is pushed off the stone hul...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. The bow clears the last pile water sp...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. The skiff noses into slack water hull...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. Oarlocks creak on a slow pull wood cr...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. The bow aims at a dark pool water tic...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. The hull kisses a rock shelf gravel s...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. A look down into unmarked weed water ...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. The bow slides along the shelf hull k...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. The skiff tracks the wet granite wind...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. A drip from the gunwale water tick, c...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. The bow enters the slot hull scrape, ...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Mist takes the far piles wind, water ...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. The bow holds a compass heading cloth...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The spar slides past wood creak, spla...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. The hard vanishes astern wind, water ...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. A slow pull in the fog creak, splash ...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. The bow finds a wider pool hull tick,...` |
...
| Save last frame | `ez_tidetable_b1_s1_last` |
| Save last frame | `ez_tidetable_b1_s2_last` |
| Save last frame | `ez_tidetable_b1_s3_last` |
| Save last frame | `ez_tidetable_b2_s1_last` |
| Save last frame | `ez_tidetable_b2_s2_last` |
| Save last frame | `ez_tidetable_b2_s3_last` |
| Save last frame | `ez_tidetable_b3_s1_last` |
| Save last frame | `ez_tidetable_b3_s2_last` |
| Save last frame | `ez_tidetable_b3_s3_last` |
| Save last frame | `ez_tidetable_b4_s1_last` |
| Save last frame | `ez_tidetable_b4_s2_last` |
| Save last frame | `ez_tidetable_b4_s3_last` |
| Save last frame | `ez_tidetable_b5_s1_last` |
| Save last frame | `ez_tidetable_b5_s2_last` |
| Save last frame | `ez_tidetable_b5_s3_last` |
| Save last frame | `ez_tidetable_b6_s1_last` |
| Save last frame | `ez_tidetable_b6_s2_last` |
| Save last frame | `ez_tidetable_b6_s3_last` |
...
**This graph:** `## films/tide-table/act-01 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/output...`
...
**This graph:** `films/tide-table/act-01`
...
**This graph:** `## tide-table (dawn skiff - Launch from the hard) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 ...`

```text
## tide-table (dawn skiff - Launch from the hard)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | The hard | Hands untie the painter from a wet ring | The skiff is pushed off the stone | The bow clears the last pile |
| 2 | The cut | The skiff noses into slack water | Oarlocks creak on a slow pull | The bow aims at a dark pool |
| 3 | First pool | The hull kisses a rock shelf | A look down into unmarked weed | The bow slides along the shelf |
| 4 | Shelf walk | The skiff tracks the wet granite | A drip from the gunwale | The bow enters the slot |
| 5 | Fog edge | Mist takes the far piles | The bow holds a compass heading | The spar slides past |
| 6 | Lost shore | The hard vanishes astern | A slow pull in the fog | The bow finds a wider pool |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. Hands untie the painter from a wet ri...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. The skiff is pushed off the stone hul...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. The bow clears the last pile water sp...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. The skiff noses into slack water hull...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. Oarlocks creak on a slow pull wood cr...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. The bow aims at a dark pool water tic...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. The hull kisses a rock shelf gravel s...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. A look down into unmarked weed water ...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. The bow slides along the shelf hull k...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. The skiff tracks the wet granite wind...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. A drip from the gunwale water tick, c...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. The bow enters the slot hull scrape, ...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Mist takes the far piles wind, water ...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. The bow holds a compass heading cloth...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The spar slides past wood creak, spla...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. The hard vanishes astern wind, water ...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. A slow pull in the fog creak, splash ...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. The bow finds a wider pool hull tick,...` |
...
**This graph (all 18 instances):** `films/tide-table/act-01`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_tidetable_b1_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b1_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b1_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b2_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b2_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b2_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b3_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b3_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b3_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b4_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b4_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b4_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b5_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b5_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b5_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b6_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b6_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b6_s3_ltx_video` |
