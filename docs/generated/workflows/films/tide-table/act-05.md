---
title: "films/tide-table/act-05"
description: "One-click dawn skiff - Night on the bow: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film s"
tags: [workflows, generated, comfyui, films]
---

# films/tide-table/act-05
...
**Who this is for:** studio users who loaded `films/tide-table/act-05` from Apps or Workflows.

> Generated from `workflows/_lab/films/tide-table/act-05.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (dawn skiff - Night on the bow): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 5/5** of a 7.5 min film (90 x 5.00s). Act 5 LoadImage should be the previous act last frame (ez_tidetable_b24_s3_last_*.png). In-graph stitch writes `ez_tidetable_act5_90s.mp4`. After all five acts: `concat-shots.sh --film tide-table --yes` -> `ez_tidetable_450s.mp4`.
...
2. Load **films/tide-table/act-05** from **Apps** or **Workflows**
...
| b1 s1 LTX I2V | `The start image holds as the first frame. The blank painter coil fills the fram...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. A drip from the coil water tick, spla...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. The drip hits stone grit, metal click...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. The splash dies water tick, wind The ...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. The hard is empty grit, cloth The cam...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. The skiff is a dark shape hull knock,...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Night takes the cut wind, splash The ...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. The bow is a silhouette hull tick, cl...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. A last hull knock wood creak, water t...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. The unmarked skiff waits wind, cloth ...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. No oar, no voice water tick, grit The...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. The camera holds until the frame is s...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Dawn is gone; the plate is night wind...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. The ring glints once metal click, clo...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The glint dies grit, splash The camer...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. The weathered unmarked bow in night h...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. A final hold on wet grain cloth, wate...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. The frame holds and does not cut wood...` |
...
| Save last frame | `ez_tidetable_b25_s1_last` |
| Save last frame | `ez_tidetable_b25_s2_last` |
| Save last frame | `ez_tidetable_b25_s3_last` |
| Save last frame | `ez_tidetable_b26_s1_last` |
| Save last frame | `ez_tidetable_b26_s2_last` |
| Save last frame | `ez_tidetable_b26_s3_last` |
| Save last frame | `ez_tidetable_b27_s1_last` |
| Save last frame | `ez_tidetable_b27_s2_last` |
| Save last frame | `ez_tidetable_b27_s3_last` |
| Save last frame | `ez_tidetable_b28_s1_last` |
| Save last frame | `ez_tidetable_b28_s2_last` |
| Save last frame | `ez_tidetable_b28_s3_last` |
| Save last frame | `ez_tidetable_b29_s1_last` |
| Save last frame | `ez_tidetable_b29_s2_last` |
| Save last frame | `ez_tidetable_b29_s3_last` |
| Save last frame | `ez_tidetable_b30_s1_last` |
| Save last frame | `ez_tidetable_b30_s2_last` |
| Save last frame | `ez_tidetable_b30_s3_last` |
...
**This graph:** `## films/tide-table/act-05 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/output...`
...
**This graph:** `films/tide-table/act-05`
...
**This graph:** `## tide-table (dawn skiff - Night on the bow) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 fram...`

```text
## tide-table (dawn skiff - Night on the bow)
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Coil | The blank painter coil fills the frame | A drip from the coil | The drip hits stone |
| 2 | Stone splash | The splash dies | The hard is empty | The skiff is a dark shape |
| 3 | Dark shape | Night takes the cut | The bow is a silhouette | A last hull knock |
| 4 | Silence | The unmarked skiff waits | No oar, no voice | The camera holds until the frame is still |
| 5 | Still frame | Dawn is gone; the plate is night | The ring glints once | The glint dies |
| 6 | Close | The weathered unmarked bow in night | A final hold on wet grain | The frame holds and does not cut |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. The blank painter coil fills the fram...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. A drip from the coil water tick, spla...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. The drip hits stone grit, metal click...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. The splash dies water tick, wind The ...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. The hard is empty grit, cloth The cam...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. The skiff is a dark shape hull knock,...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Night takes the cut wind, splash The ...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. The bow is a silhouette hull tick, cl...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. A last hull knock wood creak, water t...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. The unmarked skiff waits wind, cloth ...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. No oar, no voice water tick, grit The...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. The camera holds until the frame is s...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Dawn is gone; the plate is night wind...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. The ring glints once metal click, clo...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The glint dies grit, splash The camer...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. The weathered unmarked bow in night h...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. A final hold on wet grain cloth, wate...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. The frame holds and does not cut wood...` |
...
**This graph (all 18 instances):** `films/tide-table/act-05`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_tidetable_b25_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b25_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b25_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b26_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b26_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b26_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b27_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b27_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b27_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b28_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b28_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b28_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b29_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b29_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b29_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b30_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b30_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b30_s3_ltx_video` |
...
**This graph:** `ez_tidetable_b24_s3_last.png`
