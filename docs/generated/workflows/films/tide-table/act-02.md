---
title: "films/tide-table/act-02"
description: "One-click dawn skiff - Tide tables: 18 LTX 5.00s AV shots + stitch Prompt enhance is **off** so authored text (recipe, script labels, ACE tags, or film shots)"
tags: [workflows, generated, comfyui, films]
---

# films/tide-table/act-02
...
**Who this is for:** studio users who loaded `films/tide-table/act-02` from Apps or Workflows.

> Generated from `workflows/_lab/films/tide-table/act-02.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
One-click 90s unit (dawn skiff - Tide tables): Klein identity still + 18 sequential LTX 5.00s AV prints + in-graph stitch.
...
This graph is **act 2/5** of a 7.5 min film (90 x 5.00s). Act 2 LoadImage should be the previous act last frame (ez_tidetable_b6_s3_last_*.png). In-graph stitch writes `ez_tidetable_act2_90s.mp4`. After all five acts: `concat-shots.sh --film tide-table --yes` -> `ez_tidetable_450s.mp4`.
...
2. Load **films/tide-table/act-02** from **Apps** or **Workflows**
...
| 52 | tide-table 90s shot map | `MarkdownNote` | 2. LTX models |
...
| b1 s1 LTX I2V | `The start image holds as the first frame. The skiff grounds on a wet table grav...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Hands hold the thwart cloth, wood cre...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. The bow points at a second table wind...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. A look into a clear unmarked pool wat...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. A drip rings the pool splash, tick Th...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. The bow lifts on a swell hull knock, ...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. A pale sun bar finds the thwart wind,...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Steam of cold water in sun steam, spl...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. The skiff slides off the table gravel...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. The cut opens to a wider reach wind, ...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. A long pull creak, water tick The cam...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. The bow aims at the spit hull knock, ...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. The hull kisses spit gravel gravel sc...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. A walk of the eye along the spit wind...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The bow turns for home hull tick, cre...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. The skiff comes about in slack splash...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. The coil sits wet on the thwart cloth...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. The bow takes the lane wind, hull kno...` |
...
| Save last frame | `ez_tidetable_b7_s1_last` |
| Save last frame | `ez_tidetable_b7_s2_last` |
| Save last frame | `ez_tidetable_b7_s3_last` |
| Save last frame | `ez_tidetable_b8_s1_last` |
| Save last frame | `ez_tidetable_b8_s2_last` |
| Save last frame | `ez_tidetable_b8_s3_last` |
| Save last frame | `ez_tidetable_b9_s1_last` |
| Save last frame | `ez_tidetable_b9_s2_last` |
| Save last frame | `ez_tidetable_b9_s3_last` |
| Save last frame | `ez_tidetable_b10_s1_last` |
| Save last frame | `ez_tidetable_b10_s2_last` |
| Save last frame | `ez_tidetable_b10_s3_last` |
| Save last frame | `ez_tidetable_b11_s1_last` |
| Save last frame | `ez_tidetable_b11_s2_last` |
| Save last frame | `ez_tidetable_b11_s3_last` |
| Save last frame | `ez_tidetable_b12_s1_last` |
| Save last frame | `ez_tidetable_b12_s2_last` |
| Save last frame | `ez_tidetable_b12_s3_last` |
...
**This graph:** `## films/tide-table/act-02 LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/output...`
...
**This graph:** `films/tide-table/act-02`
...
**This graph:** `## tide-table (dawn skiff - Tide tables) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = ...`

```text
## tide-table (dawn skiff - Tide tables)

Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8n per shot). Optional silent rehearsal: **motion/silent/still-to-shot**. Optional host stitch: `./scripts/utilities/concat-shots.sh --film tide-table --yes`.
...
| Beat | Place | s1 | s2 | s3 |
| --- | --- | --- | --- | --- |
| 1 | Tide table | The skiff grounds on a wet table | Hands hold the thwart | The bow points at a second table |
| 2 | Macro pool | A look into a clear unmarked pool | A drip rings the pool | The bow lifts on a swell |
| 3 | Light leak | A pale sun bar finds the thwart | Steam of cold water in sun | The skiff slides off the table |
| 4 | Channel | The cut opens to a wider reach | A long pull | The bow aims at the spit |
| 5 | Spit | The hull kisses spit gravel | A walk of the eye along the spit | The bow turns for home |
| 6 | Turn | The skiff comes about in slack | The coil sits wet on the thwart | The bow takes the lane |
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. The skiff grounds on a wet table grav...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Hands hold the thwart cloth, wood cre...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. The bow points at a second table wind...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. A look into a clear unmarked pool wat...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. A drip rings the pool splash, tick Th...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. The bow lifts on a swell hull knock, ...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. A pale sun bar finds the thwart wind,...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Steam of cold water in sun steam, spl...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. The skiff slides off the table gravel...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. The cut opens to a wider reach wind, ...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. A long pull creak, water tick The cam...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. The bow aims at the spit hull knock, ...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. The hull kisses spit gravel gravel sc...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. A walk of the eye along the spit wind...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The bow turns for home hull tick, cre...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. The skiff comes about in slack splash...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. The coil sits wet on the thwart cloth...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. The bow takes the lane wind, hull kno...` |
...
**This graph (all 18 instances):** `films/tide-table/act-02`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_tidetable_b7_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b7_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b7_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b8_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b8_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b8_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b9_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b9_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b9_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b10_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b10_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b10_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b11_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b11_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b11_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b12_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b12_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_tidetable_b12_s3_ltx_video` |
...
**This graph:** `ez_tidetable_b6_s3_last.png`
