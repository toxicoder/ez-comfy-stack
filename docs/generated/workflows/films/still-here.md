...
**Who this is for:** studio users who loaded `films/still-here` from Apps or Workflows.

> Generated from `workflows/_lab/films/still-here.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **films/still-here** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `A photoreal third-person household morning still. One cream ceramic mug with a ...` |
...
| b1 s1 LTX I2V | `The start image holds as the first frame. In the unmarked kitchen at first ligh...` |
| b1 s2 LTX I2V | `The start image holds as the first frame. Unmarked hands pour into the chipped ...` |
| b1 s3 LTX I2V | `The start image holds as the first frame. The mug sits full on honey oak. From ...` |
| b2 s1 LTX I2V | `The start image holds as the first frame. Steam climbs from the chipped mug on ...` |
| b2 s2 LTX I2V | `The start image holds as the first frame. The invented two-note hum comes close...` |
| b2 s3 LTX I2V | `The start image holds as the first frame. The camera finds the doorway while th...` |
| b3 s1 LTX I2V | `The start image holds as the first frame. Adult hands wrap the chipped cream mu...` |
| b3 s2 LTX I2V | `The start image holds as the first frame. Hands keep the mug while the off-scre...` |
| b3 s3 LTX I2V | `The start image holds as the first frame. Hands and mug, steam thinning, identi...` |
| b4 s1 LTX I2V | `The start image holds as the first frame. The third-person camera follows into ...` |
| b4 s2 LTX I2V | `The start image holds as the first frame. The invented motif is closer; a silho...` |
| b4 s3 LTX I2V | `The start image holds as the first frame. Sun bar, doorway silhouette, cloth sh...` |
| b5 s1 LTX I2V | `The start image holds as the first frame. Third-person doorway: a small silhoue...` |
| b5 s2 LTX I2V | `The start image holds as the first frame. The silhouette turns toward morning l...` |
| b5 s3 LTX I2V | `The start image holds as the first frame. The camera pulls back toward the tabl...` |
| b6 s1 LTX I2V | `The start image holds as the first frame. The chipped cream mug sits on the tab...` |
| b6 s2 LTX I2V | `The start image holds as the first frame. The invented hum fades to one last of...` |
| b6 s3 LTX I2V | `The start image holds as the first frame. Hold on the mug, the empty chair, and...` |
...
| Instance | Value |
| --- | --- |
| Save identity PNG | `ez_stillhere_identity` |
| Save last frame | `ez_stillhere_b1_s1_last` |
| Save last frame | `ez_stillhere_b1_s2_last` |
| Save last frame | `ez_stillhere_b1_s3_last` |
| Save last frame | `ez_stillhere_b2_s1_last` |
| Save last frame | `ez_stillhere_b2_s2_last` |
| Save last frame | `ez_stillhere_b2_s3_last` |
| Save last frame | `ez_stillhere_b3_s1_last` |
| Save last frame | `ez_stillhere_b3_s2_last` |
| Save last frame | `ez_stillhere_b3_s3_last` |
| Save last frame | `ez_stillhere_b4_s1_last` |
| Save last frame | `ez_stillhere_b4_s2_last` |
| Save last frame | `ez_stillhere_b4_s3_last` |
| Save last frame | `ez_stillhere_b5_s1_last` |
| Save last frame | `ez_stillhere_b5_s2_last` |
| Save last frame | `ez_stillhere_b5_s3_last` |
| Save last frame | `ez_stillhere_b6_s1_last` |
| Save last frame | `ez_stillhere_b6_s2_last` |
| Save last frame | `ez_stillhere_b6_s3_last` |
...
**This graph:** `## films/still-here LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). The stitched MP4 is written automatically to `${COMFY_OUTPUT_DIR}` (container `/outputs`) as ...`
...
**This graph:** `## still-here (household morning) Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8n pe...`

```text
## still-here (household morning)

Queue **once**. Klein identity still -> 18 x 5.00s LTX AV prints (last-frame continuity) -> **Save 90s film (MP4)**. Do not Queue a 90s denoise (121 frames = 1+8n per shot). Optional silent rehearsal: **motion/silent/still-to-shot**. Optional host stitch: `./scripts/utilities/concat-shots.sh --film still-here --yes`.
...
| Instance | Value |
| --- | --- |
| b1 s1 LTX I2V enhance | `The start image holds as the first frame. In the unmarked kitchen at first ligh...` |
| b1 s2 LTX I2V enhance | `The start image holds as the first frame. Unmarked hands pour into the chipped ...` |
| b1 s3 LTX I2V enhance | `The start image holds as the first frame. The mug sits full on honey oak. From ...` |
| b2 s1 LTX I2V enhance | `The start image holds as the first frame. Steam climbs from the chipped mug on ...` |
| b2 s2 LTX I2V enhance | `The start image holds as the first frame. The invented two-note hum comes close...` |
| b2 s3 LTX I2V enhance | `The start image holds as the first frame. The camera finds the doorway while th...` |
| b3 s1 LTX I2V enhance | `The start image holds as the first frame. Adult hands wrap the chipped cream mu...` |
| b3 s2 LTX I2V enhance | `The start image holds as the first frame. Hands keep the mug while the off-scre...` |
| b3 s3 LTX I2V enhance | `The start image holds as the first frame. Hands and mug, steam thinning, identi...` |
| b4 s1 LTX I2V enhance | `The start image holds as the first frame. The third-person camera follows into ...` |
| b4 s2 LTX I2V enhance | `The start image holds as the first frame. The invented motif is closer; a silho...` |
| b4 s3 LTX I2V enhance | `The start image holds as the first frame. Sun bar, doorway silhouette, cloth sh...` |
| b5 s1 LTX I2V enhance | `The start image holds as the first frame. Third-person doorway: a small silhoue...` |
| b5 s2 LTX I2V enhance | `The start image holds as the first frame. The silhouette turns toward morning l...` |
| b5 s3 LTX I2V enhance | `The start image holds as the first frame. The camera pulls back toward the tabl...` |
| b6 s1 LTX I2V enhance | `The start image holds as the first frame. The chipped cream mug sits on the tab...` |
| b6 s2 LTX I2V enhance | `The start image holds as the first frame. The invented hum fades to one last of...` |
| b6 s3 LTX I2V enhance | `The start image holds as the first frame. Hold on the mug, the empty chair, and...` |
...
**This graph (all 18 instances):** `films/still-here`
...
| Instance | Value |
| --- | --- |
| Save video (MP4) - open node for preview | `ez_stillhere_b1_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b1_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b1_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b2_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b2_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b2_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b3_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b3_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b3_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b4_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b4_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b4_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b5_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b5_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b5_s3_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b6_s1_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b6_s2_ltx_video` |
| Save video (MP4) - open node for preview | `ez_stillhere_b6_s3_ltx_video` |
