...
**This graph:** `## ltx/shorts-still-5s Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LTX canvas 768x1280 (width/height must be divisible by 32; 720 and 1080 are invalid). …`
