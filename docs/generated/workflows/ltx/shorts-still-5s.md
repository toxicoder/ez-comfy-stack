...
**Who this is for:** studio users who loaded `ltx/shorts-still-5s` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/shorts-still-5s.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **ltx/shorts-still-5s** from **Apps** or **Workflows**
...
**This graph:** `## ltx/shorts-still-5s LTX canvas 768x1280 (width/height must be divisible by 32; 720 and 1080 are invalid). Vertical AV Shorts I2V (~5 s). LTX-2.5 distilled. Community License — not Apache. $10M cap…`
...
**This graph:** `ltx/shorts-still-5s`
