...
**Who this is for:** studio users who loaded `ltx/flf-5s` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/flf-5s.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **ltx/flf-5s** from **Apps** or **Workflows**
...
**This graph:** `## ltx/flf-5s LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). After Queue, click **Save video (MP4) — open node for preview** for an inline preview. File lands o…`
