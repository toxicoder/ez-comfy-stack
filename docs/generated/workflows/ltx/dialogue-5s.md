...
**Who this is for:** studio users who loaded `ltx/dialogue-5s` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/dialogue-5s.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **ltx/dialogue-5s** from **Apps** or **Workflows**
...
**This graph:** `## ltx/dialogue-5s Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). Afte…`
