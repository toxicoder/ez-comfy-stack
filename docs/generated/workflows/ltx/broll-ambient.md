...
**Who this is for:** studio users who loaded `ltx/broll-ambient` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/broll-ambient.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **ltx/broll-ambient** from **Apps** or **Workflows**
...
**This graph:** `## ltx/broll-ambient LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). Ambient B-roll AV plate (~5 s T2V). LTX-2.5 distilled. Community License — not Apache. Locke…`
