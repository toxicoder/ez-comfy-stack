...
**This graph:** `## ltx/weather-broll LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). Weather B-roll AV (~5 s T2V). LTX-2.5 distilled. Community License — not Apache. Prefix `ez_…`
