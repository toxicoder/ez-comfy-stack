...
**This graph:** `## ltx/creator/interior-walk Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Interior walk-through AV ~5 s. Lab size **1280×704**. Prefix `ez_walk`. Empty of…`
