...
**Who this is for:** studio users who loaded `ltx/creator/youtube-outro-av` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/youtube-outro-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
YouTube outro AV ~5 s with room tone. Lab size **1280×704**. Prefix `ez_yt_outro`.
...
2. Load **ltx/creator/youtube-outro-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Locked-camera outro. Room tone, a chair creak, distant city. No score. Five sec…` |
...
**This graph:** `## ltx/creator/youtube-outro-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube outro AV ~5 s with room tone. Lab size **1280×704**. Prefix `ez_yt_ou…`
...
**This graph:** `Locked-camera outro. Room tone, a chair creak, distant city. No score. Five seconds.`
...
**This graph:** `ltx/creator/youtube-outro-av`
