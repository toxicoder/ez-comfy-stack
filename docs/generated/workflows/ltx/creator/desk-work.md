...
**Who this is for:** studio users who loaded `ltx/creator/desk-work` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/desk-work.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Desk / keyboard room-tone AV ~5 s. Lab size **1280×704**. Prefix `ez_desk_av`.
...
2. Load **ltx/creator/desk-work** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Locked desk. Soft keycaps, a mug set down. No score. Five seconds.` |
...
**This graph:** `## ltx/creator/desk-work Desk / keyboard room-tone AV ~5 s. Lab size **1280×704**. Prefix `ez_desk_av`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: ltx — stop Wan, po…`
...
**This graph:** `Locked desk. Soft keycaps, a mug set down. No score. Five seconds.`
...
**This graph:** `ltx/creator/desk-work`
