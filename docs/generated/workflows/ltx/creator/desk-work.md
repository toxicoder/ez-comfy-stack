...
**This graph:** `## ltx/creator/desk-work Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Desk / keyboard room-tone AV ~5 s. Lab size **1280×704**. Prefix `ez_desk_av`. Empty…`
