...
**This graph:** `## ltx/creator/podcast-set Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Podcast-set AV ~5 s. Lab size **1280×704**. Prefix `ez_pod_set`. Empty of letterin…`
