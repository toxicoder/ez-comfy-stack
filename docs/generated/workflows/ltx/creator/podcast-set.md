...
**Who this is for:** studio users who loaded `ltx/creator/podcast-set` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/podcast-set.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Podcast-set AV ~5 s. Lab size **1280×704**. Prefix `ez_pod_set`.
...
2. Load **ltx/creator/podcast-set** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Two unmarked mics on oak. Room tone, a chair. No score. Five seconds.` |
...
**This graph:** `## ltx/creator/podcast-set Podcast-set AV ~5 s. Lab size **1280×704**. Prefix `ez_pod_set`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: ltx — stop Wan, podcast, music…`
...
**This graph:** `Two unmarked mics on oak. Room tone, a chair. No score. Five seconds.`
...
**This graph:** `ltx/creator/podcast-set`
