...
**This graph:** `## ltx/creator/music-visual Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Light / particle visualizer bed AV ~5 s. Lab size **1280×704**. Prefix `ez_music_…`
