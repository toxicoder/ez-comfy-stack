...
**Who this is for:** studio users who loaded `ltx/creator/music-visual` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/music-visual.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Light / particle visualizer bed AV ~5 s. Lab size **1280×704**. Prefix `ez_music_vis`.
...
2. Load **ltx/creator/music-visual** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Abstract warm particles over a dark unmarked set. Soft fizz, no score, no lyric…` |
...
**This graph:** `## ltx/creator/music-visual Light / particle visualizer bed AV ~5 s. Lab size **1280×704**. Prefix `ez_music_vis`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: ltx — s…`
...
**This graph:** `Abstract warm particles over a dark unmarked set. Soft fizz, no score, no lyrics.`
...
**This graph:** `ltx/creator/music-visual`
