...
**This graph:** `## ltx/creator/workshop-tools Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Workshop tools AV ~5 s. Lab size **1280×704**. Prefix `ez_tools`. Empty of lett…`
