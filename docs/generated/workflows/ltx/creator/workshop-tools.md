---
title: ltx/creator/workshop-tools
description: Workshop tools AV ~5 s
tags: [workflows, generated, comfyui, ltx]
---

# ltx/creator/workshop-tools
...
**Who this is for:** studio users who loaded `ltx/creator/workshop-tools` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/workshop-tools.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Workshop tools AV ~5 s. Lab size **1280×704**. Prefix `ez_tools`.
...
2. Load **ltx/creator/workshop-tools** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Unmarked hand tools on a bench. Soft clink, wood. No score. Five seconds.` |
...
**This graph:** `## ltx/creator/workshop-tools Workshop tools AV ~5 s. Lab size **1280×704**. Prefix `ez_tools`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: ltx — stop Wan, podcast, m…`
...
**This graph:** `Unmarked hand tools on a bench. Soft clink, wood. No score. Five seconds.`
...
**This graph:** `ltx/creator/workshop-tools`
