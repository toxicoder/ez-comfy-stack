...
**Who this is for:** studio users who loaded `ltx/creator/crowd-ambience` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/crowd-ambience.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Distant crowd bed AV ~5 s. Lab size **1280×704**. Prefix `ez_crowd`.
...
2. Load **ltx/creator/crowd-ambience** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Distant unmarked crowd under a terrace. Murmur, no score. Five seconds.` |
...
**This graph:** `## ltx/creator/crowd-ambience Distant crowd bed AV ~5 s. Lab size **1280×704**. Prefix `ez_crowd`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: ltx — stop Wan, podcast…`
...
**This graph:** `Distant unmarked crowd under a terrace. Murmur, no score. Five seconds.`
...
**This graph:** `ltx/creator/crowd-ambience`
