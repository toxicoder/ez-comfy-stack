---
title: ltx/creator/tiktok-broll
...
**Who this is for:** studio users who loaded `ltx/creator/tiktok-broll` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/tiktok-broll.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **ltx/creator/tiktok-broll** from **Apps** or **Workflows**
...
**This graph:** `ltx/creator/tiktok-broll`
