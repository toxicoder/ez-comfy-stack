...
**Who this is for:** studio users who loaded `ltx/creator/workout-rep` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/workout-rep.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **ltx/creator/workout-rep** from **Apps** or **Workflows**
...
**This graph:** `## ltx/creator/workout-rep One exercise-rep AV 9:16. Lab size **768×1280**. Prefix `ez_rep`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: ltx — stop Wan, podcast, musi…`
...
**This graph:** `ltx/creator/workout-rep`
