...
**Who this is for:** studio users who loaded `ltx/creator/instagram-reel-lifestyle` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/instagram-reel-lifestyle.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **ltx/creator/instagram-reel-lifestyle** from **Apps** or **Workflows**
...
**This graph:** `## ltx/creator/instagram-reel-lifestyle Instagram lifestyle reel AV 9:16. Lab size **768×1280**. Prefix `ez_ig_reel_av`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: l…`
...
**This graph:** `ltx/creator/instagram-reel-lifestyle`
