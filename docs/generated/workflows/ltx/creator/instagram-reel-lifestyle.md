...
**This graph:** `## ltx/creator/instagram-reel-lifestyle Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram lifestyle reel AV 9:16. Lab size **768×1280**. Prefix `ez_i…`
