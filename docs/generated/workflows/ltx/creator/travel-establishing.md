...
**Who this is for:** studio users who loaded `ltx/creator/travel-establishing` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/travel-establishing.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Travel establishing AV ~5 s. Lab size **1280×704**. Prefix `ez_travel`.
...
2. Load **ltx/creator/travel-establishing** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Slow establishing of a coastal city terrace. Wind, distant traffic. No score.` |
...
**This graph:** `## ltx/creator/travel-establishing Travel establishing AV ~5 s. Lab size **1280×704**. Prefix `ez_travel`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: ltx — stop Wan,…`
...
**This graph:** `Slow establishing of a coastal city terrace. Wind, distant traffic. No score.`
...
**This graph:** `wind, distant traffic, no score`
...
**This graph:** `ltx/creator/travel-establishing`
