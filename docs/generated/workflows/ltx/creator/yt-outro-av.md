...
**Who this is for:** studio users who loaded `ltx/creator/yt-outro-av` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/yt-outro-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **ltx/creator/yt-outro-av** from **Apps** or **Workflows**
...
**This graph:** `## ltx/creator/yt-outro-av YouTube outro AV ~5 s with room tone. Lab size **1280×704**. Prefix `ez_yt_outro`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: ltx — stop W…`
...
**This graph:** `ltx/creator/yt-outro-av`
