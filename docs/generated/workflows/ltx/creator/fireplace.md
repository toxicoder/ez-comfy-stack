...
**Who this is for:** studio users who loaded `ltx/creator/fireplace` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/fireplace.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Fireplace AV ~5 s. Lab size **1280×704**. Prefix `ez_fire`.
...
2. Load **ltx/creator/fireplace** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `A small unmarked fireplace. Soft crackle. No score. Five seconds.` |
...
**This graph:** `## ltx/creator/fireplace Fireplace AV ~5 s. Lab size **1280×704**. Prefix `ez_fire`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: ltx — stop Wan, podcast, music, other…`
...
**This graph:** `A small unmarked fireplace. Soft crackle. No score. Five seconds.`
...
**This graph:** `ltx/creator/fireplace`
