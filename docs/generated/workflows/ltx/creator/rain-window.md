...
**This graph:** `## ltx/creator/rain-window Rain-on-glass AV ~5 s. Lab size **1280×704**. Prefix `ez_rain`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: ltx — stop Wan, podcast, music,…`
