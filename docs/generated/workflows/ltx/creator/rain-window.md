...
**Who this is for:** studio users who loaded `ltx/creator/rain-window` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/creator/rain-window.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Rain-on-glass AV ~5 s. Lab size **1280×704**. Prefix `ez_rain`.
...
2. Load **ltx/creator/rain-window** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Rain on a dark window. Drops, distant thunder hush. No score. Five seconds.` |
...
**This graph:** `## ltx/creator/rain-window Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Rain-on-glass AV ~5 s. Lab size **1280×704**. Prefix `ez_rain`. Empty of lettering…`
...
**This graph:** `Rain on a dark window. Drops, distant thunder hush. No score. Five seconds.`
...
**This graph:** `ltx/creator/rain-window`
