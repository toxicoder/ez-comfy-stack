...
**Who this is for:** studio users who loaded `ltx/interior-ambience` from Apps or Workflows.

> Generated from `workflows/_lab/ltx/interior-ambience.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **ltx/interior-ambience** from **Apps** or **Workflows**
...
**This graph:** `## ltx/interior-ambience Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid)…`
...
**This graph:** `ltx/interior-ambience`
