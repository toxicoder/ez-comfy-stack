...
**This graph:** `## ltx/hook-av LTX canvas 1280x704 (width/height must be divisible by 32; 720 and 1080 are invalid). ~5 s AV cold-open / hook (LTX-2.5 T2V). Community License — not Apache. Prefix `ez_hook_video`. Pa…`
