...
**Who this is for:** studio users who loaded `klein/character-tweak` from Apps or Workflows.

> Generated from `workflows/_lab/klein/character-tweak.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/character-tweak** from **Apps** or **Workflows**
...
| 9 | Save tweak | `SaveImage` | Ungrouped |
| 10 | Operator note | `Note` | Ungrouped |
| 11 | Character still (ez_character_*.png) | `LoadImage` | Ungrouped |
| 12 | Klein Prompt Enhance (edit) | `EZKleinPromptEnhance` | Ungrouped |
| 13 | Encode character plate | `VAEEncode` | Ungrouped |
| 14 | Positive + character plate | `ReferenceLatent` | Ungrouped |
...
**This graph:** `## klein/character-tweak Klein 4B **edit** of a character still. LoadImage: `ez_character_*.png` from Character Draft (or any Klein still). Prompt only the change. Enhance **edit**. Style restyles me…`
...
**This graph:** `klein/character-tweak`
