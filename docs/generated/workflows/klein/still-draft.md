...
**This graph:** `## klein/still-draft Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. First-run Klein 4B still (Apache 2.0 distilled FP8). Models: flux-2-klein-4b-fp8.safeten…`
