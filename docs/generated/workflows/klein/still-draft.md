...
**Who this is for:** studio users who loaded `klein/still-draft` from Apps or Workflows.

> Generated from `workflows/_lab/klein/still-draft.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
First-run Klein 4B still (Apache 2.0 distilled FP8).
Models: flux-2-klein-4b-fp8.safetensors + qwen_3_4b.safetensors (CLIP type flux2) + flux2-vae.safetensors.
Widgets: seed 42 fixed · CFG 1.0 · 4 steps · 768x432 · batch 2.
SaveImage prefix: ez_still_draft.

Queue this first. Then open klein/still-hero with the same seed for 1280x720.
Aspect widgets: YouTube 16:9 default; Shorts 9:16 = 432x768; 1:1 = 768x768.
...
| 6 | Latent 768x432 batch 2 | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `## klein/still-draft First-run Klein 4B still (Apache 2.0 distilled FP8). Models: flux-2-klein-4b-fp8.safetensors + qwen_3_4b.safetensors (CLIP type flux2) + flux2-vae.safetensors. Widgets: seed 42 f…`
