...
**This graph:** `## klein/product-packshot Clean product / packshot still (Klein 4B). Default 1024×1024. Prefix `ez_packshot`. Swap the subject in the prompt; keep seamless background and soft studio light. Occupancy…`
