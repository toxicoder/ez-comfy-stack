...
**Who this is for:** studio users who loaded `klein/ig-square` from Apps or Workflows.

> Generated from `workflows/_lab/klein/ig-square.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/ig-square** from **Apps** or **Workflows**
...
| 6 | Size 1:1 Instagram | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `## klein/ig-square Generic Instagram 1:1 still (Klein 4B). Default 1024×1024. Prefix `ez_ig_square`. Edit the prompt for any feed post. Occupancy: klein — stop Wan, LTX, podcast, music. One GB10 job.…`
