...
**This graph:** `## klein/still-hero Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. HD Klein 4B still (Apache 2.0 distilled FP8). Same prompt and seed as klein/still-draft. …`
