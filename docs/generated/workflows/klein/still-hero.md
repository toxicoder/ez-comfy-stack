...
**Who this is for:** studio users who loaded `klein/still-hero` from Apps or Workflows.

> Generated from `workflows/_lab/klein/still-hero.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
HD Klein 4B still (Apache 2.0 distilled FP8). Same prompt and seed as klein/still-draft.
...
Feed ez_still_hero_*.png into wan/still-to-video-5s or ltx/still-to-video-5s.
...
2. Load **klein/still-hero** from **Apps** or **Workflows**
...
**This graph:** `## klein/still-hero HD Klein 4B still (Apache 2.0 distilled FP8). Same prompt and seed as klein/still-draft. Models: flux-2-klein-4b-fp8.safetensors + qwen_3_4b.safetensors (CLIP type flux2) + flux2-…`
