...
**This graph:** `## klein/storyboard-6up Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Six Klein 4B storyboard frames of **one scene** from new cameras (lock=view). Type an…`
