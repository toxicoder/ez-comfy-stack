...
**Who this is for:** studio users who loaded `klein/storyboard-6up` from Apps or Workflows.

> Generated from `workflows/_lab/klein/storyboard-6up.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/storyboard-6up** from **Apps** or **Workflows**
...
| 6 | Size 768x432 | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `klein/storyboard-6up`
...
**This graph:** `## klein/storyboard-6up Six Klein 4B storyboard frames of **one scene** from new cameras (lock=view). Type any scene in IDENTITY. Prefixes `ez_board_01`…`06`. Independent T2I, same seed. Identity-mod…`
