...
**Who this is for:** studio users who loaded `klein/camera-angles` from Apps or Workflows.

> Generated from `workflows/_lab/klein/camera-angles.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/camera-angles** from **Apps** or **Workflows**
...
**This graph:** `klein/camera-angles`
...
**This graph:** `## klein/camera-angles Wide / medium / close of one subject (Klein 4B, lock=view). Type any subject in IDENTITY. Prefixes `ez_angle_wide`, `ez_angle_med`, `ez_angle_close`. Independent T2I, same seed…`
