...
**This graph:** `## klein/camera-angles Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Wide / medium / close of one subject (Klein 4B, lock=view). Type any subject in IDENTI…`
