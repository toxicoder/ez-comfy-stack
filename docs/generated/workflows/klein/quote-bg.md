...
| 6 | Size 1:1 quote background | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `## klein/quote-bg Quote-card background (Klein 4B). Default 1024×1024. Prefix `ez_quote_bg`. Keep the center empty of detail; add the quote in your editor. Occupancy: klein — stop Wan, LTX, podcast, …`
