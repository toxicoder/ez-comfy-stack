...
**Who this is for:** studio users who loaded `klein/quote-bg` from Apps or Workflows.

> Generated from `workflows/_lab/klein/quote-bg.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/quote-bg** from **Apps** or **Workflows**
...
**This graph:** `## klein/quote-bg Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Quote-card background (Klein 4B). Default 1024×1024. Prefix `ez_quote_bg`. Keep the center …`
...
**This graph:** `Quote background (1024×1024)`
