...
**This graph:** `## klein/character-draft Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Klein 4B character still. Type a character, pick a style, Queue. 1024x1280 (Instagra…`
