...
**Who this is for:** studio users who loaded `klein/character-draft` from Apps or Workflows.

> Generated from `workflows/_lab/klein/character-draft.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/character-draft** from **Apps** or **Workflows**
...
| 6 | Size 4:5 character still | `EmptyFlux2LatentImage` | Ungrouped |
| 7 | KSampler | `KSampler` | Ungrouped |
| 8 | VAE Decode | `VAEDecode` | Ungrouped |
| 9 | Save character | `SaveImage` | Ungrouped |
| 10 | Operator note | `Note` | Ungrouped |
| 11 | Klein Prompt Enhance | `EZKleinPromptEnhance` | Ungrouped |
...
| Instance | Value |
| --- | --- |
| Positive | `A photoreal still of an original character, standing, full body with headroom, …` |
...
**This graph:** `## klein/character-draft Klein 4B character still. Type a character, pick a style, Queue. 1024x1280 (Instagram 4:5), seed 42, Enhance on (t2i so style applies). Prefix `ez_character`. Handoff: load *…`
...
**This graph:** `A photoreal still of an original character, standing, full body with headroom, Instagram 4:5. Distinct face, wardrobe, and one signature prop. Unmarked surfaces, empty of lettering. Eye-level 35mm.`

```text
A photoreal still of an original character, standing, full body with headroom, Instagram 4:5. Distinct face, wardrobe, and one signature prop. Unmarked surfaces, empty of lettering. Eye-level 35mm.
```
...
**This graph:** `Instagram 4:5 character still`
...
**This graph:** `klein/character-draft`
