...
**Who this is for:** studio users who loaded `klein/thumbnail` from Apps or Workflows.

> Generated from `workflows/_lab/klein/thumbnail.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/thumbnail** from **Apps** or **Workflows**
...
**This graph:** `## klein/thumbnail Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube thumbnail still (Klein 4B). Default 1280×720. Prefix `ez_thumbnail`. Keep the subj…`
