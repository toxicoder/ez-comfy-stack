...
**Who this is for:** studio users who loaded `klein/creator/youtube-end-screen` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/youtube-end-screen.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
YouTube end-screen plate, left-weighted. Lab size **1280×720**. Prefix `ez_yt_endscreen`.
...
2. Load **klein/creator/youtube-end-screen** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/youtube-end-screen Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube end-screen plate, left-weighted. Lab size **1280×720**. Prefix `e…`
...
**This graph:** `YouTube · end screen (1280×720)`
