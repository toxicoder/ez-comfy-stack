---
title: klein/creator/youtube-subscribe-plate
description: Subscribe-safe end plate 16:9
tags: [workflows, generated, comfyui, klein]
---

# klein/creator/youtube-subscribe-plate
...
**Who this is for:** studio users who loaded `klein/creator/youtube-subscribe-plate` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/youtube-subscribe-plate.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Subscribe-safe end plate 16:9. Lab size **1280×720**. Prefix `ez_yt_sub`.
...
2. Load **klein/creator/youtube-subscribe-plate** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/youtube-subscribe-plate Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Subscribe-safe end plate 16:9. Lab size **1280×720**. Prefix `ez_yt_…`
...
**This graph:** `YouTube · subscribe plate (1280×720)`
