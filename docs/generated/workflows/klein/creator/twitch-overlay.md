---
title: klein/creator/twitch-overlay
description: Twitch webcam-hole overlay 16:9
tags: [workflows, generated, comfyui, klein]
---

# klein/creator/twitch-overlay
...
**Who this is for:** studio users who loaded `klein/creator/twitch-overlay` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/twitch-overlay.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Twitch webcam-hole overlay 16:9. Lab size **1280×720**. Prefix `ez_tw_overlay`.
...
2. Load **klein/creator/twitch-overlay** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `A photoreal still of a dim unmarked streaming desk with teal practicals and a q…` |
...
**This graph:** `## klein/creator/twitch-overlay Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Twitch webcam-hole overlay 16:9. Lab size **1280×720**. Prefix `ez_tw_overlay…`
...
**This graph:** `A photoreal still of a dim unmarked streaming desk with teal practicals and a quiet backdrop. Empty of lettering and UI chrome. 16:9 stream overlay. Right third empty for a webcam. Empty of lettering…`

```text
A photoreal still of a dim unmarked streaming desk with teal practicals and a quiet backdrop. Empty of lettering and UI chrome. 16:9 stream overlay. Right third empty for a webcam. Empty of lettering and chrome.
```
...
**This graph:** `Twitch · overlay (1280×720)`
