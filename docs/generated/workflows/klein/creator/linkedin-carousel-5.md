...
**This graph:** `## klein/creator/linkedin-carousel-5 Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LinkedIn document carousel, five squares. Lab size **1024×1024**. Prefix…`
