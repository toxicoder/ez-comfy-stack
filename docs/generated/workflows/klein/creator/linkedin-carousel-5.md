...
**Who this is for:** studio users who loaded `klein/creator/linkedin-carousel-5` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/linkedin-carousel-5.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/linkedin-carousel-5** from **Apps** or **Workflows**
...
| 6 | Size 1024x1024 | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `klein/creator/linkedin-carousel-5`
...
**This graph:** `## klein/creator/linkedin-carousel-5 LinkedIn document carousel, five squares. Lab size **1024×1024**. Prefix `ez_li_c01`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy:…`
