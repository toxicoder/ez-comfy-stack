...
**Who this is for:** studio users who loaded `klein/creator/pin-standard` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/pin-standard.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/pin-standard** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/pin-standard Pinterest standard pin 2:3. Lab size **768×1152**. Prefix `ez_pin`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, LTX, p…`
