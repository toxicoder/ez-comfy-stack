...
**Who this is for:** studio users who loaded `klein/creator/episode-art` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/episode-art.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Per-episode podcast art 1:1. Lab size **1024×1024**. Prefix `ez_episode`.
...
2. Load **klein/creator/episode-art** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/episode-art Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Per-episode podcast art 1:1. Lab size **1024×1024**. Prefix `ez_episode`. Empty …`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Square episode art. One prop story, unmarked. Empty of let…`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Square episode art. One prop story, unmarked. Empty of lettering.
```
...
**This graph:** `Podcast · episode art (1024×1024)`
