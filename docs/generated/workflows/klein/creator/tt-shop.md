...
**Who this is for:** studio users who loaded `klein/creator/tt-shop` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/tt-shop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/tt-shop** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/tt-shop TikTok Shop packshot 1:1. Lab size **1024×1024**. Prefix `ez_tt_shop`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, LTX, pod…`
