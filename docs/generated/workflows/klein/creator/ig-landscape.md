...
**Who this is for:** studio users who loaded `klein/creator/ig-landscape` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/ig-landscape.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/ig-landscape** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/ig-landscape Instagram landscape feed ~1.91:1. Lab size **1216×640**. Prefix `ez_ig_land`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop W…`
