...
**This graph:** `## klein/creator/spotify-canvas-still Spotify Canvas still 9:16 (silent JPG stand-in). Lab size **576×1024**. Prefix `ez_spot_still`. Empty of lettering. Add titles in your editor, not in the prompt.…`
