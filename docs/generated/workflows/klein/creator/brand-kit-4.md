...
**This graph:** `## klein/creator/brand-kit-4 Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Four brand plates, same camera, different lights. Lab size **768×432**. Prefix `…`
