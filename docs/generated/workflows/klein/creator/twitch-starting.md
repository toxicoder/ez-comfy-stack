---
title: klein/creator/twitch-starting
description: Twitch starting-soon screen 16:9
tags: [workflows, generated, comfyui, klein]
---

# klein/creator/twitch-starting
...
**Who this is for:** studio users who loaded `klein/creator/twitch-starting` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/twitch-starting.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Twitch starting-soon screen 16:9. Lab size **1280×720**. Prefix `ez_tw_start`.
...
2. Load **klein/creator/twitch-starting** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/twitch-starting Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Twitch starting-soon screen 16:9. Lab size **1280×720**. Prefix `ez_tw_start…`
...
```text
A photoreal still of a dim unmarked streaming desk with teal practicals and a quiet backdrop. Empty of lettering and UI chrome. Quiet center for overlay type later. Empty of lettering.
```
...
**This graph:** `Twitch · starting soon (1280×720)`
