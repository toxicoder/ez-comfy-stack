...
**Who this is for:** studio users who loaded `klein/creator/instagram-portrait` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/instagram-portrait.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Instagram 4:5 feed still. Lab size **1024×1280**. Prefix `ez_ig_portrait`.
...
2. Load **klein/creator/instagram-portrait** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/instagram-portrait Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram 4:5 feed still. Lab size **1024×1280**. Prefix `ez_ig_portrait`…`
...
**This graph:** `Instagram · 4:5 portrait (1024×1280)`
