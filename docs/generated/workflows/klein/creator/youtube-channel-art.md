...
**Who this is for:** studio users who loaded `klein/creator/youtube-channel-art` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/youtube-channel-art.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
YouTube channel art 16:9 with a mobile-safe center band. Lab size **1536×864**. Prefix `ez_yt_art`.
...
2. Load **klein/creator/youtube-channel-art** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/youtube-channel-art Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube channel art 16:9 with a mobile-safe center band. Lab size **1536…`
