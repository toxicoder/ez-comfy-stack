...
**Who this is for:** studio users who loaded `klein/creator/ig-profile` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/ig-profile.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/ig-profile** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/ig-profile Instagram profile photo, circle-safe. Lab size **768×768**. Prefix `ez_ig_profile`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — st…`
