...
**This graph:** `## klein/creator/audiogram-wide Audiogram background 16:9. Lab size **1280×720**. Prefix `ez_ag_wide`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, L…`
