...
**Who this is for:** studio users who loaded `klein/creator/audiogram-wide` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/audiogram-wide.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Audiogram background 16:9. Lab size **1280×720**. Prefix `ez_ag_wide`.
...
2. Load **klein/creator/audiogram-wide** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/audiogram-wide Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Audiogram background 16:9. Lab size **1280×720**. Prefix `ez_ag_wide`. Empty …`
...
**This graph:** `Audiogram · wide (1280×720)`
