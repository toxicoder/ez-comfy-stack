...
**Who this is for:** studio users who loaded `klein/creator/ig-story` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/ig-story.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/ig-story** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/ig-story Instagram Story 9:16 with UI-safe edges. Lab size **576×1024**. Prefix `ez_ig_story`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — st…`
