...
**Who this is for:** studio users who loaded `klein/creator/youtube-chapter-card` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/youtube-chapter-card.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
YouTube chapter plate 16:9. Lab size **1280×720**. Prefix `ez_yt_chapter`.
...
2. Load **klein/creator/youtube-chapter-card** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/youtube-chapter-card Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube chapter plate 16:9. Lab size **1280×720**. Prefix `ez_yt_chapte…`
...
**This graph:** `YouTube · chapter card (1280×720)`
