...
**This graph:** `## klein/creator/youtube-chapter-card YouTube chapter plate 16:9. Lab size **1280×720**. Prefix `ez_yt_chapter`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — s…`
