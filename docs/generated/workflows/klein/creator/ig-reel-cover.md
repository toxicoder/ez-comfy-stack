...
**Who this is for:** studio users who loaded `klein/creator/ig-reel-cover` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/ig-reel-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/ig-reel-cover** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/ig-reel-cover Instagram Reel cover, center-weighted for the grid crop. Lab size **576×1024**. Prefix `ez_ig_reel`. Empty of lettering. Add titles in your editor, not in the prompt. O…`
