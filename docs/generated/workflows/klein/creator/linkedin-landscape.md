...
**Who this is for:** studio users who loaded `klein/creator/linkedin-landscape` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/linkedin-landscape.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
LinkedIn landscape post ~1.91:1. Lab size **1216×640**. Prefix `ez_li_land`.
...
2. Load **klein/creator/linkedin-landscape** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/linkedin-landscape Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LinkedIn landscape post ~1.91:1. Lab size **1216×640**. Prefix `ez_li_lan…`
...
**This graph:** `LinkedIn · landscape (1216×640)`
