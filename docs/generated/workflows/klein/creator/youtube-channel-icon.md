---
title: klein/creator/youtube-channel-icon
description: YouTube channel icon, circle-safe 1:1
tags: [workflows, generated, comfyui, klein]
---

# klein/creator/youtube-channel-icon
...
**Who this is for:** studio users who loaded `klein/creator/youtube-channel-icon` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/youtube-channel-icon.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
YouTube channel icon, circle-safe 1:1. Lab size **768×768**. Prefix `ez_yt_icon`.
...
2. Load **klein/creator/youtube-channel-icon** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/youtube-channel-icon Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube channel icon, circle-safe 1:1. Lab size **768×768**. Prefix `ez…`
...
**This graph:** `YouTube · channel icon (768×768)`
