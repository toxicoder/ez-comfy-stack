...
**This graph:** `## klein/creator/youtube-channel-icon YouTube channel icon, circle-safe 1:1. Lab size **768×768**. Prefix `ez_yt_icon`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: kl…`
