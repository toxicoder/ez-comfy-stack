...
**Who this is for:** studio users who loaded `klein/creator/tt-cover` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/tt-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/tt-cover** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/tt-cover TikTok cover 9:16. Lab size **576×1024**. Prefix `ez_tt_cover`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, LTX, podcast, …`
