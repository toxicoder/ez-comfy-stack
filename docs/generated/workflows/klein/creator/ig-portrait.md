...
**Who this is for:** studio users who loaded `klein/creator/ig-portrait` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/ig-portrait.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/ig-portrait** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/ig-portrait Instagram 4:5 feed still. Lab size **1024×1280**. Prefix `ez_ig_portrait`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, …`
