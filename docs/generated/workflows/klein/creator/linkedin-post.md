...
**Who this is for:** studio users who loaded `klein/creator/linkedin-post` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/linkedin-post.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
LinkedIn square post 1:1. Lab size **1024×1024**. Prefix `ez_li_post`.
...
2. Load **klein/creator/linkedin-post** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/linkedin-post Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LinkedIn square post 1:1. Lab size **1024×1024**. Prefix `ez_li_post`. Empty o…`
...
**This graph:** `LinkedIn · square (1024×1024)`
