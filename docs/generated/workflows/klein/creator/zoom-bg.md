...
**Who this is for:** studio users who loaded `klein/creator/zoom-bg` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/zoom-bg.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Webcam-safe Zoom / Meet background 16:9. Lab size **1280×720**. Prefix `ez_zoom`.
...
2. Load **klein/creator/zoom-bg** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/zoom-bg Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Webcam-safe Zoom / Meet background 16:9. Lab size **1280×720**. Prefix `ez_zoom`. Em…`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. 16:9 background. Center stays simple for a webcam. Empty o…`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. 16:9 background. Center stays simple for a webcam. Empty of lettering.
```
...
**This graph:** `Zoom / Meet background (1280×720)`
