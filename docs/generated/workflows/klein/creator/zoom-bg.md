...
**This graph:** `## klein/creator/zoom-bg Webcam-safe Zoom / Meet background 16:9. Lab size **1280×720**. Prefix `ez_zoom`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wa…`
