...
**Who this is for:** studio users who loaded `klein/creator/fb-post` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/fb-post.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/fb-post** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/fb-post Facebook shared-image still ~1.91:1. Lab size **1216×640**. Prefix `ez_fb_post`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan…`
