...
**Who this is for:** studio users who loaded `klein/creator/yt-chapter-card` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/yt-chapter-card.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/yt-chapter-card** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/yt-chapter-card YouTube chapter plate 16:9. Lab size **1280×720**. Prefix `ez_yt_chapter`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop W…`
