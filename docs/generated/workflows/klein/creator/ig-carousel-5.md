...
**Who this is for:** studio users who loaded `klein/creator/ig-carousel-5` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/ig-carousel-5.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/ig-carousel-5** from **Apps** or **Workflows**
...
**This graph:** `klein/creator/ig-carousel-5`
...
**This graph:** `## klein/creator/ig-carousel-5 Instagram 4:5 carousel, five slides. Lab size **1024×1280**. Prefix `ez_ig_c01`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — st…`
