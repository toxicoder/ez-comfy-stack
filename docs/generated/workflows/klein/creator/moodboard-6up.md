...
**This graph:** `## klein/creator/moodboard-6up Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Six-still moodboard of one identity. Lab size **768×432**. Prefix `ez_mood_c01…`
