...
**Who this is for:** studio users who loaded `klein/creator/moodboard-6up` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/moodboard-6up.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Six-still moodboard of one identity. Lab size **768×432**. Prefix `ez_mood_c01`.
Empty of lettering. Add titles in your editor, not in the prompt.
Occupancy: klein — stop Wan, LTX, podcast, music. One GB10 job.
Handoff: none.
Pack prefixes: `ez_mood_c01`, `ez_mood_c02`, `ez_mood_c03`, `ez_mood_c04`, `ez_mood_c05`, `ez_mood_c06`.
...
2. Load **klein/creator/moodboard-6up** from **Apps** or **Workflows**
...
| 13 | Decode HERO | `VAEDecode` | SHOT HERO |
| 14 | Save HERO | `SaveImage` | SHOT HERO |
| 16 | SHOT WIDE | `EZPromptJoin` | SHOT WIDE |
| 17 | Positive WIDE | `CLIPTextEncode` | SHOT WIDE |
| 18 | Sampler WIDE | `KSampler` | SHOT WIDE |
| 19 | Decode WIDE | `VAEDecode` | SHOT WIDE |
| 20 | Save WIDE | `SaveImage` | SHOT WIDE |
...
| 28 | SHOT PROP | `EZPromptJoin` | SHOT PROP |
| 29 | Positive PROP | `CLIPTextEncode` | SHOT PROP |
| 30 | Sampler PROP | `KSampler` | SHOT PROP |
| 31 | Decode PROP | `VAEDecode` | SHOT PROP |
| 32 | Save PROP | `SaveImage` | SHOT PROP |
| 34 | SHOT PLACE | `EZPromptJoin` | SHOT PLACE |
| 35 | Positive PLACE | `CLIPTextEncode` | SHOT PLACE |
| 36 | Sampler PLACE | `KSampler` | SHOT PLACE |
| 37 | Decode PLACE | `VAEDecode` | SHOT PLACE |
| 38 | Save PLACE | `SaveImage` | SHOT PLACE |
| 40 | SHOT CLOSE | `EZPromptJoin` | SHOT CLOSE |
| 41 | Positive CLOSE | `CLIPTextEncode` | SHOT CLOSE |
...
**This graph:** `klein/creator/moodboard-6up`
...
| Positive HERO | `Hero still. 35mm, eye level, golden hour. Same building, rooms, furniture place…` |
| Positive WIDE | `Wide world. 24mm, more city and bay. Same building, rooms, furniture placement,…` |
| Positive DETAIL | `Wardrobe detail. 85mm on the coat seam. Same building, rooms, furniture placeme…` |
...
**This graph:** `## klein/creator/moodboard-6up Six-still moodboard of one identity. Lab size **768×432**. Prefix `ez_mood_c01`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — st…`
...
| Instance | Value |
| --- | --- |
| SHOT HERO | `Hero still. 35mm, eye level, golden hour.` |
| SHOT WIDE | `Wide world. 24mm, more city and bay.` |
| SHOT DETAIL | `Wardrobe detail. 85mm on the coat seam.` |
| SHOT PROP | `Prop still. Data-staff and glyph rings, 50mm.` |
| SHOT PLACE | `Place still. Terrace palms, no person, 24mm.` |
| SHOT CLOSE | `Portrait close. 85mm, same identity.` |
...
| Instance | Value |
| --- | --- |
| Save HERO | `ez_mood_c01` |
| Save WIDE | `ez_mood_c02` |
| Save DETAIL | `ez_mood_c03` |
| Save PROP | `ez_mood_c04` |
| Save PLACE | `ez_mood_c05` |
| Save CLOSE | `ez_mood_c06` |
