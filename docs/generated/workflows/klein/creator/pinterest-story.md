...
**Who this is for:** studio users who loaded `klein/creator/pinterest-story` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/pinterest-story.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Pinterest Idea Pin 9:16. Lab size **576×1024**. Prefix `ez_pin_story`.
...
2. Load **klein/creator/pinterest-story** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/pinterest-story Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Pinterest Idea Pin 9:16. Lab size **576×1024**. Prefix `ez_pin_story`. Empty…`
...
**This graph:** `Pinterest · Idea Pin (576×1024)`
