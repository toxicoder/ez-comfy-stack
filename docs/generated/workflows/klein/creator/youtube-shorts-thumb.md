...
**Who this is for:** studio users who loaded `klein/creator/youtube-shorts-thumb` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/youtube-shorts-thumb.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
YouTube Shorts thumbnail 9:16. Lab size **576×1024**. Prefix `ez_yt_shorts_thumb`.
...
2. Load **klein/creator/youtube-shorts-thumb** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/youtube-shorts-thumb Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube Shorts thumbnail 9:16. Lab size **576×1024**. Prefix `ez_yt_sho…`
...
**This graph:** `YouTube · Shorts thumb (576×1024)`
