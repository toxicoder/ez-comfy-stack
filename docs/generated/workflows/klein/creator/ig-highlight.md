...
**Who this is for:** studio users who loaded `klein/creator/ig-highlight` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/ig-highlight.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/ig-highlight** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/ig-highlight Instagram Highlight cover, circle-safe. Lab size **768×768**. Prefix `ez_ig_highlight`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klei…`
