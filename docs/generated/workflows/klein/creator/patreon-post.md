...
**Who this is for:** studio users who loaded `klein/creator/patreon-post` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/patreon-post.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Membership post still 4:5. Lab size **1024×1280**. Prefix `ez_patreon`.
...
2. Load **klein/creator/patreon-post** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/patreon-post Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Membership post still 4:5. Lab size **1024×1280**. Prefix `ez_patreon`. Empty o…`
...
**This graph:** `Patreon · post (1024×1280)`
