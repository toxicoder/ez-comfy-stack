...
**Who this is for:** studio users who loaded `klein/creator/instagram-reel-cover` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/instagram-reel-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Instagram Reel cover, center-weighted for the grid crop. Lab size **576×1024**. Prefix `ez_ig_reel`.
...
2. Load **klein/creator/instagram-reel-cover** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/instagram-reel-cover Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram Reel cover, center-weighted for the grid crop. Lab size **576…`
...
**This graph:** `Instagram · Reel cover (576×1024)`
