...
| 6 | Size 1216x640 | `EmptyFlux2LatentImage` | PROMPT |
...
**This graph:** `## klein/creator/instagram-landscape Instagram landscape feed ~1.91:1. Lab size **1216×640**. Prefix `ez_ig_land`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein —…`
