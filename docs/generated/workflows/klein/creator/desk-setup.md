...
**This graph:** `## klein/creator/desk-setup Workspace establishing still 16:9. Lab size **1280×720**. Prefix `ez_desk`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, …`
