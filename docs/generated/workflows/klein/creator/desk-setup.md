---
title: klein/creator/desk-setup
description: Workspace establishing still 16:9
tags: [workflows, generated, comfyui, klein]
---

# klein/creator/desk-setup
...
**Who this is for:** studio users who loaded `klein/creator/desk-setup` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/desk-setup.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Workspace establishing still 16:9. Lab size **1280×720**. Prefix `ez_desk`.
...
2. Load **klein/creator/desk-setup** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/desk-setup Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Workspace establishing still 16:9. Lab size **1280×720**. Prefix `ez_desk`. Empty…`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Photoreal desk setup, oak and linen, unmarked screens. Emp…`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Photoreal desk setup, oak and linen, unmarked screens. Empty of lettering.
```
...
**This graph:** `Desk setup (1280×720)`
