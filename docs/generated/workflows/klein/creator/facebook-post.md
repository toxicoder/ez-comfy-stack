...
**This graph:** `## klein/creator/facebook-post Facebook shared-image still ~1.91:1. Lab size **1216×640**. Prefix `ez_fb_post`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — st…`
