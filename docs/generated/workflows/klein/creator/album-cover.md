...
**This graph:** `## klein/creator/album-cover Release / album cover 1:1. Lab size **1024×1024**. Prefix `ez_album`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, LTX, …`
