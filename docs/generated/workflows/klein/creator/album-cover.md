...
**Who this is for:** studio users who loaded `klein/creator/album-cover` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/album-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Release / album cover 1:1. Lab size **1024×1024**. Prefix `ez_album`.
...
2. Load **klein/creator/album-cover** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/album-cover Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Release / album cover 1:1. Lab size **1024×1024**. Prefix `ez_album`. Empty of l…`
...
**This graph:** `Album · cover (1024×1024)`
