...
| 6 | Size 1536x384 | `EmptyFlux2LatentImage` | PROMPT |
...
**This graph:** `## klein/creator/linkedin-banner LinkedIn personal banner 4:1. Lab size **1536×384**. Prefix `ez_li_banner`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop …`
