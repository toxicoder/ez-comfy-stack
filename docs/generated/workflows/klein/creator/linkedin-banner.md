...
**Who this is for:** studio users who loaded `klein/creator/linkedin-banner` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/linkedin-banner.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
LinkedIn personal banner 4:1. Lab size **1536×384**. Prefix `ez_li_banner`.
...
2. Load **klein/creator/linkedin-banner** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/linkedin-banner Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LinkedIn personal banner 4:1. Lab size **1536×384**. Prefix `ez_li_banner`. …`
...
**This graph:** `LinkedIn · banner (1536×384)`
