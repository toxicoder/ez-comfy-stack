...
**Who this is for:** studio users who loaded `klein/creator/twitch-banner` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/twitch-banner.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Twitch channel banner ~3:1. Lab size **1536×512**. Prefix `ez_tw_banner`.
...
2. Load **klein/creator/twitch-banner** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/twitch-banner Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Twitch channel banner ~3:1. Lab size **1536×512**. Prefix `ez_tw_banner`. Empt…`
...
**This graph:** `A photoreal still of a dim unmarked streaming desk with teal practicals and a quiet backdrop. Empty of lettering and UI chrome. Ultra-wide banner. Horizon low, empty sky band. Empty of lettering.`

```text
A photoreal still of a dim unmarked streaming desk with teal practicals and a quiet backdrop. Empty of lettering and UI chrome. Ultra-wide banner. Horizon low, empty sky band. Empty of lettering.
```
...
**This graph:** `Twitch · banner (1536×512)`
