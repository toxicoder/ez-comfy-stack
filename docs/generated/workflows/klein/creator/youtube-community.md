---
title: klein/creator/youtube-community
description: YouTube Community post 1:1
tags: [workflows, generated, comfyui, klein]
---

# klein/creator/youtube-community
...
**Who this is for:** studio users who loaded `klein/creator/youtube-community` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/youtube-community.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
YouTube Community post 1:1. Lab size **1024×1024**. Prefix `ez_yt_community`.
...
2. Load **klein/creator/youtube-community** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/youtube-community Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube Community post 1:1. Lab size **1024×1024**. Prefix `ez_yt_communit…`
...
**This graph:** `YouTube · Community (1024×1024)`
