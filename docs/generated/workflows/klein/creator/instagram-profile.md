...
**This graph:** `## klein/creator/instagram-profile Instagram profile photo, circle-safe. Lab size **768×768**. Prefix `ez_ig_profile`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: kle…`
