...
**Who this is for:** studio users who loaded `klein/creator/instagram-profile` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/instagram-profile.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Instagram profile photo, circle-safe. Lab size **768×768**. Prefix `ez_ig_profile`.
...
2. Load **klein/creator/instagram-profile** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/instagram-profile Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram profile photo, circle-safe. Lab size **768×768**. Prefix `ez_ig_…`
...
**This graph:** `Instagram · profile (768×768)`
