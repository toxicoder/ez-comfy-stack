---
title: klein/creator/merch-tee
description: Unmarked tee mock 1:1
tags: [workflows, generated, comfyui, klein]
---

# klein/creator/merch-tee
...
**Who this is for:** studio users who loaded `klein/creator/merch-tee` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/merch-tee.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Unmarked tee mock 1:1. Lab size **1024×1024**. Prefix `ez_tee`.
...
2. Load **klein/creator/merch-tee** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/merch-tee Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Unmarked tee mock 1:1. Lab size **1024×1024**. Prefix `ez_tee`. Empty of lettering…`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Photoreal tee on a h…`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Photoreal tee on a hanger against seamless gray. Unmarked fabric, no logos.
```
...
**This graph:** `Merch · tee (1024×1024)`
