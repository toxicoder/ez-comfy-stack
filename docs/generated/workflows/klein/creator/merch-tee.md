...
**This graph:** `## klein/creator/merch-tee Unmarked tee mock 1:1. Lab size **1024×1024**. Prefix `ez_tee`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, LTX, podcast,…`
