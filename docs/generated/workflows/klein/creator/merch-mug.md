...
**This graph:** `## klein/creator/merch-mug Merch mug mock 1:1. Lab size **1024×1024**. Prefix `ez_mug_merch`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, LTX, podca…`
