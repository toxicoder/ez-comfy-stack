...
**Who this is for:** studio users who loaded `klein/creator/pin-story` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/pin-story.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/pin-story** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/pin-story Pinterest Idea Pin 9:16. Lab size **576×1024**. Prefix `ez_pin_story`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, LTX, p…`
