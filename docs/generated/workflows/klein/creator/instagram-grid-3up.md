...
**This graph:** `## klein/creator/instagram-grid-3up Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram 1:1 three-tile grid row. Lab size **1024×1024**. Prefix `ez_ig_…`
