...
**Who this is for:** studio users who loaded `klein/creator/instagram-grid-3up` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/instagram-grid-3up.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/instagram-grid-3up** from **Apps** or **Workflows**
...
**This graph:** `klein/creator/instagram-grid-3up`
...
**This graph:** `## klein/creator/instagram-grid-3up Instagram 1:1 three-tile grid row. Lab size **1024×1024**. Prefix `ez_ig_g01`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein —…`
