...
**This graph:** `## klein/creator/instagram-story Instagram Story 9:16 with UI-safe edges. Lab size **576×1024**. Prefix `ez_ig_story`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: kle…`
