...
**Who this is for:** studio users who loaded `klein/creator/instagram-story` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/instagram-story.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Instagram Story 9:16 with UI-safe edges. Lab size **576×1024**. Prefix `ez_ig_story`.
...
2. Load **klein/creator/instagram-story** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/instagram-story Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Instagram Story 9:16 with UI-safe edges. Lab size **576×1024**. Prefix `ez_i…`
...
**This graph:** `Instagram · Story (576×1024)`
