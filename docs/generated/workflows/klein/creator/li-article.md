...
**Who this is for:** studio users who loaded `klein/creator/li-article` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/li-article.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/li-article** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/li-article LinkedIn article cover ~1.91:1. Lab size **1216×640**. Prefix `ez_li_article`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wa…`
