...
**This graph:** `## klein/creator/slide-title Course / webinar title plate 16:9. Lab size **1280×720**. Prefix `ez_slide`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan…`
