...
**Who this is for:** studio users who loaded `klein/creator/linkedin-article` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/linkedin-article.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/linkedin-article** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/linkedin-article Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. LinkedIn article cover ~1.91:1. Lab size **1216×640**. Prefix `ez_li_articl…`
