...
**This graph:** `## klein/creator/instagram-highlight Instagram Highlight cover, circle-safe. Lab size **768×768**. Prefix `ez_ig_highlight`. Empty of lettering. Add titles in your editor, not in the prompt. Occupanc…`
