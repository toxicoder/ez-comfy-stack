...
**Who this is for:** studio users who loaded `klein/creator/li-banner` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/li-banner.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/li-banner** from **Apps** or **Workflows**
...
| 6 | Size 1536x384 | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `## klein/creator/li-banner LinkedIn personal banner 4:1. Lab size **1536×384**. Prefix `ez_li_banner`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, L…`
