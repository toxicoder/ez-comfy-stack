...
**Who this is for:** studio users who loaded `klein/creator/yt-channel-art` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/yt-channel-art.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/yt-channel-art** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/yt-channel-art YouTube channel art 16:9 with a mobile-safe center band. Lab size **1536×864**. Prefix `ez_yt_art`. Empty of lettering. Add titles in your editor, not in the prompt. O…`
