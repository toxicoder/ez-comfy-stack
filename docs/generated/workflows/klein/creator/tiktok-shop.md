...
| 6 | Size 1024x1024 | `EmptyFlux2LatentImage` | PROMPT |
...
**This graph:** `## klein/creator/tiktok-shop TikTok Shop packshot 1:1. Lab size **1024×1024**. Prefix `ez_tt_shop`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, LTX,…`
