...
**This graph:** `## klein/creator/lyric-card Lyric-card background 1:1. Lab size **1024×1024**. Prefix `ez_lyric`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, LTX, p…`
