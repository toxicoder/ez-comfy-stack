...
**Who this is for:** studio users who loaded `klein/creator/yt-channel-icon` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/yt-channel-icon.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/yt-channel-icon** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/yt-channel-icon YouTube channel icon, circle-safe 1:1. Lab size **768×768**. Prefix `ez_yt_icon`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein —…`
