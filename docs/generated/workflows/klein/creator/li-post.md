...
**Who this is for:** studio users who loaded `klein/creator/li-post` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/li-post.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/creator/li-post** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/li-post LinkedIn square post 1:1. Lab size **1024×1024**. Prefix `ez_li_post`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, LTX, pod…`
