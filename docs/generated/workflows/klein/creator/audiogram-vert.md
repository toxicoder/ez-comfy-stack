...
**Who this is for:** studio users who loaded `klein/creator/audiogram-vert` from Apps or Workflows.

> Generated from `workflows/_lab/klein/creator/audiogram-vert.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Audiogram background 9:16. Lab size **576×1024**. Prefix `ez_ag_vert`.
...
2. Load **klein/creator/audiogram-vert** from **Apps** or **Workflows**
...
**This graph:** `## klein/creator/audiogram-vert Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Audiogram background 9:16. Lab size **576×1024**. Prefix `ez_ag_vert`. Empty …`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Vertical audiogram. Quiet lower third for a waveform. Empt…`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Vertical audiogram. Quiet lower third for a waveform. Empty of lettering.
```
...
**This graph:** `Audiogram · vertical (576×1024)`
