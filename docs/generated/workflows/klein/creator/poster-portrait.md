...
| 6 | Size 768x1152 | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `## klein/creator/poster-portrait Print poster 2:3. Lab size **768×1152**. Prefix `ez_poster`. Empty of lettering. Add titles in your editor, not in the prompt. Occupancy: klein — stop Wan, LTX, podca…`
