...
**Who this is for:** studio users who loaded `klein/style-lock` from Apps or Workflows.

> Generated from `workflows/_lab/klein/style-lock.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/style-lock** from **Apps** or **Workflows**
...
| 6 | Size 768x960 | `EmptyFlux2LatentImage` | Ungrouped |
...
| 13 | Decode FACADE | `VAEDecode` | SHOT FACADE |
| 14 | Save FACADE | `SaveImage` | SHOT FACADE |
| 16 | SHOT LIVING | `EZPromptJoin` | SHOT LIVING |
| 17 | Positive LIVING | `CLIPTextEncode` | SHOT LIVING |
| 18 | Sampler LIVING | `KSampler` | SHOT LIVING |
| 19 | Decode LIVING | `VAEDecode` | SHOT LIVING |
| 20 | Save LIVING | `SaveImage` | SHOT LIVING |
| 22 | SHOT TERRACE | `EZPromptJoin` | SHOT TERRACE |
| 23 | Positive TERRACE | `CLIPTextEncode` | SHOT TERRACE |
| 24 | Sampler TERRACE | `KSampler` | SHOT TERRACE |
| 25 | Decode TERRACE | `VAEDecode` | SHOT TERRACE |
| 26 | Save TERRACE | `SaveImage` | SHOT TERRACE |
| 28 | SHOT RAIN | `EZPromptJoin` | SHOT RAIN |
| 29 | Positive RAIN | `CLIPTextEncode` | SHOT RAIN |
...
| Positive FACADE | `Three-quarter exterior of this place, 24mm, Instagram 4:5. Openings readable so…` |
...
**This graph:** `## klein/style-lock Four Klein 4B stills of **one place** from new cameras (Prompt Join lock=view). Type any place in IDENTITY — default placeholder is the lab penthouse. Hidden cards are camera role…`
...
| Instance | Value |
| --- | --- |
| SHOT FACADE | `Three-quarter exterior of this place, 24mm, Instagram 4:5. Openings readable so…` |
| SHOT LIVING | `From the primary interior looking out the main opening, late-day sun, Instagram…` |
| SHOT TERRACE | `Outdoor living or threshold of this place at golden hour, Instagram 4:5.` |
| SHOT RAIN | `This same place at night or in weather. Lamps on if the bible has them. Massing…` |
...
**This graph (all 4 instances):** `view`
...
| Instance | Value |
| --- | --- |
| Save FACADE | `ez_style_01` |
| Save LIVING | `ez_style_02` |
| Save TERRACE | `ez_style_03` |
| Save RAIN | `ez_style_04` |
