...
**This graph:** `## klein/open-graph Blog / Open Graph hero (Klein 4B). Default 1216×640. Prefix `ez_og`. Leave space for a title overlay. No burned-in words. Occupancy: klein — stop Wan, LTX, podcast, music. One GB1…`
