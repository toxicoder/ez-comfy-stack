...
**Who this is for:** studio users who loaded `klein/endcard-cta` from Apps or Workflows.

> Generated from `workflows/_lab/klein/endcard-cta.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/endcard-cta** from **Apps** or **Workflows**
...
**This graph:** `## klein/endcard-cta Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. YouTube/end-card still (Klein 4B). Default 1280×720. Prefix `ez_endcard`. Keep the lower…`
...
**This graph:** `End-card / CTA (1280×720)`
