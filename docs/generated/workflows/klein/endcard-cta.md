...
| 6 | Size 16:9 end card | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `## klein/endcard-cta YouTube/end-card still (Klein 4B). Default 1280×720. Prefix `ez_endcard`. Keep the lower-right quiet — add CTA text in your editor, not in the prompt. Occupancy: klein — stop Wan…`
