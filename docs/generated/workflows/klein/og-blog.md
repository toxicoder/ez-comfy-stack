...
**Who this is for:** studio users who loaded `klein/og-blog` from Apps or Workflows.

> Generated from `workflows/_lab/klein/og-blog.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/og-blog** from **Apps** or **Workflows**
...
**This graph:** `## klein/og-blog Blog / Open Graph hero (Klein 4B). Default 1216×640. Prefix `ez_og`. Leave space for a title overlay. No burned-in words. Occupancy: klein — stop Wan, LTX, podcast, music. One GB10 j…`
