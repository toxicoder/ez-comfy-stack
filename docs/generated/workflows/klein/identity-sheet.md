...
**Who this is for:** studio users who loaded `klein/identity-sheet` from Apps or Workflows.

> Generated from `workflows/_lab/klein/identity-sheet.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/identity-sheet** from **Apps** or **Workflows**
...
flowchart LR
  ...
  N13["Decode FRONT"]
  N14["Save FRONT"]
  N16["SHOT THREE-QUARTER"]
  N17["Positive THREE-QUARTER"]
  N18["Sampler THREE-QUARTER"]
  N19["Decode THREE-QUARTER"]
  N20["Save THREE-QUARTER"]
  N22["SHOT PROFILE"]
  N23["Positive PROFILE"]
  N24["Sampler PROFILE"]
  N25["Decode PROFILE"]
  N26["Save PROFILE"]
...
| 6 | Size 1280x704 | `EmptyFlux2LatentImage` | Ungrouped |
...
| 13 | Decode FRONT | `VAEDecode` | SHOT FRONT |
| 14 | Save FRONT | `SaveImage` | SHOT FRONT |
| 16 | SHOT THREE-QUARTER | `EZPromptJoin` | SHOT THREE-QUARTER |
| 17 | Positive THREE-QUARTER | `CLIPTextEncode` | SHOT THREE-QUARTER |
| 18 | Sampler THREE-QUARTER | `KSampler` | SHOT THREE-QUARTER |
| 19 | Decode THREE-QUARTER | `VAEDecode` | SHOT THREE-QUARTER |
| 20 | Save THREE-QUARTER | `SaveImage` | SHOT THREE-QUARTER |
| 22 | SHOT PROFILE | `EZPromptJoin` | SHOT PROFILE |
| 23 | Positive PROFILE | `CLIPTextEncode` | SHOT PROFILE |
...
**This graph:** `klein/identity-sheet`
...
**This graph:** `## klein/identity-sheet Three-angle Klein identity sheet. Type any character in IDENTITY. Frozen seed 42. Identity-mode enhance is on. Optional style dropdown applies to the bible. Prints ez_identity…`
...
| Instance | Value |
| --- | --- |
| SHOT FRONT | `Front camera, eye-level, 24mm. Same identity. YouTube 16:9.` |
| SHOT THREE-QUARTER | `Three-quarter camera, 35mm, body turned 45 degrees. Same identity and light. Ca…` |
| SHOT PROFILE | `Profile camera, 50mm, full side view. Same identity and light. Camera is the on…` |
...
| Instance | Value |
| --- | --- |
| Save FRONT | `ez_identity_front` |
| Save THREE-QUARTER | `ez_identity_threequarter` |
| Save PROFILE | `ez_identity_profile` |
