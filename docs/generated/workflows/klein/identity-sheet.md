...
**This graph:** `## klein/identity-sheet Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Three-angle Klein identity sheet. Type any character in IDENTITY. Frozen seed 42. Ide…`
...
**This graph:** `16:9 LTX feeder (1280×704)`
