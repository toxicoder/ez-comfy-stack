...
**Who this is for:** studio users who loaded `klein/lower-third-bg` from Apps or Workflows.

> Generated from `workflows/_lab/klein/lower-third-bg.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/lower-third-bg** from **Apps** or **Workflows**
...
flowchart LR
  ...
  N4["Positive"]
  N5["Negative"]
  N6["Size 16:9 lower-third plate"]
  N7["KSampler"]
  N8["VAE Decode"]
  N9["Save PNG"]
  N10["Operator note"]
...
| 6 | Size 16:9 lower-third plate | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `## klein/lower-third-bg Lower-third-safe 16:9 plate (Klein 4B). Default 1280×720. Prefix `ez_lowerthird`. Keep the bottom band empty; composite titles later. Occupancy: klein — stop Wan, LTX, podcast…`
...
**This graph:** `klein/lower-third-bg`
