...
**This graph:** `## klein/instagram-square Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Generic Instagram 1:1 still (Klein 4B). Default 1024×1024. Prefix `ez_ig_square`. E…`
