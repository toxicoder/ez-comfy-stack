...
**Who this is for:** studio users who loaded `klein/time-of-day` from Apps or Workflows.

> Generated from `workflows/_lab/klein/time-of-day.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/time-of-day** from **Apps** or **Workflows**
...
**This graph:** `## klein/time-of-day Same place at golden hour / dawn / noon / night (Klein 4B). Type any place in IDENTITY. SHOT GOLDEN is the identity plate. Queue the whole graph; 02–04 Klein-edit from 01. Do not…`
