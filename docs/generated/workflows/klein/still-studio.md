...
**Who this is for:** studio users who loaded `klein/still-studio` from Apps or Workflows.

> Generated from `workflows/_lab/klein/still-studio.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/still-studio** from **Apps** or **Workflows**
