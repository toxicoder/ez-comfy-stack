...
**Who this is for:** studio users who loaded `klein/dream-house-clay` from Apps or Workflows.

> Generated from `workflows/_lab/klein/dream-house-clay.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/dream-house-clay** from **Apps** or **Workflows**
...
| 22 | Clay 01 (ez_house_clay_01.png) | `LoadImage` | SHOT 01 tower |
| 23 | Encode clay 01 | `VAEEncode` | SHOT 01 tower |
| 24 | Positive + clay 01 | `ReferenceLatent` | SHOT 01 tower |
| 25 | Sampler 01 | `KSampler` | SHOT 01 tower |
| 26 | Decode 01 | `VAEDecode` | SHOT 01 tower |
| 27 | Save 01 | `SaveImage` | SHOT 01 tower |
| 30 | SHOT 02 foyer | `EZPromptJoin` | SHOT 02 foyer |
| 31 | Positive 02 | `CLIPTextEncode` | SHOT 02 foyer |
| 32 | Clay 02 (ez_house_clay_02.png) | `LoadImage` | SHOT 02 foyer |
| 33 | Encode clay 02 | `VAEEncode` | SHOT 02 foyer |
| 34 | Positive + clay 02 | `ReferenceLatent` | SHOT 02 foyer |
| 35 | Sampler 02 | `KSampler` | SHOT 02 foyer |
| 36 | Decode 02 | `VAEDecode` | SHOT 02 foyer |
| 37 | Save 02 | `SaveImage` | SHOT 02 foyer |
| 40 | SHOT 03 lounge | `EZPromptJoin` | SHOT 03 lounge |
| 41 | Positive 03 | `CLIPTextEncode` | SHOT 03 lounge |
| 42 | Clay 03 (ez_house_clay_03.png) | `LoadImage` | SHOT 03 lounge |
| 43 | Encode clay 03 | `VAEEncode` | SHOT 03 lounge |
| 44 | Positive + clay 03 | `ReferenceLatent` | SHOT 03 lounge |
| 45 | Sampler 03 | `KSampler` | SHOT 03 lounge |
| 46 | Decode 03 | `VAEDecode` | SHOT 03 lounge |
| 47 | Save 03 | `SaveImage` | SHOT 03 lounge |
| 50 | SHOT 04 kitchen | `EZPromptJoin` | SHOT 04 kitchen |
| 51 | Positive 04 | `CLIPTextEncode` | SHOT 04 kitchen |
| 52 | Clay 04 (ez_house_clay_04.png) | `LoadImage` | SHOT 04 kitchen |
| 53 | Encode clay 04 | `VAEEncode` | SHOT 04 kitchen |
| 54 | Positive + clay 04 | `ReferenceLatent` | SHOT 04 kitchen |
| 55 | Sampler 04 | `KSampler` | SHOT 04 kitchen |
| 56 | Decode 04 | `VAEDecode` | SHOT 04 kitchen |
| 57 | Save 04 | `SaveImage` | SHOT 04 kitchen |
| 60 | SHOT 05 dining | `EZPromptJoin` | SHOT 05 dining |
| 61 | Positive 05 | `CLIPTextEncode` | SHOT 05 dining |
| 62 | Clay 05 (ez_house_clay_05.png) | `LoadImage` | SHOT 05 dining |
| 63 | Encode clay 05 | `VAEEncode` | SHOT 05 dining |
| 64 | Positive + clay 05 | `ReferenceLatent` | SHOT 05 dining |
| 65 | Sampler 05 | `KSampler` | SHOT 05 dining |
| 66 | Decode 05 | `VAEDecode` | SHOT 05 dining |
| 67 | Save 05 | `SaveImage` | SHOT 05 dining |
| 70 | SHOT 06 bedroom | `EZPromptJoin` | SHOT 06 bedroom |
| 71 | Positive 06 | `CLIPTextEncode` | SHOT 06 bedroom |
| 72 | Clay 06 (ez_house_clay_06.png) | `LoadImage` | SHOT 06 bedroom |
| 73 | Encode clay 06 | `VAEEncode` | SHOT 06 bedroom |
| 74 | Positive + clay 06 | `ReferenceLatent` | SHOT 06 bedroom |
| 75 | Sampler 06 | `KSampler` | SHOT 06 bedroom |
| 76 | Decode 06 | `VAEDecode` | SHOT 06 bedroom |
| 77 | Save 06 | `SaveImage` | SHOT 06 bedroom |
| 80 | SHOT 07 bath | `EZPromptJoin` | SHOT 07 bath |
| 81 | Positive 07 | `CLIPTextEncode` | SHOT 07 bath |
| 82 | Clay 07 (ez_house_clay_07.png) | `LoadImage` | SHOT 07 bath |
| 83 | Encode clay 07 | `VAEEncode` | SHOT 07 bath |
| 84 | Positive + clay 07 | `ReferenceLatent` | SHOT 07 bath |
| 85 | Sampler 07 | `KSampler` | SHOT 07 bath |
| 86 | Decode 07 | `VAEDecode` | SHOT 07 bath |
| 87 | Save 07 | `SaveImage` | SHOT 07 bath |
| 90 | SHOT 08 terrace | `EZPromptJoin` | SHOT 08 terrace |
| 91 | Positive 08 | `CLIPTextEncode` | SHOT 08 terrace |
| 92 | Clay 08 (ez_house_clay_08.png) | `LoadImage` | SHOT 08 terrace |
| 93 | Encode clay 08 | `VAEEncode` | SHOT 08 terrace |
| 94 | Positive + clay 08 | `ReferenceLatent` | SHOT 08 terrace |
| 95 | Sampler 08 | `KSampler` | SHOT 08 terrace |
| 96 | Decode 08 | `VAEDecode` | SHOT 08 terrace |
| 97 | Save 08 | `SaveImage` | SHOT 08 terrace |
| 100 | SHOT 09 drone | `EZPromptJoin` | SHOT 09 drone |
| 101 | Positive 09 | `CLIPTextEncode` | SHOT 09 drone |
| 102 | Clay 09 (ez_house_clay_09.png) | `LoadImage` | SHOT 09 drone |
| 103 | Encode clay 09 | `VAEEncode` | SHOT 09 drone |
| 104 | Positive + clay 09 | `ReferenceLatent` | SHOT 09 drone |
| 105 | Sampler 09 | `KSampler` | SHOT 09 drone |
| 106 | Decode 09 | `VAEDecode` | SHOT 09 drone |
| 107 | Save 09 | `SaveImage` | SHOT 09 drone |
| 110 | SHOT 10 study | `EZPromptJoin` | SHOT 10 study |
| 111 | Positive 10 | `CLIPTextEncode` | SHOT 10 study |
| 112 | Clay 10 (ez_house_clay_10.png) | `LoadImage` | SHOT 10 study |
| 113 | Encode clay 10 | `VAEEncode` | SHOT 10 study |
| 114 | Positive + clay 10 | `ReferenceLatent` | SHOT 10 study |
| 115 | Sampler 10 | `KSampler` | SHOT 10 study |
| 116 | Decode 10 | `VAEDecode` | SHOT 10 study |
| 117 | Save 10 | `SaveImage` | SHOT 10 study |
| 118 | Negative Prompt Enhance | `EZNegativePromptEnhance` | Ungrouped |
...
**This graph:** `klein/dream-house-clay`
...
**This graph:** `## klein/dream-house-clay Ten Instagram 4:5 Klein **edits** of a greybox (1024x1280, seed 42). Persistence is the 3D cameras — Klein only restyles. `manage.sh start` seeds ez_house_clay_01.png … 10.p…`
...
**This graph (all 10 instances):** `Keep the clay blocking, camera, and silhouette from the start image. Do not redesign layout.`
...
| Instance | Value |
| --- | --- |
| Clay 01 (ez_house_clay_01.png) | `ez_house_clay_01.png` |
| Clay 02 (ez_house_clay_02.png) | `ez_house_clay_02.png` |
| Clay 03 (ez_house_clay_03.png) | `ez_house_clay_03.png` |
| Clay 04 (ez_house_clay_04.png) | `ez_house_clay_04.png` |
| Clay 05 (ez_house_clay_05.png) | `ez_house_clay_05.png` |
| Clay 06 (ez_house_clay_06.png) | `ez_house_clay_06.png` |
| Clay 07 (ez_house_clay_07.png) | `ez_house_clay_07.png` |
| Clay 08 (ez_house_clay_08.png) | `ez_house_clay_08.png` |
| Clay 09 (ez_house_clay_09.png) | `ez_house_clay_09.png` |
| Clay 10 (ez_house_clay_10.png) | `ez_house_clay_10.png` |
...
**This graph (all 10 instances):** `image`
...
| Instance | Value |
| --- | --- |
| Save 01 | `ez_dream_house_clay_01` |
| Save 02 | `ez_dream_house_clay_02` |
| Save 03 | `ez_dream_house_clay_03` |
| Save 04 | `ez_dream_house_clay_04` |
| Save 05 | `ez_dream_house_clay_05` |
| Save 06 | `ez_dream_house_clay_06` |
| Save 07 | `ez_dream_house_clay_07` |
| Save 08 | `ez_dream_house_clay_08` |
| Save 09 | `ez_dream_house_clay_09` |
| Save 10 | `ez_dream_house_clay_10` |
