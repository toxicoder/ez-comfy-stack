...
| 6 | Size wide banner 3:1 | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `## klein/banner-wide Channel / LinkedIn banner (Klein 4B). Default 1536×512. Prefix `ez_banner`. Keep the upper band simple for a name overlay. Occupancy: klein — stop Wan, LTX, podcast, music. One G…`
