...
**Who this is for:** studio users who loaded `klein/banner-wide` from Apps or Workflows.

> Generated from `workflows/_lab/klein/banner-wide.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/banner-wide** from **Apps** or **Workflows**
...
**This graph:** `## klein/banner-wide Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Channel / LinkedIn banner (Klein 4B). Default 1536×512. Prefix `ez_banner`. Keep the upp…`
...
**This graph:** `Channel · banner (1536×512)`
