...
| 6 | Size 4:5 tabletop | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `## klein/food-tabletop Food / tabletop still (Klein 4B). Default 1024×1280 (4:5). Prefix `ez_tabletop`. Swap the dish in the prompt; keep unmarked surfaces. Occupancy: klein — stop Wan, LTX, podcast,…`
