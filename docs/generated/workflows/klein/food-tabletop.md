...
**Who this is for:** studio users who loaded `klein/food-tabletop` from Apps or Workflows.

> Generated from `workflows/_lab/klein/food-tabletop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **klein/food-tabletop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `A photoreal food tabletop still, Instagram 4:5. A ceramic bowl of soup and a li…` |
...
**This graph:** `## klein/food-tabletop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Food / tabletop still (Klein 4B). Default 1024×1280 (4:5). Prefix `ez_tabletop`. Swap …`
...
**This graph:** `A photoreal food tabletop still, Instagram 4:5. A ceramic bowl of soup and a linen napkin on oak, soft window sidelight. Unmarked crockery, no logos, no lettering.`

```text
A photoreal food tabletop still, Instagram 4:5. A ceramic bowl of soup and a linen napkin on oak, soft window sidelight. Unmarked crockery, no logos, no lettering.
```
...
**This graph:** `klein/food-tabletop`
...
**This graph:** `Food / tabletop (1024×1280)`
