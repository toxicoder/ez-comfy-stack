...
**Who this is for:** studio users who loaded `audio/dub/clone-translate` from Apps or Workflows.

> Generated from `workflows/_lab/audio/dub/clone-translate.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **audio/dub/clone-translate** from **Apps** or **Workflows**
