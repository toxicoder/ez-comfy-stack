...
**Who this is for:** studio users who loaded `audio/music/rap-draft` from Apps or Workflows.

> Generated from `workflows/_lab/audio/music/rap-draft.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **audio/music/rap-draft** from **Apps** or **Workflows**
