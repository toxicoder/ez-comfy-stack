...
**Who this is for:** studio users who loaded `audio/music/rap-full` from Apps or Workflows.

> Generated from `workflows/_lab/audio/music/rap-full.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **audio/music/rap-full** from **Apps** or **Workflows**
...
**This graph:** `audio/music/rap-full`
...
**This graph:** `boom bap, hip-hop, dusty drums, vinyl crackle, dry snare, sampled piano stab, upright bass, male rap vocals, dry booth, no autotune, 88 bpm`
