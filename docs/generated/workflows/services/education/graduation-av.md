---
title: "services/education/graduation-av"
description: "Graduation AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/education/graduation-av
...
**Who this is for:** studio users who loaded `services/education/graduation-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/graduation-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Graduation AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_grad`.
...
2. Load **services/education/graduation-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow walk in an unmarked hall. Footfalls, room tone. No score. Keep every objec...` |
...
**This graph:** `## services/education/graduation-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Graduation AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_grad`. Empty of...`
...
**This graph:** `Slow walk in an unmarked hall. Footfalls, room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Slow walk in an unmarked hall. Footfalls, room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/education/graduation-av`
