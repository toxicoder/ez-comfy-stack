...
Graduation AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_grad`.
...
**This graph:** `## services/education/graduation-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Graduation AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_grad`. Empty of…`
