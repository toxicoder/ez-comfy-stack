---
title: "services/education/slide-break"
description: "Silent slide-break ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/education/slide-break
...
**Who this is for:** studio users who loaded `services/education/slide-break` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/slide-break.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent slide-break ~5 s. Lab size **832x480**. Prefix `ez_svc_slide`.
...
2. Load **services/education/slide-break** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Soft light drift on a quiet unmarked set. One continuous five-second take. No c...` |
...
**This graph:** `## services/education/slide-break Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent slide-break ~5 s. Lab size **832x480**. Prefix `ez_svc_slide`. Empty...`
...
**This graph:** `Soft light drift on a quiet unmarked set. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Soft light drift on a quiet unmarked set. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/education/slide-break`
