...
Silent slide-break ~5 s. Lab size **832×480**. Prefix `ez_svc_slide`.
...
**This graph:** `## services/education/slide-break Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent slide-break ~5 s. Lab size **832×480**. Prefix `ez_svc_slide`. Empty…`
