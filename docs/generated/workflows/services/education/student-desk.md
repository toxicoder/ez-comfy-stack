---
title: "services/education/student-desk"
description: "Student-desk still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/education/student-desk
...
**Who this is for:** studio users who loaded `services/education/student-desk` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/student-desk.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Student-desk still 16:9. Lab size **1280x704**. Prefix `ez_svc_desk_st`.
...
2. Load **services/education/student-desk** from **Apps** or **Workflows**
...
**This graph:** `## services/education/student-desk Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Student-desk still 16:9. Lab size **1280x704**. Prefix `ez_svc_desk_st`. E...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Sunlit oak desk, unmarked notebook, empty screens. Empty o...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Sunlit oak desk, unmarked notebook, empty screens. Empty of lettering.
```
