...
Student-desk still 16:9. Lab size **1280×704**. Prefix `ez_svc_desk_st`.
...
**This graph:** `## services/education/student-desk Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Student-desk still 16:9. Lab size **1280×704**. Prefix `ez_svc_desk_st`. E…`
