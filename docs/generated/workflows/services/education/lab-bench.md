...
Lab-bench still 16:9. Lab size **1280×704**. Prefix `ez_svc_bench`.
...
**This graph:** `## services/education/lab-bench Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Lab-bench still 16:9. Lab size **1280×704**. Prefix `ez_svc_bench`. Empty of …`
