---
title: "services/education/lab-bench"
description: "Lab-bench still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/education/lab-bench
...
**Who this is for:** studio users who loaded `services/education/lab-bench` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/lab-bench.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Lab-bench still 16:9. Lab size **1280x704**. Prefix `ez_svc_bench`.
...
2. Load **services/education/lab-bench** from **Apps** or **Workflows**
...
**This graph:** `## services/education/lab-bench Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Lab-bench still 16:9. Lab size **1280x704**. Prefix `ez_svc_bench`. Empty of ...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked bench, glassware, no logos on tools. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked bench, glassware, no logos on tools. Empty of lettering.
```
