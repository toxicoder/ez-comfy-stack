---
title: "services/education/office-hours-av"
description: "Office-hours AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/education/office-hours-av
...
**Who this is for:** studio users who loaded `services/education/office-hours-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/office-hours-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Office-hours AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_ohours`.
...
2. Load **services/education/office-hours-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Desk conversation from the start still. Soft voices as room tone. No score. Kee...` |
...
**This graph:** `## services/education/office-hours-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Office-hours AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_ohours`. Em...`
...
**This graph:** `Desk conversation from the start still. Soft voices as room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Desk conversation from the start still. Soft voices as room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/education/office-hours-av`
