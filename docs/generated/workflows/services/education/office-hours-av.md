...
Office-hours AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_ohours`.
...
**This graph:** `## services/education/office-hours-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Office-hours AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_ohours`. Em…`
