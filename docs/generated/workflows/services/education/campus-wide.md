---
title: "services/education/campus-wide"
description: "Silent campus-wide ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/education/campus-wide
...
**Who this is for:** studio users who loaded `services/education/campus-wide` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/campus-wide.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent campus-wide ~5 s. Lab size **832x480**. Prefix `ez_svc_campus`.
...
2. Load **services/education/campus-wide** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow establishing of unmarked paths and glass. Keep identity. One continuous fi...` |
...
**This graph:** `## services/education/campus-wide Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent campus-wide ~5 s. Lab size **832x480**. Prefix `ez_svc_campus`. Empt...`
...
**This graph:** `Slow establishing of unmarked paths and glass. Keep identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Slow establishing of unmarked paths and glass. Keep identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/education/campus-wide`
