...
Silent campus-wide ~5 s. Lab size **832×480**. Prefix `ez_svc_campus`.
...
**This graph:** `## services/education/campus-wide Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent campus-wide ~5 s. Lab size **832×480**. Prefix `ez_svc_campus`. Empt…`
