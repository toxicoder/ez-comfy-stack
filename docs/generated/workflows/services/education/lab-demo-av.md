---
title: "services/education/lab-demo-av"
description: "Lab-demo AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/education/lab-demo-av
...
**Who this is for:** studio users who loaded `services/education/lab-demo-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/lab-demo-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Lab-demo AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_labdm`.
...
2. Load **services/education/lab-demo-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Hands demo unmarked glassware. Soft clink. No score. Keep every object and surf...` |
...
**This graph:** `## services/education/lab-demo-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Lab-demo AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_labdm`. Empty of le...`
...
**This graph:** `Hands demo unmarked glassware. Soft clink. No score. Keep every object and surface from the start image; do not redesign.`

```text
Hands demo unmarked glassware. Soft clink. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `glass clink, no score`
...
**This graph:** `services/education/lab-demo-av`
