...
Lab-demo AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_labdm`.
...
**This graph:** `## services/education/lab-demo-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Lab-demo AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_labdm`. Empty of le…`
