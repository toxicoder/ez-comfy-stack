---
title: "services/education/screencast-loop"
description: "Silent screencast-bed loop"
tags: [workflows, generated, comfyui, services]
---

# services/education/screencast-loop
...
**Who this is for:** studio users who loaded `services/education/screencast-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/screencast-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent screencast-bed loop. Lab size **768x768**. Prefix `ez_svc_screen`.
...
2. Load **services/education/screencast-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Soft screen glow and dust motes. Locked camera. Ping-pong friendly. No walk. Ke...` |
...
**This graph:** `ez_svc_screen_frames`
...
**This graph:** `## services/education/screencast-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent screencast-bed loop. Lab size **768x768**. Prefix `ez_svc_screen...`
...
**This graph:** `Soft screen glow and dust motes. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Soft screen glow and dust motes. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/education/screencast-loop`
