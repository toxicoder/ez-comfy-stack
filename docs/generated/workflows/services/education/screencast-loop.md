...
Silent screencast-bed loop. Lab size **768×768**. Prefix `ez_svc_screen`.
...
**This graph:** `## services/education/screencast-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent screencast-bed loop. Lab size **768×768**. Prefix `ez_svc_screen…`
