...
Certificate bed 16:9. Lab size **1280×704**. Prefix `ez_svc_cert`.
...
**This graph:** `## services/education/certificate-bed Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Certificate bed 16:9. Lab size **1280×704**. Prefix `ez_svc_cert`. Empt…`
