---
title: "services/education/certificate-bed"
description: "Certificate bed 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/education/certificate-bed
...
**Who this is for:** studio users who loaded `services/education/certificate-bed` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/certificate-bed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Certificate bed 16:9. Lab size **1280x704**. Prefix `ez_svc_cert`.
...
2. Load **services/education/certificate-bed** from **Apps** or **Workflows**
...
**This graph:** `## services/education/certificate-bed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Certificate bed 16:9. Lab size **1280x704**. Prefix `ez_svc_cert`. Empt...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet linen and oak, center empty for a later overlay. Emp...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet linen and oak, center empty for a later overlay. Empty of lettering.
```
