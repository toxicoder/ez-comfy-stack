...
Course thumbnail 16:9. Lab size **1280×704**. Prefix `ez_svc_crs_th`.
...
**This graph:** `## services/education/course-thumb Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Course thumbnail 16:9. Lab size **1280×704**. Prefix `ez_svc_crs_th`. Empt…`
