---
title: "services/education/course-thumb"
description: "Course thumbnail 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/education/course-thumb
...
**Who this is for:** studio users who loaded `services/education/course-thumb` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/course-thumb.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Course thumbnail 16:9. Lab size **1280x704**. Prefix `ez_svc_crs_th`.
...
2. Load **services/education/course-thumb** from **Apps** or **Workflows**
...
**This graph:** `## services/education/course-thumb Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Course thumbnail 16:9. Lab size **1280x704**. Prefix `ez_svc_crs_th`. Empt...`
