---
title: "services/education/course-trailer-av"
description: "Course-trailer AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/education/course-trailer-av
...
**Who this is for:** studio users who loaded `services/education/course-trailer-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/course-trailer-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Course-trailer AV 9:16. Lab size **768x1280**. Prefix `ez_svc_ctrail`.
...
2. Load **services/education/course-trailer-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Vertical trailer hook from the start still. World SFX only. No score. Keep ever...` |
...
**This graph:** `## services/education/course-trailer-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Course-trailer AV 9:16. Lab size **768x1280**. Prefix `ez_svc_ctrail`...`
...
**This graph:** `Vertical trailer hook from the start still. World SFX only. No score. Keep every object and surface from the start image; do not redesign.`

```text
Vertical trailer hook from the start still. World SFX only. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/education/course-trailer-av`
