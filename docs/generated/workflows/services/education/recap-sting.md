---
title: "services/education/recap-sting"
description: "Silent recap sting ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/education/recap-sting
...
**Who this is for:** studio users who loaded `services/education/recap-sting` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/recap-sting.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent recap sting ~5 s. Lab size **832x480**. Prefix `ez_svc_recap`.
...
2. Load **services/education/recap-sting** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Short push-in toward the start-image mark. No lettering. One continuous five-se...` |
...
**This graph:** `## services/education/recap-sting Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent recap sting ~5 s. Lab size **832x480**. Prefix `ez_svc_recap`. Empty...`
...
**This graph:** `Short push-in toward the start-image mark. No lettering. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Short push-in toward the start-image mark. No lettering. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/education/recap-sting`
