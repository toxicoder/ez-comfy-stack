...
Silent recap sting ~5 s. Lab size **832×480**. Prefix `ez_svc_recap`.
...
**This graph:** `## services/education/recap-sting Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent recap sting ~5 s. Lab size **832×480**. Prefix `ez_svc_recap`. Empty…`
