...
Syllabus header 16:9. Lab size **1536×864**. Prefix `ez_svc_syl`.
...
**This graph:** `## services/education/syllabus-header Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Syllabus header 16:9. Lab size **1536×864**. Prefix `ez_svc_syl`. Empty…`
