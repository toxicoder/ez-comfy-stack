---
title: "services/education/syllabus-header"
description: "Syllabus header 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/education/syllabus-header
...
**Who this is for:** studio users who loaded `services/education/syllabus-header` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/syllabus-header.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Syllabus header 16:9. Lab size **1536x864**. Prefix `ez_svc_syl`.
...
2. Load **services/education/syllabus-header** from **Apps** or **Workflows**
...
**This graph:** `## services/education/syllabus-header Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Syllabus header 16:9. Lab size **1536x864**. Prefix `ez_svc_syl`. Empty...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Ultra-wide quiet desk, empty sky band. Empty of lettering.`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Ultra-wide quiet desk, empty sky band. Empty of lettering.
```
