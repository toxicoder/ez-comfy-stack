---
title: "services/education/lecture-av"
description: "Lecture AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/education/lecture-av
...
**Who this is for:** studio users who loaded `services/education/lecture-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/lecture-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Lecture AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_lect`.
...
2. Load **services/education/lecture-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Locked lecture take from the start still. Room tone, a chair. No score. Keep ev...` |
...
**This graph:** `## services/education/lecture-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Lecture AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_lect`. Empty of lette...`
...
**This graph:** `Locked lecture take from the start still. Room tone, a chair. No score. Keep every object and surface from the start image; do not redesign.`

```text
Locked lecture take from the start still. Room tone, a chair. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/education/lecture-av`
