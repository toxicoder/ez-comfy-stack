...
Lecture AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_lect`.
...
**This graph:** `## services/education/lecture-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Lecture AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_lect`. Empty of lette…`
