---
title: "services/education/board-still"
description: "Board still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/education/board-still
...
**Who this is for:** studio users who loaded `services/education/board-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/board-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Board still 16:9. Lab size **1280x704**. Prefix `ez_svc_board`.
...
2. Load **services/education/board-still** from **Apps** or **Workflows**
...
**This graph:** `## services/education/board-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Board still 16:9. Lab size **1280x704**. Prefix `ez_svc_board`. Empty of le...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked slate or wall, quiet for diagrams later. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked slate or wall, quiet for diagrams later. Empty of lettering.
```
