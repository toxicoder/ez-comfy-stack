...
Board still 16:9. Lab size **1280×704**. Prefix `ez_svc_board`.
...
**This graph:** `## services/education/board-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Board still 16:9. Lab size **1280×704**. Prefix `ez_svc_board`. Empty of le…`
