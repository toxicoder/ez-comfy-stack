---
title: "services/education/lesson-title"
description: "Lesson title plate 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/education/lesson-title
...
**Who this is for:** studio users who loaded `services/education/lesson-title` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/lesson-title.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Lesson title plate 16:9. Lab size **1280x704**. Prefix `ez_svc_lesson`.
...
2. Load **services/education/lesson-title** from **Apps** or **Workflows**
...
**This graph:** `## services/education/lesson-title Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Lesson title plate 16:9. Lab size **1280x704**. Prefix `ez_svc_lesson`. Em...`
