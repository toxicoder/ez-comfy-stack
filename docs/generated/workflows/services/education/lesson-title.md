...
Lesson title plate 16:9. Lab size **1280×704**. Prefix `ez_svc_lesson`.
...
**This graph:** `## services/education/lesson-title Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Lesson title plate 16:9. Lab size **1280×704**. Prefix `ez_svc_lesson`. Em…`
