...
Cohort announce still ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_cohort`.
...
**This graph:** `## services/education/cohort-announce Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Cohort announce still ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_co…`
