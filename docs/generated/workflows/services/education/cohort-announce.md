---
title: "services/education/cohort-announce"
description: "Cohort announce still ~1.91:1"
tags: [workflows, generated, comfyui, services]
---

# services/education/cohort-announce
...
**Who this is for:** studio users who loaded `services/education/cohort-announce` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/cohort-announce.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Cohort announce still ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_cohort`.
...
2. Load **services/education/cohort-announce** from **Apps** or **Workflows**
...
**This graph:** `## services/education/cohort-announce Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Cohort announce still ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_co...`
