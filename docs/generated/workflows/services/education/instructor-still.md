...
Silent instructor motion ~5 s. Lab size **832×480**. Prefix `ez_svc_instr`.
...
**This graph:** `## services/education/instructor-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent instructor motion ~5 s. Lab size **832×480**. Prefix `ez_svc_in…`
