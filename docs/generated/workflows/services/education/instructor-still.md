---
title: "services/education/instructor-still"
description: "Silent instructor motion ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/education/instructor-still
...
**Who this is for:** studio users who loaded `services/education/instructor-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/instructor-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent instructor motion ~5 s. Lab size **832x480**. Prefix `ez_svc_instr`.
...
2. Load **services/education/instructor-still** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Gentle gesture from the start-image instructor. Locked identity. One continuous...` |
...
**This graph:** `## services/education/instructor-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent instructor motion ~5 s. Lab size **832x480**. Prefix `ez_svc_in...`
...
**This graph:** `Gentle gesture from the start-image instructor. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Gentle gesture from the start-image instructor. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/education/instructor-still`
