...
Module card 1:1. Lab size **1024×1024**. Prefix `ez_svc_mod`.
...
**This graph:** `## services/education/module-card Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Module card 1:1. Lab size **1024×1024**. Prefix `ez_svc_mod`. Empty of lett…`
