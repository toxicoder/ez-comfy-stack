---
title: "services/education/module-card"
description: "Module card 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/education/module-card
...
**Who this is for:** studio users who loaded `services/education/module-card` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/module-card.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Module card 1:1. Lab size **1024x1024**. Prefix `ez_svc_mod`.
...
2. Load **services/education/module-card** from **Apps** or **Workflows**
...
**This graph:** `## services/education/module-card Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Module card 1:1. Lab size **1024x1024**. Prefix `ez_svc_mod`. Empty of lett...`
