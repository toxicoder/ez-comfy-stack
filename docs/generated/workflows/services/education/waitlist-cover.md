...
Silent waitlist cover 9:16. Lab size **480×832**. Prefix `ez_svc_wait`.
...
**This graph:** `## services/education/waitlist-cover Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent waitlist cover 9:16. Lab size **480×832**. Prefix `ez_svc_wait`. …`
