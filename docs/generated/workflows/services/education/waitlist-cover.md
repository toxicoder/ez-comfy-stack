---
title: "services/education/waitlist-cover"
description: "Silent waitlist cover 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/education/waitlist-cover
...
**Who this is for:** studio users who loaded `services/education/waitlist-cover` from Apps or Workflows.

> Generated from `workflows/_lab/services/education/waitlist-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent waitlist cover 9:16. Lab size **480x832**. Prefix `ez_svc_wait`.
...
2. Load **services/education/waitlist-cover** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow push-in on the start-image cover still. One continuous five-second take. N...` |
...
**This graph:** `## services/education/waitlist-cover Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent waitlist cover 9:16. Lab size **480x832**. Prefix `ez_svc_wait`. ...`
...
**This graph:** `Slow push-in on the start-image cover still. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Slow push-in on the start-image cover still. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/education/waitlist-cover`
