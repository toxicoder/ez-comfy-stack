...
Silent listing-hero ~5 s. Lab size **832×480**. Prefix `ez_svc_list_h`.
...
**This graph:** `## services/real-estate/listing-hero Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent listing-hero ~5 s. Lab size **832×480**. Prefix `ez_svc_list_h`. …`
