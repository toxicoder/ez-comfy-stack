---
title: "services/real-estate/listing-hero"
description: "Silent listing-hero ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/listing-hero
...
**Who this is for:** studio users who loaded `services/real-estate/listing-hero` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/listing-hero.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent listing-hero ~5 s. Lab size **832x480**. Prefix `ez_svc_list_h`.
...
2. Load **services/real-estate/listing-hero** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow push toward the start-image facade. Keep identity. One continuous five-sec...` |
...
**This graph:** `## services/real-estate/listing-hero Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent listing-hero ~5 s. Lab size **832x480**. Prefix `ez_svc_list_h`. ...`
...
**This graph:** `Slow push toward the start-image facade. Keep identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Slow push toward the start-image facade. Keep identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/real-estate/listing-hero`
