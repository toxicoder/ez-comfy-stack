---
title: "services/real-estate/twilight-av"
description: "Twilight AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/twilight-av
...
**Who this is for:** studio users who loaded `services/real-estate/twilight-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/twilight-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Twilight AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_twil`.
...
2. Load **services/real-estate/twilight-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Dusk hold on the start-image home. Distant traffic, crickets. No score. Keep ev...` |
...
**This graph:** `## services/real-estate/twilight-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Twilight AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_twil`. Empty of l...`
...
**This graph:** `Dusk hold on the start-image home. Distant traffic, crickets. No score. Keep every object and surface from the start image; do not redesign.`

```text
Dusk hold on the start-image home. Distant traffic, crickets. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `distant traffic, crickets, no score`
...
**This graph:** `services/real-estate/twilight-av`
