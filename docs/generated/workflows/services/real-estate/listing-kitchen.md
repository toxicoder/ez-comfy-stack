...
Listing kitchen still 16:9. Lab size **1280×704**. Prefix `ez_svc_list_k`.
...
**This graph:** `## services/real-estate/listing-kitchen Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Listing kitchen still 16:9. Lab size **1280×704**. Prefix `ez_svc_lis…`
