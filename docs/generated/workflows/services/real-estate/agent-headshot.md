---
title: "services/real-estate/agent-headshot"
description: "Agent headshot 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/agent-headshot
...
**Who this is for:** studio users who loaded `services/real-estate/agent-headshot` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/agent-headshot.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Agent headshot 1:1. Lab size **1024x1024**. Prefix `ez_svc_agent`.
...
2. Load **services/real-estate/agent-headshot** from **Apps** or **Workflows**
...
**This graph:** `## services/real-estate/agent-headshot Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Agent headshot 1:1. Lab size **1024x1024**. Prefix `ez_svc_agent`. Emp...`
