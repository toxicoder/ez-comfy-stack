...
Agent headshot 1:1. Lab size **1024×1024**. Prefix `ez_svc_agent`.
...
**This graph:** `## services/real-estate/agent-headshot Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Agent headshot 1:1. Lab size **1024×1024**. Prefix `ez_svc_agent`. Emp…`
