---
title: "services/real-estate/aerial-still"
description: "Aerial listing still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/aerial-still
...
**Who this is for:** studio users who loaded `services/real-estate/aerial-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/aerial-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Aerial listing still 16:9. Lab size **1536x864**. Prefix `ez_svc_aerial`.
...
2. Load **services/real-estate/aerial-still** from **Apps** or **Workflows**
...
**This graph:** `## services/real-estate/aerial-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Aerial listing still 16:9. Lab size **1536x864**. Prefix `ez_svc_aerial`...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. High unmarked neighborhood, no logos on roofs. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. High unmarked neighborhood, no logos on roofs. Empty of lettering.
```
