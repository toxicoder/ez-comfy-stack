---
title: "services/real-estate/listing-yard"
description: "Silent listing-yard ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/listing-yard
...
**Who this is for:** studio users who loaded `services/real-estate/listing-yard` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/listing-yard.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent listing-yard ~5 s. Lab size **832x480**. Prefix `ez_svc_list_y`.
...
2. Load **services/real-estate/listing-yard** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Breeze in unmarked grass and leaves. Keep the start image. One continuous five-...` |
...
**This graph:** `## services/real-estate/listing-yard Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent listing-yard ~5 s. Lab size **832x480**. Prefix `ez_svc_list_y`. ...`
...
**This graph:** `Breeze in unmarked grass and leaves. Keep the start image. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Breeze in unmarked grass and leaves. Keep the start image. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/real-estate/listing-yard`
