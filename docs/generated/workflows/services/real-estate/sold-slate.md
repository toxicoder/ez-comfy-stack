...
Sold slate 1:1. Lab size **1024×1024**. Prefix `ez_svc_sold`.
...
**This graph:** `## services/real-estate/sold-slate Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Sold slate 1:1. Lab size **1024×1024**. Prefix `ez_svc_sold`. Empty of let…`
