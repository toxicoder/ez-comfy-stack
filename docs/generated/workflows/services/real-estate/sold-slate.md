---
title: "services/real-estate/sold-slate"
description: "Sold slate 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/sold-slate
...
**Who this is for:** studio users who loaded `services/real-estate/sold-slate` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/sold-slate.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Sold slate 1:1. Lab size **1024x1024**. Prefix `ez_svc_sold`.
...
2. Load **services/real-estate/sold-slate** from **Apps** or **Workflows**
...
**This graph:** `## services/real-estate/sold-slate Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Sold slate 1:1. Lab size **1024x1024**. Prefix `ez_svc_sold`. Empty of let...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Quiet square still, center empty for overlay type later. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Quiet square still, center empty for overlay type later. Empty of lettering.
```
