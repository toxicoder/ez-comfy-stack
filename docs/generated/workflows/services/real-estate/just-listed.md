---
title: "services/real-estate/just-listed"
description: "Silent just-listed ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/just-listed
...
**Who this is for:** studio users who loaded `services/real-estate/just-listed` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/just-listed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent just-listed ~5 s. Lab size **832x480**. Prefix `ez_svc_jlist`.
...
2. Load **services/real-estate/just-listed** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Gentle light lift on the start-image facade. One continuous five-second take. N...` |
...
**This graph:** `## services/real-estate/just-listed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent just-listed ~5 s. Lab size **832x480**. Prefix `ez_svc_jlist`. Emp...`
...
**This graph:** `Gentle light lift on the start-image facade. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Gentle light lift on the start-image facade. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/real-estate/just-listed`
