---
title: "services/real-estate/listing-bedroom"
description: "Listing bedroom still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/listing-bedroom
...
**Who this is for:** studio users who loaded `services/real-estate/listing-bedroom` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/listing-bedroom.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Listing bedroom still 16:9. Lab size **1280x704**. Prefix `ez_svc_list_br`.
...
2. Load **services/real-estate/listing-bedroom** from **Apps** or **Workflows**
...
**This graph:** `## services/real-estate/listing-bedroom Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Listing bedroom still 16:9. Lab size **1280x704**. Prefix `ez_svc_lis...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked bedroom, linen bedding, quiet window. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked bedroom, linen bedding, quiet window. Empty of lettering.
```
