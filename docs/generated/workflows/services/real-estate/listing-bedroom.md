...
Listing bedroom still 16:9. Lab size **1280×704**. Prefix `ez_svc_list_br`.
...
**This graph:** `## services/real-estate/listing-bedroom Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Listing bedroom still 16:9. Lab size **1280×704**. Prefix `ez_svc_lis…`
