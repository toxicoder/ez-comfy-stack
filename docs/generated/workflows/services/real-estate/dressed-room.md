...
Dressed-room still 16:9. Lab size **1280×704**. Prefix `ez_svc_dress`.
...
**This graph:** `## services/real-estate/dressed-room Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Dressed-room still 16:9. Lab size **1280×704**. Prefix `ez_svc_dress`. E…`
