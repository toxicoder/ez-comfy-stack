---
title: "services/real-estate/dressed-room"
description: "Dressed-room still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/dressed-room
...
**Who this is for:** studio users who loaded `services/real-estate/dressed-room` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/dressed-room.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Dressed-room still 16:9. Lab size **1280x704**. Prefix `ez_svc_dress`.
...
2. Load **services/real-estate/dressed-room** from **Apps** or **Workflows**
...
**This graph:** `## services/real-estate/dressed-room Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Dressed-room still 16:9. Lab size **1280x704**. Prefix `ez_svc_dress`. E...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Staged unmarked living room, linen sofa, no logos. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Staged unmarked living room, linen sofa, no logos. Empty of lettering.
```
