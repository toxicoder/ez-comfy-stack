---
title: "services/real-estate/amenity-loop"
description: "Silent amenity loop"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/amenity-loop
...
**Who this is for:** studio users who loaded `services/real-estate/amenity-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/amenity-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent amenity loop. Lab size **768x768**. Prefix `ez_svc_amen`.
...
2. Load **services/real-estate/amenity-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Water shimmers in an unmarked pool. Tiny cyclic motion. Locked camera. Ping-pon...` |
...
**This graph:** `## services/real-estate/amenity-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent amenity loop. Lab size **768x768**. Prefix `ez_svc_amen`. Empty o...`
...
**This graph:** `Water shimmers in an unmarked pool. Tiny cyclic motion. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Water shimmers in an unmarked pool. Tiny cyclic motion. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/real-estate/amenity-loop`
