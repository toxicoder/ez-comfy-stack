---
title: "services/real-estate/neighborhood-av"
description: "Neighborhood AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/neighborhood-av
...
**Who this is for:** studio users who loaded `services/real-estate/neighborhood-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/neighborhood-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Neighborhood AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_nhood`.
...
2. Load **services/real-estate/neighborhood-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Slow street establishing. Birds, distant cars, no score.` |
...
**This graph:** `## services/real-estate/neighborhood-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Neighborhood AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_nhood`. E...`
...
**This graph:** `Slow street establishing. Birds, distant cars, no score.`
...
**This graph:** `birds, distant cars, no score`
...
**This graph:** `services/real-estate/neighborhood-av`
