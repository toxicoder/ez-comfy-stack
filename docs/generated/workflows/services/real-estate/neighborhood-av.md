...
Neighborhood AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_nhood`.
...
**This graph:** `## services/real-estate/neighborhood-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Neighborhood AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_nhood`. E…`
