...
Listing bath still 16:9. Lab size **1280×704**. Prefix `ez_svc_list_b`.
...
**This graph:** `## services/real-estate/listing-bath Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Listing bath still 16:9. Lab size **1280×704**. Prefix `ez_svc_list_b`. …`
