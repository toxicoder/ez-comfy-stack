---
title: "services/real-estate/listing-bath"
description: "Listing bath still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/listing-bath
...
**Who this is for:** studio users who loaded `services/real-estate/listing-bath` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/listing-bath.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Listing bath still 16:9. Lab size **1280x704**. Prefix `ez_svc_list_b`.
...
2. Load **services/real-estate/listing-bath** from **Apps** or **Workflows**
...
**This graph:** `## services/real-estate/listing-bath Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Listing bath still 16:9. Lab size **1280x704**. Prefix `ez_svc_list_b`. ...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked wet room, stone and frosted glass. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked wet room, stone and frosted glass. Empty of lettering.
```
