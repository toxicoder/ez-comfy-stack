---
title: "services/real-estate/handoff-av"
description: "Handoff AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/handoff-av
...
**Who this is for:** studio users who loaded `services/real-estate/handoff-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/handoff-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Handoff AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_handof`.
...
2. Load **services/real-estate/handoff-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Keys pass on an unmarked porch. Metal clink, room tone. No score. Keep every ob...` |
...
**This graph:** `## services/real-estate/handoff-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Handoff AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_handof`. Empty of l...`
...
**This graph:** `Keys pass on an unmarked porch. Metal clink, room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Keys pass on an unmarked porch. Metal clink, room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `key clink, room tone, no score`
...
**This graph:** `services/real-estate/handoff-av`
