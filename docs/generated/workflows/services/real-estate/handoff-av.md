...
Handoff AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_handof`.
...
**This graph:** `## services/real-estate/handoff-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Handoff AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_handof`. Empty of l…`
