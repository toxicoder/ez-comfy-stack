---
title: "services/real-estate/empty-room"
description: "Empty-room still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/empty-room
...
**Who this is for:** studio users who loaded `services/real-estate/empty-room` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/empty-room.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Empty-room still 16:9. Lab size **1280x704**. Prefix `ez_svc_empty`.
...
2. Load **services/real-estate/empty-room** from **Apps** or **Workflows**
...
**This graph:** `## services/real-estate/empty-room Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Empty-room still 16:9. Lab size **1280x704**. Prefix `ez_svc_empty`. Empty...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Vacant unmarked room, plaster and oak, raking light. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Vacant unmarked room, plaster and oak, raking light. Empty of lettering.
```
