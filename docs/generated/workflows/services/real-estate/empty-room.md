...
Empty-room still 16:9. Lab size **1280×704**. Prefix `ez_svc_empty`.
...
**This graph:** `## services/real-estate/empty-room Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Empty-room still 16:9. Lab size **1280×704**. Prefix `ez_svc_empty`. Empty…`
