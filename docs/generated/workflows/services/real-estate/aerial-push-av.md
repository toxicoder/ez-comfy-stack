---
title: "services/real-estate/aerial-push-av"
description: "Aerial-push AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/aerial-push-av
...
**Who this is for:** studio users who loaded `services/real-estate/aerial-push-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/aerial-push-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Aerial-push AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_apush`.
...
2. Load **services/real-estate/aerial-push-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Slow aerial push over unmarked roofs. Wind, no score.` |
...
**This graph:** `## services/real-estate/aerial-push-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Aerial-push AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_apush`. Emp...`
...
**This graph:** `Slow aerial push over unmarked roofs. Wind, no score.`
...
**This graph:** `services/real-estate/aerial-push-av`
