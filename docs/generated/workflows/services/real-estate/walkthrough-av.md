---
title: "services/real-estate/walkthrough-av"
description: "Walkthrough AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/walkthrough-av
...
**Who this is for:** studio users who loaded `services/real-estate/walkthrough-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/walkthrough-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Walkthrough AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_walkth`.
...
2. Load **services/real-estate/walkthrough-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow walk through the start-image interior. Footfalls, room tone. No score. Kee...` |
...
**This graph:** `## services/real-estate/walkthrough-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Walkthrough AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_walkth`. Em...`
...
**This graph:** `Slow walk through the start-image interior. Footfalls, room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Slow walk through the start-image interior. Footfalls, room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `footfalls, room tone, no score`
...
**This graph:** `services/real-estate/walkthrough-av`
