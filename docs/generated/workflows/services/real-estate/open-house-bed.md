...
Open-house bed ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_openh`.
...
**This graph:** `## services/real-estate/open-house-bed Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Open-house bed ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_openh`. …`
