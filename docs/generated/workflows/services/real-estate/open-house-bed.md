---
title: "services/real-estate/open-house-bed"
description: "Open-house bed ~1.91:1"
tags: [workflows, generated, comfyui, services]
---

# services/real-estate/open-house-bed
...
**Who this is for:** studio users who loaded `services/real-estate/open-house-bed` from Apps or Workflows.

> Generated from `workflows/_lab/services/real-estate/open-house-bed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Open-house bed ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_openh`.
...
2. Load **services/real-estate/open-house-bed** from **Apps** or **Workflows**
...
**This graph:** `## services/real-estate/open-house-bed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Open-house bed ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_openh`. ...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Quiet wide interior, center empty for overlay type later. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Quiet wide interior, center empty for overlay type later. Empty of lettering.
```
