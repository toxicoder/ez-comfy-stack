---
title: "services/b2b-saas/office-wide"
description: "Silent office-wide ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/office-wide
...
**Who this is for:** studio users who loaded `services/b2b-saas/office-wide` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/office-wide.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent office-wide ~5 s. Lab size **832x480**. Prefix `ez_svc_off_w`.
...
2. Load **services/b2b-saas/office-wide** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Soft people-motion in an unmarked office. Empty screens. One continuous five-se...` |
...
**This graph:** `## services/b2b-saas/office-wide Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent office-wide ~5 s. Lab size **832x480**. Prefix `ez_svc_off_w`. Empty ...`
...
**This graph:** `Soft people-motion in an unmarked office. Empty screens. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Soft people-motion in an unmarked office. Empty screens. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/b2b-saas/office-wide`
