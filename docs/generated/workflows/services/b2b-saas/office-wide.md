...
Silent office-wide ~5 s. Lab size **832×480**. Prefix `ez_svc_off_w`.
...
**This graph:** `## services/b2b-saas/office-wide Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent office-wide ~5 s. Lab size **832×480**. Prefix `ez_svc_off_w`. Empty …`
