...
Customer-story AV 9:16. Lab size **768×1280**. Prefix `ez_svc_cust`.
...
**This graph:** `## services/b2b-saas/customer-story-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Customer-story AV 9:16. Lab size **768×1280**. Prefix `ez_svc_cust`. E…`
