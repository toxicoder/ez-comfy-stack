---
title: "services/b2b-saas/customer-story-av"
description: "Customer-story AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/customer-story-av
...
**Who this is for:** studio users who loaded `services/b2b-saas/customer-story-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/customer-story-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Customer-story AV 9:16. Lab size **768x1280**. Prefix `ez_svc_cust`.
...
2. Load **services/b2b-saas/customer-story-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Talking take from the start still. Room tone. Mouths will not match. No score. ...` |
...
**This graph:** `## services/b2b-saas/customer-story-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Customer-story AV 9:16. Lab size **768x1280**. Prefix `ez_svc_cust`. E...`
...
**This graph:** `Talking take from the start still. Room tone. Mouths will not match. No score. Keep every object and surface from the start image; do not redesign.`

```text
Talking take from the start still. Room tone. Mouths will not match. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/b2b-saas/customer-story-av`
