...
Webinar-open AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_webop`.
...
**This graph:** `## services/b2b-saas/webinar-open-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Webinar-open AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_webop`. Empt…`
