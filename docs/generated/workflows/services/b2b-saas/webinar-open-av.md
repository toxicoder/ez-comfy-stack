---
title: "services/b2b-saas/webinar-open-av"
description: "Webinar-open AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/webinar-open-av
...
**Who this is for:** studio users who loaded `services/b2b-saas/webinar-open-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/webinar-open-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Webinar-open AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_webop`.
...
2. Load **services/b2b-saas/webinar-open-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Host sits down from the start still. Chair, room tone. No score. Keep every obj...` |
...
**This graph:** `## services/b2b-saas/webinar-open-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Webinar-open AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_webop`. Empt...`
...
**This graph:** `Host sits down from the start still. Chair, room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Host sits down from the start still. Chair, room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `chair, room tone, no score`
...
**This graph:** `services/b2b-saas/webinar-open-av`
