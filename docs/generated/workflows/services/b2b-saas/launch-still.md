...
Launch still 16:9. Lab size **1280×704**. Prefix `ez_svc_launch`.
...
**This graph:** `## services/b2b-saas/launch-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Launch still 16:9. Lab size **1280×704**. Prefix `ez_svc_launch`. Empty of …`
