---
title: "services/b2b-saas/launch-still"
description: "Launch still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/launch-still
...
**Who this is for:** studio users who loaded `services/b2b-saas/launch-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/launch-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Launch still 16:9. Lab size **1280x704**. Prefix `ez_svc_launch`.
...
2. Load **services/b2b-saas/launch-still** from **Apps** or **Workflows**
...
**This graph:** `## services/b2b-saas/launch-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Launch still 16:9. Lab size **1280x704**. Prefix `ez_svc_launch`. Empty of ...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet launch plate, unmarked desk, empty of lettering. Emp...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet launch plate, unmarked desk, empty of lettering. Empty of lettering.
```
