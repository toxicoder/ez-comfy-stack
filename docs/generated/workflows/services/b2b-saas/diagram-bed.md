...
Diagram bed 16:9. Lab size **1280×704**. Prefix `ez_svc_diag`.
...
**This graph:** `## services/b2b-saas/diagram-bed Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Diagram bed 16:9. Lab size **1280×704**. Prefix `ez_svc_diag`. Empty of lett…`
