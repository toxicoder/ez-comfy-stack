---
title: "services/b2b-saas/diagram-bed"
description: "Diagram bed 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/diagram-bed
...
**Who this is for:** studio users who loaded `services/b2b-saas/diagram-bed` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/diagram-bed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Diagram bed 16:9. Lab size **1280x704**. Prefix `ez_svc_diag`.
...
2. Load **services/b2b-saas/diagram-bed** from **Apps** or **Workflows**
...
**This graph:** `## services/b2b-saas/diagram-bed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Diagram bed 16:9. Lab size **1280x704**. Prefix `ez_svc_diag`. Empty of lett...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet center for a diagram overlay later. Empty of letteri...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet center for a diagram overlay later. Empty of lettering.
```
