...
Report cover ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_report`.
...
**This graph:** `## services/b2b-saas/report-cover Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Report cover ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_report`. Empty …`
