---
title: "services/b2b-saas/report-cover"
description: "Report cover ~1.91:1"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/report-cover
...
**Who this is for:** studio users who loaded `services/b2b-saas/report-cover` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/report-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Report cover ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_report`.
...
2. Load **services/b2b-saas/report-cover** from **Apps** or **Workflows**
...
**This graph:** `## services/b2b-saas/report-cover Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Report cover ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_report`. Empty ...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Wide still, unmarked desk, quiet right third. Empty of let...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Wide still, unmarked desk, quiet right third. Empty of lettering.
```
