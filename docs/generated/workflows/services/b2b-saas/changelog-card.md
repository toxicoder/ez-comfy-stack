...
Silent changelog card ~5 s. Lab size **832×480**. Prefix `ez_svc_chglog`.
...
**This graph:** `## services/b2b-saas/changelog-card Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent changelog card ~5 s. Lab size **832×480**. Prefix `ez_svc_chglog`.…`
