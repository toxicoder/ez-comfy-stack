---
title: "services/b2b-saas/changelog-card"
description: "Silent changelog card ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/changelog-card
...
**Who this is for:** studio users who loaded `services/b2b-saas/changelog-card` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/changelog-card.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent changelog card ~5 s. Lab size **832x480**. Prefix `ez_svc_chglog`.
...
2. Load **services/b2b-saas/changelog-card** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Soft cursor-like light crawl on an empty unmarked screen. One continuous five-s...` |
...
**This graph:** `## services/b2b-saas/changelog-card Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent changelog card ~5 s. Lab size **832x480**. Prefix `ez_svc_chglog`....`
...
**This graph:** `Soft cursor-like light crawl on an empty unmarked screen. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Soft cursor-like light crawl on an empty unmarked screen. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/b2b-saas/changelog-card`
