---
title: "services/b2b-saas/pricing-bed"
description: "Pricing bed 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/pricing-bed
...
**Who this is for:** studio users who loaded `services/b2b-saas/pricing-bed` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/pricing-bed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Pricing bed 16:9. Lab size **1280x704**. Prefix `ez_svc_price`.
...
2. Load **services/b2b-saas/pricing-bed** from **Apps** or **Workflows**
...
**This graph:** `## services/b2b-saas/pricing-bed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Pricing bed 16:9. Lab size **1280x704**. Prefix `ez_svc_price`. Empty of let...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet center for overlay type later. Empty screens. Empty ...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet center for overlay type later. Empty screens. Empty of lettering.
```
