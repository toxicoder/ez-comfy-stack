---
title: "services/b2b-saas/case-cover"
description: "Case-study cover ~1.91:1"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/case-cover
...
**Who this is for:** studio users who loaded `services/b2b-saas/case-cover` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/case-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Case-study cover ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_case`.
...
2. Load **services/b2b-saas/case-cover** from **Apps** or **Workflows**
...
**This graph:** `## services/b2b-saas/case-cover Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Case-study cover ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_case`. Empty ...`
