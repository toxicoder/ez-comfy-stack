---
title: "services/b2b-saas/webinar-thumb"
description: "Webinar thumbnail 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/webinar-thumb
...
**Who this is for:** studio users who loaded `services/b2b-saas/webinar-thumb` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/webinar-thumb.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Webinar thumbnail 16:9. Lab size **1280x704**. Prefix `ez_svc_webth`.
...
2. Load **services/b2b-saas/webinar-thumb** from **Apps** or **Workflows**
...
**This graph:** `## services/b2b-saas/webinar-thumb Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Webinar thumbnail 16:9. Lab size **1280x704**. Prefix `ez_svc_webth`. Empt...`
