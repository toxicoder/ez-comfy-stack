...
Feature card 1:1. Lab size **1024×1024**. Prefix `ez_svc_feat`.
...
**This graph:** `## services/b2b-saas/feature-card Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Feature card 1:1. Lab size **1024×1024**. Prefix `ez_svc_feat`. Empty of le…`
