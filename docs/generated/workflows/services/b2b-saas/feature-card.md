---
title: "services/b2b-saas/feature-card"
description: "Feature card 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/feature-card
...
**Who this is for:** studio users who loaded `services/b2b-saas/feature-card` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/feature-card.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Feature card 1:1. Lab size **1024x1024**. Prefix `ez_svc_feat`.
...
2. Load **services/b2b-saas/feature-card** from **Apps** or **Workflows**
...
**This graph:** `## services/b2b-saas/feature-card Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Feature card 1:1. Lab size **1024x1024**. Prefix `ez_svc_feat`. Empty of le...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet square still, empty screen, center clear for type la...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet square still, empty screen, center clear for type later. Empty of lettering.
```
