...
Keynote still 16:9. Lab size **1280×704**. Prefix `ez_svc_keynt`.
...
**This graph:** `## services/b2b-saas/keynote-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Keynote still 16:9. Lab size **1280×704**. Prefix `ez_svc_keynt`. Empty of…`
