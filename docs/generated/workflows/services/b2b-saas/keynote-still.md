---
title: "services/b2b-saas/keynote-still"
description: "Keynote still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/keynote-still
...
**Who this is for:** studio users who loaded `services/b2b-saas/keynote-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/keynote-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Keynote still 16:9. Lab size **1280x704**. Prefix `ez_svc_keynt`.
...
2. Load **services/b2b-saas/keynote-still** from **Apps** or **Workflows**
...
**This graph:** `## services/b2b-saas/keynote-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Keynote still 16:9. Lab size **1280x704**. Prefix `ez_svc_keynt`. Empty of...`
