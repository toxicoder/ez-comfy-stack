---
title: "services/b2b-saas/founder-still"
description: "Silent founder motion ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/founder-still
...
**Who this is for:** studio users who loaded `services/b2b-saas/founder-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/founder-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent founder motion ~5 s. Lab size **832x480**. Prefix `ez_svc_found`.
...
2. Load **services/b2b-saas/founder-still** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Gentle gesture from the start-image founder. Locked identity. One continuous fi...` |
...
**This graph:** `## services/b2b-saas/founder-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent founder motion ~5 s. Lab size **832x480**. Prefix `ez_svc_found`. E...`
...
**This graph:** `Gentle gesture from the start-image founder. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Gentle gesture from the start-image founder. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/b2b-saas/founder-still`
