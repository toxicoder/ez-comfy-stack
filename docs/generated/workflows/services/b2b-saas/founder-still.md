...
Silent founder motion ~5 s. Lab size **832×480**. Prefix `ez_svc_found`.
...
**This graph:** `## services/b2b-saas/founder-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent founder motion ~5 s. Lab size **832×480**. Prefix `ez_svc_found`. E…`
