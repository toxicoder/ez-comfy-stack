---
title: "services/b2b-saas/ui-hero"
description: "UI hero still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/ui-hero
...
**Who this is for:** studio users who loaded `services/b2b-saas/ui-hero` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/ui-hero.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
UI hero still 16:9. Lab size **1536x864**. Prefix `ez_svc_ui`.
...
2. Load **services/b2b-saas/ui-hero** from **Apps** or **Workflows**
...
**This graph:** `## services/b2b-saas/ui-hero Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. UI hero still 16:9. Lab size **1536x864**. Prefix `ez_svc_ui`. Empty of letterin...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Unmarked laptop with an empty screen on oak, wide banner. ...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Unmarked laptop with an empty screen on oak, wide banner. Empty of lettering.
```
