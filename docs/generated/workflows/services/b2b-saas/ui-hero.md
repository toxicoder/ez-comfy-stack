...
UI hero still 16:9. Lab size **1536×864**. Prefix `ez_svc_ui`.
...
**This graph:** `## services/b2b-saas/ui-hero Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. UI hero still 16:9. Lab size **1536×864**. Prefix `ez_svc_ui`. Empty of letterin…`
