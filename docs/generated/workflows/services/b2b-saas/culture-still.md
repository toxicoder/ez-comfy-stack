---
title: "services/b2b-saas/culture-still"
description: "Culture still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/culture-still
...
**Who this is for:** studio users who loaded `services/b2b-saas/culture-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/culture-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Culture still 16:9. Lab size **1280x704**. Prefix `ez_svc_cult`.
...
2. Load **services/b2b-saas/culture-still** from **Apps** or **Workflows**
...
**This graph:** `## services/b2b-saas/culture-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Culture still 16:9. Lab size **1280x704**. Prefix `ez_svc_cult`. Empty of ...`
