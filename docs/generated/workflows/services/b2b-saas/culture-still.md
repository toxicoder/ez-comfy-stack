...
Culture still 16:9. Lab size **1280×704**. Prefix `ez_svc_cult`.
...
**This graph:** `## services/b2b-saas/culture-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Culture still 16:9. Lab size **1280×704**. Prefix `ez_svc_cult`. Empty of …`
