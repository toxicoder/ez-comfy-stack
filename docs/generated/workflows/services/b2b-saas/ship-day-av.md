---
title: "services/b2b-saas/ship-day-av"
description: "Ship-day AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/ship-day-av
...
**Who this is for:** studio users who loaded `services/b2b-saas/ship-day-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/ship-day-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Ship-day AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_ship`.
...
2. Load **services/b2b-saas/ship-day-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Soft celebration on an unmarked desk. Paper motes, no flash. No score. Keep eve...` |
...
**This graph:** `## services/b2b-saas/ship-day-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Ship-day AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_ship`. Empty of lett...`
...
**This graph:** `Soft celebration on an unmarked desk. Paper motes, no flash. No score. Keep every object and surface from the start image; do not redesign.`

```text
Soft celebration on an unmarked desk. Paper motes, no flash. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `paper motes, room tone, no score`
...
**This graph:** `services/b2b-saas/ship-day-av`
