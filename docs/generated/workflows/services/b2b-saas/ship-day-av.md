...
Ship-day AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_ship`.
...
**This graph:** `## services/b2b-saas/ship-day-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Ship-day AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_ship`. Empty of lett…`
