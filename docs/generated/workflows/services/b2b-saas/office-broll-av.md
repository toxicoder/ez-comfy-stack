---
title: "services/b2b-saas/office-broll-av"
description: "Office B-roll AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/office-broll-av
...
**Who this is for:** studio users who loaded `services/b2b-saas/office-broll-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/office-broll-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Office B-roll AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_offbr`.
...
2. Load **services/b2b-saas/office-broll-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Ambient unmarked office. Keycaps, HVAC hush, no score.` |
...
**This graph:** `## services/b2b-saas/office-broll-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Office B-roll AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_offbr`. Emp...`
...
**This graph:** `Ambient unmarked office. Keycaps, HVAC hush, no score.`
...
**This graph:** `keycaps, HVAC, no score`
...
**This graph:** `services/b2b-saas/office-broll-av`
