...
Office B-roll AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_offbr`.
...
**This graph:** `## services/b2b-saas/office-broll-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Office B-roll AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_offbr`. Emp…`
