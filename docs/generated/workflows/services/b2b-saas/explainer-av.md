---
title: "services/b2b-saas/explainer-av"
description: "Explainer AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/explainer-av
...
**Who this is for:** studio users who loaded `services/b2b-saas/explainer-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/explainer-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Explainer AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_expl`.
...
2. Load **services/b2b-saas/explainer-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Talking explainer from the start still. Room tone. No score. Keep every object ...` |
...
**This graph:** `## services/b2b-saas/explainer-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Explainer AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_expl`. Empty of le...`
...
**This graph:** `Talking explainer from the start still. Room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Talking explainer from the start still. Room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/b2b-saas/explainer-av`
