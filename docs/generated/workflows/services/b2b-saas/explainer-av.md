...
Explainer AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_expl`.
...
**This graph:** `## services/b2b-saas/explainer-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Explainer AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_expl`. Empty of le…`
