...
Cursor-demo AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_cursor`.
...
**This graph:** `## services/b2b-saas/cursor-demo-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Cursor-demo AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_cursor`. Empty…`
