---
title: "services/b2b-saas/cursor-demo-av"
description: "Cursor-demo AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/cursor-demo-av
...
**Who this is for:** studio users who loaded `services/b2b-saas/cursor-demo-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/cursor-demo-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Cursor-demo AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_cursor`.
...
2. Load **services/b2b-saas/cursor-demo-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Empty unmarked screen, a cursor crawls. Soft clicks. No score. Keep every objec...` |
...
**This graph:** `## services/b2b-saas/cursor-demo-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Cursor-demo AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_cursor`. Empty...`
...
**This graph:** `Empty unmarked screen, a cursor crawls. Soft clicks. No score. Keep every object and surface from the start image; do not redesign.`

```text
Empty unmarked screen, a cursor crawls. Soft clicks. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/b2b-saas/cursor-demo-av`
