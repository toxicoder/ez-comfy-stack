...
Ebook cover 4:5. Lab size **1024×1280**. Prefix `ez_svc_ebook`.
...
**This graph:** `## services/b2b-saas/ebook-cover Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Ebook cover 4:5. Lab size **1024×1280**. Prefix `ez_svc_ebook`. Empty of let…`
