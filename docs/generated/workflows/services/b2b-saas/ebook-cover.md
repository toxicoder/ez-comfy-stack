---
title: "services/b2b-saas/ebook-cover"
description: "Ebook cover 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/b2b-saas/ebook-cover
...
**Who this is for:** studio users who loaded `services/b2b-saas/ebook-cover` from Apps or Workflows.

> Generated from `workflows/_lab/services/b2b-saas/ebook-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Ebook cover 4:5. Lab size **1024x1280**. Prefix `ez_svc_ebook`.
...
2. Load **services/b2b-saas/ebook-cover** from **Apps** or **Workflows**
...
**This graph:** `## services/b2b-saas/ebook-cover Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Ebook cover 4:5. Lab size **1024x1280**. Prefix `ez_svc_ebook`. Empty of let...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet 4:5 still, center empty for overlay type later. Empt...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet 4:5 still, center empty for overlay type later. Empty of lettering.
```
