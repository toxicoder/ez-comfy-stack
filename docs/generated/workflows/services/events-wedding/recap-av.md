...
Recap AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_erecap`.
...
**This graph:** `## services/events-wedding/recap-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Recap AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_erecap`. Empty of le…`
