---
title: "services/events-wedding/recap-av"
description: "Recap AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/recap-av
...
**Who this is for:** studio users who loaded `services/events-wedding/recap-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/recap-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Recap AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_erecap`.
...
2. Load **services/events-wedding/recap-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow recap take from the start still. World SFX only. No score. Keep every obje...` |
...
**This graph:** `## services/events-wedding/recap-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Recap AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_erecap`. Empty of le...`
...
**This graph:** `Slow recap take from the start still. World SFX only. No score. Keep every object and surface from the start image; do not redesign.`

```text
Slow recap take from the start still. World SFX only. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/events-wedding/recap-av`
