---
title: "services/events-wedding/highlight-still"
description: "Highlight still 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/highlight-still
...
**Who this is for:** studio users who loaded `services/events-wedding/highlight-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/highlight-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Highlight still 4:5. Lab size **1024x1280**. Prefix `ez_svc_hlite`.
...
2. Load **services/events-wedding/highlight-still** from **Apps** or **Workflows**
...
**This graph:** `## services/events-wedding/highlight-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Highlight still 4:5. Lab size **1024x1280**. Prefix `ez_svc_hlite`...`
