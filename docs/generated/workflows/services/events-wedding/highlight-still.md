...
Highlight still 4:5. Lab size **1024×1280**. Prefix `ez_svc_hlite`.
...
**This graph:** `## services/events-wedding/highlight-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Highlight still 4:5. Lab size **1024×1280**. Prefix `ez_svc_hlite`…`
