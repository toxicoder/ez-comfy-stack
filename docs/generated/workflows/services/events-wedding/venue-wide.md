---
title: "services/events-wedding/venue-wide"
description: "Silent venue-wide ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/venue-wide
...
**Who this is for:** studio users who loaded `services/events-wedding/venue-wide` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/venue-wide.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent venue-wide ~5 s. Lab size **832x480**. Prefix `ez_svc_venue`.
...
2. Load **services/events-wedding/venue-wide** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Gentle guest-motion in an unmarked hall. Keep identity. One continuous five-sec...` |
...
**This graph:** `## services/events-wedding/venue-wide Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent venue-wide ~5 s. Lab size **832x480**. Prefix `ez_svc_venue`. Em...`
...
**This graph:** `Gentle guest-motion in an unmarked hall. Keep identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Gentle guest-motion in an unmarked hall. Keep identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/events-wedding/venue-wide`
