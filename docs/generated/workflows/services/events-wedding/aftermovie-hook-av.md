---
title: "services/events-wedding/aftermovie-hook-av"
description: "Aftermovie hook AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/aftermovie-hook-av
...
**Who this is for:** studio users who loaded `services/events-wedding/aftermovie-hook-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/aftermovie-hook-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Aftermovie hook AV 9:16. Lab size **768x1280**. Prefix `ez_svc_after`.
...
2. Load **services/events-wedding/aftermovie-hook-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Vertical hook from the start still. Soft whoosh. No score. Keep every object an...` |
...
**This graph:** `## services/events-wedding/aftermovie-hook-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Aftermovie hook AV 9:16. Lab size **768x1280**. Prefix `ez_svc_...`
...
**This graph:** `Vertical hook from the start still. Soft whoosh. No score. Keep every object and surface from the start image; do not redesign.`

```text
Vertical hook from the start still. Soft whoosh. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/events-wedding/aftermovie-hook-av`
