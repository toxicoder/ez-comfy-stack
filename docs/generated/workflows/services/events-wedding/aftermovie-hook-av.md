...
Aftermovie hook AV 9:16. Lab size **768×1280**. Prefix `ez_svc_after`.
...
**This graph:** `## services/events-wedding/aftermovie-hook-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Aftermovie hook AV 9:16. Lab size **768×1280**. Prefix `ez_svc_…`
