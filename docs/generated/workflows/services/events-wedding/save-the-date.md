---
title: "services/events-wedding/save-the-date"
description: "Save-the-date still 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/save-the-date
...
**Who this is for:** studio users who loaded `services/events-wedding/save-the-date` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/save-the-date.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Save-the-date still 4:5. Lab size **1024x1280**. Prefix `ez_svc_std`.
...
2. Load **services/events-wedding/save-the-date** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `A photoreal still of an unmarked interior, pale plaster and oak, no logos on wa...` |
...
**This graph:** `## services/events-wedding/save-the-date Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Save-the-date still 4:5. Lab size **1024x1280**. Prefix `ez_svc_std`...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Quiet 4:5 still, floral unmarked, center empty for type later. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Quiet 4:5 still, floral unmarked, center empty for type later. Empty of lettering.
```
