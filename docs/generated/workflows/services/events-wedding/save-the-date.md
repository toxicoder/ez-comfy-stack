...
Save-the-date still 4:5. Lab size **1024×1280**. Prefix `ez_svc_std`.
...
**This graph:** `## services/events-wedding/save-the-date Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Save-the-date still 4:5. Lab size **1024×1280**. Prefix `ez_svc_std`…`
