---
title: "services/events-wedding/conference-av"
description: "Conference AV ~5 s"
...
**Who this is for:** studio users who loaded `services/events-wedding/conference-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/conference-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
2. Load **services/events-wedding/conference-av** from **Apps** or **Workflows**
...
**This graph:** `Ambient unmarked hall. Murmur, chair, no score.`
...
**This graph:** `murmur, chair, no score`
