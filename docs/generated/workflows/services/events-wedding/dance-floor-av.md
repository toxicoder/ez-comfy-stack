...
Dance-floor AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_dance`.
...
**This graph:** `## services/events-wedding/dance-floor-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Dance-floor AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_dance`. …`
