---
title: "services/events-wedding/dance-floor-av"
description: "Dance-floor AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/dance-floor-av
...
**Who this is for:** studio users who loaded `services/events-wedding/dance-floor-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/dance-floor-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Dance-floor AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_dance`.
...
2. Load **services/events-wedding/dance-floor-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Ambient unmarked dance floor. Murmur, no score.` |
...
**This graph:** `## services/events-wedding/dance-floor-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Dance-floor AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_dance`. ...`
...
**This graph:** `Ambient unmarked dance floor. Murmur, no score.`
...
**This graph:** `crowd murmur, no score`
...
**This graph:** `services/events-wedding/dance-floor-av`
