---
title: "services/events-wedding/first-look"
description: "Silent first-look 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/first-look
...
**Who this is for:** studio users who loaded `services/events-wedding/first-look` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/first-look.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent first-look 9:16. Lab size **480x832**. Prefix `ez_svc_first`.
...
2. Load **services/events-wedding/first-look** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow turn from the start still. Fabric breeze. One continuous five-second take....` |
...
**This graph:** `## services/events-wedding/first-look Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent first-look 9:16. Lab size **480x832**. Prefix `ez_svc_first`. Em...`
...
**This graph:** `Slow turn from the start still. Fabric breeze. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Slow turn from the start still. Fabric breeze. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/events-wedding/first-look`
