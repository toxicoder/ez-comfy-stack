---
title: "services/events-wedding/rehearsal-av"
description: "Rehearsal AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/rehearsal-av
...
**Who this is for:** studio users who loaded `services/events-wedding/rehearsal-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/rehearsal-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Rehearsal AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_rehr`.
...
2. Load **services/events-wedding/rehearsal-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Quiet rehearsal from the start still. Room tone, a laugh hush. No score. Keep e...` |
...
**This graph:** `## services/events-wedding/rehearsal-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Rehearsal AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_rehr`. Empty...`
...
**This graph:** `Quiet rehearsal from the start still. Room tone, a laugh hush. No score. Keep every object and surface from the start image; do not redesign.`

```text
Quiet rehearsal from the start still. Room tone, a laugh hush. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/events-wedding/rehearsal-av`
