---
title: "services/events-wedding/invite-bed"
description: "Invite bed 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/invite-bed
...
**Who this is for:** studio users who loaded `services/events-wedding/invite-bed` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/invite-bed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Invite bed 4:5. Lab size **1024x1280**. Prefix `ez_svc_invite`.
...
2. Load **services/events-wedding/invite-bed** from **Apps** or **Workflows**
...
| 6 | Size 1024x1280 | `EmptyFlux2LatentImage` | SETTINGS |
...
**This graph:** `## services/events-wedding/invite-bed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Invite bed 4:5. Lab size **1024x1280**. Prefix `ez_svc_invite`. Empty o...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Linen and unmarked s...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Linen and unmarked stationery, center empty for type later. Empty of lettering.
```
