...
Invite bed 4:5. Lab size **1024×1280**. Prefix `ez_svc_invite`.
...
**This graph:** `## services/events-wedding/invite-bed Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Invite bed 4:5. Lab size **1024×1280**. Prefix `ez_svc_invite`. Empty o…`
