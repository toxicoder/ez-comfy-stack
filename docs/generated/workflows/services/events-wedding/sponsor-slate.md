...
Sponsor slate 16:9. Lab size **1280×704**. Prefix `ez_svc_spon`.
...
**This graph:** `## services/events-wedding/sponsor-slate Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Sponsor slate 16:9. Lab size **1280×704**. Prefix `ez_svc_spon`. Emp…`
