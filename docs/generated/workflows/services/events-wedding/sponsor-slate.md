---
title: "services/events-wedding/sponsor-slate"
description: "Sponsor slate 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/sponsor-slate
...
**Who this is for:** studio users who loaded `services/events-wedding/sponsor-slate` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/sponsor-slate.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Sponsor slate 16:9. Lab size **1280x704**. Prefix `ez_svc_spon`.
...
2. Load **services/events-wedding/sponsor-slate** from **Apps** or **Workflows**
...
**This graph:** `## services/events-wedding/sponsor-slate Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Sponsor slate 16:9. Lab size **1280x704**. Prefix `ez_svc_spon`. Emp...`
