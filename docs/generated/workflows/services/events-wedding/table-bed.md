...
Table bed 16:9. Lab size **1280×704**. Prefix `ez_svc_table`.
...
**This graph:** `## services/events-wedding/table-bed Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Table bed 16:9. Lab size **1280×704**. Prefix `ez_svc_table`. Empty of l…`
