---
title: "services/events-wedding/table-bed"
description: "Table bed 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/table-bed
...
**Who this is for:** studio users who loaded `services/events-wedding/table-bed` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/table-bed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Table bed 16:9. Lab size **1280x704**. Prefix `ez_svc_table`.
...
2. Load **services/events-wedding/table-bed** from **Apps** or **Workflows**
...
**This graph:** `## services/events-wedding/table-bed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Table bed 16:9. Lab size **1280x704**. Prefix `ez_svc_table`. Empty of l...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked place setting, linen, quiet for overlay type later. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked place setting, linen, quiet for overlay type later. Empty of lettering.
```
