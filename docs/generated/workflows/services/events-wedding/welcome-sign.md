---
title: "services/events-wedding/welcome-sign"
description: "Silent welcome-sign ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/welcome-sign
...
**Who this is for:** studio users who loaded `services/events-wedding/welcome-sign` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/welcome-sign.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent welcome-sign ~5 s. Lab size **832x480**. Prefix `ez_svc_welc`.
...
2. Load **services/events-wedding/welcome-sign** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Breeze on unmarked florals beside a blank board. One continuous five-second tak...` |
...
**This graph:** `## services/events-wedding/welcome-sign Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent welcome-sign ~5 s. Lab size **832x480**. Prefix `ez_svc_welc`....`
...
**This graph:** `Breeze on unmarked florals beside a blank board. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Breeze on unmarked florals beside a blank board. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/events-wedding/welcome-sign`
