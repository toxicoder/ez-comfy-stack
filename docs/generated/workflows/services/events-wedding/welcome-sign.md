...
Silent welcome-sign ~5 s. Lab size **832×480**. Prefix `ez_svc_welc`.
...
**This graph:** `## services/events-wedding/welcome-sign Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent welcome-sign ~5 s. Lab size **832×480**. Prefix `ez_svc_welc`.…`
