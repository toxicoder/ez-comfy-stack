---
title: "services/events-wedding/program-cover"
description: "Program cover 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/program-cover
...
**Who this is for:** studio users who loaded `services/events-wedding/program-cover` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/program-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Program cover 4:5. Lab size **1024x1280**. Prefix `ez_svc_prog`.
...
2. Load **services/events-wedding/program-cover** from **Apps** or **Workflows**
...
**This graph:** `## services/events-wedding/program-cover Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Program cover 4:5. Lab size **1024x1280**. Prefix `ez_svc_prog`. Emp...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Quiet cover still, unmarked florals, empty of lettering. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Quiet cover still, unmarked florals, empty of lettering. Empty of lettering.
```
