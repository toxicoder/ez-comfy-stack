...
Program cover 4:5. Lab size **1024×1280**. Prefix `ez_svc_prog`.
...
**This graph:** `## services/events-wedding/program-cover Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Program cover 4:5. Lab size **1024×1280**. Prefix `ez_svc_prog`. Emp…`
