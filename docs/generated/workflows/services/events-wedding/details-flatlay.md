---
title: "services/events-wedding/details-flatlay"
description: "Details flatlay 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/details-flatlay
...
**Who this is for:** studio users who loaded `services/events-wedding/details-flatlay` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/details-flatlay.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Details flatlay 1:1. Lab size **1024x1024**. Prefix `ez_svc_detfl`.
...
2. Load **services/events-wedding/details-flatlay** from **Apps** or **Workflows**
...
**This graph:** `## services/events-wedding/details-flatlay Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Details flatlay 1:1. Lab size **1024x1024**. Prefix `ez_svc_detfl`...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Overhead unmarked ri...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Overhead unmarked rings and florals on linen. Empty of lettering.
```
