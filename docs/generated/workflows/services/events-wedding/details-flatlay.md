...
Details flatlay 1:1. Lab size **1024×1024**. Prefix `ez_svc_detfl`.
...
**This graph:** `## services/events-wedding/details-flatlay Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Details flatlay 1:1. Lab size **1024×1024**. Prefix `ez_svc_detfl`…`
