...
Speaker still 4:5. Lab size **1024×1280**. Prefix `ez_svc_speak`.
...
**This graph:** `## services/events-wedding/speaker-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Speaker still 4:5. Lab size **1024×1280**. Prefix `ez_svc_speak`. Em…`
