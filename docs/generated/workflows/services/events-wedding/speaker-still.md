---
title: "services/events-wedding/speaker-still"
description: "Speaker still 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/speaker-still
...
**Who this is for:** studio users who loaded `services/events-wedding/speaker-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/speaker-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Speaker still 4:5. Lab size **1024x1280**. Prefix `ez_svc_speak`.
...
2. Load **services/events-wedding/speaker-still** from **Apps** or **Workflows**
...
**This graph:** `## services/events-wedding/speaker-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Speaker still 4:5. Lab size **1024x1280**. Prefix `ez_svc_speak`. Em...`
