---
title: "services/events-wedding/processional-av"
description: "Processional AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/processional-av
...
**Who this is for:** studio users who loaded `services/events-wedding/processional-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/processional-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Processional AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_proc`.
...
2. Load **services/events-wedding/processional-av** from **Apps** or **Workflows**
...
| 7 | Size 1280x704 | `LTXVImgToVideo` | SETTINGS |
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow aisle walk from the start still. Cloth, soft steps. No score. Keep every o...` |
...
**This graph:** `## services/events-wedding/processional-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Processional AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_proc`....`
...
**This graph:** `Slow aisle walk from the start still. Cloth, soft steps. No score. Keep every object and surface from the start image; do not redesign.`

```text
Slow aisle walk from the start still. Cloth, soft steps. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `soft steps, cloth, no score`
...
**This graph:** `services/events-wedding/processional-av`
