...
Processional AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_proc`.
...
**This graph:** `## services/events-wedding/processional-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Processional AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_proc`.…`
