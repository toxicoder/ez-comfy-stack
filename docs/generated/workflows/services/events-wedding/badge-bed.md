...
Badge bed 1:1. Lab size **1024×1024**. Prefix `ez_svc_badge`.
...
**This graph:** `## services/events-wedding/badge-bed Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Badge bed 1:1. Lab size **1024×1024**. Prefix `ez_svc_badge`. Empty of l…`
