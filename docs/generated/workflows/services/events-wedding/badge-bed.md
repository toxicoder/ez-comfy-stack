---
title: "services/events-wedding/badge-bed"
description: "Badge bed 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/badge-bed
...
**Who this is for:** studio users who loaded `services/events-wedding/badge-bed` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/badge-bed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Badge bed 1:1. Lab size **1024x1024**. Prefix `ez_svc_badge`.
...
2. Load **services/events-wedding/badge-bed** from **Apps** or **Workflows**
...
**This graph:** `## services/events-wedding/badge-bed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Badge bed 1:1. Lab size **1024x1024**. Prefix `ez_svc_badge`. Empty of l...`
