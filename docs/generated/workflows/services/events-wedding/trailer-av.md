...
Event trailer AV 9:16. Lab size **768×1280**. Prefix `ez_svc_trail`.
...
**This graph:** `## services/events-wedding/trailer-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Event trailer AV 9:16. Lab size **768×1280**. Prefix `ez_svc_trail`. Em…`
