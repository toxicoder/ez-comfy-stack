---
title: "services/events-wedding/trailer-av"
description: "Event trailer AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/trailer-av
...
**Who this is for:** studio users who loaded `services/events-wedding/trailer-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/trailer-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Event trailer AV 9:16. Lab size **768x1280**. Prefix `ez_svc_trail`.
...
2. Load **services/events-wedding/trailer-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Vertical trailer from the start still. World SFX only. No score. Keep every obj...` |
...
**This graph:** `## services/events-wedding/trailer-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Event trailer AV 9:16. Lab size **768x1280**. Prefix `ez_svc_trail`. Em...`
...
**This graph:** `Vertical trailer from the start still. World SFX only. No score. Keep every object and surface from the start image; do not redesign.`

```text
Vertical trailer from the start still. World SFX only. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/events-wedding/trailer-av`
