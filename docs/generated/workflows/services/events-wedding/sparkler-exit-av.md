...
Sparkler-exit AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_spark`.
...
**This graph:** `## services/events-wedding/sparkler-exit-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Sparkler-exit AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_spar…`
