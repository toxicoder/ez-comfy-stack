---
title: "services/events-wedding/sparkler-exit-av"
description: "Sparkler-exit AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/events-wedding/sparkler-exit-av
...
**Who this is for:** studio users who loaded `services/events-wedding/sparkler-exit-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/events-wedding/sparkler-exit-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Sparkler-exit AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_spark`.
...
2. Load **services/events-wedding/sparkler-exit-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Warm spark trails, unmarked driveway. Soft fizz. No score. Keep every object an...` |
...
**This graph:** `## services/events-wedding/sparkler-exit-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Sparkler-exit AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_spar...`
...
**This graph:** `Warm spark trails, unmarked driveway. Soft fizz. No score. Keep every object and surface from the start image; do not redesign.`

```text
Warm spark trails, unmarked driveway. Soft fizz. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/events-wedding/sparkler-exit-av`
