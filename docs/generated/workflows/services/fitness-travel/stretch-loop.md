---
title: "services/fitness-travel/stretch-loop"
description: "Silent stretch loop 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/stretch-loop
...
**Who this is for:** studio users who loaded `services/fitness-travel/stretch-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/stretch-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent stretch loop 9:16. Lab size **480x832**. Prefix `ez_svc_strch`.
...
2. Load **services/fitness-travel/stretch-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `A stretch settles and repeats. Locked camera. Ping-pong friendly. No walk. Keep...` |
...
**This graph:** `ez_svc_strch_frames`
...
**This graph:** `## services/fitness-travel/stretch-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent stretch loop 9:16. Lab size **480x832**. Prefix `ez_svc_strch`...`
...
**This graph:** `A stretch settles and repeats. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
A stretch settles and repeats. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fitness-travel/stretch-loop`
