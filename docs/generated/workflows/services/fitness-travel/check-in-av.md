...
Check-in AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_check`.
...
**This graph:** `## services/fitness-travel/check-in-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Check-in AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_check`. Empty …`
