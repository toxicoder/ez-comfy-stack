---
title: "services/fitness-travel/check-in-av"
description: "Check-in AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/check-in-av
...
**Who this is for:** studio users who loaded `services/fitness-travel/check-in-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/check-in-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Check-in AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_check`.
...
2. Load **services/fitness-travel/check-in-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Lobby check-in from the start still. Soft voices as room tone. No score. Keep e...` |
...
**This graph:** `## services/fitness-travel/check-in-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Check-in AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_check`. Empty ...`
...
**This graph:** `Lobby check-in from the start still. Soft voices as room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Lobby check-in from the start still. Soft voices as room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fitness-travel/check-in-av`
