...
Pool still 16:9. Lab size **1280×704**. Prefix `ez_svc_pool`.
...
**This graph:** `## services/fitness-travel/pool-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Pool still 16:9. Lab size **1280×704**. Prefix `ez_svc_pool`. Empty of …`
