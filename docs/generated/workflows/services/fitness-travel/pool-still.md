---
title: "services/fitness-travel/pool-still"
description: "Pool still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/pool-still
...
**Who this is for:** studio users who loaded `services/fitness-travel/pool-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/pool-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Pool still 16:9. Lab size **1280x704**. Prefix `ez_svc_pool`.
...
2. Load **services/fitness-travel/pool-still** from **Apps** or **Workflows**
...
**This graph:** `## services/fitness-travel/pool-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Pool still 16:9. Lab size **1280x704**. Prefix `ez_svc_pool`. Empty of ...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked pool, palms, no lettering on tiles. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked pool, palms, no lettering on tiles. Empty of lettering.
```
