---
title: "services/fitness-travel/home-gym"
description: "Home-gym still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/home-gym
...
**Who this is for:** studio users who loaded `services/fitness-travel/home-gym` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/home-gym.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Home-gym still 16:9. Lab size **1280x704**. Prefix `ez_svc_hgym`.
...
2. Load **services/fitness-travel/home-gym** from **Apps** or **Workflows**
...
**This graph:** `## services/fitness-travel/home-gym Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Home-gym still 16:9. Lab size **1280x704**. Prefix `ez_svc_hgym`. Empty o...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked spare room, a mat, morning window. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked spare room, a mat, morning window. Empty of lettering.
```
