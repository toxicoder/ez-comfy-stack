...
Home-gym still 16:9. Lab size **1280×704**. Prefix `ez_svc_hgym`.
...
**This graph:** `## services/fitness-travel/home-gym Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Home-gym still 16:9. Lab size **1280×704**. Prefix `ez_svc_hgym`. Empty o…`
