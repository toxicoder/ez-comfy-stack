---
title: "services/fitness-travel/rep-loop"
description: "Silent rep loop 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/rep-loop
...
**Who this is for:** studio users who loaded `services/fitness-travel/rep-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/rep-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent rep loop 9:16. Lab size **480x832**. Prefix `ez_svc_rep`.
...
2. Load **services/fitness-travel/rep-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `One athletic rep cycles. Ping-pong friendly. Locked camera. Ping-pong friendly....` |
...
**This graph:** `## services/fitness-travel/rep-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent rep loop 9:16. Lab size **480x832**. Prefix `ez_svc_rep`. Empty of...`
...
**This graph:** `One athletic rep cycles. Ping-pong friendly. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
One athletic rep cycles. Ping-pong friendly. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fitness-travel/rep-loop`
