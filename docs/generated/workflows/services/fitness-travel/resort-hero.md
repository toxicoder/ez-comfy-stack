...
Silent resort-hero ~5 s. Lab size **832×480**. Prefix `ez_svc_resort`.
...
**This graph:** `## services/fitness-travel/resort-hero Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent resort-hero ~5 s. Lab size **832×480**. Prefix `ez_svc_resort`.…`
