---
title: "services/fitness-travel/resort-hero"
description: "Silent resort-hero ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/resort-hero
...
**Who this is for:** studio users who loaded `services/fitness-travel/resort-hero` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/resort-hero.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent resort-hero ~5 s. Lab size **832x480**. Prefix `ez_svc_resort`.
...
2. Load **services/fitness-travel/resort-hero** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Palm breeze on the start-image terrace. Keep identity. One continuous five-seco...` |
...
**This graph:** `## services/fitness-travel/resort-hero Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent resort-hero ~5 s. Lab size **832x480**. Prefix `ez_svc_resort`....`
...
**This graph:** `Palm breeze on the start-image terrace. Keep identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Palm breeze on the start-image terrace. Keep identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fitness-travel/resort-hero`
