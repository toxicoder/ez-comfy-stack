---
title: "services/fitness-travel/city-arrive"
description: "Silent city-arrive ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/city-arrive
...
**Who this is for:** studio users who loaded `services/fitness-travel/city-arrive` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/city-arrive.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent city-arrive ~5 s. Lab size **832x480**. Prefix `ez_svc_arrive`.
...
2. Load **services/fitness-travel/city-arrive** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow dolly past unmarked glass towers. Keep identity. One continuous five-secon...` |
...
**This graph:** `## services/fitness-travel/city-arrive Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent city-arrive ~5 s. Lab size **832x480**. Prefix `ez_svc_arrive`....`
...
**This graph:** `Slow dolly past unmarked glass towers. Keep identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Slow dolly past unmarked glass towers. Keep identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fitness-travel/city-arrive`
