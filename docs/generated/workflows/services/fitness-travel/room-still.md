---
title: "services/fitness-travel/room-still"
description: "Resort room still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/room-still
...
**Who this is for:** studio users who loaded `services/fitness-travel/room-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/room-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Resort room still 16:9. Lab size **1280x704**. Prefix `ez_svc_room`.
...
2. Load **services/fitness-travel/room-still** from **Apps** or **Workflows**
...
**This graph:** `## services/fitness-travel/room-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Resort room still 16:9. Lab size **1280x704**. Prefix `ez_svc_room`. Em...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked guest room, linen, bright bay slot. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked guest room, linen, bright bay slot. Empty of lettering.
```
