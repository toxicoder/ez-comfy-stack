...
Resort room still 16:9. Lab size **1280×704**. Prefix `ez_svc_room`.
...
**This graph:** `## services/fitness-travel/room-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Resort room still 16:9. Lab size **1280×704**. Prefix `ez_svc_room`. Em…`
