---
title: "services/fitness-travel/packing-av"
description: "Packing AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/packing-av
...
**Who this is for:** studio users who loaded `services/fitness-travel/packing-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/packing-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Packing AV 9:16. Lab size **768x1280**. Prefix `ez_svc_pack`.
...
2. Load **services/fitness-travel/packing-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Hands pack unmarked clothes. Soft fabric, zipper. No score. Keep every object a...` |
...
**This graph:** `## services/fitness-travel/packing-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Packing AV 9:16. Lab size **768x1280**. Prefix `ez_svc_pack`. Empty of ...`
...
**This graph:** `Hands pack unmarked clothes. Soft fabric, zipper. No score. Keep every object and surface from the start image; do not redesign.`

```text
Hands pack unmarked clothes. Soft fabric, zipper. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `fabric, zipper, no score`
...
**This graph:** `services/fitness-travel/packing-av`
