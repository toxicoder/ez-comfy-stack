---
title: "services/fitness-travel/meal-prep"
description: "Meal-prep still 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/meal-prep
...
**Who this is for:** studio users who loaded `services/fitness-travel/meal-prep` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/meal-prep.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Meal-prep still 4:5. Lab size **1024x1280**. Prefix `ez_svc_meal`.
...
2. Load **services/fitness-travel/meal-prep** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `A photoreal still of plated food on unmarked crockery, a linen napkin on oak, s...` |
...
**This graph:** `## services/fitness-travel/meal-prep Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Meal-prep still 4:5. Lab size **1024x1280**. Prefix `ez_svc_meal`. Empty...`
...
**This graph:** `A photoreal still of plated food on unmarked crockery, a linen napkin on oak, soft window sidelight. Empty of lettering. Plated prep on unmarked crockery, oak, window light. Empty of lettering.`

```text
A photoreal still of plated food on unmarked crockery, a linen napkin on oak, soft window sidelight. Empty of lettering. Plated prep on unmarked crockery, oak, window light. Empty of lettering.
```
