...
Meal-prep still 4:5. Lab size **1024×1280**. Prefix `ez_svc_meal`.
...
**This graph:** `## services/fitness-travel/meal-prep Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Meal-prep still 4:5. Lab size **1024×1280**. Prefix `ez_svc_meal`. Empty…`
