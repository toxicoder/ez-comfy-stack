---
title: "services/fitness-travel/trail-still"
description: "Silent trail ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/trail-still
...
**Who this is for:** studio users who loaded `services/fitness-travel/trail-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/trail-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent trail ~5 s. Lab size **832x480**. Prefix `ez_svc_trailf`.
...
2. Load **services/fitness-travel/trail-still** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Leaves drift on the start-image path. Locked identity. One continuous five-seco...` |
...
**This graph:** `## services/fitness-travel/trail-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent trail ~5 s. Lab size **832x480**. Prefix `ez_svc_trailf`. Empty...`
...
**This graph:** `Leaves drift on the start-image path. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Leaves drift on the start-image path. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fitness-travel/trail-still`
