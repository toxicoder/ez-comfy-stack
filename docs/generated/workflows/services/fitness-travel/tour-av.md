---
title: "services/fitness-travel/tour-av"
description: "Tour AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/tour-av
...
**Who this is for:** studio users who loaded `services/fitness-travel/tour-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/tour-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Tour AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_tour`.
...
2. Load **services/fitness-travel/tour-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Slow resort tour. Wind, distant surf, no score.` |
...
**This graph:** `## services/fitness-travel/tour-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Tour AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_tour`. Empty of letter...`
...
**This graph:** `Slow resort tour. Wind, distant surf, no score.`
...
**This graph:** `services/fitness-travel/tour-av`
