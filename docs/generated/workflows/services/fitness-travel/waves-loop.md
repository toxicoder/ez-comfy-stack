...
Silent waves loop. Lab size **768×768**. Prefix `ez_svc_waves`.
...
**This graph:** `## services/fitness-travel/waves-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent waves loop. Lab size **768×768**. Prefix `ez_svc_waves`. Empty o…`
