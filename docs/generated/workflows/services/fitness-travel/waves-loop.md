---
title: "services/fitness-travel/waves-loop"
description: "Silent waves loop"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/waves-loop
...
**Who this is for:** studio users who loaded `services/fitness-travel/waves-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/waves-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent waves loop. Lab size **768x768**. Prefix `ez_svc_waves`.
...
2. Load **services/fitness-travel/waves-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Unmarked shoreline, a small wave cycle. Locked camera. Ping-pong friendly. No w...` |
...
**This graph:** `ez_svc_waves_frames`
...
**This graph:** `## services/fitness-travel/waves-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent waves loop. Lab size **768x768**. Prefix `ez_svc_waves`. Empty o...`
...
**This graph:** `Unmarked shoreline, a small wave cycle. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Unmarked shoreline, a small wave cycle. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fitness-travel/waves-loop`
