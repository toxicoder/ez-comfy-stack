---
title: "services/fitness-travel/sunset-av"
description: "Sunset AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/sunset-av
...
**Who this is for:** studio users who loaded `services/fitness-travel/sunset-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/sunset-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Sunset AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_sun`.
...
2. Load **services/fitness-travel/sunset-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Locked sunset hold. Wind, distant surf, no score.` |
...
**This graph:** `## services/fitness-travel/sunset-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Sunset AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_sun`. Empty of let...`
...
**This graph:** `Locked sunset hold. Wind, distant surf, no score.`
...
**This graph:** `wind, distant surf, no score`
...
**This graph:** `services/fitness-travel/sunset-av`
