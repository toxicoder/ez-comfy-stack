...
Move still 4:5. Lab size **1024×1280**. Prefix `ez_svc_move`.
...
**This graph:** `## services/fitness-travel/move-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Move still 4:5. Lab size **1024×1280**. Prefix `ez_svc_move`. Empty of …`
