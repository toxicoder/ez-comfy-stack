---
title: "services/fitness-travel/coach-still"
description: "Silent coach motion 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/coach-still
...
**Who this is for:** studio users who loaded `services/fitness-travel/coach-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/coach-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent coach motion 9:16. Lab size **480x832**. Prefix `ez_svc_coach`.
...
2. Load **services/fitness-travel/coach-still** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `One coaching gesture from the start still. Locked identity. One continuous five...` |
...
**This graph:** `## services/fitness-travel/coach-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent coach motion 9:16. Lab size **480x832**. Prefix `ez_svc_coach`....`
...
**This graph:** `One coaching gesture from the start still. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
One coaching gesture from the start still. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fitness-travel/coach-still`
