---
title: "services/fitness-travel/workout-av"
description: "Workout AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/workout-av
...
**Who this is for:** studio users who loaded `services/fitness-travel/workout-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/workout-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Workout AV 9:16. Lab size **768x1280**. Prefix `ez_svc_work`.
...
2. Load **services/fitness-travel/workout-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `One athletic take from the start still. Breath, shoe squeak. No score. Keep eve...` |
...
**This graph:** `## services/fitness-travel/workout-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Workout AV 9:16. Lab size **768x1280**. Prefix `ez_svc_work`. Empty of ...`
...
**This graph:** `One athletic take from the start still. Breath, shoe squeak. No score. Keep every object and surface from the start image; do not redesign.`

```text
One athletic take from the start still. Breath, shoe squeak. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `breath, shoe squeak, no score`
...
**This graph:** `services/fitness-travel/workout-av`
