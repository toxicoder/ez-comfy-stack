...
Workout AV 9:16. Lab size **768×1280**. Prefix `ez_svc_work`.
...
**This graph:** `## services/fitness-travel/workout-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Workout AV 9:16. Lab size **768×1280**. Prefix `ez_svc_work`. Empty of …`
