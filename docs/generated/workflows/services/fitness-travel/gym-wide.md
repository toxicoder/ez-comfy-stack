---
title: "services/fitness-travel/gym-wide"
description: "Gym wide still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/gym-wide
...
**Who this is for:** studio users who loaded `services/fitness-travel/gym-wide` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/gym-wide.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Gym wide still 16:9. Lab size **1280x704**. Prefix `ez_svc_gymw`.
...
2. Load **services/fitness-travel/gym-wide** from **Apps** or **Workflows**
...
**This graph:** `## services/fitness-travel/gym-wide Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Gym wide still 16:9. Lab size **1280x704**. Prefix `ez_svc_gymw`. Empty o...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Wide unmarked gym, rubber floor, empty screens. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Wide unmarked gym, rubber floor, empty screens. Empty of lettering.
```
