...
Gym wide still 16:9. Lab size **1280×704**. Prefix `ez_svc_gymw`.
...
**This graph:** `## services/fitness-travel/gym-wide Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Gym wide still 16:9. Lab size **1280×704**. Prefix `ez_svc_gymw`. Empty o…`
