---
title: "services/fitness-travel/class-av"
description: "Fitness class AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/class-av
...
**Who this is for:** studio users who loaded `services/fitness-travel/class-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/class-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Fitness class AV 9:16. Lab size **768x1280**. Prefix `ez_svc_fclass`.
...
2. Load **services/fitness-travel/class-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Class take from the start still. Breath, room tone. No score. Keep every object...` |
...
**This graph:** `## services/fitness-travel/class-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Fitness class AV 9:16. Lab size **768x1280**. Prefix `ez_svc_fclass`. Emp...`
...
**This graph:** `Class take from the start still. Breath, room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Class take from the start still. Breath, room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `breath, room tone, no score`
...
**This graph:** `services/fitness-travel/class-av`
