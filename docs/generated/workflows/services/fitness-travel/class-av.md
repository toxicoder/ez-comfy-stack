...
Fitness class AV 9:16. Lab size **768×1280**. Prefix `ez_svc_fclass`.
...
**This graph:** `## services/fitness-travel/class-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Fitness class AV 9:16. Lab size **768×1280**. Prefix `ez_svc_fclass`. Emp…`
