---
title: "services/fitness-travel/recovery-still"
description: "Recovery still 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/fitness-travel/recovery-still
...
**Who this is for:** studio users who loaded `services/fitness-travel/recovery-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/fitness-travel/recovery-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Recovery still 4:5. Lab size **1024x1280**. Prefix `ez_svc_recov`.
...
2. Load **services/fitness-travel/recovery-still** from **Apps** or **Workflows**
...
**This graph:** `## services/fitness-travel/recovery-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Recovery still 4:5. Lab size **1024x1280**. Prefix `ez_svc_recov`. ...`
