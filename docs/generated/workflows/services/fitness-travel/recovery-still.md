...
Recovery still 4:5. Lab size **1024×1280**. Prefix `ez_svc_recov`.
...
**This graph:** `## services/fitness-travel/recovery-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Recovery still 4:5. Lab size **1024×1280**. Prefix `ez_svc_recov`. …`
