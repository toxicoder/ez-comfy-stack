---
title: "services/fashion-beauty/campaign-av"
description: "Campaign AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/campaign-av
...
**Who this is for:** studio users who loaded `services/fashion-beauty/campaign-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/campaign-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Campaign AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_camp_v`.
...
2. Load **services/fashion-beauty/campaign-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow campaign take from the start still. Wind, cloth. No score. Keep every obje...` |
...
**This graph:** `## services/fashion-beauty/campaign-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Campaign AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_camp_v`. Empty...`
...
**This graph:** `Slow campaign take from the start still. Wind, cloth. No score. Keep every object and surface from the start image; do not redesign.`

```text
Slow campaign take from the start still. Wind, cloth. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `wind, cloth, no score`
...
**This graph:** `services/fashion-beauty/campaign-av`
