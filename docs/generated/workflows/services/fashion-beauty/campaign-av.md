...
Campaign AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_camp_v`.
...
**This graph:** `## services/fashion-beauty/campaign-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Campaign AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_camp_v`. Empty…`
