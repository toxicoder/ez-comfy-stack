...
Lookbook cover 4:5. Lab size **1024×1280**. Prefix `ez_svc_lookbk`.
...
**This graph:** `## services/fashion-beauty/lookbook-cover Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Lookbook cover 4:5. Lab size **1024×1280**. Prefix `ez_svc_lookbk`.…`
