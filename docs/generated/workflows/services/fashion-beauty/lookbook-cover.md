---
title: "services/fashion-beauty/lookbook-cover"
description: "Lookbook cover 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/lookbook-cover
...
**Who this is for:** studio users who loaded `services/fashion-beauty/lookbook-cover` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/lookbook-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Lookbook cover 4:5. Lab size **1024x1280**. Prefix `ez_svc_lookbk`.
...
2. Load **services/fashion-beauty/lookbook-cover** from **Apps** or **Workflows**
...
**This graph:** `## services/fashion-beauty/lookbook-cover Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Lookbook cover 4:5. Lab size **1024x1280**. Prefix `ez_svc_lookbk`....`
