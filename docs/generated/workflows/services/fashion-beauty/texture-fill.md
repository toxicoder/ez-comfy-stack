---
title: "services/fashion-beauty/texture-fill"
description: "Texture fill 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/texture-fill
...
**Who this is for:** studio users who loaded `services/fashion-beauty/texture-fill` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/texture-fill.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Texture fill 1:1. Lab size **1024x1024**. Prefix `ez_svc_texfil`.
...
2. Load **services/fashion-beauty/texture-fill** from **Apps** or **Workflows**
...
**This graph:** `## services/fashion-beauty/texture-fill Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Texture fill 1:1. Lab size **1024x1024**. Prefix `ez_svc_texfil`. Emp...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Full-frame fabric or...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Full-frame fabric or cream texture, unmarked. Empty of lettering.
```
