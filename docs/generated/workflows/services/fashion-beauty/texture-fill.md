...
Texture fill 1:1. Lab size **1024×1024**. Prefix `ez_svc_texfil`.
...
**This graph:** `## services/fashion-beauty/texture-fill Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Texture fill 1:1. Lab size **1024×1024**. Prefix `ez_svc_texfil`. Emp…`
