...
Fashion walk AV 9:16. Lab size **768×1280**. Prefix `ez_svc_fwalk`.
...
**This graph:** `## services/fashion-beauty/walk-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Fashion walk AV 9:16. Lab size **768×1280**. Prefix `ez_svc_fwalk`. Empty …`
