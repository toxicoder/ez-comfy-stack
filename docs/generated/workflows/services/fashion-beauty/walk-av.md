---
title: "services/fashion-beauty/walk-av"
description: "Fashion walk AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/walk-av
...
**Who this is for:** studio users who loaded `services/fashion-beauty/walk-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/walk-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Fashion walk AV 9:16. Lab size **768x1280**. Prefix `ez_svc_fwalk`.
...
2. Load **services/fashion-beauty/walk-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow walk from the start still. Heel, cloth. No score. Keep every object and su...` |
...
**This graph:** `## services/fashion-beauty/walk-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Fashion walk AV 9:16. Lab size **768x1280**. Prefix `ez_svc_fwalk`. Empty ...`
...
**This graph:** `Slow walk from the start still. Heel, cloth. No score. Keep every object and surface from the start image; do not redesign.`

```text
Slow walk from the start still. Heel, cloth. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fashion-beauty/walk-av`
