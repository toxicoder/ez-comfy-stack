...
Fitting AV 9:16. Lab size **768×1280**. Prefix `ez_svc_fit`.
...
**This graph:** `## services/fashion-beauty/fitting-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Fitting AV 9:16. Lab size **768×1280**. Prefix `ez_svc_fit`. Empty of l…`
