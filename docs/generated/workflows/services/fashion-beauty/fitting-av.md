---
title: "services/fashion-beauty/fitting-av"
description: "Fitting AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/fitting-av
...
**Who this is for:** studio users who loaded `services/fashion-beauty/fitting-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/fitting-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Fitting AV 9:16. Lab size **768x1280**. Prefix `ez_svc_fit`.
...
2. Load **services/fashion-beauty/fitting-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Fitting-room take from the start still. Cloth, zipper hush. No score. Keep ever...` |
...
**This graph:** `## services/fashion-beauty/fitting-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Fitting AV 9:16. Lab size **768x1280**. Prefix `ez_svc_fit`. Empty of l...`
...
**This graph:** `Fitting-room take from the start still. Cloth, zipper hush. No score. Keep every object and surface from the start image; do not redesign.`

```text
Fitting-room take from the start still. Cloth, zipper hush. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `cloth, zipper, no score`
...
**This graph:** `services/fashion-beauty/fitting-av`
