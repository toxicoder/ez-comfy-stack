---
title: "services/fashion-beauty/swatch-macro"
description: "Swatch macro 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/swatch-macro
...
**Who this is for:** studio users who loaded `services/fashion-beauty/swatch-macro` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/swatch-macro.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Swatch macro 1:1. Lab size **1024x1024**. Prefix `ez_svc_swatch`.
...
2. Load **services/fashion-beauty/swatch-macro** from **Apps** or **Workflows**
...
**This graph:** `## services/fashion-beauty/swatch-macro Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Swatch macro 1:1. Lab size **1024x1024**. Prefix `ez_svc_swatch`. Emp...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Macro of unmarked cr...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Macro of unmarked cream on skin-tone ceramic, 85mm. Empty of lettering.
```
