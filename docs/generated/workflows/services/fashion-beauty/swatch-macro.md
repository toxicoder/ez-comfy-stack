...
Swatch macro 1:1. Lab size **1024×1024**. Prefix `ez_svc_swatch`.
...
**This graph:** `## services/fashion-beauty/swatch-macro Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Swatch macro 1:1. Lab size **1024×1024**. Prefix `ez_svc_swatch`. Emp…`
