---
title: "services/fashion-beauty/hair-loop"
description: "Silent hair loop 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/hair-loop
...
**Who this is for:** studio users who loaded `services/fashion-beauty/hair-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/hair-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent hair loop 9:16. Lab size **480x832**. Prefix `ez_svc_hair`.
...
2. Load **services/fashion-beauty/hair-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Hair lifts in a tiny cycle. Locked camera. Ping-pong friendly. No walk. Keep ev...` |
...
**This graph:** `## services/fashion-beauty/hair-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent hair loop 9:16. Lab size **480x832**. Prefix `ez_svc_hair`. Empty...`
...
**This graph:** `Hair lifts in a tiny cycle. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Hair lifts in a tiny cycle. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fashion-beauty/hair-loop`
