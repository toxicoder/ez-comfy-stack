---
title: "services/fashion-beauty/glow-loop"
description: "Silent glow loop"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/glow-loop
...
**Who this is for:** studio users who loaded `services/fashion-beauty/glow-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/glow-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent glow loop. Lab size **768x768**. Prefix `ez_svc_glow`.
...
2. Load **services/fashion-beauty/glow-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Skin highlight shimmers, then settles. Locked camera. Ping-pong friendly. No wa...` |
...
**This graph:** `## services/fashion-beauty/glow-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent glow loop. Lab size **768x768**. Prefix `ez_svc_glow`. Empty of l...`
...
**This graph:** `Skin highlight shimmers, then settles. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Skin highlight shimmers, then settles. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fashion-beauty/glow-loop`
