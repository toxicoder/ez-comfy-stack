---
title: "services/fashion-beauty/makeup-step"
description: "Silent makeup-step 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/makeup-step
...
**Who this is for:** studio users who loaded `services/fashion-beauty/makeup-step` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/makeup-step.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent makeup-step 9:16. Lab size **480x832**. Prefix `ez_svc_makeup`.
...
2. Load **services/fashion-beauty/makeup-step** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `A brush passes the start-image cheek. Locked identity. One continuous five-seco...` |
...
**This graph:** `## services/fashion-beauty/makeup-step Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent makeup-step 9:16. Lab size **480x832**. Prefix `ez_svc_makeup`....`
...
**This graph:** `A brush passes the start-image cheek. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
A brush passes the start-image cheek. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fashion-beauty/makeup-step`
