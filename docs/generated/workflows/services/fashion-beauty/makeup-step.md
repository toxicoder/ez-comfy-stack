...
Silent makeup-step 9:16. Lab size **480×832**. Prefix `ez_svc_makeup`.
...
**This graph:** `## services/fashion-beauty/makeup-step Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent makeup-step 9:16. Lab size **480×832**. Prefix `ez_svc_makeup`.…`
