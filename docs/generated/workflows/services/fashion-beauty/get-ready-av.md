...
Get-ready AV 9:16. Lab size **768×1280**. Prefix `ez_svc_ready`.
...
**This graph:** `## services/fashion-beauty/get-ready-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Get-ready AV 9:16. Lab size **768×1280**. Prefix `ez_svc_ready`. Empt…`
