---
title: "services/fashion-beauty/get-ready-av"
description: "Get-ready AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/get-ready-av
...
**Who this is for:** studio users who loaded `services/fashion-beauty/get-ready-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/get-ready-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Get-ready AV 9:16. Lab size **768x1280**. Prefix `ez_svc_ready`.
...
2. Load **services/fashion-beauty/get-ready-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Getting-ready take from the start still. Soft room tone. No score. Keep every o...` |
...
**This graph:** `## services/fashion-beauty/get-ready-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Get-ready AV 9:16. Lab size **768x1280**. Prefix `ez_svc_ready`. Empt...`
...
**This graph:** `Getting-ready take from the start still. Soft room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Getting-ready take from the start still. Soft room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fashion-beauty/get-ready-av`
