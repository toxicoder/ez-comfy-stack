---
title: "services/fashion-beauty/look-full"
description: "Silent full-look 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/look-full
...
**Who this is for:** studio users who loaded `services/fashion-beauty/look-full` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/look-full.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent full-look 9:16. Lab size **480x832**. Prefix `ez_svc_look_f`.
...
2. Load **services/fashion-beauty/look-full** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `A warm breeze moves coat hem. Locked vertical identity. One continuous five-sec...` |
...
**This graph:** `## services/fashion-beauty/look-full Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent full-look 9:16. Lab size **480x832**. Prefix `ez_svc_look_f`. Emp...`
...
**This graph:** `A warm breeze moves coat hem. Locked vertical identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
A warm breeze moves coat hem. Locked vertical identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fashion-beauty/look-full`
