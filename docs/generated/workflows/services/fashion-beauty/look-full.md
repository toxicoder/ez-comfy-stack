...
Silent full-look 9:16. Lab size **480×832**. Prefix `ez_svc_look_f`.
...
**This graph:** `## services/fashion-beauty/look-full Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent full-look 9:16. Lab size **480×832**. Prefix `ez_svc_look_f`. Emp…`
