---
title: "services/fashion-beauty/look-back"
description: "Look back 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/look-back
...
**Who this is for:** studio users who loaded `services/fashion-beauty/look-back` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/look-back.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Look back 4:5. Lab size **1024x1280**. Prefix `ez_svc_look_b`.
...
2. Load **services/fashion-beauty/look-back** from **Apps** or **Workflows**
...
**This graph:** `## services/fashion-beauty/look-back Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Look back 4:5. Lab size **1024x1280**. Prefix `ez_svc_look_b`. Empty of ...`
