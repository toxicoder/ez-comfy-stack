...
Editorial still 4:5. Lab size **1024×1280**. Prefix `ez_svc_edit`.
...
**This graph:** `## services/fashion-beauty/editorial-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Editorial still 4:5. Lab size **1024×1280**. Prefix `ez_svc_edit`.…`
