---
title: "services/fashion-beauty/editorial-still"
description: "Editorial still 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/editorial-still
...
**Who this is for:** studio users who loaded `services/fashion-beauty/editorial-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/editorial-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Editorial still 4:5. Lab size **1024x1280**. Prefix `ez_svc_edit`.
...
2. Load **services/fashion-beauty/editorial-still** from **Apps** or **Workflows**
...
**This graph:** `## services/fashion-beauty/editorial-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Editorial still 4:5. Lab size **1024x1280**. Prefix `ez_svc_edit`....`
