...
Look detail 1:1. Lab size **1024×1024**. Prefix `ez_svc_look_d`.
...
**This graph:** `## services/fashion-beauty/look-detail Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Look detail 1:1. Lab size **1024×1024**. Prefix `ez_svc_look_d`. Empty…`
