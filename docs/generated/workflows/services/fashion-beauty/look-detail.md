---
title: "services/fashion-beauty/look-detail"
description: "Look detail 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/look-detail
...
**Who this is for:** studio users who loaded `services/fashion-beauty/look-detail` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/look-detail.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Look detail 1:1. Lab size **1024x1024**. Prefix `ez_svc_look_d`.
...
2. Load **services/fashion-beauty/look-detail** from **Apps** or **Workflows**
...
**This graph:** `## services/fashion-beauty/look-detail Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Look detail 1:1. Lab size **1024x1024**. Prefix `ez_svc_look_d`. Empty...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Seam and fabric macr...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Seam and fabric macro, 85mm, unmarked. Empty of lettering.
```
