---
title: "services/fashion-beauty/beauty-pack"
description: "Beauty packshot 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/beauty-pack
...
**Who this is for:** studio users who loaded `services/fashion-beauty/beauty-pack` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/beauty-pack.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Beauty packshot 1:1. Lab size **1024x1024**. Prefix `ez_svc_bpack`.
...
2. Load **services/fashion-beauty/beauty-pack** from **Apps** or **Workflows**
...
**This graph:** `## services/fashion-beauty/beauty-pack Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Beauty packshot 1:1. Lab size **1024x1024**. Prefix `ez_svc_bpack`. Em...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Unmarked bottles on ...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Unmarked bottles on marble, soft beauty key. Empty of lettering.
```
