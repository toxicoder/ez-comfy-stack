...
Beauty packshot 1:1. Lab size **1024×1024**. Prefix `ez_svc_bpack`.
...
**This graph:** `## services/fashion-beauty/beauty-pack Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Beauty packshot 1:1. Lab size **1024×1024**. Prefix `ez_svc_bpack`. Em…`
