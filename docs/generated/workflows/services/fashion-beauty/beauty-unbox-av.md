...
Beauty unbox AV 9:16. Lab size **768×1280**. Prefix `ez_svc_bunbox`.
...
**This graph:** `## services/fashion-beauty/beauty-unbox-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Beauty unbox AV 9:16. Lab size **768×1280**. Prefix `ez_svc_bunbox…`
