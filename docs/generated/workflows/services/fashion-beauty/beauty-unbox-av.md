---
title: "services/fashion-beauty/beauty-unbox-av"
description: "Beauty unbox AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/beauty-unbox-av
...
**Who this is for:** studio users who loaded `services/fashion-beauty/beauty-unbox-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/beauty-unbox-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Beauty unbox AV 9:16. Lab size **768x1280**. Prefix `ez_svc_bunbox`.
...
2. Load **services/fashion-beauty/beauty-unbox-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Hands ease an unmarked compact. Soft clicks. No score. Keep every object and su...` |
...
**This graph:** `## services/fashion-beauty/beauty-unbox-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Beauty unbox AV 9:16. Lab size **768x1280**. Prefix `ez_svc_bunbox...`
...
**This graph:** `Hands ease an unmarked compact. Soft clicks. No score. Keep every object and surface from the start image; do not redesign.`

```text
Hands ease an unmarked compact. Soft clicks. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `soft clicks, no score`
...
**This graph:** `services/fashion-beauty/beauty-unbox-av`
