---
title: "services/fashion-beauty/street-look"
description: "Silent street-look 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/street-look
...
**Who this is for:** studio users who loaded `services/fashion-beauty/street-look` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/street-look.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent street-look 9:16. Lab size **480x832**. Prefix `ez_svc_street`.
...
2. Load **services/fashion-beauty/street-look** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow walk-hold from the start still. Fabric breeze. One continuous five-second ...` |
...
**This graph:** `## services/fashion-beauty/street-look Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent street-look 9:16. Lab size **480x832**. Prefix `ez_svc_street`....`
...
**This graph:** `Slow walk-hold from the start still. Fabric breeze. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Slow walk-hold from the start still. Fabric breeze. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fashion-beauty/street-look`
