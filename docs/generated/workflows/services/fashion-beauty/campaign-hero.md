...
Campaign hero 16:9. Lab size **1280×704**. Prefix `ez_svc_camp_h`.
...
**This graph:** `## services/fashion-beauty/campaign-hero Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Campaign hero 16:9. Lab size **1280×704**. Prefix `ez_svc_camp_h`. E…`
