---
title: "services/fashion-beauty/campaign-hero"
description: "Campaign hero 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/campaign-hero
...
**Who this is for:** studio users who loaded `services/fashion-beauty/campaign-hero` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/campaign-hero.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Campaign hero 16:9. Lab size **1280x704**. Prefix `ez_svc_camp_h`.
...
2. Load **services/fashion-beauty/campaign-hero** from **Apps** or **Workflows**
...
**This graph:** `## services/fashion-beauty/campaign-hero Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Campaign hero 16:9. Lab size **1280x704**. Prefix `ez_svc_camp_h`. E...`
