---
title: "services/fashion-beauty/nail-loop"
description: "Silent nail loop"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/nail-loop
...
**Who this is for:** studio users who loaded `services/fashion-beauty/nail-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/nail-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent nail loop. Lab size **768x768**. Prefix `ez_svc_nail`.
...
2. Load **services/fashion-beauty/nail-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `A tiny light crawl across unmarked nails. Locked camera. Ping-pong friendly. No...` |
...
**This graph:** `## services/fashion-beauty/nail-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent nail loop. Lab size **768x768**. Prefix `ez_svc_nail`. Empty of l...`
...
**This graph:** `A tiny light crawl across unmarked nails. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
A tiny light crawl across unmarked nails. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/fashion-beauty/nail-loop`
