---
title: "services/fashion-beauty/fabric-twirl-av"
description: "Fabric-twirl AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/fashion-beauty/fabric-twirl-av
...
**Who this is for:** studio users who loaded `services/fashion-beauty/fabric-twirl-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/fashion-beauty/fabric-twirl-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Fabric-twirl AV 9:16. Lab size **768x1280**. Prefix `ez_svc_twirl`.
...
2. Load **services/fashion-beauty/fabric-twirl-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow twirl from the start still. Cloth rustle. No score. Keep every object and ...` |
...
**This graph:** `## services/fashion-beauty/fabric-twirl-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Fabric-twirl AV 9:16. Lab size **768x1280**. Prefix `ez_svc_twirl`...`
...
**This graph:** `Slow twirl from the start still. Cloth rustle. No score. Keep every object and surface from the start image; do not redesign.`

```text
Slow twirl from the start still. Cloth rustle. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `cloth rustle, no score`
...
**This graph:** `services/fashion-beauty/fabric-twirl-av`
