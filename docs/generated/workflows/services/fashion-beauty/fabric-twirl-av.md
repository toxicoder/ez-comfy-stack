...
Fabric-twirl AV 9:16. Lab size **768×1280**. Prefix `ez_svc_twirl`.
...
**This graph:** `## services/fashion-beauty/fabric-twirl-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Fabric-twirl AV 9:16. Lab size **768×1280**. Prefix `ez_svc_twirl`…`
