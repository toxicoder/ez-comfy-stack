---
title: "services/local-business/kitchen-pass-av"
description: "Kitchen-pass AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/kitchen-pass-av
...
**Who this is for:** studio users who loaded `services/local-business/kitchen-pass-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/kitchen-pass-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Kitchen-pass AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_kpass`.
...
2. Load **services/local-business/kitchen-pass-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Plates slide an unmarked pass. Ceramic, steam, no score.` |
...
**This graph:** `## services/local-business/kitchen-pass-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Kitchen-pass AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_kpass`...`
...
**This graph:** `Plates slide an unmarked pass. Ceramic, steam, no score.`
...
**This graph:** `ceramic, steam, no score`
...
**This graph:** `services/local-business/kitchen-pass-av`
