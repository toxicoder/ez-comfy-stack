...
Kitchen-pass AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_kpass`.
...
**This graph:** `## services/local-business/kitchen-pass-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Kitchen-pass AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_kpass`…`
