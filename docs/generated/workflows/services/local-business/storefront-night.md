...
Storefront night still 16:9. Lab size **1280×704**. Prefix `ez_svc_sf_nite`.
...
**This graph:** `## services/local-business/storefront-night Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Storefront night still 16:9. Lab size **1280×704**. Prefix `ez_sv…`
