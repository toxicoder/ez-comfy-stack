---
title: "services/local-business/storefront-night"
description: "Storefront night still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/storefront-night
...
**Who this is for:** studio users who loaded `services/local-business/storefront-night` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/storefront-night.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Storefront night still 16:9. Lab size **1280x704**. Prefix `ez_svc_sf_nite`.
...
2. Load **services/local-business/storefront-night** from **Apps** or **Workflows**
...
| 6 | Size 1280x704 | `EmptyFlux2LatentImage` | SETTINGS |
...
**This graph:** `## services/local-business/storefront-night Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Storefront night still 16:9. Lab size **1280x704**. Prefix `ez_sv...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked shopfront, warm practicals, wet pavement. No neon logos. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked shopfront, warm practicals, wet pavement. No neon logos. Empty of lettering.
```
