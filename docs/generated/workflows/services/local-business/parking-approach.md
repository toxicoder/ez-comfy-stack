---
title: "services/local-business/parking-approach"
description: "Silent parking approach ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/parking-approach
...
**Who this is for:** studio users who loaded `services/local-business/parking-approach` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/parking-approach.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent parking approach ~5 s. Lab size **832x480**. Prefix `ez_svc_park`.
...
2. Load **services/local-business/parking-approach** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow push toward the start-image lot and facade. One continuous five-second tak...` |
...
**This graph:** `## services/local-business/parking-approach Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent parking approach ~5 s. Lab size **832x480**. Prefix `ez_sv...`
...
**This graph:** `Slow push toward the start-image lot and facade. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Slow push toward the start-image lot and facade. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/local-business/parking-approach`
