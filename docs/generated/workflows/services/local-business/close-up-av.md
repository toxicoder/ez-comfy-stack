---
title: "services/local-business/close-up-av"
description: "Close-up service AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/close-up-av
...
**Who this is for:** studio users who loaded `services/local-business/close-up-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/close-up-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Close-up service AV 9:16. Lab size **768x1280**. Prefix `ez_svc_close`.
...
2. Load **services/local-business/close-up-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Macro of unmarked hands at work. Soft taps. No score. Keep every object and sur...` |
...
**This graph:** `## services/local-business/close-up-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Close-up service AV 9:16. Lab size **768x1280**. Prefix `ez_svc_close`...`
...
**This graph:** `Macro of unmarked hands at work. Soft taps. No score. Keep every object and surface from the start image; do not redesign.`

```text
Macro of unmarked hands at work. Soft taps. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/local-business/close-up-av`
