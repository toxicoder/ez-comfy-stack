...
Close-up service AV 9:16. Lab size **768×1280**. Prefix `ez_svc_close`.
...
**This graph:** `## services/local-business/close-up-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Close-up service AV 9:16. Lab size **768×1280**. Prefix `ez_svc_close`…`
