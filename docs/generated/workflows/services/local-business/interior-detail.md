...
Interior detail still 1:1. Lab size **1024×1024**. Prefix `ez_svc_int_d`.
...
**This graph:** `## services/local-business/interior-detail Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Interior detail still 1:1. Lab size **1024×1024**. Prefix `ez_svc_…`
