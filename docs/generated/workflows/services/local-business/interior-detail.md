---
title: "services/local-business/interior-detail"
description: "Interior detail still 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/interior-detail
...
**Who this is for:** studio users who loaded `services/local-business/interior-detail` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/interior-detail.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Interior detail still 1:1. Lab size **1024x1024**. Prefix `ez_svc_int_d`.
...
2. Load **services/local-business/interior-detail** from **Apps** or **Workflows**
...
**This graph:** `## services/local-business/interior-detail Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Interior detail still 1:1. Lab size **1024x1024**. Prefix `ez_svc_...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Detail of unmarked millwork and a ceramic, 50mm. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Detail of unmarked millwork and a ceramic, 50mm. Empty of lettering.
```
