---
title: "services/local-business/hours-bed"
description: "Silent hours-bed ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/hours-bed
...
**Who this is for:** studio users who loaded `services/local-business/hours-bed` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/hours-bed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent hours-bed ~5 s. Lab size **832x480**. Prefix `ez_svc_hours`.
...
2. Load **services/local-business/hours-bed** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Soft light pulse on a quiet unmarked facade. Tiny cyclic motion. One continuous...` |
...
**This graph:** `## services/local-business/hours-bed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent hours-bed ~5 s. Lab size **832x480**. Prefix `ez_svc_hours`. Empt...`
...
**This graph:** `Soft light pulse on a quiet unmarked facade. Tiny cyclic motion. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Soft light pulse on a quiet unmarked facade. Tiny cyclic motion. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/local-business/hours-bed`
