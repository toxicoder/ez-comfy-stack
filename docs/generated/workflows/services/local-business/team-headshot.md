...
Team headshot 1:1. Lab size **1024×1024**. Prefix `ez_svc_team`.
...
**This graph:** `## services/local-business/team-headshot Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Team headshot 1:1. Lab size **1024×1024**. Prefix `ez_svc_team`. Emp…`
