---
title: "services/local-business/team-headshot"
description: "Team headshot 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/team-headshot
...
**Who this is for:** studio users who loaded `services/local-business/team-headshot` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/team-headshot.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Team headshot 1:1. Lab size **1024x1024**. Prefix `ez_svc_team`.
...
2. Load **services/local-business/team-headshot** from **Apps** or **Workflows**
...
**This graph:** `## services/local-business/team-headshot Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Team headshot 1:1. Lab size **1024x1024**. Prefix `ez_svc_team`. Emp...`
