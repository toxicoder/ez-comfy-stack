---
title: "services/local-business/gym-floor"
description: "Gym-floor still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/gym-floor
...
**Who this is for:** studio users who loaded `services/local-business/gym-floor` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/gym-floor.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Gym-floor still 16:9. Lab size **1280x704**. Prefix `ez_svc_gymfl`.
...
2. Load **services/local-business/gym-floor** from **Apps** or **Workflows**
...
**This graph:** `## services/local-business/gym-floor Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Gym-floor still 16:9. Lab size **1280x704**. Prefix `ez_svc_gymfl`. Empt...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked gym, rubber floor, empty of logos and screens. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked gym, rubber floor, empty of logos and screens. Empty of lettering.
```
