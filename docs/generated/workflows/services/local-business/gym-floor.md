...
Gym-floor still 16:9. Lab size **1280×704**. Prefix `ez_svc_gymfl`.
...
**This graph:** `## services/local-business/gym-floor Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Gym-floor still 16:9. Lab size **1280×704**. Prefix `ez_svc_gymfl`. Empt…`
