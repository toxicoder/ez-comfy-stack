...
Silent storefront day ~5 s. Lab size **832×480**. Prefix `ez_svc_sf_day`.
...
**This graph:** `## services/local-business/storefront-day Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent storefront day ~5 s. Lab size **832×480**. Prefix `ez_svc_sf…`
