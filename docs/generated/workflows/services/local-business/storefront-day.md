---
title: "services/local-business/storefront-day"
description: "Silent storefront day ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/storefront-day
...
**Who this is for:** studio users who loaded `services/local-business/storefront-day` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/storefront-day.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent storefront day ~5 s. Lab size **832x480**. Prefix `ez_svc_sf_day`.
...
2. Load **services/local-business/storefront-day** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Gentle traffic and awning drift. Keep the start-image facade. One continuous fi...` |
...
**This graph:** `## services/local-business/storefront-day Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent storefront day ~5 s. Lab size **832x480**. Prefix `ez_svc_sf...`
...
**This graph:** `Gentle traffic and awning drift. Keep the start-image facade. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Gentle traffic and awning drift. Keep the start-image facade. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/local-business/storefront-day`
