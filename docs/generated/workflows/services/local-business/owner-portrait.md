...
Owner portrait 4:5. Lab size **1024×1280**. Prefix `ez_svc_owner`.
...
**This graph:** `## services/local-business/owner-portrait Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Owner portrait 4:5. Lab size **1024×1280**. Prefix `ez_svc_owner`. …`
