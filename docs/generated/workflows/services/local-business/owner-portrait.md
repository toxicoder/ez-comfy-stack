---
title: "services/local-business/owner-portrait"
description: "Owner portrait 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/owner-portrait
...
**Who this is for:** studio users who loaded `services/local-business/owner-portrait` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/owner-portrait.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Owner portrait 4:5. Lab size **1024x1280**. Prefix `ez_svc_owner`.
...
2. Load **services/local-business/owner-portrait** from **Apps** or **Workflows**
...
**This graph:** `## services/local-business/owner-portrait Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Owner portrait 4:5. Lab size **1024x1280**. Prefix `ez_svc_owner`. ...`
