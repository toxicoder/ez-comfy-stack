...
Service B-roll AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_svcbr`.
...
**This graph:** `## services/local-business/service-broll-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Service B-roll AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_svc…`
