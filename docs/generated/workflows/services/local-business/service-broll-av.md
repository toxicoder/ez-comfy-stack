---
title: "services/local-business/service-broll-av"
description: "Service B-roll AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/service-broll-av
...
**Who this is for:** studio users who loaded `services/local-business/service-broll-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/service-broll-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Service B-roll AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_svcbr`.
...
2. Load **services/local-business/service-broll-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Ambient unmarked shop floor. Soft tools, room tone. No score.` |
...
**This graph:** `## services/local-business/service-broll-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Service B-roll AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_svc...`
...
**This graph:** `Ambient unmarked shop floor. Soft tools, room tone. No score.`
...
**This graph:** `soft tools, room tone, no score`
...
**This graph:** `services/local-business/service-broll-av`
