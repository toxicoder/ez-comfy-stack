---
title: "services/local-business/interior-wide"
description: "Interior wide still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/interior-wide
...
**Who this is for:** studio users who loaded `services/local-business/interior-wide` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/interior-wide.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Interior wide still 16:9. Lab size **1280x704**. Prefix `ez_svc_int_w`.
...
2. Load **services/local-business/interior-wide** from **Apps** or **Workflows**
...
**This graph:** `## services/local-business/interior-wide Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Interior wide still 16:9. Lab size **1280x704**. Prefix `ez_svc_int_...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Wide unmarked dining room, oak and plaster, empty of lettering. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Wide unmarked dining room, oak and plaster, empty of lettering. Empty of lettering.
```
