...
Interior wide still 16:9. Lab size **1280×704**. Prefix `ez_svc_int_w`.
...
**This graph:** `## services/local-business/interior-wide Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Interior wide still 16:9. Lab size **1280×704**. Prefix `ez_svc_int_…`
