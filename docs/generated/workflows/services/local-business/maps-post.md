...
Local maps post 1:1. Lab size **1024×1024**. Prefix `ez_svc_maps_ps`.
...
**This graph:** `## services/local-business/maps-post Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Local maps post 1:1. Lab size **1024×1024**. Prefix `ez_svc_maps_ps`. Em…`
