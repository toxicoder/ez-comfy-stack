---
title: "services/local-business/maps-post"
description: "Local maps post 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/maps-post
...
**Who this is for:** studio users who loaded `services/local-business/maps-post` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/maps-post.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Local maps post 1:1. Lab size **1024x1024**. Prefix `ez_svc_maps_ps`.
...
2. Load **services/local-business/maps-post** from **Apps** or **Workflows**
...
**This graph:** `## services/local-business/maps-post Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Local maps post 1:1. Lab size **1024x1024**. Prefix `ez_svc_maps_ps`. Em...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Square facade still, subject large, unmarked. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Square facade still, subject large, unmarked. Empty of lettering.
```
