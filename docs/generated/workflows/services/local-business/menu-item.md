...
Menu-item still 1:1. Lab size **1024×1024**. Prefix `ez_svc_menu`.
...
**This graph:** `## services/local-business/menu-item Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Menu-item still 1:1. Lab size **1024×1024**. Prefix `ez_svc_menu`. Empty…`
