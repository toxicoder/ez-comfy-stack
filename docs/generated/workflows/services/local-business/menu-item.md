---
title: "services/local-business/menu-item"
description: "Menu-item still 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/menu-item
...
**Who this is for:** studio users who loaded `services/local-business/menu-item` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/menu-item.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Menu-item still 1:1. Lab size **1024x1024**. Prefix `ez_svc_menu`.
...
2. Load **services/local-business/menu-item** from **Apps** or **Workflows**
...
**This graph:** `## services/local-business/menu-item Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Menu-item still 1:1. Lab size **1024x1024**. Prefix `ez_svc_menu`. Empty...`
...
**This graph:** `A photoreal still of plated food on unmarked crockery, a linen napkin on oak, soft window sidelight. Empty of lettering. Overhead plated dish on unmarked crockery, oak, window light. Empty of letteri...`

```text
A photoreal still of plated food on unmarked crockery, a linen napkin on oak, soft window sidelight. Empty of lettering. Overhead plated dish on unmarked crockery, oak, window light. Empty of lettering.
```
