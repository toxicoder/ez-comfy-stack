---
title: "services/local-business/maps-cover"
description: "Local maps cover ~1.91:1"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/maps-cover
...
**Who this is for:** studio users who loaded `services/local-business/maps-cover` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/maps-cover.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Local maps cover ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_maps_cv`.
...
2. Load **services/local-business/maps-cover** from **Apps** or **Workflows**
...
**This graph:** `## services/local-business/maps-cover Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Local maps cover ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_maps_cv...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Wide unmarked facade, sky band empty, no sign lettering. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Wide unmarked facade, sky band empty, no sign lettering. Empty of lettering.
```
...
**This graph:** `~1.91:1 landscape (1216x640)`
