...
Local maps cover ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_maps_cv`.
...
**This graph:** `## services/local-business/maps-cover Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Local maps cover ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_maps_cv…`
...
**This graph:** `~1.91:1 landscape (1216×640)`
