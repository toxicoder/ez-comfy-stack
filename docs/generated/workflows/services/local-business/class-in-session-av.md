...
Class-in-session AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_class`.
...
| 6 | Size 1280x704 | `EmptyLTXVLatentVideo` | Ungrouped |
...
**This graph:** `## services/local-business/class-in-session-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Class-in-session AV ~5 s. Lab size **1280×704**. Prefix `ez_sv…`
