---
title: "services/local-business/class-in-session-av"
description: "Class-in-session AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/class-in-session-av
...
**Who this is for:** studio users who loaded `services/local-business/class-in-session-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/class-in-session-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Class-in-session AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_class`.
...
2. Load **services/local-business/class-in-session-av** from **Apps** or **Workflows**
...
| 6 | Size 1280x704 | `EmptyLTXVLatentVideo` | SETTINGS |
...
| Instance | Value |
| --- | --- |
| Positive | `Wide unmarked studio class. Breath, shoe squeak, no score.` |
...
**This graph:** `## services/local-business/class-in-session-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Class-in-session AV ~5 s. Lab size **1280x704**. Prefix `ez_sv...`
...
**This graph:** `Wide unmarked studio class. Breath, shoe squeak, no score.`
...
**This graph:** `services/local-business/class-in-session-av`
