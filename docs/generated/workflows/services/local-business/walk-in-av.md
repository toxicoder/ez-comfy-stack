---
title: "services/local-business/walk-in-av"
description: "Walk-in AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/walk-in-av
...
**Who this is for:** studio users who loaded `services/local-business/walk-in-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/walk-in-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Walk-in AV 9:16. Lab size **768x1280**. Prefix `ez_svc_walkin`.
...
2. Load **services/local-business/walk-in-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Door opens into the start-image interior. Bell, room tone. No score. Keep every...` |
...
**This graph:** `## services/local-business/walk-in-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Walk-in AV 9:16. Lab size **768x1280**. Prefix `ez_svc_walkin`. Empty o...`
...
**This graph:** `Door opens into the start-image interior. Bell, room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Door opens into the start-image interior. Bell, room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `door bell, room tone, no score`
...
**This graph:** `services/local-business/walk-in-av`
