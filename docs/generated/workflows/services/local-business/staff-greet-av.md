---
title: "services/local-business/staff-greet-av"
description: "Staff greet AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/staff-greet-av
...
**Who this is for:** studio users who loaded `services/local-business/staff-greet-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/staff-greet-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Staff greet AV 9:16. Lab size **768x1280**. Prefix `ez_svc_greet`.
...
2. Load **services/local-business/staff-greet-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `A host steps forward from the start still. Room tone, a smile beat. No score. K...` |
...
**This graph:** `## services/local-business/staff-greet-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Staff greet AV 9:16. Lab size **768x1280**. Prefix `ez_svc_greet`. ...`
...
**This graph:** `A host steps forward from the start still. Room tone, a smile beat. No score. Keep every object and surface from the start image; do not redesign.`

```text
A host steps forward from the start still. Room tone, a smile beat. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/local-business/staff-greet-av`
