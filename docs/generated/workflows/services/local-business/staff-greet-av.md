...
Staff greet AV 9:16. Lab size **768×1280**. Prefix `ez_svc_greet`.
...
**This graph:** `## services/local-business/staff-greet-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Staff greet AV 9:16. Lab size **768×1280**. Prefix `ez_svc_greet`. …`
