---
title: "services/local-business/plated-special"
description: "Silent plated-special 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/plated-special
...
**Who this is for:** studio users who loaded `services/local-business/plated-special` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/plated-special.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent plated-special 9:16. Lab size **480x832**. Prefix `ez_svc_plated`.
...
2. Load **services/local-business/plated-special** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Steam lifts from the start-image plate. Locked vertical. One continuous five-se...` |
...
**This graph:** `## services/local-business/plated-special Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent plated-special 9:16. Lab size **480x832**. Prefix `ez_svc_pl...`
...
**This graph:** `Steam lifts from the start-image plate. Locked vertical. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Steam lifts from the start-image plate. Locked vertical. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/local-business/plated-special`
