...
Silent plated-special 9:16. Lab size **480×832**. Prefix `ez_svc_plated`.
...
**This graph:** `## services/local-business/plated-special Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent plated-special 9:16. Lab size **480×832**. Prefix `ez_svc_pl…`
