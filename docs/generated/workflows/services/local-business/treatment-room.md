---
title: "services/local-business/treatment-room"
description: "Treatment-room still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/local-business/treatment-room
...
**Who this is for:** studio users who loaded `services/local-business/treatment-room` from Apps or Workflows.

> Generated from `workflows/_lab/services/local-business/treatment-room.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Treatment-room still 16:9. Lab size **1280x704**. Prefix `ez_svc_treat`.
...
2. Load **services/local-business/treatment-room** from **Apps** or **Workflows**
...
**This graph:** `## services/local-business/treatment-room Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Treatment-room still 16:9. Lab size **1280x704**. Prefix `ez_svc_tr...`
...
**This graph:** `A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked clinic room, linen and pale plaster, quiet. Empty of lettering.`

```text
A photoreal still of an unmarked interior, pale plaster and oak, no logos on walls or screens. Empty of lettering. Unmarked clinic room, linen and pale plaster, quiet. Empty of lettering.
```
