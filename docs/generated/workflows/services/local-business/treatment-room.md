...
Treatment-room still 16:9. Lab size **1280×704**. Prefix `ez_svc_treat`.
...
**This graph:** `## services/local-business/treatment-room Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Treatment-room still 16:9. Lab size **1280×704**. Prefix `ez_svc_tr…`
