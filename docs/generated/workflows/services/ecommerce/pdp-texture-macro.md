...
PDP texture macro 1:1. Lab size **1024×1024**. Prefix `ez_svc_pdp_macro`.
...
**This graph:** `## services/ecommerce/pdp-texture-macro Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. PDP texture macro 1:1. Lab size **1024×1024**. Prefix `ez_svc_pdp_mac…`
