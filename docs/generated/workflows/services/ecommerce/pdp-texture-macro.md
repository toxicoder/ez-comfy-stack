---
title: "services/ecommerce/pdp-texture-macro"
description: "PDP texture macro 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/pdp-texture-macro
...
**Who this is for:** studio users who loaded `services/ecommerce/pdp-texture-macro` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/pdp-texture-macro.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
PDP texture macro 1:1. Lab size **1024x1024**. Prefix `ez_svc_pdp_macro`.
...
2. Load **services/ecommerce/pdp-texture-macro** from **Apps** or **Workflows**
...
**This graph:** `## services/ecommerce/pdp-texture-macro Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. PDP texture macro 1:1. Lab size **1024x1024**. Prefix `ez_svc_pdp_mac...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Macro of glaze and o...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Macro of glaze and oak grain, 85mm, shallow depth. Unmarked. Empty of lettering.
```
