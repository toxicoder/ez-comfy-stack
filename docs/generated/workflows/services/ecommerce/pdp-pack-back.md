---
title: "services/ecommerce/pdp-pack-back"
description: "PDP pack-back still 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/pdp-pack-back
...
**Who this is for:** studio users who loaded `services/ecommerce/pdp-pack-back` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/pdp-pack-back.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
PDP pack-back still 1:1. Lab size **1024x1024**. Prefix `ez_svc_pdp_back`.
...
2. Load **services/ecommerce/pdp-pack-back** from **Apps** or **Workflows**
...
**This graph:** `## services/ecommerce/pdp-pack-back Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. PDP pack-back still 1:1. Lab size **1024x1024**. Prefix `ez_svc_pdp_back`...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Rear three-quarter o...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Rear three-quarter of the unmarked mug on seamless gray. Empty of lettering.
```
