...
PDP pack-back still 1:1. Lab size **1024×1024**. Prefix `ez_svc_pdp_back`.
...
**This graph:** `## services/ecommerce/pdp-pack-back Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. PDP pack-back still 1:1. Lab size **1024×1024**. Prefix `ez_svc_pdp_back`…`
