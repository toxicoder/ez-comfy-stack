---
title: "services/ecommerce/drop-tease"
description: "Silent drop-tease ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/drop-tease
...
**Who this is for:** studio users who loaded `services/ecommerce/drop-tease` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/drop-tease.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent drop-tease ~5 s. Lab size **832x480**. Prefix `ez_svc_drop`.
...
2. Load **services/ecommerce/drop-tease** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow reveal of the start-image product from shadow into key. One continuous fiv...` |
...
**This graph:** `## services/ecommerce/drop-tease Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent drop-tease ~5 s. Lab size **832x480**. Prefix `ez_svc_drop`. Empty of...`
...
**This graph:** `Slow reveal of the start-image product from shadow into key. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Slow reveal of the start-image product from shadow into key. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/ecommerce/drop-tease`
