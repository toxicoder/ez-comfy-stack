---
title: "services/ecommerce/gift-set-still"
description: "Gift-set still 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/gift-set-still
...
**Who this is for:** studio users who loaded `services/ecommerce/gift-set-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/gift-set-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Gift-set still 4:5. Lab size **1024x1280**. Prefix `ez_svc_gift`.
...
2. Load **services/ecommerce/gift-set-still** from **Apps** or **Workflows**
...
**This graph:** `## services/ecommerce/gift-set-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Gift-set still 4:5. Lab size **1024x1280**. Prefix `ez_svc_gift`. Empty ...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Stacked unmarked box...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Stacked unmarked box and mug on oak, warm key, quiet edges. Empty of lettering.
```
