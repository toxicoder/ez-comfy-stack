...
Gift-set still 4:5. Lab size **1024×1280**. Prefix `ez_svc_gift`.
...
**This graph:** `## services/ecommerce/gift-set-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Gift-set still 4:5. Lab size **1024×1280**. Prefix `ez_svc_gift`. Empty …`
