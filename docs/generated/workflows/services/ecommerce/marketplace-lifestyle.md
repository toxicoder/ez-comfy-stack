---
title: "services/ecommerce/marketplace-lifestyle"
description: "Silent marketplace lifestyle ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/marketplace-lifestyle
...
**Who this is for:** studio users who loaded `services/ecommerce/marketplace-lifestyle` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/marketplace-lifestyle.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent marketplace lifestyle ~5 s. Lab size **832x480**. Prefix `ez_svc_mkt_life`.
...
2. Load **services/ecommerce/marketplace-lifestyle** from **Apps** or **Workflows**
...
| 8 | I2V size 832x480 x 121 | `Wan22ImageToVideoLatent` | SETTINGS |
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Gentle breeze on linen beside the start-image mug. Locked identity. One continu...` |
...
**This graph:** `## services/ecommerce/marketplace-lifestyle Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent marketplace lifestyle ~5 s. Lab size **832x480**. Prefix `...`
...
**This graph:** `Gentle breeze on linen beside the start-image mug. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Gentle breeze on linen beside the start-image mug. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/ecommerce/marketplace-lifestyle`
