---
title: "services/ecommerce/pdp-in-use"
description: "Silent in-use product motion ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/pdp-in-use
...
**Who this is for:** studio users who loaded `services/ecommerce/pdp-in-use` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/pdp-in-use.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent in-use product motion ~5 s. Lab size **832x480**. Prefix `ez_svc_pdp_use`.
...
2. Load **services/ecommerce/pdp-in-use** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Hands ease the start-image mug. Slow, locked identity. One continuous five-seco...` |
...
**This graph:** `## services/ecommerce/pdp-in-use Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent in-use product motion ~5 s. Lab size **832x480**. Prefix `ez_svc_pdp_...`
...
**This graph:** `Hands ease the start-image mug. Slow, locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Hands ease the start-image mug. Slow, locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/ecommerce/pdp-in-use`
