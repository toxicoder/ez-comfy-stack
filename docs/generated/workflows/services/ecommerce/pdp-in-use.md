...
Silent in-use product motion ~5 s. Lab size **832×480**. Prefix `ez_svc_pdp_use`.
...
**This graph:** `## services/ecommerce/pdp-in-use Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent in-use product motion ~5 s. Lab size **832×480**. Prefix `ez_svc_pdp_…`
