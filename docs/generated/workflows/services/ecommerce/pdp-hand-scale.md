---
title: "services/ecommerce/pdp-hand-scale"
description: "Silent hand-scale product motion ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/pdp-hand-scale
...
**Who this is for:** studio users who loaded `services/ecommerce/pdp-hand-scale` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/pdp-hand-scale.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent hand-scale product motion ~5 s. Lab size **832x480**. Prefix `ez_svc_pdp_hand`.
...
2. Load **services/ecommerce/pdp-hand-scale** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `A hand turns the start-image product for scale. Table holds. One continuous fiv...` |
...
**This graph:** `## services/ecommerce/pdp-hand-scale Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent hand-scale product motion ~5 s. Lab size **832x480**. Prefix `ez_...`
...
**This graph:** `A hand turns the start-image product for scale. Table holds. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
A hand turns the start-image product for scale. Table holds. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/ecommerce/pdp-hand-scale`
