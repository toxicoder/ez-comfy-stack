...
Silent hand-scale product motion ~5 s. Lab size **832×480**. Prefix `ez_svc_pdp_hand`.
...
**This graph:** `## services/ecommerce/pdp-hand-scale Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent hand-scale product motion ~5 s. Lab size **832×480**. Prefix `ez_…`
