---
title: "services/ecommerce/wear-test-av"
description: "Wear-test AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/wear-test-av
...
**Who this is for:** studio users who loaded `services/ecommerce/wear-test-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/wear-test-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Wear-test AV 9:16. Lab size **768x1280**. Prefix `ez_svc_wear`.
...
2. Load **services/ecommerce/wear-test-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow try-on from the start still. Cloth rustle. No score. Keep every object and...` |
...
**This graph:** `## services/ecommerce/wear-test-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Wear-test AV 9:16. Lab size **768x1280**. Prefix `ez_svc_wear`. Empty of l...`
...
**This graph:** `Slow try-on from the start still. Cloth rustle. No score. Keep every object and surface from the start image; do not redesign.`

```text
Slow try-on from the start still. Cloth rustle. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/ecommerce/wear-test-av`
