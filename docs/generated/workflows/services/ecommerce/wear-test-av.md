...
Wear-test AV 9:16. Lab size **768×1280**. Prefix `ez_svc_wear`.
...
**This graph:** `## services/ecommerce/wear-test-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Wear-test AV 9:16. Lab size **768×1280**. Prefix `ez_svc_wear`. Empty of l…`
