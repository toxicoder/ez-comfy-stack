---
title: "services/ecommerce/drape-loop"
description: "Silent fabric drape loop"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/drape-loop
...
**Who this is for:** studio users who loaded `services/ecommerce/drape-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/drape-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent fabric drape loop. Lab size **768x768**. Prefix `ez_svc_drape`.
...
2. Load **services/ecommerce/drape-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Cloth settles and lifts in a tiny cycle. Locked camera. Ping-pong friendly. No ...` |
...
**This graph:** `ez_svc_drape_frames`
...
**This graph:** `## services/ecommerce/drape-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent fabric drape loop. Lab size **768x768**. Prefix `ez_svc_drape`. Empty...`
...
**This graph:** `Cloth settles and lifts in a tiny cycle. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Cloth settles and lifts in a tiny cycle. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/ecommerce/drape-loop`
