...
Silent fabric drape loop. Lab size **768×768**. Prefix `ez_svc_drape`.
...
**This graph:** `## services/ecommerce/drape-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent fabric drape loop. Lab size **768×768**. Prefix `ez_svc_drape`. Empty…`
