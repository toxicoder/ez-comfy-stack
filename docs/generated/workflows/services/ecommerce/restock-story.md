---
title: "services/ecommerce/restock-story"
description: "Silent restock story 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/restock-story
...
**Who this is for:** studio users who loaded `services/ecommerce/restock-story` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/restock-story.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent restock story 9:16. Lab size **480x832**. Prefix `ez_svc_restock`.
...
2. Load **services/ecommerce/restock-story** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `A carton slides onto a shelf. Locked vertical framing. One continuous five-seco...` |
...
**This graph:** `## services/ecommerce/restock-story Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent restock story 9:16. Lab size **480x832**. Prefix `ez_svc_restock`....`
...
**This graph:** `A carton slides onto a shelf. Locked vertical framing. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
A carton slides onto a shelf. Locked vertical framing. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/ecommerce/restock-story`
