...
Silent restock story 9:16. Lab size **480×832**. Prefix `ez_svc_restock`.
...
**This graph:** `## services/ecommerce/restock-story Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent restock story 9:16. Lab size **480×832**. Prefix `ez_svc_restock`.…`
