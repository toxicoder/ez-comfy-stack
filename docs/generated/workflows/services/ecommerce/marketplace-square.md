...
Marketplace square packshot 1:1. Lab size **1024×1024**. Prefix `ez_svc_mkt_sq`.
...
**This graph:** `## services/ecommerce/marketplace-square Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Marketplace square packshot 1:1. Lab size **1024×1024**. Prefix `ez_…`
