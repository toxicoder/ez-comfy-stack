---
title: "services/ecommerce/marketplace-square"
description: "Marketplace square packshot 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/marketplace-square
...
**Who this is for:** studio users who loaded `services/ecommerce/marketplace-square` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/marketplace-square.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Marketplace square packshot 1:1. Lab size **1024x1024**. Prefix `ez_svc_mkt_sq`.
...
2. Load **services/ecommerce/marketplace-square** from **Apps** or **Workflows**
...
flowchart LR
  ...
  N14["Quality"]
  N15["Format / platform"]
  N16["Example / reference (optional)"]
...
| 6 | Size 1024x1024 | `EmptyFlux2LatentImage` | SETTINGS |
...
**This graph:** `## services/ecommerce/marketplace-square Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Marketplace square packshot 1:1. Lab size **1024x1024**. Prefix `ez_...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Clean product, soft ...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Clean product, soft key, unmarked seamless. Readable at small sizes. Empty of lettering.
```
