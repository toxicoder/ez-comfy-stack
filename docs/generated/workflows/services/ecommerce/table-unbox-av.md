---
title: "services/ecommerce/table-unbox-av"
description: "Table unbox AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/table-unbox-av
...
**Who this is for:** studio users who loaded `services/ecommerce/table-unbox-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/table-unbox-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Table unbox AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_unbox`.
...
2. Load **services/ecommerce/table-unbox-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Hands ease a box on oak. Paper rustle, cardboard. No score. Keep the start imag...` |
...
**This graph:** `## services/ecommerce/table-unbox-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Table unbox AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_unbox`. Empty...`
...
**This graph:** `Hands ease a box on oak. Paper rustle, cardboard. No score. Keep the start image. Keep every object and surface from the start image; do not redesign.`

```text
Hands ease a box on oak. Paper rustle, cardboard. No score. Keep the start image. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `paper rustle, cardboard, no score`
...
**This graph:** `services/ecommerce/table-unbox-av`
