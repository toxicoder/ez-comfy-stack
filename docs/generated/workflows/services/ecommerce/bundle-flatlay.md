...
Bundle flatlay 1:1. Lab size **1024×1024**. Prefix `ez_svc_bundle`.
...
**This graph:** `## services/ecommerce/bundle-flatlay Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Bundle flatlay 1:1. Lab size **1024×1024**. Prefix `ez_svc_bundle`. Empt…`
