---
title: "services/ecommerce/bundle-flatlay"
description: "Bundle flatlay 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/bundle-flatlay
...
**Who this is for:** studio users who loaded `services/ecommerce/bundle-flatlay` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/bundle-flatlay.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Bundle flatlay 1:1. Lab size **1024x1024**. Prefix `ez_svc_bundle`.
...
2. Load **services/ecommerce/bundle-flatlay** from **Apps** or **Workflows**
...
**This graph:** `## services/ecommerce/bundle-flatlay Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Bundle flatlay 1:1. Lab size **1024x1024**. Prefix `ez_svc_bundle`. Empt...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Overhead unmarked gi...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Overhead unmarked gift bundle on linen, soft window light. Empty of lettering.
```
