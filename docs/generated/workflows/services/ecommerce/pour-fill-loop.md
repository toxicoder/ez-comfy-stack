---
title: "services/ecommerce/pour-fill-loop"
description: "Silent pour-fill loop"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/pour-fill-loop
...
**Who this is for:** studio users who loaded `services/ecommerce/pour-fill-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/pour-fill-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent pour-fill loop. Lab size **768x768**. Prefix `ez_svc_pour`.
...
2. Load **services/ecommerce/pour-fill-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Liquid rises in the unmarked mug, then settles. Locked camera. Ping-pong friend...` |
...
**This graph:** `## services/ecommerce/pour-fill-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent pour-fill loop. Lab size **768x768**. Prefix `ez_svc_pour`. Empty...`
...
**This graph:** `Liquid rises in the unmarked mug, then settles. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Liquid rises in the unmarked mug, then settles. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/ecommerce/pour-fill-loop`
