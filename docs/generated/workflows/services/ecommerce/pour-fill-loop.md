...
Silent pour-fill loop. Lab size **768×768**. Prefix `ez_svc_pour`.
...
**This graph:** `## services/ecommerce/pour-fill-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent pour-fill loop. Lab size **768×768**. Prefix `ez_svc_pour`. Empty…`
