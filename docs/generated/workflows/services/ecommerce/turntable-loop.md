---
title: "services/ecommerce/turntable-loop"
description: "Silent product turntable loop"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/turntable-loop
...
**Who this is for:** studio users who loaded `services/ecommerce/turntable-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/turntable-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent product turntable loop. Lab size **768x768**. Prefix `ez_svc_turn`.
...
2. Load **services/ecommerce/turntable-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow cyclic orbit around the start-image product. Locked camera. Ping-pong frie...` |
...
**This graph:** `## services/ecommerce/turntable-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent product turntable loop. Lab size **768x768**. Prefix `ez_svc_turn...`
...
**This graph:** `Slow cyclic orbit around the start-image product. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Slow cyclic orbit around the start-image product. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/ecommerce/turntable-loop`
