...
Silent product turntable loop. Lab size **768×768**. Prefix `ez_svc_turn`.
...
**This graph:** `## services/ecommerce/turntable-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent product turntable loop. Lab size **768×768**. Prefix `ez_svc_turn…`
