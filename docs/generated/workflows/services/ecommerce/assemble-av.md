...
Assemble AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_asm`.
...
**This graph:** `## services/ecommerce/assemble-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Assemble AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_asm`. Empty of lett…`
