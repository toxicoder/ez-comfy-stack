---
title: "services/ecommerce/assemble-av"
description: "Assemble AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/assemble-av
...
**Who this is for:** studio users who loaded `services/ecommerce/assemble-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/assemble-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Assemble AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_asm`.
...
2. Load **services/ecommerce/assemble-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Hands fit unmarked parts on a bench. Soft clicks, wood. No score. Keep every ob...` |
...
**This graph:** `## services/ecommerce/assemble-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Assemble AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_asm`. Empty of lett...`
...
**This graph:** `Hands fit unmarked parts on a bench. Soft clicks, wood. No score. Keep every object and surface from the start image; do not redesign.`

```text
Hands fit unmarked parts on a bench. Soft clicks, wood. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `soft clicks, wood, no score`
...
**This graph:** `services/ecommerce/assemble-av`
