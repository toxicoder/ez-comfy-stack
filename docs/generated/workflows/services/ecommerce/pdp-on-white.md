---
title: "services/ecommerce/pdp-on-white"
description: "PDP on-white packshot 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/pdp-on-white
...
**Who this is for:** studio users who loaded `services/ecommerce/pdp-on-white` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/pdp-on-white.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
PDP on-white packshot 1:1. Lab size **1024x1024**. Prefix `ez_svc_pdp_white`.
...
2. Load **services/ecommerce/pdp-on-white** from **Apps** or **Workflows**
...
**This graph:** `## services/ecommerce/pdp-on-white Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. PDP on-white packshot 1:1. Lab size **1024x1024**. Prefix `ez_svc_pdp_whit...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Seamless light-gray ...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Seamless light-gray cyclorama, three-quarter product, soft studio key. Empty of lettering.
```
