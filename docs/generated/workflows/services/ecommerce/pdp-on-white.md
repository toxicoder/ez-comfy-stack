...
PDP on-white packshot 1:1. Lab size **1024×1024**. Prefix `ez_svc_pdp_white`.
...
**This graph:** `## services/ecommerce/pdp-on-white Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. PDP on-white packshot 1:1. Lab size **1024×1024**. Prefix `ez_svc_pdp_whit…`
