...
Collection banner 16:9. Lab size **1536×864**. Prefix `ez_svc_coll_ban`.
...
| 6 | Size 1536x864 | `EmptyFlux2LatentImage` | Ungrouped |
...
**This graph:** `## services/ecommerce/collection-banner Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Collection banner 16:9. Lab size **1536×864**. Prefix `ez_svc_coll_ba…`
...
**This graph:** `YouTube · channel art (1536×864)`
