---
title: "services/ecommerce/collection-banner"
description: "Collection banner 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/collection-banner
...
**Who this is for:** studio users who loaded `services/ecommerce/collection-banner` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/collection-banner.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Collection banner 16:9. Lab size **1536x864**. Prefix `ez_svc_coll_ban`.
...
2. Load **services/ecommerce/collection-banner** from **Apps** or **Workflows**
...
| 6 | Size 1536x864 | `EmptyFlux2LatentImage` | SETTINGS |
...
**This graph:** `## services/ecommerce/collection-banner Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Collection banner 16:9. Lab size **1536x864**. Prefix `ez_svc_coll_ba...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Wide row of unmarked...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Wide row of unmarked ceramics on oak, horizon low, quiet sky band. Empty of lettering.
```
...
**This graph:** `YouTube - channel art (1536x864)`
