...
Cart upsell background 9:16. Lab size **576×1024**. Prefix `ez_svc_cart`.
...
**This graph:** `## services/ecommerce/cart-upsell-bg Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Cart upsell background 9:16. Lab size **576×1024**. Prefix `ez_svc_cart`…`
