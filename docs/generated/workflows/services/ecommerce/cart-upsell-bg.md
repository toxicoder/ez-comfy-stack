---
title: "services/ecommerce/cart-upsell-bg"
description: "Cart upsell background 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/cart-upsell-bg
...
**Who this is for:** studio users who loaded `services/ecommerce/cart-upsell-bg` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/cart-upsell-bg.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Cart upsell background 9:16. Lab size **576x1024**. Prefix `ez_svc_cart`.
...
2. Load **services/ecommerce/cart-upsell-bg** from **Apps** or **Workflows**
...
| 6 | Size 576x1024 | `EmptyFlux2LatentImage` | SETTINGS |
...
| 18 | Describe image | `EZImageDescribe` | INPUT |
...
| Instance | Value |
| --- | --- |
| Positive | `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmar...` |
...
**This graph:** `## services/ecommerce/cart-upsell-bg Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Cart upsell background 9:16. Lab size **576x1024**. Prefix `ez_svc_cart`...`
...
**This graph:** `A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Quiet vertical still...`

```text
A photoreal still of a cream ceramic mug with a hairline chip on the rim, unmarked, on honey-oak beside a dark window. Soft studio key, gentle contact shadow. Empty of lettering. Quiet vertical still of the product, middle third holds the subject. Empty of lettering.
```
