...
Shelf-scan AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_shelf`.
...
**This graph:** `## services/ecommerce/shelf-scan-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Shelf-scan AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_shelf`. Empty o…`
