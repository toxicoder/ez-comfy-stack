---
title: "services/ecommerce/shelf-scan-av"
description: "Shelf-scan AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/ecommerce/shelf-scan-av
...
**Who this is for:** studio users who loaded `services/ecommerce/shelf-scan-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/ecommerce/shelf-scan-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Shelf-scan AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_shelf`.
...
2. Load **services/ecommerce/shelf-scan-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow lateral move along an unmarked shelf. Soft room tone. No score. Keep every...` |
...
**This graph:** `## services/ecommerce/shelf-scan-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Shelf-scan AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_shelf`. Empty o...`
...
**This graph:** `Slow lateral move along an unmarked shelf. Soft room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Slow lateral move along an unmarked shelf. Soft room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/ecommerce/shelf-scan-av`
