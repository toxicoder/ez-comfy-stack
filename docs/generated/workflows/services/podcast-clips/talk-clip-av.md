...
Talk-clip AV 9:16. Lab size **768×1280**. Prefix `ez_svc_talk`.
...
**This graph:** `## services/podcast-clips/talk-clip-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Talk-clip AV 9:16. Lab size **768×1280**. Prefix `ez_svc_talk`. Empty …`
