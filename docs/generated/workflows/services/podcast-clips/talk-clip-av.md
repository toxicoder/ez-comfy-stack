---
title: "services/podcast-clips/talk-clip-av"
description: "Talk-clip AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/talk-clip-av
...
**Who this is for:** studio users who loaded `services/podcast-clips/talk-clip-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/talk-clip-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Talk-clip AV 9:16. Lab size **768x1280**. Prefix `ez_svc_talk`.
...
2. Load **services/podcast-clips/talk-clip-av** from **Apps** or **Workflows**
...
**This graph:** `## services/podcast-clips/talk-clip-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Talk-clip AV 9:16. Lab size **768x1280**. Prefix `ez_svc_talk`. Empty ...`
...
**This graph:** `services/podcast-clips/talk-clip-av`
