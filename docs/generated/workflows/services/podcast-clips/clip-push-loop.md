---
title: "services/podcast-clips/clip-push-loop"
description: "Silent clip-push loop"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/clip-push-loop
...
**Who this is for:** studio users who loaded `services/podcast-clips/clip-push-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/clip-push-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent clip-push loop. Lab size **768x768**. Prefix `ez_svc_cpush`.
...
2. Load **services/podcast-clips/clip-push-loop** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Tiny cyclic push toward the start-image desk. Locked camera. Ping-pong friendly...` |
...
**This graph:** `ez_svc_cpush_frames`
...
**This graph:** `## services/podcast-clips/clip-push-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent clip-push loop. Lab size **768x768**. Prefix `ez_svc_cpush`. ...`
...
**This graph:** `Tiny cyclic push toward the start-image desk. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Tiny cyclic push toward the start-image desk. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/podcast-clips/clip-push-loop`
