...
Waveform bed 16:9. Lab size **1280×704**. Prefix `ez_svc_wave`.
...
**This graph:** `## services/podcast-clips/waveform-bed Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Waveform bed 16:9. Lab size **1280×704**. Prefix `ez_svc_wave`. Empty …`
