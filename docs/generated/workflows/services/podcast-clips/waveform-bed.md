---
title: "services/podcast-clips/waveform-bed"
description: "Waveform bed 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/waveform-bed
...
**Who this is for:** studio users who loaded `services/podcast-clips/waveform-bed` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/waveform-bed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Waveform bed 16:9. Lab size **1280x704**. Prefix `ez_svc_wave`.
...
2. Load **services/podcast-clips/waveform-bed** from **Apps** or **Workflows**
...
**This graph:** `## services/podcast-clips/waveform-bed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Waveform bed 16:9. Lab size **1280x704**. Prefix `ez_svc_wave`. Empty ...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet lower fifth for a waveform overlay later. Empty of l...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet lower fifth for a waveform overlay later. Empty of lettering.
```
