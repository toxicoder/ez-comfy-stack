---
title: "services/podcast-clips/clip-wide"
description: "Podcast clip still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/clip-wide
...
**Who this is for:** studio users who loaded `services/podcast-clips/clip-wide` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/clip-wide.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Podcast clip still 16:9. Lab size **1280x704**. Prefix `ez_svc_clip_w`.
...
2. Load **services/podcast-clips/clip-wide** from **Apps** or **Workflows**
...
**This graph:** `## services/podcast-clips/clip-wide Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Podcast clip still 16:9. Lab size **1280x704**. Prefix `ez_svc_clip_w`. E...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Two unmarked mics on oak, quiet lower fifth for a waveform...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Two unmarked mics on oak, quiet lower fifth for a waveform later. Empty of lettering.
```
