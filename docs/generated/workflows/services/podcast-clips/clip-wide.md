...
Podcast clip still 16:9. Lab size **1280×704**. Prefix `ez_svc_clip_w`.
...
**This graph:** `## services/podcast-clips/clip-wide Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Podcast clip still 16:9. Lab size **1280×704**. Prefix `ez_svc_clip_w`. E…`
