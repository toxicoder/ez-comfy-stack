...
Studio-walk AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_swalk`.
...
**This graph:** `## services/podcast-clips/studio-walk-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Studio-walk AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_swalk`. E…`
