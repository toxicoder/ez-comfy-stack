---
title: "services/podcast-clips/studio-walk-av"
description: "Studio-walk AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/studio-walk-av
...
**Who this is for:** studio users who loaded `services/podcast-clips/studio-walk-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/studio-walk-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Studio-walk AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_swalk`.
...
2. Load **services/podcast-clips/studio-walk-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Slow walk through an unmarked studio. Footfalls, room tone. No score.` |
...
**This graph:** `## services/podcast-clips/studio-walk-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Studio-walk AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_swalk`. E...`
...
**This graph:** `Slow walk through an unmarked studio. Footfalls, room tone. No score.`
...
**This graph:** `services/podcast-clips/studio-walk-av`
