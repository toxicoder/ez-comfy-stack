---
title: "services/podcast-clips/live-badge-bed"
description: "Silent live-badge bed 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/live-badge-bed
...
**Who this is for:** studio users who loaded `services/podcast-clips/live-badge-bed` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/live-badge-bed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent live-badge bed 9:16. Lab size **480x832**. Prefix `ez_svc_live`.
...
2. Load **services/podcast-clips/live-badge-bed** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Soft cyclic light on a quiet set. Tiny motion only. One continuous five-second ...` |
...
**This graph:** `## services/podcast-clips/live-badge-bed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent live-badge bed 9:16. Lab size **480x832**. Prefix `ez_svc_liv...`
...
**This graph:** `Soft cyclic light on a quiet set. Tiny motion only. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Soft cyclic light on a quiet set. Tiny motion only. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/podcast-clips/live-badge-bed`
