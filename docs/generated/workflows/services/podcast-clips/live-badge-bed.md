...
Silent live-badge bed 9:16. Lab size **480×832**. Prefix `ez_svc_live`.
...
**This graph:** `## services/podcast-clips/live-badge-bed Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent live-badge bed 9:16. Lab size **480×832**. Prefix `ez_svc_liv…`
