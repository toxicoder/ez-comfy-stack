...
Quote-card background 16:9. Lab size **1280×704**. Prefix `ez_svc_qte_w`.
...
**This graph:** `## services/podcast-clips/quote-wide Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Quote-card background 16:9. Lab size **1280×704**. Prefix `ez_svc_qte_w`…`
