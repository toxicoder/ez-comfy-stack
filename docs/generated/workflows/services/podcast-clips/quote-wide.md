---
title: "services/podcast-clips/quote-wide"
description: "Quote-card background 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/quote-wide
...
**Who this is for:** studio users who loaded `services/podcast-clips/quote-wide` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/quote-wide.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Quote-card background 16:9. Lab size **1280x704**. Prefix `ez_svc_qte_w`.
...
2. Load **services/podcast-clips/quote-wide** from **Apps** or **Workflows**
...
**This graph:** `## services/podcast-clips/quote-wide Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Quote-card background 16:9. Lab size **1280x704**. Prefix `ez_svc_qte_w`...`
