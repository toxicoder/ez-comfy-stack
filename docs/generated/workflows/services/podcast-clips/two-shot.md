---
title: "services/podcast-clips/two-shot"
description: "Two-shot still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/two-shot
...
**Who this is for:** studio users who loaded `services/podcast-clips/two-shot` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/two-shot.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Two-shot still 16:9. Lab size **1280x704**. Prefix `ez_svc_twoshot`.
...
2. Load **services/podcast-clips/two-shot** from **Apps** or **Workflows**
...
**This graph:** `## services/podcast-clips/two-shot Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Two-shot still 16:9. Lab size **1280x704**. Prefix `ez_svc_twoshot`. Empty...`
