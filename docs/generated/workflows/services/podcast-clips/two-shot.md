...
Two-shot still 16:9. Lab size **1280×704**. Prefix `ez_svc_twoshot`.
...
**This graph:** `## services/podcast-clips/two-shot Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Two-shot still 16:9. Lab size **1280×704**. Prefix `ez_svc_twoshot`. Empty…`
