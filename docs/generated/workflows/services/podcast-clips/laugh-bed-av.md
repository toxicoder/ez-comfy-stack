---
title: "services/podcast-clips/laugh-bed-av"
description: "Laugh-bed AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/laugh-bed-av
...
**Who this is for:** studio users who loaded `services/podcast-clips/laugh-bed-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/laugh-bed-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Laugh-bed AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_laugh`.
...
2. Load **services/podcast-clips/laugh-bed-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `Quiet set, a distant laugh as world SFX, no score.` |
...
**This graph:** `## services/podcast-clips/laugh-bed-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Laugh-bed AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_laugh`. Empty...`
...
**This graph:** `Quiet set, a distant laugh as world SFX, no score.`
...
**This graph:** `distant laugh, room tone, no score`
...
**This graph:** `services/podcast-clips/laugh-bed-av`
