...
Quote-card background 9:16. Lab size **576×1024**. Prefix `ez_svc_qte_v`.
...
**This graph:** `## services/podcast-clips/quote-vert Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Quote-card background 9:16. Lab size **576×1024**. Prefix `ez_svc_qte_v`…`
