---
title: "services/podcast-clips/quote-vert"
description: "Quote-card background 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/quote-vert
...
**Who this is for:** studio users who loaded `services/podcast-clips/quote-vert` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/quote-vert.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Quote-card background 9:16. Lab size **576x1024**. Prefix `ez_svc_qte_v`.
...
2. Load **services/podcast-clips/quote-vert** from **Apps** or **Workflows**
...
**This graph:** `## services/podcast-clips/quote-vert Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Quote-card background 9:16. Lab size **576x1024**. Prefix `ez_svc_qte_v`...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet center for overlay type later. Empty of lettering.`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Quiet center for overlay type later. Empty of lettering.
```
