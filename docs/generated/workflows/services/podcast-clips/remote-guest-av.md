...
Remote-guest AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_remote`.
...
**This graph:** `## services/podcast-clips/remote-guest-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Remote-guest AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_remote`…`
