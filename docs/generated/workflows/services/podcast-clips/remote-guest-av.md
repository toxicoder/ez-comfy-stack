---
title: "services/podcast-clips/remote-guest-av"
description: "Remote-guest AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/remote-guest-av
...
**Who this is for:** studio users who loaded `services/podcast-clips/remote-guest-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/remote-guest-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Remote-guest AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_remote`.
...
2. Load **services/podcast-clips/remote-guest-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Laptop-and-mic take from the start still. Soft room tone. No score. Keep every ...` |
...
**This graph:** `## services/podcast-clips/remote-guest-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Remote-guest AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_remote`...`
...
**This graph:** `Laptop-and-mic take from the start still. Soft room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Laptop-and-mic take from the start still. Soft room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/podcast-clips/remote-guest-av`
