...
Season-trailer AV 9:16. Lab size **768×1280**. Prefix `ez_svc_strail`.
...
**This graph:** `## services/podcast-clips/season-trailer-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Season-trailer AV 9:16. Lab size **768×1280**. Prefix `ez_svc_str…`
