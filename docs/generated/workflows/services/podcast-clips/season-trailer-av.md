---
title: "services/podcast-clips/season-trailer-av"
description: "Season-trailer AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/season-trailer-av
...
**Who this is for:** studio users who loaded `services/podcast-clips/season-trailer-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/season-trailer-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Season-trailer AV 9:16. Lab size **768x1280**. Prefix `ez_svc_strail`.
...
2. Load **services/podcast-clips/season-trailer-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Vertical trailer hook from the start still. Soft whoosh. No score. Keep every o...` |
...
**This graph:** `## services/podcast-clips/season-trailer-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Season-trailer AV 9:16. Lab size **768x1280**. Prefix `ez_svc_str...`
...
**This graph:** `Vertical trailer hook from the start still. Soft whoosh. No score. Keep every object and surface from the start image; do not redesign.`

```text
Vertical trailer hook from the start still. Soft whoosh. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `soft whoosh, no score`
...
**This graph:** `services/podcast-clips/season-trailer-av`
