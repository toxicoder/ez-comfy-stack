---
title: "services/podcast-clips/lower-third-loop"
description: "Silent lower-third bed loop"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/lower-third-loop
...
**Who this is for:** studio users who loaded `services/podcast-clips/lower-third-loop` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/lower-third-loop.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent lower-third bed loop. Lab size **768x768**. Prefix `ez_svc_lthird`.
...
2. Load **services/podcast-clips/lower-third-loop** from **Apps** or **Workflows**
...
| 8 | Loop size 768x768 x 49 | `Wan22ImageToVideoLatent` | SETTINGS |
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Soft light drift. Lower band stays simple. Locked camera. Ping-pong friendly. N...` |
...
**This graph:** `ez_svc_lthird_frames`
...
**This graph:** `## services/podcast-clips/lower-third-loop Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent lower-third bed loop. Lab size **768x768**. Prefix `ez_svc_...`
...
**This graph:** `Soft light drift. Lower band stays simple. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.`

```text
Soft light drift. Lower band stays simple. Locked camera. Ping-pong friendly. No walk. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `looping, 12 fps, ping-pong`
...
**This graph:** `services/podcast-clips/lower-third-loop`
...
**This graph:** `Wan - 1:1 square (768x768)`
