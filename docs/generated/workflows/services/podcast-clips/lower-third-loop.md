...
Silent lower-third bed loop. Lab size **768×768**. Prefix `ez_svc_lthird`.
...
**This graph:** `## services/podcast-clips/lower-third-loop Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent lower-third bed loop. Lab size **768×768**. Prefix `ez_svc_…`
...
**This graph:** `Wan · 1:1 square (768×768)`
