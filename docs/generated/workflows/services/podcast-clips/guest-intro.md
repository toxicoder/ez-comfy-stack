---
title: "services/podcast-clips/guest-intro"
description: "Silent guest-intro 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/guest-intro
...
**Who this is for:** studio users who loaded `services/podcast-clips/guest-intro` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/guest-intro.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent guest-intro 9:16. Lab size **480x832**. Prefix `ez_svc_guest`.
...
2. Load **services/podcast-clips/guest-intro** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Slow push-in on the start-image guest. Locked identity. One continuous five-sec...` |
...
**This graph:** `## services/podcast-clips/guest-intro Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent guest-intro 9:16. Lab size **480x832**. Prefix `ez_svc_guest`. E...`
...
**This graph:** `Slow push-in on the start-image guest. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Slow push-in on the start-image guest. Locked identity. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/podcast-clips/guest-intro`
