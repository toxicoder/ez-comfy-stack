...
Silent guest-intro 9:16. Lab size **480×832**. Prefix `ez_svc_guest`.
...
**This graph:** `## services/podcast-clips/guest-intro Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent guest-intro 9:16. Lab size **480×832**. Prefix `ez_svc_guest`. E…`
