---
title: "services/podcast-clips/chapter-art"
description: "Chapter art 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/chapter-art
...
**Who this is for:** studio users who loaded `services/podcast-clips/chapter-art` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/chapter-art.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Chapter art 1:1. Lab size **1024x1024**. Prefix `ez_svc_chapt`.
...
2. Load **services/podcast-clips/chapter-art** from **Apps** or **Workflows**
...
**This graph:** `## services/podcast-clips/chapter-art Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Chapter art 1:1. Lab size **1024x1024**. Prefix `ez_svc_chapt`. Empty o...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Square chapter still, one prop story, unmarked. Empty of l...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Square chapter still, one prop story, unmarked. Empty of lettering.
```
