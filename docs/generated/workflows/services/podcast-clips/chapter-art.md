...
Chapter art 1:1. Lab size **1024×1024**. Prefix `ez_svc_chapt`.
...
**This graph:** `## services/podcast-clips/chapter-art Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Chapter art 1:1. Lab size **1024×1024**. Prefix `ez_svc_chapt`. Empty o…`
