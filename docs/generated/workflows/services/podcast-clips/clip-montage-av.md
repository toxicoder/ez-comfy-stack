---
title: "services/podcast-clips/clip-montage-av"
description: "Clip-montage AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/clip-montage-av
...
**Who this is for:** studio users who loaded `services/podcast-clips/clip-montage-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/clip-montage-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Clip-montage AV 9:16. Lab size **768x1280**. Prefix `ez_svc_mont`.
...
2. Load **services/podcast-clips/clip-montage-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Fast energy from the start still. World SFX only. No score. Keep every object a...` |
...
**This graph:** `## services/podcast-clips/clip-montage-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Clip-montage AV 9:16. Lab size **768x1280**. Prefix `ez_svc_mont`. ...`
...
**This graph:** `Fast energy from the start still. World SFX only. No score. Keep every object and surface from the start image; do not redesign.`

```text
Fast energy from the start still. World SFX only. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/podcast-clips/clip-montage-av`
