...
Clip-montage AV 9:16. Lab size **768×1280**. Prefix `ez_svc_mont`.
...
**This graph:** `## services/podcast-clips/clip-montage-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Clip-montage AV 9:16. Lab size **768×1280**. Prefix `ez_svc_mont`. …`
