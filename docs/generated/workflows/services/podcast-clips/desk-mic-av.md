...
Desk-mic AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_dmic`.
...
**This graph:** `## services/podcast-clips/desk-mic-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Desk-mic AV ~5 s. Lab size **1280×704**. Prefix `ez_svc_dmic`. Empty of…`
