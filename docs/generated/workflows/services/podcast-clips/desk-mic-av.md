---
title: "services/podcast-clips/desk-mic-av"
description: "Desk-mic AV ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/desk-mic-av
...
**Who this is for:** studio users who loaded `services/podcast-clips/desk-mic-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/desk-mic-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Desk-mic AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_dmic`.
...
2. Load **services/podcast-clips/desk-mic-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Locked desk. Soft keycaps, a mug set down. No score. Keep every object and surf...` |
...
**This graph:** `## services/podcast-clips/desk-mic-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Desk-mic AV ~5 s. Lab size **1280x704**. Prefix `ez_svc_dmic`. Empty of...`
...
**This graph:** `Locked desk. Soft keycaps, a mug set down. No score. Keep every object and surface from the start image; do not redesign.`

```text
Locked desk. Soft keycaps, a mug set down. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `keycaps, mug, no score`
...
**This graph:** `services/podcast-clips/desk-mic-av`
