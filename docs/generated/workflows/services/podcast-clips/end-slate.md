...
End slate 16:9. Lab size **1280×704**. Prefix `ez_svc_endsl`.
...
**This graph:** `## services/podcast-clips/end-slate Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. End slate 16:9. Lab size **1280×704**. Prefix `ez_svc_endsl`. Empty of le…`
