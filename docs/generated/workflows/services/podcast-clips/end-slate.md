---
title: "services/podcast-clips/end-slate"
description: "End slate 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/end-slate
...
**Who this is for:** studio users who loaded `services/podcast-clips/end-slate` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/end-slate.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
End slate 16:9. Lab size **1280x704**. Prefix `ez_svc_endsl`.
...
2. Load **services/podcast-clips/end-slate** from **Apps** or **Workflows**
...
**This graph:** `## services/podcast-clips/end-slate Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. End slate 16:9. Lab size **1280x704**. Prefix `ez_svc_endsl`. Empty of le...`
