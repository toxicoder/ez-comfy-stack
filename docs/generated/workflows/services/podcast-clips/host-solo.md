...
Host-solo still 1:1. Lab size **1024×1024**. Prefix `ez_svc_host`.
...
**This graph:** `## services/podcast-clips/host-solo Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Host-solo still 1:1. Lab size **1024×1024**. Prefix `ez_svc_host`. Empty …`
