---
title: "services/podcast-clips/host-solo"
description: "Host-solo still 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/host-solo
...
**Who this is for:** studio users who loaded `services/podcast-clips/host-solo` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/host-solo.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Host-solo still 1:1. Lab size **1024x1024**. Prefix `ez_svc_host`.
...
2. Load **services/podcast-clips/host-solo** from **Apps** or **Workflows**
...
**This graph:** `## services/podcast-clips/host-solo Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Host-solo still 1:1. Lab size **1024x1024**. Prefix `ez_svc_host`. Empty ...`
