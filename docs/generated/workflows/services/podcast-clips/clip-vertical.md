...
Podcast clip still 9:16. Lab size **576×1024**. Prefix `ez_svc_clip_v`.
...
**This graph:** `## services/podcast-clips/clip-vertical Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Podcast clip still 9:16. Lab size **576×1024**. Prefix `ez_svc_clip_v…`
