---
title: "services/podcast-clips/clip-vertical"
description: "Podcast clip still 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/podcast-clips/clip-vertical
...
**Who this is for:** studio users who loaded `services/podcast-clips/clip-vertical` from Apps or Workflows.

> Generated from `workflows/_lab/services/podcast-clips/clip-vertical.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Podcast clip still 9:16. Lab size **576x1024**. Prefix `ez_svc_clip_v`.
...
2. Load **services/podcast-clips/clip-vertical** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Positive | `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ...` |
...
**This graph:** `## services/podcast-clips/clip-vertical Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Podcast clip still 9:16. Lab size **576x1024**. Prefix `ez_svc_clip_v...`
...
**This graph:** `A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Vertical desk still. Quiet lower third for a waveform. Emp...`

```text
A photoreal still of a sunlit oak desk with linen, an unmarked notebook, and a ceramic mug. Screens stay empty of logos. Empty of lettering. Vertical desk still. Quiet lower third for a waveform. Empty of lettering.
```
