...
Reaction still 1:1. Lab size **1024×1024**. Prefix `ez_svc_react`.
...
**This graph:** `## services/performance-ads/reaction-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Reaction still 1:1. Lab size **1024×1024**. Prefix `ez_svc_react`.…`
