---
title: "services/performance-ads/reaction-still"
description: "Reaction still 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/reaction-still
...
**Who this is for:** studio users who loaded `services/performance-ads/reaction-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/reaction-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Reaction still 1:1. Lab size **1024x1024**. Prefix `ez_svc_react`.
...
2. Load **services/performance-ads/reaction-still** from **Apps** or **Workflows**
...
**This graph:** `## services/performance-ads/reaction-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Reaction still 1:1. Lab size **1024x1024**. Prefix `ez_svc_react`....`
