---
title: "services/performance-ads/vertical-ad"
description: "Vertical ad still 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/vertical-ad
...
**Who this is for:** studio users who loaded `services/performance-ads/vertical-ad` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/vertical-ad.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Vertical ad still 9:16. Lab size **576x1024**. Prefix `ez_svc_vert_ad`.
...
2. Load **services/performance-ads/vertical-ad** from **Apps** or **Workflows**
...
**This graph:** `## services/performance-ads/vertical-ad Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Vertical ad still 9:16. Lab size **576x1024**. Prefix `ez_svc_vert_ad...`
