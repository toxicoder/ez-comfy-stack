...
Vertical ad still 9:16. Lab size **576×1024**. Prefix `ez_svc_vert_ad`.
...
**This graph:** `## services/performance-ads/vertical-ad Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Vertical ad still 9:16. Lab size **576×1024**. Prefix `ez_svc_vert_ad…`
