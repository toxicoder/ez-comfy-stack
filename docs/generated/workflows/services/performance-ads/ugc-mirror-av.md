---
title: "services/performance-ads/ugc-mirror-av"
description: "UGC mirror AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/ugc-mirror-av
...
**Who this is for:** studio users who loaded `services/performance-ads/ugc-mirror-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/ugc-mirror-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
UGC mirror AV 9:16. Lab size **768x1280**. Prefix `ez_svc_ugc_mir`.
...
2. Load **services/performance-ads/ugc-mirror-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Mirror selfie take from the start still. Soft room tone. No score. Keep every o...` |
...
**This graph:** `## services/performance-ads/ugc-mirror-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. UGC mirror AV 9:16. Lab size **768x1280**. Prefix `ez_svc_ugc_mir`....`
...
**This graph:** `Mirror selfie take from the start still. Soft room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Mirror selfie take from the start still. Soft room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/performance-ads/ugc-mirror-av`
