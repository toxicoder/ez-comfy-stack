...
UGC mirror AV 9:16. Lab size **768×1280**. Prefix `ez_svc_ugc_mir`.
...
**This graph:** `## services/performance-ads/ugc-mirror-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. UGC mirror AV 9:16. Lab size **768×1280**. Prefix `ez_svc_ugc_mir`.…`
