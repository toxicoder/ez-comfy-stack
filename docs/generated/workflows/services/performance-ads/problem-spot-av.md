...
Problem-spot AV 9:16. Lab size **768×1280**. Prefix `ez_svc_prob`.
...
**This graph:** `## services/performance-ads/problem-spot-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Problem-spot AV 9:16. Lab size **768×1280**. Prefix `ez_svc_prob`…`
