---
title: "services/performance-ads/problem-spot-av"
description: "Problem-spot AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/problem-spot-av
...
**Who this is for:** studio users who loaded `services/performance-ads/problem-spot-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/problem-spot-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Problem-spot AV 9:16. Lab size **768x1280**. Prefix `ez_svc_prob`.
...
2. Load **services/performance-ads/problem-spot-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Quick problem beat from the start still. World SFX only. No score. Keep every o...` |
...
**This graph:** `## services/performance-ads/problem-spot-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Problem-spot AV 9:16. Lab size **768x1280**. Prefix `ez_svc_prob`...`
...
**This graph:** `Quick problem beat from the start still. World SFX only. No score. Keep every object and surface from the start image; do not redesign.`

```text
Quick problem beat from the start still. World SFX only. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/performance-ads/problem-spot-av`
