---
title: "services/performance-ads/wide-ad"
description: "Wide ad still ~1.91:1"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/wide-ad
...
**Who this is for:** studio users who loaded `services/performance-ads/wide-ad` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/wide-ad.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Wide ad still ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_wide_ad`.
...
2. Load **services/performance-ads/wide-ad** from **Apps** or **Workflows**
...
**This graph:** `## services/performance-ads/wide-ad Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Wide ad still ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_wide_ad`. Em...`
