...
Wide ad still ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_wide_ad`.
...
**This graph:** `## services/performance-ads/wide-ad Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Wide ad still ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_wide_ad`. Em…`
