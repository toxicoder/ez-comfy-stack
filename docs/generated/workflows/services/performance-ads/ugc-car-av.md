---
title: "services/performance-ads/ugc-car-av"
description: "UGC car AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/ugc-car-av
...
**Who this is for:** studio users who loaded `services/performance-ads/ugc-car-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/ugc-car-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
UGC car AV 9:16. Lab size **768x1280**. Prefix `ez_svc_ugc_car`.
...
2. Load **services/performance-ads/ugc-car-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Passenger-seat take from the start still. Soft road hush. No score. Keep every ...` |
...
**This graph:** `## services/performance-ads/ugc-car-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. UGC car AV 9:16. Lab size **768x1280**. Prefix `ez_svc_ugc_car`. Empty...`
...
**This graph:** `Passenger-seat take from the start still. Soft road hush. No score. Keep every object and surface from the start image; do not redesign.`

```text
Passenger-seat take from the start still. Soft road hush. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/performance-ads/ugc-car-av`
