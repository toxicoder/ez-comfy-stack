...
UGC car AV 9:16. Lab size **768×1280**. Prefix `ez_svc_ugc_car`.
...
**This graph:** `## services/performance-ads/ugc-car-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. UGC car AV 9:16. Lab size **768×1280**. Prefix `ez_svc_ugc_car`. Empty…`
