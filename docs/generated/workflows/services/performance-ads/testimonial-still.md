---
title: "services/performance-ads/testimonial-still"
description: "Testimonial still 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/testimonial-still
...
**Who this is for:** studio users who loaded `services/performance-ads/testimonial-still` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/testimonial-still.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Testimonial still 4:5. Lab size **1024x1280**. Prefix `ez_svc_testi`.
...
2. Load **services/performance-ads/testimonial-still** from **Apps** or **Workflows**
...
**This graph:** `## services/performance-ads/testimonial-still Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Testimonial still 4:5. Lab size **1024x1280**. Prefix `ez_svc_t...`
