...
Testimonial still 4:5. Lab size **1024×1280**. Prefix `ez_svc_testi`.
...
**This graph:** `## services/performance-ads/testimonial-still Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Testimonial still 4:5. Lab size **1024×1280**. Prefix `ez_svc_t…`
