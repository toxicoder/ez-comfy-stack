...
Square ad still 1:1. Lab size **1024×1024**. Prefix `ez_svc_sq_ad`.
...
**This graph:** `## services/performance-ads/square-ad Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Square ad still 1:1. Lab size **1024×1024**. Prefix `ez_svc_sq_ad`. Emp…`
