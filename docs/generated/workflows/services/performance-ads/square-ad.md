---
title: "services/performance-ads/square-ad"
description: "Square ad still 1:1"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/square-ad
...
**Who this is for:** studio users who loaded `services/performance-ads/square-ad` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/square-ad.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Square ad still 1:1. Lab size **1024x1024**. Prefix `ez_svc_sq_ad`.
...
2. Load **services/performance-ads/square-ad** from **Apps** or **Workflows**
...
**This graph:** `## services/performance-ads/square-ad Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Square ad still 1:1. Lab size **1024x1024**. Prefix `ez_svc_sq_ad`. Emp...`
