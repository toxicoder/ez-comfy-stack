---
title: "services/performance-ads/ugc-kitchen-av"
description: "UGC kitchen AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/ugc-kitchen-av
...
**Who this is for:** studio users who loaded `services/performance-ads/ugc-kitchen-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/ugc-kitchen-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
UGC kitchen AV 9:16. Lab size **768x1280**. Prefix `ez_svc_ugc_kit`.
...
LTX canvas 768x1280 (width/height must be divisible by 32; 720 and 1080 are invalid). Disclose AI-generated media. No score. Mouths will not match.
...
2. Load **services/performance-ads/ugc-kitchen-av** from **Apps** or **Workflows**
...
| 5 | Motion / prompt | `CLIPTextEncode` | PROMPT |
| 6 | Negative | `CLIPTextEncode` | PROMPT |
| 7 | Size 768x1280 | `LTXVImgToVideo` | SETTINGS |
...
| 17 | Operator note - video output | `Note` | NOTE |
| 18 | Save video (MP4) - open node for preview | `VHS_VideoCombine` | OUTPUT |
| 19 | LTX Prompt Enhance | `EZLTXPromptEnhance` | PROMPT |
| 20 | Audio VAE Decode | `LTXVAudioVAEDecode` | OUTPUT |
| 21 | Negative Prompt Enhance | `EZNegativePromptEnhance` | PROMPT |
| 22 | Quality | `EZQuality` | QUALITY |
| 23 | Format / platform | `EZVideoFormat` | SETTINGS |
| 24 | Describe image | `EZImageDescribe` | INPUT |
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Handheld kitchen take from the start still. Ceramic clink, room tone. No score....` |
...
**This graph:** `## services/performance-ads/ugc-kitchen-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. UGC kitchen AV 9:16. Lab size **768x1280**. Prefix `ez_svc_ugc_kit...`
...
**This graph:** `Handheld kitchen take from the start still. Ceramic clink, room tone. No score. Keep every object and surface from the start image; do not redesign.`

```text
Handheld kitchen take from the start still. Ceramic clink, room tone. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `ceramic clink, room tone, no score`
...
**This graph:** `services/performance-ads/ugc-kitchen-av`
...
**This graph:** `LTX - 9:16 Shorts (768x1280)`
