...
UGC kitchen AV 9:16. Lab size **768×1280**. Prefix `ez_svc_ugc_kit`.
...
LTX canvas 768×1280 (width/height must be divisible by 32; 720 and 1080 are invalid). Disclose AI-generated media. No score. Mouths will not match.
...
**This graph:** `## services/performance-ads/ugc-kitchen-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. UGC kitchen AV 9:16. Lab size **768×1280**. Prefix `ez_svc_ugc_kit…`
