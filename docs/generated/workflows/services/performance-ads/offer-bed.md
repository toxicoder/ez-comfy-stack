...
Offer-bed still 16:9. Lab size **1280×704**. Prefix `ez_svc_offer`.
...
**This graph:** `## services/performance-ads/offer-bed Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Offer-bed still 16:9. Lab size **1280×704**. Prefix `ez_svc_offer`. Emp…`
