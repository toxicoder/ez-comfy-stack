---
title: "services/performance-ads/offer-bed"
description: "Offer-bed still 16:9"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/offer-bed
...
**Who this is for:** studio users who loaded `services/performance-ads/offer-bed` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/offer-bed.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Offer-bed still 16:9. Lab size **1280x704**. Prefix `ez_svc_offer`.
...
2. Load **services/performance-ads/offer-bed** from **Apps** or **Workflows**
...
**This graph:** `## services/performance-ads/offer-bed Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Offer-bed still 16:9. Lab size **1280x704**. Prefix `ez_svc_offer`. Emp...`
