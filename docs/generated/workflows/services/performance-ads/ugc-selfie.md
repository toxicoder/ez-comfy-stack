---
title: "services/performance-ads/ugc-selfie"
description: "Silent UGC selfie 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/ugc-selfie
...
**Who this is for:** studio users who loaded `services/performance-ads/ugc-selfie` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/ugc-selfie.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent UGC selfie 9:16. Lab size **480x832**. Prefix `ez_svc_ugc_self`.
...
2. Load **services/performance-ads/ugc-selfie** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Handheld micro-shake. Keep the start-image face locked. No whip pan. One contin...` |
...
**This graph:** `## services/performance-ads/ugc-selfie Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent UGC selfie 9:16. Lab size **480x832**. Prefix `ez_svc_ugc_self`...`
...
**This graph:** `Handheld micro-shake. Keep the start-image face locked. No whip pan. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Handheld micro-shake. Keep the start-image face locked. No whip pan. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/performance-ads/ugc-selfie`
