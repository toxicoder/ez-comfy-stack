...
Silent UGC selfie 9:16. Lab size **480×832**. Prefix `ez_svc_ugc_self`.
...
**This graph:** `## services/performance-ads/ugc-selfie Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent UGC selfie 9:16. Lab size **480×832**. Prefix `ez_svc_ugc_self`…`
