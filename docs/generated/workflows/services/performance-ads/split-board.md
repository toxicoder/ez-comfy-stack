---
title: "services/performance-ads/split-board"
description: "Split-board still ~1.91:1"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/split-board
...
**Who this is for:** studio users who loaded `services/performance-ads/split-board` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/split-board.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Split-board still ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_split`.
...
2. Load **services/performance-ads/split-board** from **Apps** or **Workflows**
...
**This graph:** `## services/performance-ads/split-board Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Split-board still ~1.91:1. Lab size **1216x640**. Prefix `ez_svc_spli...`
