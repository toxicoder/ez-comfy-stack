...
Split-board still ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_split`.
...
**This graph:** `## services/performance-ads/split-board Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Split-board still ~1.91:1. Lab size **1216×640**. Prefix `ez_svc_spli…`
