---
title: "services/performance-ads/stitch-setup"
description: "Silent stitch-setup 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/stitch-setup
...
**Who this is for:** studio users who loaded `services/performance-ads/stitch-setup` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/stitch-setup.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent stitch-setup 9:16. Lab size **480x832**. Prefix `ez_svc_stitch`.
...
2. Load **services/performance-ads/stitch-setup** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Talent steps into the start-image mark. Locked vertical. One continuous five-se...` |
...
**This graph:** `## services/performance-ads/stitch-setup Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent stitch-setup 9:16. Lab size **480x832**. Prefix `ez_svc_stitc...`
...
**This graph:** `Talent steps into the start-image mark. Locked vertical. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Talent steps into the start-image mark. Locked vertical. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/performance-ads/stitch-setup`
