...
Silent stitch-setup 9:16. Lab size **480×832**. Prefix `ez_svc_stitch`.
...
**This graph:** `## services/performance-ads/stitch-setup Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent stitch-setup 9:16. Lab size **480×832**. Prefix `ez_svc_stitc…`
