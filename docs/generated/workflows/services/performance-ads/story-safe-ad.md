...
Story-safe ad still 9:16. Lab size **576×1024**. Prefix `ez_svc_story`.
...
**This graph:** `## services/performance-ads/story-safe-ad Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Story-safe ad still 9:16. Lab size **576×1024**. Prefix `ez_svc_sto…`
