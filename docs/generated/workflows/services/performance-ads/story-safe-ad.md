---
title: "services/performance-ads/story-safe-ad"
description: "Story-safe ad still 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/story-safe-ad
...
**Who this is for:** studio users who loaded `services/performance-ads/story-safe-ad` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/story-safe-ad.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Story-safe ad still 9:16. Lab size **576x1024**. Prefix `ez_svc_story`.
...
2. Load **services/performance-ads/story-safe-ad** from **Apps** or **Workflows**
...
**This graph:** `## services/performance-ads/story-safe-ad Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Story-safe ad still 9:16. Lab size **576x1024**. Prefix `ez_svc_sto...`
