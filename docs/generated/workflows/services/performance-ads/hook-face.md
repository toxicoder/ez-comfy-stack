---
title: "services/performance-ads/hook-face"
description: "Silent hook-face punch 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/hook-face
...
**Who this is for:** studio users who loaded `services/performance-ads/hook-face` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/hook-face.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent hook-face punch 9:16. Lab size **480x832**. Prefix `ez_svc_hk_face`.
...
2. Load **services/performance-ads/hook-face** from **Apps** or **Workflows**
...
| 8 | I2V size 480x832 x 121 | `Wan22ImageToVideoLatent` | SETTINGS |
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Punch-in toward the start-image face in the first second, then hold. One contin...` |
...
**This graph:** `## services/performance-ads/hook-face Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent hook-face punch 9:16. Lab size **480x832**. Prefix `ez_svc_hk_fa...`
...
**This graph:** `Punch-in toward the start-image face in the first second, then hold. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Punch-in toward the start-image face in the first second, then hold. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/performance-ads/hook-face`
...
**This graph:** `Wan - 9:16 Shorts (480x832)`
