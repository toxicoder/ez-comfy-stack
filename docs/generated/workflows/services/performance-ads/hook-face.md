...
Silent hook-face punch 9:16. Lab size **480×832**. Prefix `ez_svc_hk_face`.
...
| 8 | I2V size 480x832 x 121 | `Wan22ImageToVideoLatent` | Ungrouped |
...
**This graph:** `## services/performance-ads/hook-face Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent hook-face punch 9:16. Lab size **480×832**. Prefix `ez_svc_hk_fa…`
...
**This graph:** `Wan · 9:16 Shorts (480×832)`
