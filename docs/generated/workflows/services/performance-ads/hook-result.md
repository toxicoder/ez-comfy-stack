...
Silent result-hook ~5 s. Lab size **832×480**. Prefix `ez_svc_hk_res`.
...
**This graph:** `## services/performance-ads/hook-result Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Silent result-hook ~5 s. Lab size **832×480**. Prefix `ez_svc_hk_res`…`
