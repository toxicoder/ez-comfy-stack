---
title: "services/performance-ads/hook-result"
description: "Silent result-hook ~5 s"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/hook-result
...
**Who this is for:** studio users who loaded `services/performance-ads/hook-result` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/hook-result.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Silent result-hook ~5 s. Lab size **832x480**. Prefix `ez_svc_hk_res`.
...
2. Load **services/performance-ads/hook-result** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Reveal the start-image result. Gentle light lift. One continuous five-second ta...` |
...
**This graph:** `## services/performance-ads/hook-result Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Silent result-hook ~5 s. Lab size **832x480**. Prefix `ez_svc_hk_res`...`
...
**This graph:** `Reveal the start-image result. Gentle light lift. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.`

```text
Reveal the start-image result. Gentle light lift. One continuous five-second take. No cut. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/performance-ads/hook-result`
