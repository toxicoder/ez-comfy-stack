...
Problem-hook still 4:5. Lab size **1024×1280**. Prefix `ez_svc_hk_prob`.
...
**This graph:** `## services/performance-ads/hook-problem Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Problem-hook still 4:5. Lab size **1024×1280**. Prefix `ez_svc_hk_pr…`
