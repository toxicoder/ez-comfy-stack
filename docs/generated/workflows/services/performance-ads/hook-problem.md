---
title: "services/performance-ads/hook-problem"
description: "Problem-hook still 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/hook-problem
...
**Who this is for:** studio users who loaded `services/performance-ads/hook-problem` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/hook-problem.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Problem-hook still 4:5. Lab size **1024x1280**. Prefix `ez_svc_hk_prob`.
...
2. Load **services/performance-ads/hook-problem** from **Apps** or **Workflows**
...
**This graph:** `## services/performance-ads/hook-problem Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Problem-hook still 4:5. Lab size **1024x1280**. Prefix `ez_svc_hk_pr...`
