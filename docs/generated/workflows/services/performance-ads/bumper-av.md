---
title: "services/performance-ads/bumper-av"
description: "Bumper AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/bumper-av
...
**Who this is for:** studio users who loaded `services/performance-ads/bumper-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/bumper-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Bumper AV 9:16. Lab size **768x1280**. Prefix `ez_svc_bumper`.
...
2. Load **services/performance-ads/bumper-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Short punch-in bumper from the start still. Soft whoosh. No score. Keep every o...` |
...
**This graph:** `## services/performance-ads/bumper-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Bumper AV 9:16. Lab size **768x1280**. Prefix `ez_svc_bumper`. Empty of...`
...
**This graph:** `Short punch-in bumper from the start still. Soft whoosh. No score. Keep every object and surface from the start image; do not redesign.`

```text
Short punch-in bumper from the start still. Soft whoosh. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/performance-ads/bumper-av`
