...
Bumper AV 9:16. Lab size **768×1280**. Prefix `ez_svc_bumper`.
...
**This graph:** `## services/performance-ads/bumper-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Bumper AV 9:16. Lab size **768×1280**. Prefix `ez_svc_bumper`. Empty of…`
