...
Talent on a plain wall 4:5. Lab size **1024×1280**. Prefix `ez_svc_talent`.
...
**This graph:** `## services/performance-ads/talent-plain-wall Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Talent on a plain wall 4:5. Lab size **1024×1280**. Prefix `ez_…`
