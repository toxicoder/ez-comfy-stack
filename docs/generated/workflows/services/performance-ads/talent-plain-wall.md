---
title: "services/performance-ads/talent-plain-wall"
description: "Talent on a plain wall 4:5"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/talent-plain-wall
...
**Who this is for:** studio users who loaded `services/performance-ads/talent-plain-wall` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/talent-plain-wall.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Talent on a plain wall 4:5. Lab size **1024x1280**. Prefix `ez_svc_talent`.
...
2. Load **services/performance-ads/talent-plain-wall** from **Apps** or **Workflows**
...
**This graph:** `## services/performance-ads/talent-plain-wall Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Talent on a plain wall 4:5. Lab size **1024x1280**. Prefix `ez_...`
