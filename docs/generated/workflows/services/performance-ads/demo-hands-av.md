---
title: "services/performance-ads/demo-hands-av"
description: "Demo-hands AV 9:16"
tags: [workflows, generated, comfyui, services]
---

# services/performance-ads/demo-hands-av
...
**Who this is for:** studio users who loaded `services/performance-ads/demo-hands-av` from Apps or Workflows.

> Generated from `workflows/_lab/services/performance-ads/demo-hands-av.json`. Do not hand-edit this file. Re-run `python3 docs/generate_workflow_docs.py` (or `make docs`).
...
Demo-hands AV 9:16. Lab size **768x1280**. Prefix `ez_svc_demo`.
...
2. Load **services/performance-ads/demo-hands-av** from **Apps** or **Workflows**
...
| Instance | Value |
| --- | --- |
| Motion / prompt | `Hands demonstrate the start-image product. Soft taps. No score. Keep every obje...` |
...
**This graph:** `## services/performance-ads/demo-hands-av Format / platform sets pixels (Custom uses Width x Height). Quality does not change size. Demo-hands AV 9:16. Lab size **768x1280**. Prefix `ez_svc_demo`. Em...`
...
**This graph:** `Hands demonstrate the start-image product. Soft taps. No score. Keep every object and surface from the start image; do not redesign.`

```text
Hands demonstrate the start-image product. Soft taps. No score. Keep every object and surface from the start image; do not redesign.
```
...
**This graph:** `services/performance-ads/demo-hands-av`
