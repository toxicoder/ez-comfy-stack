...
Demo-hands AV 9:16. Lab size **768×1280**. Prefix `ez_svc_demo`.
...
**This graph:** `## services/performance-ads/demo-hands-av Format / platform sets pixels (Custom uses Width × Height). Quality does not change size. Demo-hands AV 9:16. Lab size **768×1280**. Prefix `ez_svc_demo`. Em…`
