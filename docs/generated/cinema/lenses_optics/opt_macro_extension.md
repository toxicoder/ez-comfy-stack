...
description: "Cinema Rack illustration — Macro extension."
...
- A muted 5s illustration of **Macro extension** (`opt_macro_extension`)
...
<video controls preload="none" playsinline poster="../../../assets/cinema/lenses_optics/opt_macro_extension.jpg"><source src="../../../assets/cinema/lenses_optics/opt_macro_extension.mp4" type="video/mp4"></video>
</div>

## Clause

Macro extension, pores and weave as landscape.
