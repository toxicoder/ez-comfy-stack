---
title: "Clear zero"
description: "Cinema Rack illustration — Clear zero."
...
- A muted 5s illustration of **Clear zero** (`opt_clear_zero`)
...
<video controls preload="none" playsinline poster="../../../assets/cinema/lenses_optics/opt_clear_zero.jpg"><source src="../../../assets/cinema/lenses_optics/opt_clear_zero.mp4" type="video/mp4"></video>
</div>

## Clause

No taking filter, maximum bite and contrast.
