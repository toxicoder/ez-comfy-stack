...
| `_lab/audio/albums/drive-through/<album>/` | Six Drive-through albums (101 ACE-Step bass-set EDM takes, 150–480 s, short build then switch-ups, tempos 165–176 + cover + album pack; ninety-nine instrumental, two DJ-shout treats). SaveAudio stem `NN - Song Title`. Catalog: [Local music](../music.md) |
