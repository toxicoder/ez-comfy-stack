...
| `motion/av/still-to-video-12s.json` | LTX-2.5 I2V ~5 s with audio muxed into MP4 (121) |
| `motion/av/text-to-video-12s.json` | LTX-2.5 T2V ~5 s with audio muxed into MP4 |
...
| `motion/av/shorts-still-12s.json` | Vertical AV Shorts I2V |
