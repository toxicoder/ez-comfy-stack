...
| `_lab/audio/albums/drive-through/<album>/` | Five Drive-through albums (85 ACE-Step bass-set EDM takes, 150–480 s, short build then switch-ups, tempos 165–176 + cover + album pack; eighty-three instrumental, two DJ-shout treats). SaveAudio stem `NN - Song Title`. Catalog: [Local music](../music.md) |
