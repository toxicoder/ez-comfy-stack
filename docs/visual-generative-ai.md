...
3. **Motion** — same PNG into **motion/av/still-to-video-5s** (LTX-2.5 I2V). Prompt only the motion and sound. Let LTX’s own 2× upscaler / DFR Templates handle resolution.
