...
| Workflow | What it does |
| --- | --- |
| **[motion/av/still-to-video-8s](../generated/workflows/motion/av/still-to-video-8s.md)** | ~8 s I2V. Default **1280×704**; **Format / platform** (LTX 16:9 / 9:16 / Custom, never 720). Native audio (Community License, $10M cap) |
...
| **[motion/av/text-to-video-8s](../generated/workflows/motion/av/text-to-video-8s.md)** | ~8 s T2V AV. Default **1280×704**; same Format / platform combo |

---

## Showcase (LTX-2.5)

Authored recipes. Prompt Enhance **off**. Occupancy **ltx**. Same 8.00 s / 193 / **1280×704** printer as the heroes. Two-stage DFR stays in Comfy **Templates → LTX-2.5**.
...
Shipped **[motion/av/clip-chain](../generated/workflows/motion/av/clip-chain.md)** is four beats. Duplicate **Beat** groups on the canvas for longer chains. App Mode will not pick up Beat 5+ prompts. 4 × 8 s sequential prints are tens of minutes on GB10. Occupancy **ltx** XOR.
