...
| Workflow | What it does |
| --- | --- |
| **[motion/av/still-to-video-12s](../generated/workflows/motion/av/still-to-video-12s.md)** | ~12 s I2V. Default **1280×704**; **Format / platform** (LTX 16:9 / 9:16 / Custom, never 720). Native audio (Community License, $10M cap) |
| **[motion/av/text-to-video-12s](../generated/workflows/motion/av/text-to-video-12s.md)** | ~12 s T2V AV. Default **1280×704**; same Format / platform combo |
...
| Workflow | What it does |
| --- | --- |
| **[motion/av/dialogue-12s](../generated/workflows/motion/av/dialogue-12s.md)** | T2V with a quoted spoken line + interleaved foley. `LTXVModalityGuidance` (A/V coupling). Prefix `ez_ltx_dialogue`. Mouths will not match |
| **[motion/av/multishot-12s](../generated/workflows/motion/av/multishot-12s.md)** | Native multishot T2V: named hard cut + match cut in one 12 s clip. Prefix `ez_ltx_multishot` |
...
| **[motion/av/first-last-12s](../generated/workflows/motion/av/first-last-12s.md)** | First-last-frame AV. Two Klein stills pin start/end via `LTXVAddGuide` on the video latent (before audio concat). Prefix `ez_ltx_flf` |
| **[motion/av/audio-to-video-12s](../generated/workflows/motion/av/audio-to-video-12s.md)** | Audio freeze: `LoadAudio` → encode into the joint latent; MP4 muxes the **original** wav (no audio VAE decode). Prefix `ez_ltx_a2v`. Drop `ez_a2v_bed.wav` in `${COMFY_OUTPUT_DIR}/input` |
...
| **[motion/av/shorts-still-12s](../generated/workflows/motion/av/shorts-still-12s.md)** | Vertical AV I2V (~12 s) with world audio |
