...
| --- | --- |
| **[wan/i2v-5s](../generated/workflows/wan/i2v-5s.md)** | Silent I2V smoke, 832×480, **121** frames @ 24 fps. MagCache **draft-only** (`extra.lab_magcache`) |
| **[wan/flf-5s](../generated/workflows/wan/flf-5s.md)** | Fun InP first-last-frame 5 s (opt-in `download-wan --tier fun-inp`). MagCache off |
...
| **[optional/wan/i2v-a14b](../generated/workflows/optional/wan/i2v-a14b.md)** | Optional A14B FP8: high+low UNET on canvas, Queue on high-noise 8-step (`download-wan --tier a14b`). MagCache off. Unload 5B first. Under `_lab/optional/` |
...
| **[wan/t2v-5s](../generated/workflows/wan/t2v-5s.md)** | Silent T2V smoke, 121 frames (LoadImage bypassed) |
| **[wan/i2v-shot](../generated/workflows/wan/i2v-shot.md)** | Concat-safe **120** frames + last-frame SaveImage. 90s shots, or prefix `ez_shot_01..06` |
...
| Workflow | What it does |
| --- | --- |
| **[ltx/i2v-5s](../generated/workflows/ltx/i2v-5s.md)** | ~5 s I2V, **1280×704**, native audio (Community License, $10M cap) |
| **[ltx/t2v-5s](../generated/workflows/ltx/t2v-5s.md)** | ~5 s T2V AV, **1280×704** |
...
| **[ltx/flf-5s](../generated/workflows/ltx/flf-5s.md)** | First-last-frame AV. Two Klein stills pin start/end via `LTXVAddGuide` on the video latent (before audio concat). Prefix `ez_ltx_flf` |
| **[ltx/a2v-5s](../generated/workflows/ltx/a2v-5s.md)** | Audio freeze: `LoadAudio` → encode into the joint latent; MP4 muxes the **original** wav (no audio VAE decode). Prefix `ez_ltx_a2v`. Drop `ez_a2v_bed.wav` in `${COMFY_OUTPUT_DIR}/input` |
...
| Workflow | What it does |
| --- | --- |
| **[wan/shorts-i2v](../generated/workflows/wan/shorts-i2v.md)** | Vertical silent I2V from that still |
| **[ltx/shorts-i2v](../generated/workflows/ltx/shorts-i2v.md)** | Vertical AV I2V (~5 s) with world audio |
...
| Workflow | What it does |
| --- | --- |
| **[wan/orbit-i2v](../generated/workflows/wan/orbit-i2v.md)** | Slow orbit I2V ~5 s |
| **[wan/push-in-i2v](../generated/workflows/wan/push-in-i2v.md)** | Hero push-in I2V ~5 s |
| **[wan/parallax-i2v](../generated/workflows/wan/parallax-i2v.md)** | Subtle parallax I2V ~5 s |
...
90s shot printers (**[wan/i2v-shot](../generated/workflows/wan/i2v-shot.md)**, **[ltx/i2v-shot](../generated/workflows/ltx/i2v-shot.md)**) live with the films: [Film catalog](workflows-film.md).
