...
Five Drive-through albums under `_lab/audio/albums/drive-through/<album>/`. Warped hybrid-trap bass set spliced from [Audio Rack](audio-rack.md) (not rap over a club bed). Short build, then a heavy drop, then switch-ups. 150–480 s, tempos 165–176, chest-sub bass, no brass or high leads. Headliner / Afterparty / Secret Homage vary Comfy node placement. EDM playbook: [Drive-through EDM](music-edm.md).
...
| **[audio/albums/drive-through/hour-1/07-wide-open](../generated/workflows/audio/albums/drive-through/hour-1.md)** | color bass **168**, seed **239** | `07 - Wide Open` | **DJ shout treat.** Color bass warp |
...
| **[audio/albums/drive-through/hour-1/09-second-wave](../generated/workflows/audio/albums/drive-through/hour-1.md)** | warped hybrid-trap **168**, seed **241** | `09 - Second Wave` | **DJ shout treat.** Hybrid trap warp |
