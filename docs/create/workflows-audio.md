...
| --- | --- |
| **[audio/dub/localize](../generated/workflows/audio/dub/localize.md)** | Multi-speaker clone-and-translate. Pick or upload source media. Rights gate. **Clone CFG** auto 0 on EN→ES. Duration-locked `ez_dub_yt` for YouTube Languages. Prefix `ez_dub_mix` |
| **[audio/podcast/audio-first](../generated/workflows/audio/podcast/audio-first.md)** | Two-host episode. Kokoro stock voices + ACE-Step instrumental bed. Prefix `ez_podcast_ep` |
