...
description: Eighty-five 180 s warped hybrid-trap EDM takes (Hour 1–2, Headliner, Afterparty, Secret Homage) on ACE-Step.
...
- **Eighty-five 180 s original Drive-through EDM takes** (eighty-three instrumental, two DJ-shout treats) without cloud music APIs
...
| --- | --- | --- | --- |
| **01-night-window** | warped hybrid-trap **145**, seed **193** | `01 - Night Window` | Drop-first hybrid trap warp |
...
| **09-second-wave** | warped hybrid-trap **150**, seed **241** | `09 - Second Wave` | **DJ shout treat.** Drop-first hybrid trap warp |
...
| Graph | Tags / bpm | Prefix | Take |
| --- | --- | --- | --- |
| **01-rumble-strip** | warped hybrid-trap **140**, seed **271** | `01 - Rumble Strip` | Drop-first hybrid trap warp |
...
| **09-groove-mile** | warped hybrid-trap **144**, seed **317** | `09 - Groove Mile` | Drop-first hybrid trap warp |
...
| **13-night-oil** | warped hybrid-trap **142**, seed **349** | `13 - Night Oil` | Drop-first hybrid trap warp |
...
| Graph | Tags / bpm | Prefix | Take |
| --- | --- | --- | --- |
| **01-lantern-merge** | warped hybrid-trap **150**, seed **367** | `01 - Lantern Merge` | Drop-first hybrid trap warp |
...
| **06-fern-stack** | warped hybrid-trap **155**, seed **397** | `06 - Fern Stack` | Drop-first hybrid trap warp |
...
| **15-ember-crest** | warped hybrid-trap **165**, seed **449** | `15 - Ember Crest` | Drop-first hybrid trap warp |
...
| **02-diesel-hum** | warped hybrid-trap **152**, seed **461** | `02 - Diesel Hum` | Drop-first hybrid trap warp |
...
| **11-haul-crate** | warped hybrid-trap **170**, seed **521** | `11 - Haul Crate` | Drop-first hybrid trap warp |
...
| **20-trailer-hitch** | warped hybrid-trap **165**, seed **587** | `20 - Trailer Hitch` | Drop-first hybrid trap warp |
...
| **06-dummy-light** | warped hybrid-trap **145**, seed **617** | `06 - Dummy Light` | Drop-first hybrid trap warp |
...
| **11-hidden-booth** | warped hybrid-trap **140**, seed **647** | `11 - Hidden Booth` | Drop-first hybrid trap warp |
...
| **19-cold-cache** | warped hybrid-trap **142**, seed **701** | `19 - Cold Cache` | Drop-first hybrid trap warp |
