...
- Copying a family CLIP string into **stills/still-draft**, **motion/silent/text-to-video-5s**, or **motion/av/text-to-video-12s**
...
3. Paste into **stills/still-draft**, **motion/silent/text-to-video-5s**, or **motion/av/text-to-video-12s**. For I2V, set Family to `wan_i2v` / `ltx_i2v` first so look axes are already omitted.
