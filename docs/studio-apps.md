...
- Creator widgets: Quality (Lab / Draft / High / Free Commercial Use), Prompt, Style, Rewrite prompt, Seed (unique labels, wired LoadImage / LoadAudio)
