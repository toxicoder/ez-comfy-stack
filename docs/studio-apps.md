...
| App | What it does |
| --- | --- |
| **klein-still-draft-lab-example** | Spark Still. 768×432, seed 42, Enhance off on the identity. Prefix `ez_still_draft` |
| **klein-identity-sheet-lab-example** | Front / three-quarter / profile. 1280×704, Enhance off |
| **klein-storyboard-6up-lab-example** | Six new cameras of one rooftop (`ez_board_01`…`06`) |
| **klein-dream-house-lab-example** | World bible. Ten 4:5 stills, independent T2I, Enhance off on the bible |
