...
| `_lab/audio/drive-through/phaseN/music-edm-drive-through-*-lab-example.json` | Thirty ACE-Step 180 s Drive-through rave-set EDM takes (phase0 hour 1, phase1 hour 2; twenty-eight instrumental, two DJ-shout treats). Prefix `Drive-through - Song Title - vN`. American festival EDM, drop-early dirty pyro. Catalog: [Local music](music.md) |
