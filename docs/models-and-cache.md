...
| `_lab/audio/drive-through/music-edm-drive-through-*-lab-example.json` | Fifteen ACE-Step 180 s Drive-through rave-set EDM takes (thirteen instrumental, two DJ-shout treats). Catalog: [Local music](music.md) |
