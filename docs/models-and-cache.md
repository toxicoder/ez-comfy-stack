...
| `_lab/audio/drive-through/phaseN/music-edm-drive-through-*-lab-example.json` | Forty-five ACE-Step 180 s Drive-through rave-set EDM takes (phase0 hour 1, phase1 hour 2, phase2 hour 3 headliner; forty-three instrumental, two DJ-shout treats). Prefix `Drive-through - Song Title - vN`. American festival EDM, drop-early dirty pyro. Catalog: [Local music](music.md) |
