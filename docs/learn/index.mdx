...
8. Optional DCC: [Clay to finish](clay-to-finish.md) · [Blender creator suite](blender-creator.md) · [Dream-house tours](dream-house.md)
9. [Glossary](../glossary.md) — dictionary, not the course
