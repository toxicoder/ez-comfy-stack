...
description: Why the US-safe studio is still -> silent 5 s -> AV 8 s, and how each model reads a prompt.
...
**Handoff:** Queue a Klein still -> set Wan **LoadImage** to that PNG -> optional LTX I2V from the **same** first frame at **1280x704** (portrait **768x1280**).
