...
- **One hundred one original Drive-through EDM takes** (150–480 s, short builds, fast tempos) without cloud music APIs
...
<Cards>
  ...
  <Card title="Drive-through EDM">
    ...
    Six bass-set albums (101 takes, 150–480 s). Short build, heavy drop, then switch-ups. Tempos 165–176. Not rap over a club bed.
