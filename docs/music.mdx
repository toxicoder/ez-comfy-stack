...
- **One hundred one original Drive-through EDM takes** (~90-120 s, fast switch-ups, 165-176 BPM) without cloud music APIs
...
<Cards>
  ...
  <Card title="Drive-through EDM">
    ...
    Six bass-set albums (101 takes, ~90-120 s). The score covers the full take: beds, layers, and 3D moves rotate every 2 bars. Tempos 165-176. Not rap over a club bed.
...
# Square covers letterbox onto 1920x1080. Shorts: --size 1080x1920
```
