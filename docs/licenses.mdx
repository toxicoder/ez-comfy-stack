...
| **Opt-in** | Podcast (Kokoro, ACE-Step), rap AIO, Qwen3.6-35B-A3B GGUF (`download-llm --tier qwen36-35b-a3b`, occupancy `llm-desk`), describe VLM (`download-llm --tier describe`), Z-Image, Wan A14B, Fun InP, TRELLIS.2, … |
