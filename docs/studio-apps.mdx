...
| **stills/background-swap** | klein | `ez_bg_swap` — replace backdrop, ground, and nearby set dressing; empty Flux.2 canvas + ReferenceLatent; match source size. Other/background character toggles |
