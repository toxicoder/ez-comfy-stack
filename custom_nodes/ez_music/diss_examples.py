...
Hypothesis dead, the rumor spent
...
Dark pad hums while the real you breaks
...
The 808 is loud, the dose is none
...
Dark pad waiting to cash the take
Nill Bye mad in a quiet lab
Rake in his feels with a rented cab
Club-talk medicine, science kit
One of us measured, and one of us quit
...
Club talk folds when the whiskers read
...
LAB_NOTEBOOK_LYRICS = """[intro]
ink still wet
Nill Bye logging

[verse]
Rake keeps a legend in a group-chat haze
I keep a notebook with a dated page
Club-talk lore with a missing time
That's a rumor that will not rhyme
I stamp the hour, I stamp the flask
You stamp a story, then you duck the ask
...
Lab notebook truth, that is the call
...
Science writes, club talk fades
...
Lab book closed, that is the quote
...
OFFICE_HOURS_LYRICS = """[intro]
soft drums
door open
Nill Bye waiting

[verse]
Rake booked a slot, then he ghosted the hall
Talks a high like he gave it his all
Office hours empty, the chalkboard clean
Your whole brand is a no-show scene
I respect struggle, I reject the skip
You wear the cool like a scholarship
Laid-back loop, high-key fail
Sad-boy mask on a rented tale
You tell the night it was all so deep
I tell the night you were fast asleep
...
GRANT_DENIED_LYRICS = """[spoken word]
Grant review
...
Dark pad hums while the real you drains
...
Dark pad waiting to cash the claim
Nill Bye mad in a quiet lab
Rake in his feels with a rented cab
...
Club-talk leak in the sealed envelope
...
Double-blind truth, that is the call
...
That is not a test, that is a show
Double-blind watching as the claim lets go
I hold the still, you hold the bit
I write the truth, you write the hit
...
DISS_EXAMPLES: tuple[DissExample, ...] = (
    ...
    },
    {
        ...
        "duration": DISS_DURATION_S,
        "seed": 37,
        "prefix": "ez_rap_nill_doubleblind",
