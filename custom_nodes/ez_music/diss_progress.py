...
WINTERIZE_WELLS_LYRICS = format_diss_lyrics(
    ...
    chorus=(
        "Winterize wells\n"
        "Nill Bye on the NERC sheet\n"
        "Gas carried the outage, so gas gets the jacket\n"
        "A loophole is not a standard\n"
        "Heat-trace the wellhead, insulate the flange\n"
        "Your grid passes the cold quiz"
    ),
    verses=(
        "Uri taught the isolated bus a physics class\n"
        "Four million dark, pumps dead, hertz falling\n"
        "Nill Bye weatherizing the wellhead first, nercsheet\n"
        "Windmills were a prettier villain. The freeze was the fuel\n"
        "NERC already wrote the winterization ladder\n"
        "Mandatory, audited, no slow-shop carve-out\n"
        "Heat-trace on the separator, jackets on the flange\n"
        "A standard that lives in a binder is not a standard\n"
        "It lives on the steel when the mercury drops\n"
        "Two-thousand-eleven already mailed the warning\n"
        "The body-count made the headline. The flange makes the fix\n"
        "I install the jacket. That is the whole thesis, wellhead",
        "Boom-bap dust on a weatherization ladder\n"
        "Vinyl on a wellhead that learned a coat\n"
        "Nill Bye filing the NERC sheet as a civic tool, flangekit\n"
        "Isolated buses fail alone. Jackets do not care about talking points\n"
        "Weatherize generation and the gas that feeds it\n"
        "A thermal plant is a chain. The weakest link is uninsulated steel\n"
        "FERC can watch. The operator still torques the clamp\n"
        "A loophole for the slow shop is how the next freeze writes itself, heattrace\n"
        "Close the carve-out. Date the audit. Publish the miss\n"
        "A published miss is a gift to the next crew\n"
        "Hide the miss and the hertz fall again, nercsheet\n"
        "Science is a jacket you can put on a pipe",
        "Neighbor watts help when the island is a choice, wellhead\n"
        "Winterize is the on-site half of that sentence, flangekit\n"
        "Nill Bye posting the winterize wells\n"
        "You do not need a miracle state. You need heat-trace\n"
        "You need spare compression, dual-fuel where it pencils\n"
        "You need a drill in November, not a presser in February\n"
        "A drill is cheap. A blackout is a ledger of funerals\n"
        "I want the flange warm. The slogan can wait\n"
        "I want the well producing when the front arrives\n"
        "The front does not read a radio grin, heattrace\n"
        "The front reads insulation R-value and a torque spec\n"
        "Torque specs are how a grid grows up",
        "Keep the dusty drums, print the NERC clause, nercsheet\n"
        "A civic fix is a standard with a date and a photo of the jacket\n"
        "Nill Bye keeping the weatherization ladder\n"
        "Gas froze in the wellhead. So the wellhead gets the coat\n"
        "Wind still spins when the air is cold and the steel is ready\n"
        "Ready is the word. Ready is not a vibe, wellhead\n"
        "Ready is a clamp, a tape, a spare, a night crew\n"
        "Bring the jacket, lose the carve-out\n"
        "The next Uri is a calendar, not a rumor\n"
        "Calendars are science you can hang on a wall, flangekit\n"
        "Hang the ladder. Torque the flange\n"
        "Winterize wells is the whole install, heattrace",
    ),
    outro="flange warm\nhertz hold\ncut\nyeah",
)
