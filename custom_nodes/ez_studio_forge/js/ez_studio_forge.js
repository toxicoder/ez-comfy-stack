/**
 * EZAppForge frontend: read-only path, template, occupancy, and status widgets.
 *
...
/**
 * Fill path, template, occupancy, widgets, and status on a forge node.
 * @param {object} node
 * @param {string} path
...
app.registerExtension({
  ...
  /**
   * Wrap EZAppForge with preview widgets.
