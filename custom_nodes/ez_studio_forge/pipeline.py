...
_TEMPLATE_RULES: tuple[tuple[str, str], ...] = (
    ...
    ("background edit", "stills/background-edit"),
    ("bg edit", "stills/background-edit"),
    ("restyle background", "stills/background-edit"),
    ("cartoon background", "stills/background-edit"),
    ...
    ("dialogue", "motion/av/dialogue-8s"),
    ...
    ("a2v", "motion/av/audio-to-video-8s"),
    ("foley", "motion/av/still-to-video-8s"),
    ("silent", "motion/silent/still-to-video-5s"),
    ("i2v", "motion/silent/still-to-video-5s"),
    ("ltx", "motion/av/still-to-video-8s"),
    ("wan", "motion/silent/still-to-video-5s"),
    ("av", "motion/av/still-to-video-8s"),
