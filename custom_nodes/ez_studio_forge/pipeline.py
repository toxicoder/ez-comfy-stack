...
_TEMPLATE_RULES: tuple[tuple[str, str], ...] = (
    ("pinterest", "klein/creator/pinterest-pin"),
    ("idea pin", "klein/creator/pinterest-story"),
    ...
    ("highlight", "klein/creator/instagram-highlight"),
    ("carousel", "klein/creator/instagram-carousel-5"),
    ("channel art", "klein/creator/youtube-channel-art"),
    ("channel icon", "klein/creator/youtube-channel-icon"),
    ("shorts thumb", "klein/creator/youtube-shorts-thumb"),
    ("audiogram", "klein/creator/audiogram-wide"),
    ("linkedin banner", "klein/creator/linkedin-banner"),
    ("zoom background", "klein/creator/zoom-bg"),
    ("merch", "klein/creator/merch-tee"),
    ("image studio", "klein/image-studio"),
    ("still studio", "klein/still-studio"),
    ("background swap", "klein/image-studio"),
    ("face swap", "klein/image-studio"),
    ("creator mode", "klein/image-studio"),
    ("platform still", "klein/still-studio"),
    ("format still", "klein/still-studio"),
    ("instagram-square", "klein/instagram-square"),
    ("1:1", "klein/instagram-square"),
    ("square", "klein/instagram-square"),
    ("text swap", "klein/text-swap"),
    ("text-swap", "klein/text-swap"),
    ("replace text", "klein/text-swap"),
    ("relabel", "klein/text-swap"),
    ("lettering", "klein/text-swap"),
    ("thumbnail", "klein/thumbnail"),
    ("open-graph", "klein/open-graph"),
    ("og image", "klein/open-graph"),
    ("banner", "klein/banner-wide"),
    ("packshot", "klein/product-packshot"),
    ("sticker", "wan/sticker-loop"),
    ("bumper", "wan/bumper-loop"),
    ("gif", "wan/gif-loop"),
    ("loop", "wan/gif-loop"),
    ("dialogue", "ltx/dialogue-5s"),
    ...
    ("a2v", "ltx/audio-to-video-5s"),
    ("foley", "ltx/still-to-video-5s"),
    ("silent", "wan/still-to-video-5s"),
    ("i2v", "wan/still-to-video-5s"),
    ("ltx", "ltx/still-to-video-5s"),
    ("wan", "wan/still-to-video-5s"),
    ("av", "ltx/still-to-video-5s"),
    ("still", "klein/still-draft"),
    ("plate", "klein/still-draft"),
)

DEFAULT_TEMPLATE = "klein/still-draft"
