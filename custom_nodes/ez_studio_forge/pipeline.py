...
_TEMPLATE_RULES: tuple[tuple[str, str], ...] = (
    ...
    ("background swap", "stills/image-studio"),
    ...
    ("dialogue", "motion/av/dialogue-5s"),
    ...
    ("a2v", "motion/av/audio-to-video-5s"),
    ("foley", "motion/av/still-to-video-5s"),
    ("silent", "motion/silent/still-to-video-5s"),
    ("i2v", "motion/silent/still-to-video-5s"),
    ("ltx", "motion/av/still-to-video-5s"),
    ("wan", "motion/silent/still-to-video-5s"),
    ("av", "motion/av/still-to-video-5s"),
