...
_TEMPLATE_RULES: tuple[tuple[str, str], ...] = (
    ...
    ("dialogue", "motion/av/dialogue-10s"),
    ...
    ("a2v", "motion/av/audio-to-video-10s"),
    ("foley", "motion/av/still-to-video-10s"),
    ("silent", "motion/silent/still-to-video-5s"),
    ("i2v", "motion/silent/still-to-video-5s"),
    ("ltx", "motion/av/still-to-video-10s"),
    ("wan", "motion/silent/still-to-video-5s"),
    ("av", "motion/av/still-to-video-10s"),
