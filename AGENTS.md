...
This is a **sample** stack. Do not pull in K3s, Bazel, full dashboard, or multi-node NCCL. Point long-term users at nvidia-dgx-spark-lab. H3 farm uses 3 independent Comfy workers + shared `MODELS_DIR`; still no in-tree NCCL.
